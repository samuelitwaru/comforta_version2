...
namespace GeneXus.Programs {
   public class gx00d0 : GXDataArea
   {
      ...
      public void execute( out Guid aP0_pProductServiceId )
      {
         this.AV8pProductServiceId = Guid.Empty ;
         ExecuteImpl();
         aP0_pProductServiceId=this.AV8pProductServiceId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV8pProductServiceId = StringUtil.StrToGuid( gxfirstwebparm);
               AssignAttri("", false, "AV8pProductServiceId", AV8pProductServiceId.ToString());
            }
            if ( toggleJsOutput )
            {
               if ( context.isSpaRequest( ) )
      ...
      protected void gxgrGrid1_refresh_invoke( )
      {
         ...
         AV6cProductServiceId = StringUtil.StrToGuid( GetPar( "cProductServiceId"));
         ...
         gxgrGrid1_refresh( subGrid1_Rows, AV6cProductServiceId, AV7cProductServiceName) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00d0.aspx", new object[] {UrlEncode(AV8pProductServiceId.ToString())}, new string[] {"pProductServiceId"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCPRODUCTSERVICEID", AV6cProductServiceId.ToString());
         ...
         GxWebStd.gx_hidden_field( context, "vPPRODUCTSERVICEID", AV8pProductServiceId.ToString());
      ...
      {
         return formatLink("gx00d0.aspx", new object[] {UrlEncode(AV8pProductServiceId.ToString())}, new string[] {"pProductServiceId"})  ;
      }
      ...
      {
         return "Selection List Trn_Product Service" ;
      }
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductserviceidfilter_Internalname, "Product Service Id", "", "", lblLblproductserviceidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e110d1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00D0.htm");
            ...
            GxWebStd.gx_label_element( context, edtavCproductserviceid_Internalname, "Product Service Id", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_34_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCproductserviceid_Internalname, AV6cProductServiceId.ToString(), AV6cProductServiceId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCproductserviceid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCproductserviceid_Visible, edtavCproductserviceid_Enabled, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "", "", false, "", "HLP_Gx00D0.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproductservicenamefilter_Internalname, "Product Service Name", "", "", lblLblproductservicenamefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e120d1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00D0.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e130d1_client"+"'", TempTags, "", 2, "HLP_Gx00D0.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
         ...
         if ( wbEnd == 34 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(34), 2, 0)+","+"null"+");", "Cancel", bttBtn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00D0.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START0D2( )
      {
         ...
         Form.Meta.addItem("description", "Selection List Trn_Product Service", 0) ;
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_34_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrToGuid( cgiGet( "GXH_vCPRODUCTSERVICEID")) != AV6cProductServiceId )
                                       {
                                          Rfr0gs = true;
                                       }
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000D2 */
            pr_default.execute(0, new Object[] {AV6cProductServiceId, lV7cProductServiceName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_34_idx = 1;
            sGXsfl_34_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_34_idx), 4, 0), 4, "0");
            SubsflControlProps_342( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A59ProductServiceName = H000D2_A59ProductServiceName[0];
               A40000ProductServiceImage_GXI = H000D2_A40000ProductServiceImage_GXI[0];
               AssignProp("", false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_34_Refreshing);
               AssignProp("", false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
               A58ProductServiceId = H000D2_A58ProductServiceId[0];
               A61ProductServiceImage = H000D2_A61ProductServiceImage[0];
               AssignProp("", false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_34_Refreshing);
               AssignProp("", false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
               /* Execute user event: Load */
               E150D2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PRODUCTSERVICEID"+"_"+sGXsfl_34_idx, GetSecureSignedToken( sGXsfl_34_idx, A58ProductServiceId, context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV7cProductServiceName = StringUtil.Concat( StringUtil.RTrim( AV7cProductServiceName), "%", "");
         /* Using cursor H000D3 */
         pr_default.execute(1, new Object[] {AV6cProductServiceId, lV7cProductServiceName});
      ...
      protected void STRUP0D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(cgiGet( edtavCproductserviceid_Internalname), "") == 0 )
            {
               AV6cProductServiceId = Guid.Empty;
               AssignAttri("", false, "AV6cProductServiceId", AV6cProductServiceId.ToString());
            }
            else
            {
               try
               {
                  AV6cProductServiceId = StringUtil.StrToGuid( cgiGet( edtavCproductserviceid_Internalname));
                  AssignAttri("", false, "AV6cProductServiceId", AV6cProductServiceId.ToString());
               }
               catch ( Exception  )
               {
                  GX_msglist.addItem(context.GetMessage( "GXM_invalidguid", ""), 1, "vCPRODUCTSERVICEID");
      ...
      protected void E140D2( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Selection List %1", "Trn_Product Service", "", "", "", "", "", "", "", "");
      ...
      protected void E160D2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8pProductServiceId = A58ProductServiceId;
         AssignAttri("", false, "AV8pProductServiceId", AV8pProductServiceId.ToString());
         context.setWebReturnParms(new Object[] {(Guid)AV8pProductServiceId});
         context.setWebReturnParmsMetadata(new Object[] {"AV8pProductServiceId"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8pProductServiceId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV8pProductServiceId", AV8pProductServiceId.ToString());
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492316274628", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00d0.js", "?202492316274628", false, true);
      ...
      protected void SubsflControlProps_342( )
      {
         ...
         edtProductServiceId_Internalname = "PRODUCTSERVICEID_"+sGXsfl_34_idx;
         edtProductServiceImage_Internalname = "PRODUCTSERVICEIMAGE_"+sGXsfl_34_idx;
      }

      protected void SubsflControlProps_fel_342( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_34_fel_idx;
         edtProductServiceId_Internalname = "PRODUCTSERVICEID_"+sGXsfl_34_fel_idx;
         edtProductServiceImage_Internalname = "PRODUCTSERVICEIMAGE_"+sGXsfl_34_fel_idx;
      }
      ...
      protected void sendrow_342( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_34_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( A58ProductServiceId.ToString())+"'"+"]);";
            ...
            Grid1Row.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(string)edtProductServiceImage_Internalname,(string)sImgUrl,(string)"",(string)"",(string)"",context.GetTheme( ),(short)-1,(short)0,(string)"",(string)"",(short)0,(short)-1,(short)0,(string)"px",(short)0,(string)"px",(short)0,(short)0,(short)0,(string)"",(string)"",(string)StyleString,(string)ClassString,(string)"WWColumn OptionalColumn",(string)"",(string)"",(string)"",(string)"",(string)"",(string)"",(short)1,(bool)A61ProductServiceImage_IsBlob,(bool)true,context.GetImageSrcSet( sImgUrl)});
      ...
      protected void StartGridControl34( )
      {
         ...
         else
         {
            ...
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", GXUtil.ValueEncode( A58ProductServiceId.ToString()));
            Grid1Container.AddColumnProperties(Grid1Column);
            Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
            Grid1Column.AddObjectProperty("Value", context.convertURL( A61ProductServiceImage));
            Grid1Container.AddColumnProperties(Grid1Column);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Trn_Product Service";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cProductServiceId","fld":"vCPRODUCTSERVICEID"},{"av":"AV7cProductServiceName","fld":"vCPRODUCTSERVICENAME"}]}""");
         ...
         setEventMetadata("LBLPRODUCTSERVICEIDFILTER.CLICK","""{"handler":"E110D1","iparms":[{"av":"divProductserviceidfiltercontainer_Class","ctrl":"PRODUCTSERVICEIDFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("LBLPRODUCTSERVICENAMEFILTER.CLICK","""{"handler":"E120D1","iparms":[{"av":"divProductservicenamefiltercontainer_Class","ctrl":"PRODUCTSERVICENAMEFILTERCONTAINER","prop":"Class"}]""");
         ...
         setEventMetadata("ENTER","""{"handler":"E160D2","iparms":[{"av":"A58ProductServiceId","fld":"PRODUCTSERVICEID","hsh":true}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV8pProductServiceId","fld":"vPPRODUCTSERVICEID"}]}""");
         setEventMetadata("GRID1_FIRSTPAGE","""{"handler":"subgrid1_firstpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cProductServiceId","fld":"vCPRODUCTSERVICEID"},{"av":"AV7cProductServiceName","fld":"vCPRODUCTSERVICENAME"}]}""");
         setEventMetadata("GRID1_PREVPAGE","""{"handler":"subgrid1_previouspage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cProductServiceId","fld":"vCPRODUCTSERVICEID"},{"av":"AV7cProductServiceName","fld":"vCPRODUCTSERVICENAME"}]}""");
         setEventMetadata("GRID1_NEXTPAGE","""{"handler":"subgrid1_nextpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cProductServiceId","fld":"vCPRODUCTSERVICEID"},{"av":"AV7cProductServiceName","fld":"vCPRODUCTSERVICENAME"}]}""");
         setEventMetadata("GRID1_LASTPAGE","""{"handler":"subgrid1_lastpage","iparms":[{"av":"GRID1_nFirstRecordOnPage"},{"av":"GRID1_nEOF"},{"av":"subGrid1_Rows","ctrl":"GRID1","prop":"Rows"},{"av":"AV6cProductServiceId","fld":"vCPRODUCTSERVICEID"},{"av":"AV7cProductServiceName","fld":"vCPRODUCTSERVICENAME"}]}""");
         setEventMetadata("VALIDV_CPRODUCTSERVICEID","""{"handler":"Validv_Cproductserviceid","iparms":[]}""");
         setEventMetadata("NULL","""{"handler":"Valid_Productserviceimage","iparms":[]}""");
         return  ;
      }
      ...
      {
         AV8pProductServiceId = Guid.Empty;
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         AV6cProductServiceId = Guid.Empty;
         AV7cProductServiceName = "";
         ...
         A59ProductServiceName = "";
         H000D2_A59ProductServiceName = new string[] {""} ;
         H000D2_A40000ProductServiceImage_GXI = new string[] {""} ;
         H000D2_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         H000D2_A61ProductServiceImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00d0__default(),
            new Object[][] {
                new Object[] {
               H000D2_A59ProductServiceName, H000D2_A40000ProductServiceImage_GXI, H000D2_A58ProductServiceId, H000D2_A61ProductServiceImage
               }
               , new Object[] {
      ...
      private Guid AV8pProductServiceId ;
      private Guid AV6cProductServiceId ;
      ...
      private string[] H000D2_A59ProductServiceName ;
      private string[] H000D2_A40000ProductServiceImage_GXI ;
      private Guid[] H000D2_A58ProductServiceId ;
      private string[] H000D2_A61ProductServiceImage ;
      private long[] H000D3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private Guid aP0_pProductServiceId ;
   }
   ...
   public class gx00d0__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV6cProductServiceId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " ProductServiceName, ProductServiceImage_GXI, ProductServiceId, ProductServiceImage";
                                             ...
                                             Guid AV6cProductServiceId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM Trn_ProductService";
         AddWhere(sWhereString, "(ProductServiceId >= :AV6cProductServiceId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV7cProductServiceName)) )
         {
            AddWhere(sWhereString, "(ProductServiceName like :lV7cProductServiceName)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000D2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (Guid)dynConstraints[2] );
               case 1 :
                     return conditional_H000D3(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (Guid)dynConstraints[2] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV6cProductServiceId",GXType.UniqueIdentifier,36,0) ,
          new ParDef("lV7cProductServiceName",GXType.VarChar,100,0) ,
