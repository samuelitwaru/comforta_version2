...
namespace GeneXus.Programs {
   public class gamwwapplications : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV38ManageFiltersExecutionStep, AV53Pgmname, AV11FilName, AV48IsAuthorized_Display, AV50IsAuthorized_Update, AV51IsAuthorized_Delete, AV19IsAuthorized_GAMActionPermission, AV27IsAuthorized_UAMenus, AV20IsAuthorized_Name, AV52IsAuthorized_Insert) ;
      ...
      protected void WB8F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_19_8F2( true) ;
         }
         else
         {
            wb_table1_19_8F2( false) ;
         }
         return  ;
      }

      protected void wb_table1_19_8F2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignAttri("", false, edtavUpdate_Internalname, AV49Update);
      ...
      private void E178F2( )
      {
         ...
         while ( AV54GXV1 <= AV24GAMApplications.Count )
         {
            ...
            if ( AV48IsAuthorized_Display )
            {
               ...
               edtavDisplay_Link = formatLink("gamapplicationentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            ...
            if ( AV50IsAuthorized_Update )
            {
               ...
               edtavUpdate_Link = formatLink("gamapplicationentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            ...
            if ( AV51IsAuthorized_Delete )
            {
               ...
               edtavDelete_Link = formatLink("gamapplicationentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
      ...
      protected void E118F2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            if (returnInSub) return;
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMWWApplicationsFilters")) + "," + UrlEncode(StringUtil.RTrim(AV53Pgmname+"GridState"));
      ...
      protected void S122( )
      {
         ...
         {
            AV35GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV53Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV35GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV11FilName)),  0,  AV11FilName,  AV11FilName,  false,  "",  "") ;
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV53Pgmname+"GridState",  AV35GridState.ToXml(false, true, "", "")) ;
      }

      protected void wb_table1_19_8F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_24_8F2( true) ;
         }
         else
         {
            wb_table2_24_8F2( false) ;
         }
         return  ;
      }

      protected void wb_table2_24_8F2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_19_8F2e( true) ;
         }
         else
         {
            wb_table1_19_8F2e( false) ;
         }
      }

      protected void wb_table2_24_8F2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_24_8F2e( true) ;
         }
         else
         {
            wb_table2_24_8F2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112115464815", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwapplications.js", "?2024112115464819", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"edtavGamactionpermission_Title","ctrl":"vGAMACTIONPERMISSION","prop":"Title"},{"av":"edtavUamenus_Title","ctrl":"vUAMENUS","prop":"Title"},{"av":"AV38ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV53Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"AV48IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV50IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV51IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV19IsAuthorized_GAMActionPermission","fld":"vISAUTHORIZED_GAMACTIONPERMISSION","hsh":true},{"av":"AV27IsAuthorized_UAMenus","fld":"vISAUTHORIZED_UAMENUS","hsh":true},{"av":"AV20IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV52IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV38ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV44GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV46GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV19IsAuthorized_GAMActionPermission","fld":"vISAUTHORIZED_GAMACTIONPERMISSION","hsh":true},{"av":"AV27IsAuthorized_UAMenus","fld":"vISAUTHORIZED_UAMENUS","hsh":true},{"av":"AV48IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV50IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV51IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"edtavGamactionpermission_Visible","ctrl":"vGAMACTIONPERMISSION","prop":"Visible"},{"av":"edtavUamenus_Visible","ctrl":"vUAMENUS","prop":"Visible"},{"av":"AV52IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV42ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV35GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E128F2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV38ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV53Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"edtavGamactionpermission_Title","ctrl":"vGAMACTIONPERMISSION","prop":"Title"},{"av":"edtavUamenus_Title","ctrl":"vUAMENUS","prop":"Title"},{"av":"AV48IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV50IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV51IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV19IsAuthorized_GAMActionPermission","fld":"vISAUTHORIZED_GAMACTIONPERMISSION","hsh":true},{"av":"AV27IsAuthorized_UAMenus","fld":"vISAUTHORIZED_UAMENUS","hsh":true},{"av":"AV20IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV52IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E138F2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV38ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV53Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"edtavGamactionpermission_Title","ctrl":"vGAMACTIONPERMISSION","prop":"Title"},{"av":"edtavUamenus_Title","ctrl":"vUAMENUS","prop":"Title"},{"av":"AV48IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV50IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV51IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV19IsAuthorized_GAMActionPermission","fld":"vISAUTHORIZED_GAMACTIONPERMISSION","hsh":true},{"av":"AV27IsAuthorized_UAMenus","fld":"vISAUTHORIZED_UAMENUS","hsh":true},{"av":"AV20IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV52IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E178F2","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"AV48IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV50IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV51IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV19IsAuthorized_GAMActionPermission","fld":"vISAUTHORIZED_GAMACTIONPERMISSION","hsh":true},{"av":"AV27IsAuthorized_UAMenus","fld":"vISAUTHORIZED_UAMENUS","hsh":true},{"av":"AV20IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV14GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV16Id","fld":"vID","pic":"ZZZZZZZZZZZ9"},{"av":"AV15GUID","fld":"vGUID"},{"av":"AV21Name","fld":"vNAME"},{"av":"AV47Display","fld":"vDISPLAY"},{"av":"edtavDisplay_Link","ctrl":"vDISPLAY","prop":"Link"},{"av":"AV49Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV5Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"AV13GAMActionPermission","fld":"vGAMACTIONPERMISSION"},{"av":"edtavGamactionpermission_Link","ctrl":"vGAMACTIONPERMISSION","prop":"Link"},{"av":"AV28UAMenus","fld":"vUAMENUS"},{"av":"edtavUamenus_Link","ctrl":"vUAMENUS","prop":"Link"},{"av":"edtavName_Link","ctrl":"vNAME","prop":"Link"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E118F2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV38ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV53Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"edtavGamactionpermission_Title","ctrl":"vGAMACTIONPERMISSION","prop":"Title"},{"av":"edtavUamenus_Title","ctrl":"vUAMENUS","prop":"Title"},{"av":"AV48IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV50IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV51IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV19IsAuthorized_GAMActionPermission","fld":"vISAUTHORIZED_GAMACTIONPERMISSION","hsh":true},{"av":"AV27IsAuthorized_UAMenus","fld":"vISAUTHORIZED_UAMENUS","hsh":true},{"av":"AV20IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV52IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV35GridState","fld":"vGRIDSTATE"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E148F2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV38ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV53Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"edtavGamactionpermission_Title","ctrl":"vGAMACTIONPERMISSION","prop":"Title"},{"av":"edtavUamenus_Title","ctrl":"vUAMENUS","prop":"Title"},{"av":"AV48IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV50IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV51IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV19IsAuthorized_GAMActionPermission","fld":"vISAUTHORIZED_GAMACTIONPERMISSION","hsh":true},{"av":"AV27IsAuthorized_UAMenus","fld":"vISAUTHORIZED_UAMENUS","hsh":true},{"av":"AV20IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV52IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
