      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(AV16Repository.gxTpr_Useractivationmethod, "U") == 0 )
         {
            ...
            if ( AV12GAMUser.success() )
            {
               ...
               AV17SMTPSession.Host = context.GetMessage( "smtp.gmail.com", "");
               AV17SMTPSession.Port = 587;
               AV17SMTPSession.Authentication = 1;
               AV17SMTPSession.AuthenticationMethod = context.GetMessage( "STARTTLS", "");
               AV17SMTPSession.UserName = context.GetMessage( "markbrightbaraka22@gmail.com", "");
               AV17SMTPSession.Password = context.GetMessage( "fpmizvkxpbhaclfl", "");
               AV17SMTPSession.Secure = 1;
               AV17SMTPSession.Sender.Address = context.GetMessage( "markbrightbaraka@gmail.com", "");
