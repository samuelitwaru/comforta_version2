...
namespace GeneXus.Programs {
   public class trn_residentview : GXDataArea
   {
      public trn_residentview( )
      {
      ...
      public trn_residentview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_ResidentId ,
                           ...
                           string aP3_TabCode )
      {
         this.AV10ResidentId = aP0_ResidentId;
      ...
      {
         get {
            return "trn_residentview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_residentview.aspx"+UrlEncode(AV10ResidentId.ToString()) + "," + UrlEncode(AV11LocationId.ToString()) + "," + UrlEncode(AV12OrganisationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_residentview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISCUSSIONS", AV18IsAuthorized_Discussions);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DISCUSSIONS", GetSecureSignedToken( "", AV18IsAuthorized_Discussions, context));
         GxWebStd.gx_hidden_field( context, "vRESIDENTID", AV10ResidentId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTID", GetSecureSignedToken( "", AV10ResidentId, context));
         GxWebStd.gx_hidden_field( context, "vLOCATIONID", AV11LocationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vLOCATIONID", GetSecureSignedToken( "", AV11LocationId, context));
         GxWebStd.gx_hidden_field( context, "vORGANISATIONID", AV12OrganisationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vORGANISATIONID", GetSecureSignedToken( "", AV12OrganisationId, context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Networkindividualwc == null ) )
         {
            WebComp_Networkindividualwc.componentjscripts();
         }
         if ( ! ( WebComp_Networkcompanywc == null ) )
         {
            WebComp_Networkcompanywc.componentjscripts();
         }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_residentview.aspx"+UrlEncode(AV10ResidentId.ToString()) + "," + UrlEncode(AV11LocationId.ToString()) + "," + UrlEncode(AV12OrganisationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_residentview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_ResidentView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Resident View", "") ;
      }
      ...
      protected void WB650( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_ResidentView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_residentgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNetworkindividual_title_Internalname, context.GetMessage( "Informal Network Individuals", ""), "", "", lblNetworkindividual_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_ResidentView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "NetworkIndividual") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablenetworkindividual_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0037"+"", StringUtil.RTrim( WebComp_Networkindividualwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0037"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Networkindividualwc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldNetworkindividualwc), StringUtil.Lower( WebComp_Networkindividualwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
                  }
                  WebComp_Networkindividualwc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldNetworkindividualwc), StringUtil.Lower( WebComp_Networkindividualwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblNetworkcompany_title_Internalname, context.GetMessage( "Informal Network Companies", ""), "", "", lblNetworkcompany_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_ResidentView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "NetworkCompany") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablenetworkcompany_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0045"+"", StringUtil.RTrim( WebComp_Networkcompanywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0045"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Networkcompanywc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldNetworkcompanywc), StringUtil.Lower( WebComp_Networkcompanywc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0045"+"");
                  }
                  WebComp_Networkcompanywc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldNetworkcompanywc), StringUtil.Lower( WebComp_Networkcompanywc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START652( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Resident View", ""), 0) ;
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldNetworkindividualwc = cgiGet( "W0037");
                           if ( ( StringUtil.Len( OldNetworkindividualwc) == 0 ) || ( StringUtil.StrCmp(OldNetworkindividualwc, WebComp_Networkindividualwc_Component) != 0 ) )
                           {
                              WebComp_Networkindividualwc = getWebComponent(GetType(), "GeneXus.Programs", OldNetworkindividualwc, new Object[] {context} );
                              WebComp_Networkindividualwc.ComponentInit();
                              WebComp_Networkindividualwc.Name = "OldNetworkindividualwc";
                              WebComp_Networkindividualwc_Component = OldNetworkindividualwc;
                           }
                           if ( StringUtil.Len( WebComp_Networkindividualwc_Component) != 0 )
                           {
                              WebComp_Networkindividualwc.componentprocess("W0037", "", sEvt);
                           }
                           WebComp_Networkindividualwc_Component = OldNetworkindividualwc;
                        }
                        else if ( nCmpId == 45 )
                        {
                           OldNetworkcompanywc = cgiGet( "W0045");
                           if ( ( StringUtil.Len( OldNetworkcompanywc) == 0 ) || ( StringUtil.StrCmp(OldNetworkcompanywc, WebComp_Networkcompanywc_Component) != 0 ) )
                           {
                              WebComp_Networkcompanywc = getWebComponent(GetType(), "GeneXus.Programs", OldNetworkcompanywc, new Object[] {context} );
                              WebComp_Networkcompanywc.ComponentInit();
                              WebComp_Networkcompanywc.Name = "OldNetworkcompanywc";
                              WebComp_Networkcompanywc_Component = OldNetworkcompanywc;
                           }
                           if ( StringUtil.Len( WebComp_Networkcompanywc_Component) != 0 )
                           {
                              WebComp_Networkcompanywc.componentprocess("W0045", "", sEvt);
                           }
                           WebComp_Networkcompanywc_Component = OldNetworkcompanywc;
                        }
                        else if ( nCmpId == 50 )
      ...
      protected void PA652( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_residentview.aspx")), "trn_residentview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_residentview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10ResidentId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10ResidentId", AV10ResidentId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTID", GetSecureSignedToken( "", AV10ResidentId, context));
                     if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
                     {
                        AV11LocationId = StringUtil.StrToGuid( GetPar( "LocationId"));
                        AssignAttri("", false, "AV11LocationId", AV11LocationId.ToString());
                        GxWebStd.gx_hidden_field( context, "gxhash_vLOCATIONID", GetSecureSignedToken( "", AV11LocationId, context));
                        AV12OrganisationId = StringUtil.StrToGuid( GetPar( "OrganisationId"));
                        AssignAttri("", false, "AV12OrganisationId", AV12OrganisationId.ToString());
                        GxWebStd.gx_hidden_field( context, "gxhash_vORGANISATIONID", GetSecureSignedToken( "", AV12OrganisationId, context));
      ...
      protected void RF652( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Networkindividualwc_Component) != 0 )
               {
                  WebComp_Networkindividualwc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Networkcompanywc_Component) != 0 )
               {
                  WebComp_Networkcompanywc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         ...
         {
            /* Using cursor H00652 */
            pr_default.execute(0, new Object[] {AV10ResidentId, AV11LocationId, AV12OrganisationId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A11OrganisationId = H00652_A11OrganisationId[0];
               A29LocationId = H00652_A29LocationId[0];
               A62ResidentId = H00652_A62ResidentId[0];
               /* Execute user event: Load */
               E16652 ();
      ...
      protected void E14652( )
      {
         ...
         AV19GXLvl9 = 0;
         /* Using cursor H00653 */
         pr_default.execute(1, new Object[] {AV10ResidentId, AV11LocationId, AV12OrganisationId});
      ...
      protected void E15652( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Resident",  StringUtil.Trim( A62ResidentId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Resident",  2) )
         {
         ...
         GXt_boolean1 = AV18IsAuthorized_Discussions;
         ...
         AV18IsAuthorized_Discussions = GXt_boolean1;
         AssignAttri("", false, "AV18IsAuthorized_Discussions", AV18IsAuthorized_Discussions);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DISCUSSIONS", GetSecureSignedToken( "", AV18IsAuthorized_Discussions, context));
         if ( AV18IsAuthorized_Discussions )
         {
      ...
      protected void E11652( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0050",(string)"",(string)"Trn_Resident",(short)2,StringUtil.Trim( A62ResidentId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString()),(string)AV16RecordDescription});
      ...
      protected void E12652( )
      {
         ...
         if ( AV18IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0050",(string)"",(string)"Trn_Resident",StringUtil.Trim( A62ResidentId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString()),(string)AV16RecordDescription,formatLink("trn_residentview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_ResidentGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_residentgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_ResidentGeneral";
            WebComp_Webcomponent_general_Component = "Trn_ResidentGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10ResidentId,(Guid)AV11LocationId,(Guid)AV12OrganisationId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV14SelectedTabCode, "NetworkIndividual") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Networkindividualwc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Networkindividualwc_Component), StringUtil.Lower( "Trn_ResidentNetworkIndividualWC")) != 0 )
            {
               WebComp_Networkindividualwc = getWebComponent(GetType(), "GeneXus.Programs", "trn_residentnetworkindividualwc", new Object[] {context} );
               WebComp_Networkindividualwc.ComponentInit();
               WebComp_Networkindividualwc.Name = "Trn_ResidentNetworkIndividualWC";
               WebComp_Networkindividualwc_Component = "Trn_ResidentNetworkIndividualWC";
            }
            if ( StringUtil.Len( WebComp_Networkindividualwc_Component) != 0 )
            {
               WebComp_Networkindividualwc.setjustcreated();
               WebComp_Networkindividualwc.componentprepare(new Object[] {(string)"W0037",(string)"",(Guid)AV10ResidentId,(Guid)AV11LocationId,(Guid)AV12OrganisationId});
               WebComp_Networkindividualwc.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Networkindividualwc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
               WebComp_Networkindividualwc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
         ...
         if ( AV13LoadAllTabs || ( StringUtil.StrCmp(AV14SelectedTabCode, "NetworkCompany") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Networkcompanywc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Networkcompanywc_Component), StringUtil.Lower( "Trn_ResidentNetworkCompanyWC")) != 0 )
            {
               WebComp_Networkcompanywc = getWebComponent(GetType(), "GeneXus.Programs", "trn_residentnetworkcompanywc", new Object[] {context} );
               WebComp_Networkcompanywc.ComponentInit();
               WebComp_Networkcompanywc.Name = "Trn_ResidentNetworkCompanyWC";
               WebComp_Networkcompanywc_Component = "Trn_ResidentNetworkCompanyWC";
            }
            if ( StringUtil.Len( WebComp_Networkcompanywc_Component) != 0 )
            {
               WebComp_Networkcompanywc.setjustcreated();
               WebComp_Networkcompanywc.componentprepare(new Object[] {(string)"W0045",(string)"",(Guid)AV10ResidentId,(Guid)AV11LocationId,(Guid)AV12OrganisationId});
               WebComp_Networkcompanywc.componentbind(new Object[] {(string)"",(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Networkcompanywc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0045"+"");
               WebComp_Networkcompanywc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10ResidentId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10ResidentId", AV10ResidentId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vRESIDENTID", GetSecureSignedToken( "", AV10ResidentId, context));
         AV11LocationId = (Guid)getParm(obj,1);
         AssignAttri("", false, "AV11LocationId", AV11LocationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vLOCATIONID", GetSecureSignedToken( "", AV11LocationId, context));
         AV12OrganisationId = (Guid)getParm(obj,2);
         AssignAttri("", false, "AV12OrganisationId", AV12OrganisationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vORGANISATIONID", GetSecureSignedToken( "", AV12OrganisationId, context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Networkindividualwc == null ) )
         {
            if ( StringUtil.Len( WebComp_Networkindividualwc_Component) != 0 )
            {
               WebComp_Networkindividualwc.componentthemes();
            }
         }
         if ( ! ( WebComp_Networkcompanywc == null ) )
         {
            if ( StringUtil.Len( WebComp_Networkcompanywc_Component) != 0 )
            {
               WebComp_Networkcompanywc.componentthemes();
            }
         }
         if ( ! ( WebComp_Wwpaux_wc == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112914311996", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_residentview.js", "?2024112914311997", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_residentgeneral_cell_Internalname = "TRN_RESIDENTGENERAL_CELL";
         lblNetworkindividual_title_Internalname = "NETWORKINDIVIDUAL_TITLE";
         divUnnamedtablenetworkindividual_Internalname = "UNNAMEDTABLENETWORKINDIVIDUAL";
         lblNetworkcompany_title_Internalname = "NETWORKCOMPANY_TITLE";
         divUnnamedtablenetworkcompany_Internalname = "UNNAMEDTABLENETWORKCOMPANY";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Resident View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV16RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV18IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10ResidentId","fld":"vRESIDENTID","hsh":true},{"av":"AV11LocationId","fld":"vLOCATIONID","hsh":true},{"av":"AV12OrganisationId","fld":"vORGANISATIONID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"Ddc_discussions_Icon","ctrl":"DDC_DISCUSSIONS","prop":"Icon"},{"av":"Ddc_subscriptions_Visible","ctrl":"DDC_SUBSCRIPTIONS","prop":"Visible"},{"av":"AV18IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"Ddc_discussions_Visible","ctrl":"DDC_DISCUSSIONS","prop":"Visible"}]}""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11652","iparms":[{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV16RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12652","iparms":[{"av":"AV18IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV16RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A62ResidentId","fld":"RESIDENTID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13652","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV13LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV14SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10ResidentId","fld":"vRESIDENTID","hsh":true},{"av":"AV11LocationId","fld":"vLOCATIONID","hsh":true},{"av":"AV12OrganisationId","fld":"vORGANISATIONID","hsh":true}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV14SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV13LoadAllTabs","fld":"vLOADALLTABS"},{"ctrl":"NETWORKINDIVIDUALWC"},{"ctrl":"NETWORKCOMPANYWC"}]}""");
         return  ;
      }
      ...
      {
         wcpOAV10ResidentId = Guid.Empty;
         wcpOAV11LocationId = Guid.Empty;
         wcpOAV12OrganisationId = Guid.Empty;
         wcpOAV8TabCode = "";
         ...
         lblNetworkindividual_title_Jsonclick = "";
         WebComp_Networkindividualwc_Component = "";
         OldNetworkindividualwc = "";
         lblNetworkcompany_title_Jsonclick = "";
         WebComp_Networkcompanywc_Component = "";
         OldNetworkcompanywc = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00652_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00652_A29LocationId = new Guid[] {Guid.Empty} ;
         H00652_A62ResidentId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentview__default(),
            new Object[][] {
                new Object[] {
         ...
         WebComp_Networkindividualwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Networkcompanywc = new GeneXus.Http.GXNullWebComponent();
      ...
      private string divTrn_residentgeneral_cell_Internalname ;
      ...
      private string lblNetworkindividual_title_Internalname ;
      private string lblNetworkindividual_title_Jsonclick ;
      private string divUnnamedtablenetworkindividual_Internalname ;
      private string WebComp_Networkindividualwc_Component ;
      private string OldNetworkindividualwc ;
      private string lblNetworkcompany_title_Internalname ;
      private string lblNetworkcompany_title_Jsonclick ;
      private string divUnnamedtablenetworkcompany_Internalname ;
      private string WebComp_Networkcompanywc_Component ;
      private string OldNetworkcompanywc ;
      ...
      private Guid wcpOAV10ResidentId ;
      private Guid wcpOAV11LocationId ;
      private Guid wcpOAV12OrganisationId ;
      private Guid A62ResidentId ;
      private Guid A29LocationId ;
      private Guid A11OrganisationId ;
      private IGxSession AV17Session ;
      private GXWebComponent WebComp_Webcomponent_general ;
      private GXWebComponent WebComp_Networkindividualwc ;
      private GXWebComponent WebComp_Networkcompanywc ;
      ...
      private Guid[] H00652_A11OrganisationId ;
      private Guid[] H00652_A29LocationId ;
      private Guid[] H00652_A62ResidentId ;
   ...
   public class trn_residentview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10ResidentId",GXType.UniqueIdentifier,36,0) ,
