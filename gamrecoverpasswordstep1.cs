...
namespace GeneXus.Programs {
   public class gamrecoverpasswordstep1 : GXDataArea
   {
      ...
      protected void E120V2( )
      {
         ...
         if ( AV6Errors.Count == 0 )
         {
            ...
            if ( AV6Errors.Count == 0 )
            {
               ...
               GX_msglist.addItem(context.GetMessage( "WWP_GAM_EmailSentInstructionsChangePassword", ""));
            }
            else
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102518425229", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamrecoverpasswordstep1.js", "?2024102518425232", false, true);
