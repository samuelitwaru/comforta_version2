...
namespace GeneXus.Programs {
   public class trn_coltrn_tilewc : GXWebComponent
   {
      public trn_coltrn_tilewc( )
      {
      ...
      public trn_coltrn_tilewc( IGxContext context )
      {
      ...
      public void execute( Guid aP0_Trn_ColId )
      {
         this.AV8Trn_ColId = aP0_Trn_ColId;
         ExecuteImpl();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "Trn_ColId");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8Trn_ColId = StringUtil.StrToGuid( GetPar( "Trn_ColId"));
                  AssignAttri(sPrefix, false, "AV8Trn_ColId", AV8Trn_ColId.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)AV8Trn_ColId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV28IsAuthorized_ProductServiceName = StringUtil.StrToBool( GetPar( "IsAuthorized_ProductServiceName"));
         AV29IsAuthorized_SG_ToPageName = StringUtil.StrToBool( GetPar( "IsAuthorized_SG_ToPageName"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV8Trn_ColId, AV20ManageFiltersExecutionStep, AV37Pgmname, AV31IsAuthorized_Display, AV33IsAuthorized_Update, AV35IsAuthorized_Delete, AV27IsAuthorized_Trn_TileName, AV28IsAuthorized_ProductServiceName, AV29IsAuthorized_SG_ToPageName, AV36IsAuthorized_Insert, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Trn_Col Trn_Tile WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_coltrn_tilewc.aspx", new object[] {UrlEncode(AV8Trn_ColId.ToString())}, new string[] {"Trn_ColId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_PRODUCTSERVICENAME", AV28IsAuthorized_ProductServiceName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_PRODUCTSERVICENAME", GetSecureSignedToken( sPrefix, AV28IsAuthorized_ProductServiceName, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_SG_TOPAGENAME", AV29IsAuthorized_SG_ToPageName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_SG_TOPAGENAME", GetSecureSignedToken( sPrefix, AV29IsAuthorized_SG_ToPageName, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8Trn_ColId", wcpOAV8Trn_ColId.ToString());
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV36IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTRN_COLID", AV8Trn_ColId.ToString());
      ...
      protected void RenderHtmlCloseForm5W2( )
      {
      ...
      {
         return "Trn_ColTrn_TileWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Trn_Col Trn_Tile WC" ;
      }
      ...
      protected void WB5W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_coltrn_tilewc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(35), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_ColTrn_TileWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTrn_ColId_Internalname, A328Trn_ColId.ToString(), A328Trn_ColId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTrn_ColId_Jsonclick, 0, "Attribute", "", "", "", "", edtTrn_ColId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ColTrn_TileWC.htm");
            /* User Defined Control */
      ...
      protected void START5W2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Trn_Col Trn_Tile WC", 0) ;
            context.wjLoc = "";
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV28IsAuthorized_ProductServiceName ,
                                       bool AV29IsAuthorized_SG_ToPageName ,
      ...
      protected void RF5W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H005W2 */
            pr_default.execute(0, new Object[] {AV8Trn_ColId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A328Trn_ColId = H005W2_A328Trn_ColId[0];
               AssignAttri(sPrefix, false, "A328Trn_ColId", A328Trn_ColId.ToString());
               A330SG_ToPageName = H005W2_A330SG_ToPageName[0];
               A329SG_ToPageId = H005W2_A329SG_ToPageId[0];
               A40000ProductServiceImage_GXI = H005W2_A40000ProductServiceImage_GXI[0];
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
               A60ProductServiceDescription = H005W2_A60ProductServiceDescription[0];
               A59ProductServiceName = H005W2_A59ProductServiceName[0];
               A58ProductServiceId = H005W2_A58ProductServiceId[0];
               n58ProductServiceId = H005W2_n58ProductServiceId[0];
               A271Trn_TileBGImageUrl = H005W2_A271Trn_TileBGImageUrl[0];
               A270Trn_TileColor = H005W2_A270Trn_TileColor[0];
               A268Trn_TileWidth = H005W2_A268Trn_TileWidth[0];
               A265Trn_TileName = H005W2_A265Trn_TileName[0];
               A264Trn_TileId = H005W2_A264Trn_TileId[0];
               A61ProductServiceImage = H005W2_A61ProductServiceImage[0];
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A61ProductServiceImage)) ? A40000ProductServiceImage_GXI : context.convertURL( context.PathToRelativeUrl( A61ProductServiceImage))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtProductServiceImage_Internalname, "SrcSet", context.GetImageSrcSet( A61ProductServiceImage), true);
               A330SG_ToPageName = H005W2_A330SG_ToPageName[0];
               A40000ProductServiceImage_GXI = H005W2_A40000ProductServiceImage_GXI[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H005W3 */
         pr_default.execute(1, new Object[] {AV8Trn_ColId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtTrn_ColId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtTrn_ColId_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP5W0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8Trn_ColId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8Trn_ColId"));
      ...
      protected void E165W2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_TRN_TILENAME", GetSecureSignedToken( sPrefix, AV27IsAuthorized_Trn_TileName, context));
         GXt_boolean1 = AV28IsAuthorized_ProductServiceName;
         ...
         AV28IsAuthorized_ProductServiceName = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV28IsAuthorized_ProductServiceName", AV28IsAuthorized_ProductServiceName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_PRODUCTSERVICENAME", GetSecureSignedToken( sPrefix, AV28IsAuthorized_ProductServiceName, context));
         GXt_boolean1 = AV29IsAuthorized_SG_ToPageName;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_pageview_Execute", out  GXt_boolean1) ;
         AV29IsAuthorized_SG_ToPageName = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV29IsAuthorized_SG_ToPageName", AV29IsAuthorized_SG_ToPageName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_SG_TOPAGENAME", GetSecureSignedToken( sPrefix, AV29IsAuthorized_SG_ToPageName, context));
         Ddo_grid_Gridinternalname = subGrid_Internalname;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
         edtTrn_ColId_Visible = 0;
         AssignProp(sPrefix, false, edtTrn_ColId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtTrn_ColId_Visible), 5, 0), true);
      ...
      private void E185W2( )
      {
         ...
         {
            edtavDisplay_Link = formatLink("trn_tileview.aspx", new object[] {UrlEncode(A264Trn_TileId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Trn_TileId","TabCode"}) ;
         }
         AV32Update = "<i class=\"fa fa-pen\"></i>";
         AssignAttri(sPrefix, false, edtavUpdate_Internalname, AV32Update);
         if ( AV33IsAuthorized_Update )
         {
            edtavUpdate_Link = formatLink("trn_tile.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(A264Trn_TileId.ToString())}, new string[] {"Mode","Trn_TileId"}) ;
         }
         AV34Delete = "<i class=\"fa fa-times\"></i>";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV34Delete);
         if ( AV35IsAuthorized_Delete )
         {
            edtavDelete_Link = formatLink("trn_tile.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(A264Trn_TileId.ToString())}, new string[] {"Mode","Trn_TileId"}) ;
         }
         if ( AV27IsAuthorized_Trn_TileName )
         {
            edtTrn_TileName_Link = formatLink("trn_tileview.aspx", new object[] {UrlEncode(A264Trn_TileId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Trn_TileId","TabCode"}) ;
         }
         edtTrn_TileBGImageUrl_Linktarget = "_blank";
         edtTrn_TileBGImageUrl_Link = A271Trn_TileBGImageUrl;
         if ( AV28IsAuthorized_ProductServiceName )
         {
            edtProductServiceName_Link = formatLink("trn_productserviceview.aspx", new object[] {UrlEncode(A58ProductServiceId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"ProductServiceId","TabCode"}) ;
         }
         if ( AV29IsAuthorized_SG_ToPageName )
         {
            edtSG_ToPageName_Link = formatLink("trn_pageview.aspx", new object[] {UrlEncode(A329SG_ToPageId.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"Trn_PageId","TabCode"}) ;
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E115W2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_ColTrn_TileWCFilters")),UrlEncode(StringUtil.RTrim(AV37Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_ColTrn_TileWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_ColTrn_TileWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void E155W2( )
      {
         ...
         {
            CallWebObject(formatLink("trn_tile.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(Guid.Empty.ToString())}, new string[] {"Mode","Trn_TileId"}) );
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_ColTrn_TileWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "Trn_ColId";
         AV11TrnContextAtt.gxTpr_Attributevalue = AV8Trn_ColId.ToString();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8Trn_ColId = (Guid)getParm(obj,0);
         AssignAttri(sPrefix, false, "AV8Trn_ColId", AV8Trn_ColId.ToString());
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8Trn_ColId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_coltrn_tilewc", GetJustCreated( ));
         ...
         {
            AV8Trn_ColId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "AV8Trn_ColId", AV8Trn_ColId.ToString());
         }
         wcpOAV8Trn_ColId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8Trn_ColId"));
         if ( ! GetJustCreated( ) && ( ( AV8Trn_ColId != wcpOAV8Trn_ColId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8Trn_ColId = AV8Trn_ColId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8Trn_ColId = cgiGet( sPrefix+"AV8Trn_ColId_CTRL");
         if ( StringUtil.Len( sCtrlAV8Trn_ColId) > 0 )
         {
            AV8Trn_ColId = StringUtil.StrToGuid( cgiGet( sCtrlAV8Trn_ColId));
            AssignAttri(sPrefix, false, "AV8Trn_ColId", AV8Trn_ColId.ToString());
         }
         else
         {
            AV8Trn_ColId = StringUtil.StrToGuid( cgiGet( sPrefix+"AV8Trn_ColId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8Trn_ColId_PARM", AV8Trn_ColId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8Trn_ColId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8Trn_ColId_CTRL", StringUtil.RTrim( sCtrlAV8Trn_ColId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249267194937", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_coltrn_tilewc.js", "?20249267194937", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl35( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Product Service Name") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Product Service Description") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Product Service Image") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV8Trn_ColId","fld":"vTRN_COLID"},{"av":"sPrefix"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_Trn_TileName","fld":"vISAUTHORIZED_TRN_TILENAME","hsh":true},{"av":"AV28IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV29IsAuthorized_SG_ToPageName","fld":"vISAUTHORIZED_SG_TOPAGENAME","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E125W2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8Trn_ColId","fld":"vTRN_COLID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_Trn_TileName","fld":"vISAUTHORIZED_TRN_TILENAME","hsh":true},{"av":"AV28IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV29IsAuthorized_SG_ToPageName","fld":"vISAUTHORIZED_SG_TOPAGENAME","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E135W2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8Trn_ColId","fld":"vTRN_COLID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_Trn_TileName","fld":"vISAUTHORIZED_TRN_TILENAME","hsh":true},{"av":"AV28IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV29IsAuthorized_SG_ToPageName","fld":"vISAUTHORIZED_SG_TOPAGENAME","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E145W2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8Trn_ColId","fld":"vTRN_COLID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_Trn_TileName","fld":"vISAUTHORIZED_TRN_TILENAME","hsh":true},{"av":"AV28IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV29IsAuthorized_SG_ToPageName","fld":"vISAUTHORIZED_SG_TOPAGENAME","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E185W2","iparms":[{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"A264Trn_TileId","fld":"TRN_TILEID","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_Trn_TileName","fld":"vISAUTHORIZED_TRN_TILENAME","hsh":true},{"av":"A271Trn_TileBGImageUrl","fld":"TRN_TILEBGIMAGEURL"},{"av":"AV28IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"A58ProductServiceId","fld":"PRODUCTSERVICEID"},{"av":"AV29IsAuthorized_SG_ToPageName","fld":"vISAUTHORIZED_SG_TOPAGENAME","hsh":true},{"av":"A329SG_ToPageId","fld":"SG_TOPAGEID"}]""");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E115W2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8Trn_ColId","fld":"vTRN_COLID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_Trn_TileName","fld":"vISAUTHORIZED_TRN_TILENAME","hsh":true},{"av":"AV28IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV29IsAuthorized_SG_ToPageName","fld":"vISAUTHORIZED_SG_TOPAGENAME","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E155W2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8Trn_ColId","fld":"vTRN_COLID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_Trn_TileName","fld":"vISAUTHORIZED_TRN_TILENAME","hsh":true},{"av":"AV28IsAuthorized_ProductServiceName","fld":"vISAUTHORIZED_PRODUCTSERVICENAME","hsh":true},{"av":"AV29IsAuthorized_SG_ToPageName","fld":"vISAUTHORIZED_SG_TOPAGENAME","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A264Trn_TileId","fld":"TRN_TILEID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV34Delete = "";
         lV16FilterFullText = "";
         H005W2_A328Trn_ColId = new Guid[] {Guid.Empty} ;
         H005W2_A330SG_ToPageName = new string[] {""} ;
         H005W2_A329SG_ToPageId = new Guid[] {Guid.Empty} ;
         H005W2_A40000ProductServiceImage_GXI = new string[] {""} ;
         H005W2_A60ProductServiceDescription = new string[] {""} ;
         H005W2_A59ProductServiceName = new string[] {""} ;
         H005W2_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         H005W2_n58ProductServiceId = new bool[] {false} ;
         H005W2_A271Trn_TileBGImageUrl = new string[] {""} ;
         H005W2_A270Trn_TileColor = new string[] {""} ;
         H005W2_A268Trn_TileWidth = new short[1] ;
         H005W2_A265Trn_TileName = new string[] {""} ;
         H005W2_A264Trn_TileId = new Guid[] {Guid.Empty} ;
         H005W2_A61ProductServiceImage = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_coltrn_tilewc__default(),
            new Object[][] {
                new Object[] {
               H005W2_A328Trn_ColId, H005W2_A330SG_ToPageName, H005W2_A329SG_ToPageId, H005W2_A40000ProductServiceImage_GXI, H005W2_A60ProductServiceDescription, H005W2_A59ProductServiceName, H005W2_A58ProductServiceId, H005W2_n58ProductServiceId, H005W2_A271Trn_TileBGImageUrl, H005W2_A270Trn_TileColor,
               H005W2_A268Trn_TileWidth, H005W2_A265Trn_TileName, H005W2_A264Trn_TileId, H005W2_A61ProductServiceImage
               }
               , new Object[] {
      ...
      private int edtTrn_ColId_Visible ;
      ...
      private string sCtrlAV8Trn_ColId ;
      ...
      private bool AV28IsAuthorized_ProductServiceName ;
      private bool AV29IsAuthorized_SG_ToPageName ;
      ...
      private Guid[] H005W2_A328Trn_ColId ;
      private string[] H005W2_A330SG_ToPageName ;
      private Guid[] H005W2_A329SG_ToPageId ;
      private string[] H005W2_A40000ProductServiceImage_GXI ;
      private string[] H005W2_A60ProductServiceDescription ;
      private string[] H005W2_A59ProductServiceName ;
      private Guid[] H005W2_A58ProductServiceId ;
      private bool[] H005W2_n58ProductServiceId ;
      private string[] H005W2_A271Trn_TileBGImageUrl ;
      private string[] H005W2_A270Trn_TileColor ;
      private short[] H005W2_A268Trn_TileWidth ;
      private string[] H005W2_A265Trn_TileName ;
      private Guid[] H005W2_A264Trn_TileId ;
      private string[] H005W2_A61ProductServiceImage ;
   ...
   public class trn_coltrn_tilewc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV8Trn_ColId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.Trn_ColId, T2.Trn_PageName AS SG_ToPageName, T1.SG_ToPageId AS SG_ToPageId, T3.ProductServiceImage_GXI, T3.ProductServiceDescription, T3.ProductServiceName, T1.ProductServiceId, T1.Trn_TileBGImageUrl, T1.Trn_TileColor, T1.Trn_TileWidth, T1.Trn_TileName, T1.Trn_TileId, T3.ProductServiceImage";
         sFromString = " FROM ((Trn_Tile T1 INNER JOIN Trn_Page T2 ON T2.Trn_PageId = T1.SG_ToPageId) LEFT JOIN Trn_ProductService T3 ON T3.ProductServiceId = T1.ProductServiceId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.Trn_ColId = :AV8Trn_ColId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( T1.Trn_TileName like '%' || :lV16FilterFullText) or ( 'small' like '%' || LOWER(:lV16FilterFullText) and T1.Trn_TileWidth = 1) or ( 'medium' like '%' || LOWER(:lV16FilterFullText) and T1.Trn_TileWidth = 2) or ( 'large' like '%' || LOWER(:lV16FilterFullText) and T1.Trn_TileWidth = 3) or ( T1.Trn_TileColor like '%' || :lV16FilterFullText) or ( T1.Trn_TileBGImageUrl like '%' || :lV16FilterFullText) or ( T3.ProductServiceName like '%' || :lV16FilterFullText) or ( T3.ProductServiceDescription like '%' || :lV16FilterFullText) or ( T2.Trn_PageName like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.Trn_ColId, T1.Trn_TileName, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_ColId DESC, T1.Trn_TileName DESC, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Trn_ColId, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_ColId DESC, T1.Trn_TileId DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Trn_ColId, T1.Trn_TileWidth, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_ColId DESC, T1.Trn_TileWidth DESC, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Trn_ColId, T1.Trn_TileColor, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 4 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_ColId DESC, T1.Trn_TileColor DESC, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Trn_ColId, T1.Trn_TileBGImageUrl, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 5 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_ColId DESC, T1.Trn_TileBGImageUrl DESC, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Trn_ColId, T1.ProductServiceId, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 6 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_ColId DESC, T1.ProductServiceId DESC, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Trn_ColId, T3.ProductServiceName, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 7 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_ColId DESC, T3.ProductServiceName DESC, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Trn_ColId, T3.ProductServiceDescription, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 8 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_ColId DESC, T3.ProductServiceDescription DESC, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Trn_ColId, T1.SG_ToPageId, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 9 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_ColId DESC, T1.SG_ToPageId DESC, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Trn_ColId, T2.Trn_PageName, T1.Trn_TileId";
         }
         else if ( ( AV14OrderedBy == 10 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_ColId DESC, T2.Trn_PageName DESC, T1.Trn_TileId";
         }
         else if ( true )
         {
                                             ...
                                             Guid AV8Trn_ColId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((Trn_Tile T1 INNER JOIN Trn_Page T3 ON T3.Trn_PageId = T1.SG_ToPageId) LEFT JOIN Trn_ProductService T2 ON T2.ProductServiceId = T1.ProductServiceId)";
         AddWhere(sWhereString, "(T1.Trn_ColId = :AV8Trn_ColId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16FilterFullText)) )
         {
            AddWhere(sWhereString, "(( T1.Trn_TileName like '%' || :lV16FilterFullText) or ( 'small' like '%' || LOWER(:lV16FilterFullText) and T1.Trn_TileWidth = 1) or ( 'medium' like '%' || LOWER(:lV16FilterFullText) and T1.Trn_TileWidth = 2) or ( 'large' like '%' || LOWER(:lV16FilterFullText) and T1.Trn_TileWidth = 3) or ( T1.Trn_TileColor like '%' || :lV16FilterFullText) or ( T1.Trn_TileBGImageUrl like '%' || :lV16FilterFullText) or ( T2.ProductServiceName like '%' || :lV16FilterFullText) or ( T2.ProductServiceDescription like '%' || :lV16FilterFullText) or ( T3.Trn_PageName like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int7[1] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005W2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (string)dynConstraints[7] , (short)dynConstraints[8] , (bool)dynConstraints[9] , (Guid)dynConstraints[10] , (Guid)dynConstraints[11] );
               case 1 :
