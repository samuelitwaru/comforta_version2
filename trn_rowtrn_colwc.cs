...
namespace GeneXus.Programs {
   public class trn_rowtrn_colwc : GXWebComponent
   {
      public trn_rowtrn_colwc( )
      {
      ...
      public trn_rowtrn_colwc( IGxContext context )
      {
      ...
      {
         this.AV8Trn_RowId = aP0_Trn_RowId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8Trn_RowId = StringUtil.StrToGuid( GetPar( "Trn_RowId"));
                  AssignAttri(sPrefix, false, "AV8Trn_RowId", AV8Trn_RowId.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)AV8Trn_RowId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV8Trn_RowId, AV20ManageFiltersExecutionStep, AV35Pgmname, AV29IsAuthorized_Display, AV31IsAuthorized_Update, AV33IsAuthorized_Delete, AV27IsAuthorized_Trn_ColName, AV34IsAuthorized_Insert, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Trn_Row Trn_Col WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_rowtrn_colwc.aspx"+UrlEncode(AV8Trn_RowId.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_rowtrn_colwc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8Trn_RowId", wcpOAV8Trn_RowId.ToString());
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV34IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV34IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vTRN_ROWID", AV8Trn_RowId.ToString());
      ...
      {
         return "Trn_RowTrn_ColWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Trn_Row Trn_Col WC" ;
      }
      ...
      protected void WB630( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_rowtrn_colwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(35), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_RowTrn_ColWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtTrn_RowId_Internalname, A319Trn_RowId.ToString(), A319Trn_RowId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTrn_RowId_Jsonclick, 0, "Attribute", "", "", "", "", edtTrn_RowId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_RowTrn_ColWC.htm");
            /* User Defined Control */
      ...
      protected void START632( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Trn_Row Trn_Col WC", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_rowtrn_colwc.aspx")), "trn_rowtrn_colwc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_rowtrn_colwc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF632( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00632 */
            pr_default.execute(0, new Object[] {AV8Trn_RowId, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A319Trn_RowId = H00632_A319Trn_RowId[0];
               AssignAttri(sPrefix, false, "A319Trn_RowId", A319Trn_RowId.ToString());
               A264Trn_TileId = H00632_A264Trn_TileId[0];
               A327Trn_ColName = H00632_A327Trn_ColName[0];
               A328Trn_ColId = H00632_A328Trn_ColId[0];
               /* Execute user event: Grid.Load */
               E18632 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H00633 */
         pr_default.execute(1, new Object[] {AV8Trn_RowId, lV16FilterFullText});
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtTrn_RowId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtTrn_RowId_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP630( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8Trn_RowId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8Trn_RowId"));
      ...
      protected void E16632( )
      {
         ...
         AssignProp(sPrefix, false, edtTrn_RowId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtTrn_RowId_Visible), 5, 0), true);
      ...
      protected void E11632( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_RowTrn_ColWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV35Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("Trn_RowTrn_ColWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_RowTrn_ColWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_RowTrn_ColWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "Trn_RowId";
         AV11TrnContextAtt.gxTpr_Attributevalue = AV8Trn_RowId.ToString();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8Trn_RowId = (Guid)getParm(obj,0);
         AssignAttri(sPrefix, false, "AV8Trn_RowId", AV8Trn_RowId.ToString());
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8Trn_RowId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_rowtrn_colwc", GetJustCreated( ));
         ...
         {
            AV8Trn_RowId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "AV8Trn_RowId", AV8Trn_RowId.ToString());
         }
         wcpOAV8Trn_RowId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8Trn_RowId"));
         if ( ! GetJustCreated( ) && ( ( AV8Trn_RowId != wcpOAV8Trn_RowId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8Trn_RowId = AV8Trn_RowId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8Trn_RowId = cgiGet( sPrefix+"AV8Trn_RowId_CTRL");
         if ( StringUtil.Len( sCtrlAV8Trn_RowId) > 0 )
         {
            AV8Trn_RowId = StringUtil.StrToGuid( cgiGet( sCtrlAV8Trn_RowId));
            AssignAttri(sPrefix, false, "AV8Trn_RowId", AV8Trn_RowId.ToString());
         }
         else
         {
            AV8Trn_RowId = StringUtil.StrToGuid( cgiGet( sPrefix+"AV8Trn_RowId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8Trn_RowId_PARM", AV8Trn_RowId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8Trn_RowId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8Trn_RowId_CTRL", StringUtil.RTrim( sCtrlAV8Trn_RowId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719475882", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_rowtrn_colwc.js", "?202492719475882", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:Trn_ColId|1:Trn_ColName|2:Trn_TileId";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E15632","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8Trn_RowId","fld":"vTRN_ROWID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV35Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV29IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV31IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV33IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_Trn_ColName","fld":"vISAUTHORIZED_TRN_COLNAME","hsh":true},{"av":"AV34IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A328Trn_ColId","fld":"TRN_COLID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         lV16FilterFullText = "";
         H00632_A319Trn_RowId = new Guid[] {Guid.Empty} ;
         H00632_A264Trn_TileId = new Guid[] {Guid.Empty} ;
         H00632_A327Trn_ColName = new string[] {""} ;
         H00632_A328Trn_ColId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_rowtrn_colwc__default(),
            new Object[][] {
                new Object[] {
               H00632_A319Trn_RowId, H00632_A264Trn_TileId, H00632_A327Trn_ColName, H00632_A328Trn_ColId
               }
               , new Object[] {
      ...
      private string sCtrlAV8Trn_RowId ;
      ...
      private Guid AV8Trn_RowId ;
      private Guid wcpOAV8Trn_RowId ;
      ...
      private Guid[] H00632_A319Trn_RowId ;
      private Guid[] H00632_A264Trn_TileId ;
      private string[] H00632_A327Trn_ColName ;
      private Guid[] H00632_A328Trn_ColId ;
   ...
   public class trn_rowtrn_colwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV8Trn_RowId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " Trn_RowId, Trn_TileId, Trn_ColName, Trn_ColId";
         sFromString = " FROM Trn_Col1";
         sOrderString = "";
         AddWhere(sWhereString, "(Trn_RowId = :AV8Trn_RowId)");
         ...
         {
            sOrderString += " ORDER BY Trn_RowId, Trn_ColName, Trn_ColId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY Trn_RowId DESC, Trn_ColName DESC, Trn_ColId";
         }
         ...
         {
            sOrderString += " ORDER BY Trn_RowId DESC, Trn_ColId DESC";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY Trn_RowId, Trn_TileId, Trn_ColId";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY Trn_RowId DESC, Trn_TileId DESC, Trn_ColId";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00632(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] , (bool)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] );
               case 1 :
                     return conditional_H00633(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (short)dynConstraints[2] , (bool)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8Trn_RowId",GXType.UniqueIdentifier,36,0) ,
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00633", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00633,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
