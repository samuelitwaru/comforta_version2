...
namespace GeneXus.Programs {
   public class trn_rowtrn_colwc : GXWebComponent
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202410251842418", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_rowtrn_colwc.js", "?202410251842419", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:Trn_ColId|1:Trn_ColName";
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_rowtrn_colwc__default(),
            new Object[][] {
                new Object[] {
               H00632_A319Trn_RowId, H00632_A327Trn_ColName, H00632_A328Trn_ColId
               }
               , new Object[] {
   ...
   public class trn_rowtrn_colwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV8Trn_RowId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " Trn_RowId, Trn_ColName, Trn_ColId";
