...
namespace GeneXus.Programs {
   public class wp_organisationlocalgensupplierswcgetfilterdata : GXProcedure
   {
      ...
      public wp_organisationlocalgensupplierswcgetfilterdata( )
      {
      ...
      public wp_organisationlocalgensupplierswcgetfilterdata( IGxContext context )
      {
      ...
      protected void S111( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV30Session.Get("WP_OrganisationLocalGenSuppliersWCGridState"), "") == 0 )
         {
            AV32GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "WP_OrganisationLocalGenSuppliersWCGridState"), null, "", "");
         }
         else
         {
            AV32GridState.FromXml(AV30Session.Get("WP_OrganisationLocalGenSuppliersWCGridState"), null, "", "");
         }
         AV43GXV1 = 1;
      ...
      protected void S121( )
      {
         ...
         AV45Udparg1 = new prc_getuserorganisationid(context).executeUdp( );
         ...
         /* Using cursor P00852 */
         pr_default.execute(0, new Object[] {AV45Udparg1, lV41FilterFullText, lV41FilterFullText, lV41FilterFullText, lV41FilterFullText, lV11TFSupplierGenCompanyName, AV12TFSupplierGenCompanyName_Sel, lV13TFSupplierGenTypeName, AV14TFSupplierGenTypeName_Sel, lV15TFSupplierGenContactName, AV16TFSupplierGenContactName_Sel, lV17TFSupplierGenContactPhone, AV18TFSupplierGenContactPhone_Sel});
         while ( (pr_default.getStatus(0) != 101) )
         {
            BRK852 = false;
            A282SupplierGenTypeId = P00852_A282SupplierGenTypeId[0];
            A11OrganisationId = P00852_A11OrganisationId[0];
            n11OrganisationId = P00852_n11OrganisationId[0];
            A44SupplierGenCompanyName = P00852_A44SupplierGenCompanyName[0];
            A48SupplierGenContactPhone = P00852_A48SupplierGenContactPhone[0];
            A47SupplierGenContactName = P00852_A47SupplierGenContactName[0];
            A290SupplierGenTypeName = P00852_A290SupplierGenTypeName[0];
            A42SupplierGenId = P00852_A42SupplierGenId[0];
            A290SupplierGenTypeName = P00852_A290SupplierGenTypeName[0];
            AV29count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P00852_A44SupplierGenCompanyName[0], A44SupplierGenCompanyName) == 0 ) )
            {
               BRK852 = false;
               A42SupplierGenId = P00852_A42SupplierGenId[0];
      ...
      protected void S131( )
      {
         ...
         lV17TFSupplierGenContactPhone = StringUtil.PadR( StringUtil.RTrim( AV17TFSupplierGenContactPhone), 20, "%");
         /* Using cursor P00853 */
         pr_default.execute(1, new Object[] {AV45Udparg1, lV41FilterFullText, lV41FilterFullText, lV41FilterFullText, lV41FilterFullText, lV11TFSupplierGenCompanyName, AV12TFSupplierGenCompanyName_Sel, lV13TFSupplierGenTypeName, AV14TFSupplierGenTypeName_Sel, lV15TFSupplierGenContactName, AV16TFSupplierGenContactName_Sel, lV17TFSupplierGenContactPhone, AV18TFSupplierGenContactPhone_Sel});
         while ( (pr_default.getStatus(1) != 101) )
         {
            BRK854 = false;
            A282SupplierGenTypeId = P00853_A282SupplierGenTypeId[0];
            A11OrganisationId = P00853_A11OrganisationId[0];
            n11OrganisationId = P00853_n11OrganisationId[0];
            A48SupplierGenContactPhone = P00853_A48SupplierGenContactPhone[0];
            A47SupplierGenContactName = P00853_A47SupplierGenContactName[0];
            A290SupplierGenTypeName = P00853_A290SupplierGenTypeName[0];
            A44SupplierGenCompanyName = P00853_A44SupplierGenCompanyName[0];
            A42SupplierGenId = P00853_A42SupplierGenId[0];
            A290SupplierGenTypeName = P00853_A290SupplierGenTypeName[0];
            AV29count = 0;
            while ( (pr_default.getStatus(1) != 101) && ( P00853_A282SupplierGenTypeId[0] == A282SupplierGenTypeId ) )
            {
               BRK854 = false;
               A42SupplierGenId = P00853_A42SupplierGenId[0];
               AV29count = (long)(AV29count+1);
      ...
      protected void S141( )
      {
         ...
         lV17TFSupplierGenContactPhone = StringUtil.PadR( StringUtil.RTrim( AV17TFSupplierGenContactPhone), 20, "%");
         /* Using cursor P00854 */
         pr_default.execute(2, new Object[] {AV45Udparg1, lV41FilterFullText, lV41FilterFullText, lV41FilterFullText, lV41FilterFullText, lV11TFSupplierGenCompanyName, AV12TFSupplierGenCompanyName_Sel, lV13TFSupplierGenTypeName, AV14TFSupplierGenTypeName_Sel, lV15TFSupplierGenContactName, AV16TFSupplierGenContactName_Sel, lV17TFSupplierGenContactPhone, AV18TFSupplierGenContactPhone_Sel});
         while ( (pr_default.getStatus(2) != 101) )
         {
            BRK856 = false;
            A282SupplierGenTypeId = P00854_A282SupplierGenTypeId[0];
            A11OrganisationId = P00854_A11OrganisationId[0];
            n11OrganisationId = P00854_n11OrganisationId[0];
            A47SupplierGenContactName = P00854_A47SupplierGenContactName[0];
            A48SupplierGenContactPhone = P00854_A48SupplierGenContactPhone[0];
            A290SupplierGenTypeName = P00854_A290SupplierGenTypeName[0];
            A44SupplierGenCompanyName = P00854_A44SupplierGenCompanyName[0];
            A42SupplierGenId = P00854_A42SupplierGenId[0];
            A290SupplierGenTypeName = P00854_A290SupplierGenTypeName[0];
            AV29count = 0;
            while ( (pr_default.getStatus(2) != 101) && ( StringUtil.StrCmp(P00854_A47SupplierGenContactName[0], A47SupplierGenContactName) == 0 ) )
            {
               BRK856 = false;
               A42SupplierGenId = P00854_A42SupplierGenId[0];
               AV29count = (long)(AV29count+1);
      ...
      protected void S151( )
      {
         ...
         lV17TFSupplierGenContactPhone = StringUtil.PadR( StringUtil.RTrim( AV17TFSupplierGenContactPhone), 20, "%");
         /* Using cursor P00855 */
         pr_default.execute(3, new Object[] {AV45Udparg1, lV41FilterFullText, lV41FilterFullText, lV41FilterFullText, lV41FilterFullText, lV11TFSupplierGenCompanyName, AV12TFSupplierGenCompanyName_Sel, lV13TFSupplierGenTypeName, AV14TFSupplierGenTypeName_Sel, lV15TFSupplierGenContactName, AV16TFSupplierGenContactName_Sel, lV17TFSupplierGenContactPhone, AV18TFSupplierGenContactPhone_Sel});
         while ( (pr_default.getStatus(3) != 101) )
         {
            BRK858 = false;
            A282SupplierGenTypeId = P00855_A282SupplierGenTypeId[0];
            A11OrganisationId = P00855_A11OrganisationId[0];
            n11OrganisationId = P00855_n11OrganisationId[0];
            A48SupplierGenContactPhone = P00855_A48SupplierGenContactPhone[0];
            A47SupplierGenContactName = P00855_A47SupplierGenContactName[0];
            A290SupplierGenTypeName = P00855_A290SupplierGenTypeName[0];
            A44SupplierGenCompanyName = P00855_A44SupplierGenCompanyName[0];
            A42SupplierGenId = P00855_A42SupplierGenId[0];
            A290SupplierGenTypeName = P00855_A290SupplierGenTypeName[0];
            AV29count = 0;
            while ( (pr_default.getStatus(3) != 101) && ( StringUtil.StrCmp(P00855_A48SupplierGenContactPhone[0], A48SupplierGenContactPhone) == 0 ) )
            {
               BRK858 = false;
               A42SupplierGenId = P00855_A42SupplierGenId[0];
               AV29count = (long)(AV29count+1);
      ...
      public override void initialize( )
      {
         ...
         P00852_A282SupplierGenTypeId = new Guid[] {Guid.Empty} ;
         P00852_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00852_n11OrganisationId = new bool[] {false} ;
         P00852_A44SupplierGenCompanyName = new string[] {""} ;
         P00852_A48SupplierGenContactPhone = new string[] {""} ;
         P00852_A47SupplierGenContactName = new string[] {""} ;
         P00852_A290SupplierGenTypeName = new string[] {""} ;
         P00852_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         A282SupplierGenTypeId = Guid.Empty;
         A42SupplierGenId = Guid.Empty;
         AV24Option = "";
         P00853_A282SupplierGenTypeId = new Guid[] {Guid.Empty} ;
         P00853_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00853_n11OrganisationId = new bool[] {false} ;
         P00853_A48SupplierGenContactPhone = new string[] {""} ;
         P00853_A47SupplierGenContactName = new string[] {""} ;
         P00853_A290SupplierGenTypeName = new string[] {""} ;
         P00853_A44SupplierGenCompanyName = new string[] {""} ;
         P00853_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         P00854_A282SupplierGenTypeId = new Guid[] {Guid.Empty} ;
         P00854_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00854_n11OrganisationId = new bool[] {false} ;
         P00854_A47SupplierGenContactName = new string[] {""} ;
         P00854_A48SupplierGenContactPhone = new string[] {""} ;
         P00854_A290SupplierGenTypeName = new string[] {""} ;
         P00854_A44SupplierGenCompanyName = new string[] {""} ;
         P00854_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         P00855_A282SupplierGenTypeId = new Guid[] {Guid.Empty} ;
         P00855_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00855_n11OrganisationId = new bool[] {false} ;
         P00855_A48SupplierGenContactPhone = new string[] {""} ;
         P00855_A47SupplierGenContactName = new string[] {""} ;
         P00855_A290SupplierGenTypeName = new string[] {""} ;
         P00855_A44SupplierGenCompanyName = new string[] {""} ;
         P00855_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_organisationlocalgensupplierswcgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P00852_A282SupplierGenTypeId, P00852_A11OrganisationId, P00852_n11OrganisationId, P00852_A44SupplierGenCompanyName, P00852_A48SupplierGenContactPhone, P00852_A47SupplierGenContactName, P00852_A290SupplierGenTypeName, P00852_A42SupplierGenId
               }
               , new Object[] {
               P00853_A282SupplierGenTypeId, P00853_A11OrganisationId, P00853_n11OrganisationId, P00853_A48SupplierGenContactPhone, P00853_A47SupplierGenContactName, P00853_A290SupplierGenTypeName, P00853_A44SupplierGenCompanyName, P00853_A42SupplierGenId
               }
               , new Object[] {
               P00854_A282SupplierGenTypeId, P00854_A11OrganisationId, P00854_n11OrganisationId, P00854_A47SupplierGenContactName, P00854_A48SupplierGenContactPhone, P00854_A290SupplierGenTypeName, P00854_A44SupplierGenCompanyName, P00854_A42SupplierGenId
               }
               , new Object[] {
               P00855_A282SupplierGenTypeId, P00855_A11OrganisationId, P00855_n11OrganisationId, P00855_A48SupplierGenContactPhone, P00855_A47SupplierGenContactName, P00855_A290SupplierGenTypeName, P00855_A44SupplierGenCompanyName, P00855_A42SupplierGenId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00852_A282SupplierGenTypeId ;
      private Guid[] P00852_A11OrganisationId ;
      private bool[] P00852_n11OrganisationId ;
      private string[] P00852_A44SupplierGenCompanyName ;
      private string[] P00852_A48SupplierGenContactPhone ;
      private string[] P00852_A47SupplierGenContactName ;
      private string[] P00852_A290SupplierGenTypeName ;
      private Guid[] P00852_A42SupplierGenId ;
      private Guid[] P00853_A282SupplierGenTypeId ;
      private Guid[] P00853_A11OrganisationId ;
      private bool[] P00853_n11OrganisationId ;
      private string[] P00853_A48SupplierGenContactPhone ;
      private string[] P00853_A47SupplierGenContactName ;
      private string[] P00853_A290SupplierGenTypeName ;
      private string[] P00853_A44SupplierGenCompanyName ;
      private Guid[] P00853_A42SupplierGenId ;
      private Guid[] P00854_A282SupplierGenTypeId ;
      private Guid[] P00854_A11OrganisationId ;
      private bool[] P00854_n11OrganisationId ;
      private string[] P00854_A47SupplierGenContactName ;
      private string[] P00854_A48SupplierGenContactPhone ;
      private string[] P00854_A290SupplierGenTypeName ;
      private string[] P00854_A44SupplierGenCompanyName ;
      private Guid[] P00854_A42SupplierGenId ;
      private Guid[] P00855_A282SupplierGenTypeId ;
      private Guid[] P00855_A11OrganisationId ;
      private bool[] P00855_n11OrganisationId ;
      private string[] P00855_A48SupplierGenContactPhone ;
      private string[] P00855_A47SupplierGenContactName ;
      private string[] P00855_A290SupplierGenTypeName ;
      private string[] P00855_A44SupplierGenCompanyName ;
      private Guid[] P00855_A42SupplierGenId ;
      private string aP3_OptionsJson ;
      private string aP4_OptionsDescJson ;
      private string aP5_OptionIndexesJson ;
   }

   public class wp_organisationlocalgensupplierswcgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV45Udparg1 )
      {
         ...
         scmdbuf = "SELECT T1.SupplierGenTypeId, T1.OrganisationId, T1.SupplierGenCompanyName, T1.SupplierGenContactPhone, T1.SupplierGenContactName, T2.SupplierGenTypeName, T1.SupplierGenId FROM (Trn_SupplierGen T1 INNER JOIN Trn_SupplierGenType T2 ON T2.SupplierGenTypeId = T1.SupplierGenTypeId)";
         AddWhere(sWhereString, "(T1.OrganisationId = :AV45Udparg1)");
                                             ...
                                             Guid AV45Udparg1 )
      {
         ...
         scmdbuf = "SELECT T1.SupplierGenTypeId, T1.OrganisationId, T1.SupplierGenContactName, T1.SupplierGenContactPhone, T2.SupplierGenTypeName, T1.SupplierGenCompanyName, T1.SupplierGenId FROM (Trn_SupplierGen T1 INNER JOIN Trn_SupplierGenType T2 ON T2.SupplierGenTypeId = T1.SupplierGenTypeId)";
         AddWhere(sWhereString, "(T1.OrganisationId = :AV45Udparg1)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV41FilterFullText)) )
         {
            AddWhere(sWhereString, "(( T1.SupplierGenCompanyName like '%' || :lV41FilterFullText) or ( T2.SupplierGenTypeName like '%' || :lV41FilterFullText) or ( T1.SupplierGenContactName like '%' || :lV41FilterFullText) or ( T1.SupplierGenContactPhone like '%' || :lV41FilterFullText))");
