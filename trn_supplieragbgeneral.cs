   ...
   public class trn_supplieragbgeneral : GXWebComponent
   {
      ...
      protected void WB570( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup2_Internalname, "Supplier Information", 1, 0, "px", 0, "px", "Group", "", "HLP_Trn_SupplierAgbGeneral.htm");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtSupplierAgbTypeName_Internalname, "Category", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocksupplieragbphonecode_description_Internalname, "Phone", "", "", lblTextblocksupplieragbphonecode_description_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierAgbGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void wb_table1_46_572e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbSupplierAgbWebsite, cmbSupplierAgbWebsite_Internalname, StringUtil.RTrim( A440SupplierAgbWebsite), 1, cmbSupplierAgbWebsite_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbSupplierAgbWebsite.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,63);\"", "", true, 0, "HLP_Trn_SupplierAgbGeneral.htm");
            cmbSupplierAgbWebsite.CurrentValue = StringUtil.RTrim( A440SupplierAgbWebsite);
            AssignProp(sPrefix, false, cmbSupplierAgbWebsite_Internalname, "Values", (string)(cmbSupplierAgbWebsite.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup4_Internalname, "Address Information", 1, 0, "px", 0, "px", "Group", "", "HLP_Trn_SupplierAgbGeneral.htm");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtSupplierAgbAddressLine1_Internalname, A333SupplierAgbAddressLine1, StringUtil.RTrim( context.localUtil.Format( A333SupplierAgbAddressLine1, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,71);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierAgbAddressLine1_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierAgbAddressLine1_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierAgbGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtSupplierAgbAddressZipCode_Internalname, A298SupplierAgbAddressZipCode, StringUtil.RTrim( context.localUtil.Format( A298SupplierAgbAddressZipCode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,86);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierAgbAddressZipCode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierAgbAddressZipCode_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierAgbGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void fix_multi_value_controls( )
      {
         if ( cmbSupplierAgbWebsite.ItemCount > 0 )
         {
            ...
            AssignAttri(sPrefix, false, "A440SupplierAgbWebsite", A440SupplierAgbWebsite);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbSupplierAgbWebsite.CurrentValue = StringUtil.RTrim( A440SupplierAgbWebsite);
            AssignProp(sPrefix, false, cmbSupplierAgbWebsite_Internalname, "Values", cmbSupplierAgbWebsite.ToJavascriptSource(), true);
         }
      }
      ...
      protected void RF572( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A440SupplierAgbWebsite = H00572_A440SupplierAgbWebsite[0];
               AssignAttri(sPrefix, false, "A440SupplierAgbWebsite", A440SupplierAgbWebsite);
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, cmbSupplierAgbWebsite_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbSupplierAgbWebsite.Enabled), 5, 0), true);
      ...
      protected void wb_table1_46_572( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavSupplieragbphonecode_description_Internalname, "Supplier Agb Phone Code_Description", "gx-form-item DropDownComponentLabel", 0, true, "width: 25%;");
            /* Single line edit */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241119832031", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_supplieragbgeneral.js", "?20241119832032", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         cmbSupplierAgbWebsite_Internalname = sPrefix+"SUPPLIERAGBWEBSITE";
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_supplieragbgeneral__default(),
            new Object[][] {
                new Object[] {
               H00572_A283SupplierAgbTypeId, H00572_A49SupplierAgbId, H00572_A56SupplierAgbPhone, H00572_A298SupplierAgbAddressZipCode, H00572_A299SupplierAgbAddressCity, H00572_A334SupplierAgbAddressLine2, H00572_A333SupplierAgbAddressLine1, H00572_A440SupplierAgbWebsite, H00572_A57SupplierAgbEmail, H00572_A378SupplierAgbPhoneNumber,
