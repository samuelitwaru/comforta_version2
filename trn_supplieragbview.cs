...
namespace GeneXus.Programs {
   public class trn_supplieragbview : GXDataArea
   {
      public trn_supplieragbview( )
      {
      ...
      public trn_supplieragbview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_SupplierAgbId ,
                           string aP1_TabCode )
      {
         this.AV10SupplierAgbId = aP0_SupplierAgbId;
      ...
      {
         get {
            return "trn_supplieragbview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_supplieragbview.aspx"+UrlEncode(AV10SupplierAgbId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_supplieragbview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vSUPPLIERAGBID", AV10SupplierAgbId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIERAGBID", GetSecureSignedToken( "", AV10SupplierAgbId, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_supplieragbview.aspx"+UrlEncode(AV10SupplierAgbId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_supplieragbview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_SupplierAgbView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Supplier Agb View", "") ;
      }
      ...
      protected void WB4P0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierAgbView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_supplieragbgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void START4P2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Supplier Agb View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA4P2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_supplieragbview.aspx")), "trn_supplieragbview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_supplieragbview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10SupplierAgbId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10SupplierAgbId", AV10SupplierAgbId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIERAGBID", GetSecureSignedToken( "", AV10SupplierAgbId, context));
      ...
      protected void RF4P2( )
      {
         ...
         {
            /* Using cursor H004P2 */
            pr_default.execute(0, new Object[] {AV10SupplierAgbId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A49SupplierAgbId = H004P2_A49SupplierAgbId[0];
               /* Execute user event: Load */
               E154P2 ();
      ...
      protected void E134P2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_supplieragbww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H004P3 */
         pr_default.execute(1, new Object[] {AV10SupplierAgbId});
      ...
      protected void E144P2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_SupplierAgb",  StringUtil.Trim( A49SupplierAgbId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_SupplierAgb",  2) )
         {
      ...
      protected void E114P2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_SupplierAgb",(short)2,StringUtil.Trim( A49SupplierAgbId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E124P2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_SupplierAgb",StringUtil.Trim( A49SupplierAgbId.ToString()),(string)AV14RecordDescription,formatLink("trn_supplieragbview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_SupplierAgbGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_supplieragbgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_SupplierAgbGeneral";
            WebComp_Webcomponent_general_Component = "Trn_SupplierAgbGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10SupplierAgbId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10SupplierAgbId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10SupplierAgbId", AV10SupplierAgbId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIERAGBID", GetSecureSignedToken( "", AV10SupplierAgbId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112914302618", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_supplieragbview.js", "?2024112914302618", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_supplieragbgeneral_cell_Internalname = "TRN_SUPPLIERAGBGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Supplier Agb View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A49SupplierAgbId","fld":"SUPPLIERAGBID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10SupplierAgbId","fld":"vSUPPLIERAGBID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E114P2","iparms":[{"av":"A49SupplierAgbId","fld":"SUPPLIERAGBID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E124P2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A49SupplierAgbId","fld":"SUPPLIERAGBID"}]""");
      ...
      {
         wcpOAV10SupplierAgbId = Guid.Empty;
         wcpOAV8TabCode = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sDynURL = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H004P2_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_supplieragbview__default(),
            new Object[][] {
                new Object[] {
               H004P2_A49SupplierAgbId
               }
               , new Object[] {
               H004P3_A49SupplierAgbId, H004P3_A51SupplierAgbName
               }
            }
         );
      ...
      private string divTrn_supplieragbgeneral_cell_Internalname ;
      ...
      private Guid AV10SupplierAgbId ;
      private Guid wcpOAV10SupplierAgbId ;
      ...
      private Guid[] H004P2_A49SupplierAgbId ;
   ...
   public class trn_supplieragbview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10SupplierAgbId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH004P3;
          ...
          def= new CursorDef[] {
              new CursorDef("H004P2", "SELECT SupplierAgbId FROM Trn_SupplierAGB WHERE SupplierAgbId = :AV10SupplierAgbId ORDER BY SupplierAgbId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004P2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H004P3", "SELECT SupplierAgbId, SupplierAgbName FROM Trn_SupplierAGB WHERE SupplierAgbId = :AV10SupplierAgbId ORDER BY SupplierAgbId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004P3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
