...
namespace GeneXus.Programs {
   public class trn_productserviceloaddvcombo : GXProcedure
   {
                           ...
                           out string aP10_Combo_DataJson )
      {
         ...
         this.AV21SearchTxtParms = aP7_SearchTxtParms;
         this.AV22SelectedValue = "" ;
         this.AV23SelectedText = "" ;
         this.AV24Combo_DataJson = "" ;
         initialize();
         ExecuteImpl();
         aP8_SelectedValue=this.AV22SelectedValue;
         aP9_SelectedText=this.AV23SelectedText;
         aP10_Combo_DataJson=this.AV24Combo_DataJson;
      }
      ...
      public string executeUdp( string aP0_ComboName ,
                                ...
                                out string aP9_SelectedText )
      {
         execute(aP0_ComboName, aP1_TrnMode, aP2_IsDynamicCall, aP3_ProductServiceId, aP4_LocationId, aP5_OrganisationId, aP6_Cond_OrganisationId, aP7_SearchTxtParms, out aP8_SelectedValue, out aP9_SelectedText, out aP10_Combo_DataJson);
      ...
      protected void S111( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            {
               A11OrganisationId = P00782_A11OrganisationId[0];
               A31LocationName = P00782_A31LocationName[0];
               A29LocationId = P00782_A29LocationId[0];
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               ...
               while ( (pr_default.getStatus(1) != 101) )
               {
                  ...
                  A31LocationName = P00783_A31LocationName[0];
                  A31LocationName = P00783_A31LocationName[0];
            ...
            {
               if ( ! (Guid.Empty==AV31LocationId) )
               {
                  AV22SelectedValue = StringUtil.Trim( AV31LocationId.ToString());
                  /* Using cursor P00784 */
                  pr_default.execute(2, new Object[] {AV31LocationId, AV32Cond_OrganisationId});
                  while ( (pr_default.getStatus(2) != 101) )
                  {
                     A11OrganisationId = P00784_A11OrganisationId[0];
                     A29LocationId = P00784_A29LocationId[0];
                     A31LocationName = P00784_A31LocationName[0];
                     AV23SelectedText = A31LocationName;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      protected void S121( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            {
               A13OrganisationName = P00785_A13OrganisationName[0];
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               ...
               while ( (pr_default.getStatus(4) != 101) )
               {
                  ...
                  A13OrganisationName = P00786_A13OrganisationName[0];
                  A13OrganisationName = P00786_A13OrganisationName[0];
            ...
            else
            {
               ...
               {
                  AV22SelectedValue = StringUtil.Trim( AV30OrganisationId.ToString());
                  /* Using cursor P00787 */
                  pr_default.execute(5, new Object[] {AV30OrganisationId});
                  while ( (pr_default.getStatus(5) != 101) )
                  {
                     A11OrganisationId = P00787_A11OrganisationId[0];
                     A13OrganisationName = P00787_A13OrganisationName[0];
                     AV23SelectedText = A13OrganisationName;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      protected void S131( )
      {
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               ...
               {
                  /* Using cursor P00789 */
                  pr_default.execute(7, new Object[] {AV20ProductServiceId, AV31LocationId, AV30OrganisationId});
                  while ( (pr_default.getStatus(7) != 101) )
                  {
                     A11OrganisationId = P00789_A11OrganisationId[0];
                     A29LocationId = P00789_A29LocationId[0];
                     A58ProductServiceId = P00789_A58ProductServiceId[0];
               ...
               else
               {
                  ...
                  /* Using cursor P007810 */
                  pr_default.execute(8, new Object[] {AV28SupplierGenId});
                  while ( (pr_default.getStatus(8) != 101) )
                  {
                     A42SupplierGenId = P007810_A42SupplierGenId[0];
                     n42SupplierGenId = P007810_n42SupplierGenId[0];
                     A44SupplierGenCompanyName = P007810_A44SupplierGenCompanyName[0];
                     AV23SelectedText = A44SupplierGenCompanyName;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      protected void S141( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            lV14SearchTxt = StringUtil.Concat( StringUtil.RTrim( AV14SearchTxt), "%", "");
            /* Using cursor P007811 */
            pr_default.execute(9, new Object[] {lV14SearchTxt, GXPagingFrom11, GXPagingTo11, GXPagingTo11});
            while ( (pr_default.getStatus(9) != 101) )
            {
               A51SupplierAgbName = P007811_A51SupplierAgbName[0];
               A49SupplierAgbId = P007811_A49SupplierAgbId[0];
               n49SupplierAgbId = P007811_n49SupplierAgbId[0];
               AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  /* Using cursor P007812 */
                  pr_default.execute(10, new Object[] {AV20ProductServiceId, AV31LocationId, AV30OrganisationId});
                  while ( (pr_default.getStatus(10) != 101) )
                  {
                     A11OrganisationId = P007812_A11OrganisationId[0];
                     A29LocationId = P007812_A29LocationId[0];
                     A58ProductServiceId = P007812_A58ProductServiceId[0];
                     A49SupplierAgbId = P007812_A49SupplierAgbId[0];
                     n49SupplierAgbId = P007812_n49SupplierAgbId[0];
                     A51SupplierAgbName = P007812_A51SupplierAgbName[0];
                     A51SupplierAgbName = P007812_A51SupplierAgbName[0];
               ...
               else
               {
                  ...
                  /* Using cursor P007813 */
                  pr_default.execute(11, new Object[] {AV29SupplierAgbId});
                  while ( (pr_default.getStatus(11) != 101) )
                  {
                     A49SupplierAgbId = P007813_A49SupplierAgbId[0];
                     n49SupplierAgbId = P007813_n49SupplierAgbId[0];
                     A51SupplierAgbName = P007813_A51SupplierAgbName[0];
                     AV23SelectedText = A51SupplierAgbName;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      public override void initialize( )
      {
         ...
         P00782_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00782_A31LocationName = new string[] {""} ;
         P00782_A29LocationId = new Guid[] {Guid.Empty} ;
         ...
         P00783_A31LocationName = new string[] {""} ;
         A58ProductServiceId = Guid.Empty;
         P00784_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00784_A29LocationId = new Guid[] {Guid.Empty} ;
         P00784_A31LocationName = new string[] {""} ;
         A13OrganisationName = "";
         P00785_A13OrganisationName = new string[] {""} ;
         ...
         P00786_A13OrganisationName = new string[] {""} ;
         P00787_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00787_A13OrganisationName = new string[] {""} ;
         A44SupplierGenCompanyName = "";
         ...
         P00789_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P00789_A29LocationId = new Guid[] {Guid.Empty} ;
         P00789_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         ...
         P007810_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         P007810_n42SupplierGenId = new bool[] {false} ;
         P007810_A44SupplierGenCompanyName = new string[] {""} ;
         A51SupplierAgbName = "";
         P007811_A51SupplierAgbName = new string[] {""} ;
         P007811_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         P007811_n49SupplierAgbId = new bool[] {false} ;
         A49SupplierAgbId = Guid.Empty;
         P007812_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P007812_A29LocationId = new Guid[] {Guid.Empty} ;
         P007812_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         P007812_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         P007812_n49SupplierAgbId = new bool[] {false} ;
         P007812_A51SupplierAgbName = new string[] {""} ;
         AV29SupplierAgbId = Guid.Empty;
         P007813_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         P007813_n49SupplierAgbId = new bool[] {false} ;
         P007813_A51SupplierAgbName = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_productserviceloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P00782_A11OrganisationId, P00782_A31LocationName, P00782_A29LocationId
               }
               , new Object[] {
               P00783_A11OrganisationId, P00783_A29LocationId, P00783_A58ProductServiceId, P00783_A31LocationName
               }
               , new Object[] {
               P00784_A11OrganisationId, P00784_A29LocationId, P00784_A31LocationName
               }
               , new Object[] {
               P00785_A13OrganisationName, P00785_A11OrganisationId
               }
               , new Object[] {
               P00786_A11OrganisationId, P00786_A29LocationId, P00786_A58ProductServiceId, P00786_A13OrganisationName
               }
               , new Object[] {
               P00787_A11OrganisationId, P00787_A13OrganisationName
               }
               , new Object[] {
               P00788_A44SupplierGenCompanyName, P00788_A42SupplierGenId
               }
               , new Object[] {
               P00789_A11OrganisationId, P00789_A29LocationId, P00789_A58ProductServiceId, P00789_A42SupplierGenId, P00789_n42SupplierGenId, P00789_A44SupplierGenCompanyName
               }
               , new Object[] {
               P007810_A42SupplierGenId, P007810_A44SupplierGenCompanyName
               }
               , new Object[] {
               P007811_A51SupplierAgbName, P007811_A49SupplierAgbId
               }
               , new Object[] {
               P007812_A11OrganisationId, P007812_A29LocationId, P007812_A58ProductServiceId, P007812_A49SupplierAgbId, P007812_n49SupplierAgbId, P007812_A51SupplierAgbName
               }
               , new Object[] {
               P007813_A49SupplierAgbId, P007813_A51SupplierAgbName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P00782_A11OrganisationId ;
      private string[] P00782_A31LocationName ;
      private Guid[] P00782_A29LocationId ;
      ...
      private string[] P00783_A31LocationName ;
      private Guid[] P00784_A11OrganisationId ;
      private Guid[] P00784_A29LocationId ;
      private string[] P00784_A31LocationName ;
      private string[] P00785_A13OrganisationName ;
      ...
      private string[] P00786_A13OrganisationName ;
      private Guid[] P00787_A11OrganisationId ;
      private string[] P00787_A13OrganisationName ;
      private string[] P00788_A44SupplierGenCompanyName ;
      private Guid[] P00788_A42SupplierGenId ;
      private bool[] P00788_n42SupplierGenId ;
      private Guid[] P00789_A11OrganisationId ;
      private Guid[] P00789_A29LocationId ;
      private Guid[] P00789_A58ProductServiceId ;
      private Guid[] P00789_A42SupplierGenId ;
      private bool[] P00789_n42SupplierGenId ;
      private string[] P00789_A44SupplierGenCompanyName ;
      private Guid[] P007810_A42SupplierGenId ;
      private bool[] P007810_n42SupplierGenId ;
      private string[] P007810_A44SupplierGenCompanyName ;
      private string[] P007811_A51SupplierAgbName ;
      private Guid[] P007811_A49SupplierAgbId ;
      private bool[] P007811_n49SupplierAgbId ;
      private Guid[] P007812_A11OrganisationId ;
      private Guid[] P007812_A29LocationId ;
      private Guid[] P007812_A58ProductServiceId ;
      private Guid[] P007812_A49SupplierAgbId ;
      private bool[] P007812_n49SupplierAgbId ;
      private string[] P007812_A51SupplierAgbName ;
      private Guid[] P007813_A49SupplierAgbId ;
      private bool[] P007813_n49SupplierAgbId ;
      private string[] P007813_A51SupplierAgbName ;
   ...
   public class trn_productserviceloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
      ...
      protected Object[] conditional_P00788( IGxContext context ,
                                             string AV14SearchTxt ,
      ...
      protected Object[] conditional_P007811( IGxContext context ,
                                              string AV14SearchTxt ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P00782(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
               case 3 :
                     return conditional_P00785(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 6 :
                     return conditional_P00788(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 9 :
                     return conditional_P007811(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmP007810;
          prmP007810 = new Object[] {
          new ParDef("AV28SupplierGenId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmP007812;
          prmP007812 = new Object[] {
          new ParDef("AV20ProductServiceId",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV31LocationId",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV30OrganisationId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmP007813;
          prmP007813 = new Object[] {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P00783", "SELECT T1.OrganisationId, T1.LocationId, T1.ProductServiceId, T2.LocationName FROM (Trn_ProductService T1 INNER JOIN Trn_Location T2 ON T2.LocationId = T1.LocationId AND T2.OrganisationId = T1.OrganisationId) WHERE T1.ProductServiceId = :AV20ProductServiceId and T1.LocationId = :AV31LocationId and T1.OrganisationId = :AV30OrganisationId ORDER BY T1.ProductServiceId, T1.LocationId, T1.OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00783,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00784", "SELECT OrganisationId, LocationId, LocationName FROM Trn_Location WHERE LocationId = :AV31LocationId and OrganisationId = :AV32Cond_OrganisationId ORDER BY LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00784,1, GxCacheFrequency.OFF ,false,true )
             ...
             ,new CursorDef("P00786", "SELECT T1.OrganisationId, T1.LocationId, T1.ProductServiceId, T2.OrganisationName FROM (Trn_ProductService T1 INNER JOIN Trn_Organisation T2 ON T2.OrganisationId = T1.OrganisationId) WHERE T1.ProductServiceId = :AV20ProductServiceId and T1.LocationId = :AV31LocationId and T1.OrganisationId = :AV30OrganisationId ORDER BY T1.ProductServiceId, T1.LocationId, T1.OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00786,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00787", "SELECT OrganisationId, OrganisationName FROM Trn_Organisation WHERE OrganisationId = :AV30OrganisationId ORDER BY OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00787,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P00788", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00788,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P00789", "SELECT T1.OrganisationId, T1.LocationId, T1.ProductServiceId, T1.SupplierGenId, T2.SupplierGenCompanyName FROM (Trn_ProductService T1 LEFT JOIN Trn_SupplierGen T2 ON T2.SupplierGenId = T1.SupplierGenId) WHERE T1.ProductServiceId = :AV20ProductServiceId and T1.LocationId = :AV31LocationId and T1.OrganisationId = :AV30OrganisationId ORDER BY T1.ProductServiceId, T1.LocationId, T1.OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00789,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P007810", "SELECT SupplierGenId, SupplierGenCompanyName FROM Trn_SupplierGen WHERE SupplierGenId = :AV28SupplierGenId ORDER BY SupplierGenId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007810,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P007811", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007811,100, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("P007812", "SELECT T1.OrganisationId, T1.LocationId, T1.ProductServiceId, T1.SupplierAgbId, T2.SupplierAgbName FROM (Trn_ProductService T1 LEFT JOIN Trn_SupplierAGB T2 ON T2.SupplierAgbId = T1.SupplierAgbId) WHERE T1.ProductServiceId = :AV20ProductServiceId and T1.LocationId = :AV31LocationId and T1.OrganisationId = :AV30OrganisationId ORDER BY T1.ProductServiceId, T1.LocationId, T1.OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007812,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P007813", "SELECT SupplierAgbId, SupplierAgbName FROM Trn_SupplierAGB WHERE SupplierAgbId = :AV29SupplierAgbId ORDER BY SupplierAgbId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP007813,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
