...
namespace GeneXus.Programs {
   public class gamwwconnections : GXDataArea
   {
      ...
      {
         return context.GetMessage( "WWP_GAM_Connections", "") ;
      }
      ...
      protected void WB960( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_21_962( true) ;
         }
         else
         {
            wb_table1_21_962( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_962e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START962( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "WWP_GAM_Connections", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E16962( )
      {
         ...
         edtavBtnkeys_Title = context.GetMessage( "WWP_GAM_Keys", "");
         AssignProp("", false, edtavBtnkeys_Internalname, "Title", edtavBtnkeys_Title, !bGXsfl_40_Refreshing);
      }
      ...
      private void E18962( )
      {
         ...
         while ( AV73GXV1 <= AV60GAMConnections.Count )
         {
            ...
            if ( AV65IsAuthorized_Display )
            {
               ...
               edtavDisplay_Link = formatLink("gamconnectionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            ...
            if ( AV66IsAuthorized_Update )
            {
               ...
               edtavUpdate_Link = formatLink("gamconnectionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            ...
            if ( AV67IsAuthorized_Delete )
            {
               ...
               edtavDelete_Link = formatLink("gamconnectionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV31GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV11FilName)),  0,  AV11FilName,  AV11FilName,  false,  "",  "") ;
      ...
      protected void wb_table1_21_962( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_26_962( true) ;
         }
         else
         {
            wb_table2_26_962( false) ;
         }
         return  ;
      }

      protected void wb_table2_26_962e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_21_962e( true) ;
         }
         else
         {
            wb_table1_21_962e( false) ;
         }
      }

      protected void wb_table2_26_962( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_26_962e( true) ;
         }
         else
         {
            wb_table2_26_962e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411211548390", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwconnections.js", "?202411211548395", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl40( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( context.GetMessage( "WWP_GAM_UserName", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E15962","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV51ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV45ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV72Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV11FilName","fld":"vFILNAME"},{"av":"edtavBtnkeys_Title","ctrl":"vBTNKEYS","prop":"Title"},{"av":"AV65IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV66IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV67IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV70IsAuthorized_BtnKeys","fld":"vISAUTHORIZED_BTNKEYS","hsh":true},{"av":"AV17IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV68IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
