...
namespace GeneXus.Programs {
   public class trn_templateview : GXDataArea
   {
      public trn_templateview( )
      {
      ...
      public trn_templateview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_Trn_TemplateId ,
                           string aP1_TabCode )
      {
         this.AV10Trn_TemplateId = aP0_Trn_TemplateId;
      ...
      {
         get {
            return "trn_templateview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_templateview.aspx"+UrlEncode(AV10Trn_TemplateId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_templateview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTRN_TEMPLATEID", AV10Trn_TemplateId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_TEMPLATEID", GetSecureSignedToken( "", AV10Trn_TemplateId, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_templateview.aspx"+UrlEncode(AV10Trn_TemplateId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_templateview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_TemplateView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Template View", "") ;
      }
      ...
      protected void WB4I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_TemplateView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_templategeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void START4I2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Template View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA4I2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_templateview.aspx")), "trn_templateview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_templateview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10Trn_TemplateId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10Trn_TemplateId", AV10Trn_TemplateId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vTRN_TEMPLATEID", GetSecureSignedToken( "", AV10Trn_TemplateId, context));
      ...
      protected void RF4I2( )
      {
         ...
         {
            /* Using cursor H004I2 */
            pr_default.execute(0, new Object[] {AV10Trn_TemplateId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A278Trn_TemplateId = H004I2_A278Trn_TemplateId[0];
               /* Execute user event: Load */
               E154I2 ();
      ...
      protected void E134I2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_templateww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H004I3 */
         pr_default.execute(1, new Object[] {AV10Trn_TemplateId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A278Trn_TemplateId = H004I3_A278Trn_TemplateId[0];
            A279Trn_TemplateName = H004I3_A279Trn_TemplateName[0];
            AV17GXLvl9 = 1;
            Form.Caption = A279Trn_TemplateName;
      ...
      protected void E144I2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Template",  StringUtil.Trim( A278Trn_TemplateId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Template",  2) )
         {
      ...
      protected void E114I2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Template",(short)2,StringUtil.Trim( A278Trn_TemplateId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E124I2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Template",StringUtil.Trim( A278Trn_TemplateId.ToString()),(string)AV14RecordDescription,formatLink("trn_templateview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_TemplateGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_templategeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_TemplateGeneral";
            WebComp_Webcomponent_general_Component = "Trn_TemplateGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10Trn_TemplateId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10Trn_TemplateId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10Trn_TemplateId", AV10Trn_TemplateId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_TEMPLATEID", GetSecureSignedToken( "", AV10Trn_TemplateId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411291430268", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_templateview.js", "?202411291430268", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_templategeneral_cell_Internalname = "TRN_TEMPLATEGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Template View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A278Trn_TemplateId","fld":"TRN_TEMPLATEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10Trn_TemplateId","fld":"vTRN_TEMPLATEID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E114I2","iparms":[{"av":"A278Trn_TemplateId","fld":"TRN_TEMPLATEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E124I2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A278Trn_TemplateId","fld":"TRN_TEMPLATEID"}]""");
      ...
      {
         wcpOAV10Trn_TemplateId = Guid.Empty;
         wcpOAV8TabCode = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sDynURL = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H004I2_A278Trn_TemplateId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H004I3_A278Trn_TemplateId = new Guid[] {Guid.Empty} ;
         H004I3_A279Trn_TemplateName = new string[] {""} ;
         A279Trn_TemplateName = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_templateview__default(),
            new Object[][] {
                new Object[] {
               H004I2_A278Trn_TemplateId
               }
               , new Object[] {
               H004I3_A278Trn_TemplateId, H004I3_A279Trn_TemplateName
               }
            }
         );
      ...
      private string divTrn_templategeneral_cell_Internalname ;
      ...
      private Guid AV10Trn_TemplateId ;
      private Guid wcpOAV10Trn_TemplateId ;
      ...
      private Guid[] H004I2_A278Trn_TemplateId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H004I3_A278Trn_TemplateId ;
      private string[] H004I3_A279Trn_TemplateName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_templateview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10Trn_TemplateId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH004I3;
          ...
          def= new CursorDef[] {
              new CursorDef("H004I2", "SELECT Trn_TemplateId FROM Trn_Template WHERE Trn_TemplateId = :AV10Trn_TemplateId ORDER BY Trn_TemplateId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004I2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H004I3", "SELECT Trn_TemplateId, Trn_TemplateName FROM Trn_Template WHERE Trn_TemplateId = :AV10Trn_TemplateId ORDER BY Trn_TemplateId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004I3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
