...
namespace GeneXus.Programs {
   public class trn_tileview : GXDataArea
   {
      public trn_tileview( )
      {
      ...
      public trn_tileview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_Trn_TileId ,
                           string aP1_TabCode )
      {
         this.AV10Trn_TileId = aP0_Trn_TileId;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_tileview.aspx"+UrlEncode(AV10Trn_TileId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_tileview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTRN_TILEID", AV10Trn_TileId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_TILEID", GetSecureSignedToken( "", AV10Trn_TileId, context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Attributewc == null ) )
         {
            WebComp_Attributewc.componentjscripts();
         }
         if ( ! ( WebComp_Childtilewc == null ) )
         {
            WebComp_Childtilewc.componentjscripts();
         }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "trn_tileview.aspx"+UrlEncode(AV10Trn_TileId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_tileview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      {
         return context.GetMessage( "Trn_Tile View", "") ;
      }
      ...
      protected void WB5Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Tile", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_TileView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_tilegeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblAttribute_title_Internalname, context.GetMessage( "Attribute", ""), "", "", lblAttribute_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_TileView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Attribute") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtableattribute_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0037"+"", StringUtil.RTrim( WebComp_Attributewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0037"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Attributewc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldAttributewc), StringUtil.Lower( WebComp_Attributewc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
                  }
                  WebComp_Attributewc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldAttributewc), StringUtil.Lower( WebComp_Attributewc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblChildtile_title_Internalname, context.GetMessage( "Child Tile", ""), "", "", lblChildtile_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_TileView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "ChildTile") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablechildtile_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0045"+"", StringUtil.RTrim( WebComp_Childtilewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0045"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Childtilewc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldChildtilewc), StringUtil.Lower( WebComp_Childtilewc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0045"+"");
                  }
                  WebComp_Childtilewc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldChildtilewc), StringUtil.Lower( WebComp_Childtilewc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START5Y2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Tile View", ""), 0) ;
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldAttributewc = cgiGet( "W0037");
                           if ( ( StringUtil.Len( OldAttributewc) == 0 ) || ( StringUtil.StrCmp(OldAttributewc, WebComp_Attributewc_Component) != 0 ) )
                           {
                              WebComp_Attributewc = getWebComponent(GetType(), "GeneXus.Programs", OldAttributewc, new Object[] {context} );
                              WebComp_Attributewc.ComponentInit();
                              WebComp_Attributewc.Name = "OldAttributewc";
                              WebComp_Attributewc_Component = OldAttributewc;
                           }
                           if ( StringUtil.Len( WebComp_Attributewc_Component) != 0 )
                           {
                              WebComp_Attributewc.componentprocess("W0037", "", sEvt);
                           }
                           WebComp_Attributewc_Component = OldAttributewc;
                        }
                        else if ( nCmpId == 45 )
                        {
                           OldChildtilewc = cgiGet( "W0045");
                           if ( ( StringUtil.Len( OldChildtilewc) == 0 ) || ( StringUtil.StrCmp(OldChildtilewc, WebComp_Childtilewc_Component) != 0 ) )
                           {
                              WebComp_Childtilewc = getWebComponent(GetType(), "GeneXus.Programs", OldChildtilewc, new Object[] {context} );
                              WebComp_Childtilewc.ComponentInit();
                              WebComp_Childtilewc.Name = "OldChildtilewc";
                              WebComp_Childtilewc_Component = OldChildtilewc;
                           }
                           if ( StringUtil.Len( WebComp_Childtilewc_Component) != 0 )
                           {
                              WebComp_Childtilewc.componentprocess("W0045", "", sEvt);
                           }
                           WebComp_Childtilewc_Component = OldChildtilewc;
                        }
                        else if ( nCmpId == 50 )
      ...
      protected void PA5Y2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_tileview.aspx")), "trn_tileview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_tileview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10Trn_TileId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10Trn_TileId", AV10Trn_TileId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vTRN_TILEID", GetSecureSignedToken( "", AV10Trn_TileId, context));
      ...
      protected void RF5Y2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Attributewc_Component) != 0 )
               {
                  WebComp_Attributewc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Childtilewc_Component) != 0 )
               {
                  WebComp_Childtilewc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         ...
         {
            /* Using cursor H005Y2 */
            pr_default.execute(0, new Object[] {AV10Trn_TileId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A264Trn_TileId = H005Y2_A264Trn_TileId[0];
               /* Execute user event: Load */
               E165Y2 ();
      ...
      protected void E145Y2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_tileww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H005Y3 */
         pr_default.execute(1, new Object[] {AV10Trn_TileId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A264Trn_TileId = H005Y3_A264Trn_TileId[0];
            A265Trn_TileName = H005Y3_A265Trn_TileName[0];
            AV16GXLvl9 = 1;
            Form.Caption = A265Trn_TileName;
      ...
      protected void E155Y2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Tile",  StringUtil.Trim( A264Trn_TileId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Tile",  2) )
         {
      ...
      protected void E115Y2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0050",(string)"",(string)"Trn_Tile",(short)2,StringUtil.Trim( A264Trn_TileId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E125Y2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0050",(string)"",(string)"Trn_Tile",StringUtil.Trim( A264Trn_TileId.ToString()),(string)AV14RecordDescription,formatLink("trn_tileview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_TileGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_tilegeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_TileGeneral";
            WebComp_Webcomponent_general_Component = "Trn_TileGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10Trn_TileId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Attribute") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Attributewc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Attributewc_Component), StringUtil.Lower( "Trn_TileAttributeWC")) != 0 )
            {
               WebComp_Attributewc = getWebComponent(GetType(), "GeneXus.Programs", "trn_tileattributewc", new Object[] {context} );
               WebComp_Attributewc.ComponentInit();
               WebComp_Attributewc.Name = "Trn_TileAttributeWC";
               WebComp_Attributewc_Component = "Trn_TileAttributeWC";
            }
            if ( StringUtil.Len( WebComp_Attributewc_Component) != 0 )
            {
               WebComp_Attributewc.setjustcreated();
               WebComp_Attributewc.componentprepare(new Object[] {(string)"W0037",(string)"",(Guid)AV10Trn_TileId});
               WebComp_Attributewc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Attributewc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
               WebComp_Attributewc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "ChildTile") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Childtilewc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Childtilewc_Component), StringUtil.Lower( "Trn_TileChildTileWC")) != 0 )
            {
               WebComp_Childtilewc = getWebComponent(GetType(), "GeneXus.Programs", "trn_tilechildtilewc", new Object[] {context} );
               WebComp_Childtilewc.ComponentInit();
               WebComp_Childtilewc.Name = "Trn_TileChildTileWC";
               WebComp_Childtilewc_Component = "Trn_TileChildTileWC";
            }
            if ( StringUtil.Len( WebComp_Childtilewc_Component) != 0 )
            {
               WebComp_Childtilewc.setjustcreated();
               WebComp_Childtilewc.componentprepare(new Object[] {(string)"W0045",(string)"",(Guid)AV10Trn_TileId});
               WebComp_Childtilewc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Childtilewc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0045"+"");
               WebComp_Childtilewc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10Trn_TileId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10Trn_TileId", AV10Trn_TileId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_TILEID", GetSecureSignedToken( "", AV10Trn_TileId, context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Attributewc == null ) )
         {
            if ( StringUtil.Len( WebComp_Attributewc_Component) != 0 )
            {
               WebComp_Attributewc.componentthemes();
            }
         }
         if ( ! ( WebComp_Childtilewc == null ) )
         {
            if ( StringUtil.Len( WebComp_Childtilewc_Component) != 0 )
            {
               WebComp_Childtilewc.componentthemes();
            }
         }
         if ( ! ( WebComp_Wwpaux_wc == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024101016444868", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_tileview.js", "?2024101016444868", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_tilegeneral_cell_Internalname = "TRN_TILEGENERAL_CELL";
         lblAttribute_title_Internalname = "ATTRIBUTE_TITLE";
         divUnnamedtableattribute_Internalname = "UNNAMEDTABLEATTRIBUTE";
         lblChildtile_title_Internalname = "CHILDTILE_TITLE";
         divUnnamedtablechildtile_Internalname = "UNNAMEDTABLECHILDTILE";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Tile View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A264Trn_TileId","fld":"TRN_TILEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV10Trn_TileId","fld":"vTRN_TILEID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E115Y2","iparms":[{"av":"A264Trn_TileId","fld":"TRN_TILEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E125Y2","iparms":[{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A264Trn_TileId","fld":"TRN_TILEID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E135Y2","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10Trn_TileId","fld":"vTRN_TILEID","hsh":true}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"ctrl":"ATTRIBUTEWC"},{"ctrl":"CHILDTILEWC"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         lblAttribute_title_Jsonclick = "";
         WebComp_Attributewc_Component = "";
         OldAttributewc = "";
         lblChildtile_title_Jsonclick = "";
         WebComp_Childtilewc_Component = "";
         OldChildtilewc = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H005Y2_A264Trn_TileId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H005Y3_A264Trn_TileId = new Guid[] {Guid.Empty} ;
         H005Y3_A265Trn_TileName = new string[] {""} ;
         A265Trn_TileName = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_tileview__default(),
            new Object[][] {
                new Object[] {
               H005Y2_A264Trn_TileId
               }
               , new Object[] {
               H005Y3_A264Trn_TileId, H005Y3_A265Trn_TileName
               }
            }
         );
         WebComp_Webcomponent_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Attributewc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Childtilewc = new GeneXus.Http.GXNullWebComponent();
      ...
      private string divTrn_tilegeneral_cell_Internalname ;
      ...
      private string lblAttribute_title_Internalname ;
      private string lblAttribute_title_Jsonclick ;
      private string divUnnamedtableattribute_Internalname ;
      private string WebComp_Attributewc_Component ;
      private string OldAttributewc ;
      private string lblChildtile_title_Internalname ;
      private string lblChildtile_title_Jsonclick ;
      private string divUnnamedtablechildtile_Internalname ;
      private string WebComp_Childtilewc_Component ;
      private string OldChildtilewc ;
      ...
      private bool bDynCreated_Attributewc ;
      private bool bDynCreated_Childtilewc ;
      private string AV14RecordDescription ;
      private string A265Trn_TileName ;
      private Guid AV10Trn_TileId ;
      private Guid wcpOAV10Trn_TileId ;
      private Guid A264Trn_TileId ;
      private IGxSession AV15Session ;
      private GXWebComponent WebComp_Webcomponent_general ;
      private GXWebComponent WebComp_Attributewc ;
      private GXWebComponent WebComp_Childtilewc ;
      ...
      private Guid[] H005Y2_A264Trn_TileId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H005Y3_A264Trn_TileId ;
      private string[] H005Y3_A265Trn_TileName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_tileview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10Trn_TileId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH005Y3;
          ...
          def= new CursorDef[] {
              new CursorDef("H005Y2", "SELECT Trn_TileId FROM Trn_Tile WHERE Trn_TileId = :AV10Trn_TileId ORDER BY Trn_TileId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Y2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H005Y3", "SELECT Trn_TileId, Trn_TileName FROM Trn_Tile WHERE Trn_TileId = :AV10Trn_TileId ORDER BY Trn_TileId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005Y3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
