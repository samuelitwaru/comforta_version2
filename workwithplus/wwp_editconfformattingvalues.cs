...
namespace GeneXus.Programs.workwithplus {
   public class wwp_editconfformattingvalues : GXWebComponent
   {
      ...
      public void execute( string aP0_VarProgramName ,
                           GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable> aP1_ConfFormattingVariables )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV7VarProgramName,(GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable>)AV6ConfFormattingVariables});
                  componentstart();
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 10), "GRIDS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AV11GXV1 = (int)(nGXsfl_15_idx+GRIDS_nFirstRecordOnPage);
      ...
      protected void gxgrGrids_refresh( int subGrids_Rows ,
                                        GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable> AV6ConfFormattingVariables ,
                                        string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void STRUP1I0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            while ( nGXsfl_15_fel_idx < nRC_GXsfl_15 )
            {
               ...
               AV11GXV1 = (int)(nGXsfl_15_fel_idx+GRIDS_nFirstRecordOnPage);
               if ( ( AV6ConfFormattingVariables.Count >= AV11GXV1 ) && ( AV11GXV1 > 0 ) )
               {
                  AV6ConfFormattingVariables.CurrentItem = ((GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV11GXV1));
                  if ( ( ( context.localUtil.CToN( cgiGet( edtavDefaultvalue_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavDefaultvalue_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")) > Convert.ToDecimal( 9999999999L )) ) )
      ...
      private void E151I2( )
      {
         ...
         returnInSub = false;
         AV11GXV1 = 1;
         while ( AV11GXV1 <= AV6ConfFormattingVariables.Count )
         {
            AV6ConfFormattingVariables.CurrentItem = ((GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV11GXV1));
            AV8DefaultValue = (long)(Math.Round(NumberUtil.Val( ((GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable)(AV6ConfFormattingVariables.CurrentItem)).gxTpr_Defaultvalue, "."), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, edtavDefaultvalue_Internalname, StringUtil.LTrimStr( (decimal)(AV8DefaultValue), 10, 0));
            /* Load Method */
            if ( wbStart != -1 )
            {
      ...
      {
         AV11GXV1 = (int)(nGXsfl_15_idx+GRIDS_nFirstRecordOnPage);
         if ( ( AV11GXV1 > 0 ) && ( AV6ConfFormattingVariables.Count >= AV11GXV1 ) )
         {
            AV6ConfFormattingVariables.CurrentItem = ((GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV11GXV1));
         }
         ...
         returnInSub = false;
         AV13GXV3 = 1;
         while ( AV13GXV3 <= AV6ConfFormattingVariables.Count )
         {
            AV5ConfFormattingVariable = ((GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable)AV6ConfFormattingVariables.Item(AV13GXV3));
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri(sPrefix, false, "AV7VarProgramName", AV7VarProgramName);
         AV6ConfFormattingVariables = (GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable>)getParm(obj,1);
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "AV7VarProgramName", AV7VarProgramName);
            AV6ConfFormattingVariables = (GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable>)getParm(obj,3);
         }
         wcpOAV7VarProgramName = cgiGet( sPrefix+"wcpOAV7VarProgramName");
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV6ConfFormattingVariables = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable>();
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411156322557", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/wwp_editconfformattingvalues.js", "?202411156322557", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/GridEmpowerer/GridEmpowererRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDS.LOAD","""{"handler":"E151I2","iparms":[{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15}]""");
         setEventMetadata("GRIDS.LOAD",""","oparms":[{"av":"AV8DefaultValue","fld":"vDEFAULTVALUE","pic":"ZZZZZZZZZ9"}]}""");
         setEventMetadata("'DOUSERACTION1'","""{"handler":"E111I1","iparms":[]}""");
         setEventMetadata("'DOUSERACTIONRESET'","""{"handler":"E121I2","iparms":[{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","prop":"GridRC","grid":15},{"av":"AV7VarProgramName","fld":"vVARPROGRAMNAME"}]}""");
         setEventMetadata("ENTER","""{"handler":"E131I2","iparms":[{"av":"AV7VarProgramName","fld":"vVARPROGRAMNAME"},{"av":"AV6ConfFormattingVariables","fld":"vCONFFORMATTINGVARIABLES","grid":15},{"av":"nGXsfl_15_idx","ctrl":"GRID","prop":"GridCurrRow","grid":15},{"av":"GRIDS_nFirstRecordOnPage"},{"av":"nRC_GXsfl_15","ctrl":"GRIDS","grid":15,"prop":"GridRC","grid":15},{"av":"AV8DefaultValue","fld":"vDEFAULTVALUE","grid":15,"pic":"ZZZZZZZZZ9"}]}""");
      ...
      {
         AV6ConfFormattingVariables = new GXBaseCollection<GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable>( context, "WWPConfFormattingVariable", "Comforta_version2");
         ...
         AV5ConfFormattingVariable = new GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable(context);
      ...
      private GeneXus.Programs.workwithplus.SdtWWPConfFormattingVariable AV5ConfFormattingVariable ;
