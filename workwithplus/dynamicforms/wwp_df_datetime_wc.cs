   ...
   public class wwp_df_datetime_wc : GXWebComponent
   {
      ...
      protected void WB2O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavData_Internalname, context.localUtil.TToC( AV9Data, 10, 8, 1, 2, "/", ":", " "), context.localUtil.Format( AV9Data, "99/99/99 99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',5,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'MDY',5,12,'eng',false,0);"+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavData_Jsonclick, 0, "AttributeDateTime", "", "", "", "", 1, edtavData_Enabled, 1, "text", "", 17, "chr", 1, "row", 17, 0, 0, 0, 0, -1, 0, false, "", "end", false, "", "HLP_WorkWithPlus/DynamicForms/WWP_DF_Datetime_WC.htm");
      ...
      protected void S112( )
      {
         ...
         AssignAttri(sPrefix, false, "AV9Data", context.localUtil.TToC( AV9Data, 8, 5, 1, 2, "/", ":", " "));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024927194522", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_datetime_wc.js", "?2024927194523", false, true);
