...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_dfc_date_wc : GXWebComponent
   {
      public wwp_dfc_date_wc( )
      {
      ...
      public wwp_dfc_date_wc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WWP_Dynamic Form Creation_Date_WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_date_wc.aspx"+UrlEncode(StringUtil.RTrim(AV10WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV9WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV8SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dfc_date_wc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WorkWithPlus.DynamicForms.WWP_DFC_Date_WC" ;
      }

      public override string GetPgmdesc( )
      {
         return "WWP_Dynamic Form Creation_Date_WC" ;
      }
      ...
      protected void WB2W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_date_wc.aspx");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDatatitle_Internalname, lblDatatitle_Caption, "", "", lblDatatitle_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DynFormDataDescription", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/DynamicForms/WWP_DFC_Date_WC.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavData_Internalname, context.localUtil.Format(AV5Data, "99/99/99"), context.localUtil.Format( AV5Data, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavData_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavData_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WorkWithPlus/DynamicForms/WWP_DFC_Date_WC.htm");
            GxWebStd.gx_bitmap( context, edtavData_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavData_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WorkWithPlus/DynamicForms/WWP_DFC_Date_WC.htm");
            ...
            wb_table1_17_2W2( true) ;
         }
         else
         {
            wb_table1_17_2W2( false) ;
         }
         return  ;
      }

      protected void wb_table1_17_2W2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_30_2W2( true) ;
         }
         else
         {
            wb_table2_30_2W2( false) ;
         }
         return  ;
      }

      protected void wb_table2_30_2W2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_35_2W2( true) ;
         }
         else
         {
            wb_table3_35_2W2( false) ;
         }
         return  ;
      }

      protected void wb_table3_35_2W2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
      ...
      protected void START2W2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WWP_Dynamic Form Creation_Date_WC", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_date_wc.aspx")), "workwithplus.dynamicforms.wwp_dfc_date_wc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_date_wc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void STRUP2W0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavData_Internalname), 1) == 0 )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_faildate", new   object[]  {"Data"}), 1, "vDATA");
               GX_FocusControl = edtavData_Internalname;
               AssignAttri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV5Data = DateTime.MinValue;
               AssignAttri(sPrefix, false, "AV5Data", context.localUtil.Format(AV5Data, "99/99/99"));
            }
            else
            {
               AV5Data = context.localUtil.CToD( cgiGet( edtavData_Internalname), 1);
               AssignAttri(sPrefix, false, "AV5Data", context.localUtil.Format(AV5Data, "99/99/99"));
            }
      ...
      protected void wb_table3_35_2W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_35_2W2e( true) ;
         }
         else
         {
            wb_table3_35_2W2e( false) ;
         }
      }

      protected void wb_table2_30_2W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_30_2W2e( true) ;
         }
         else
         {
            wb_table2_30_2W2e( false) ;
         }
      }

      protected void wb_table1_17_2W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_17_2W2e( true) ;
         }
         else
         {
            wb_table1_17_2W2e( false) ;
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "workwithplus\\dynamicforms\\wwp_dfc_date_wc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719451819", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_date_wc.js", "?202492719451819", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"AV11IsFirstElement","fld":"vISFIRSTELEMENT","hsh":true},{"av":"AV12IsLastElement","fld":"vISLASTELEMENT","hsh":true},{"av":"AV17ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true},{"av":"AV16WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true},{"av":"Gx_date","fld":"vTODAY","hsh":true}]""");
         ...
         setEventMetadata("'DOMOVEUP'","""{"handler":"E162W2","iparms":[{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E172W2","iparms":[{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E112W2","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E132W2","iparms":[{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E122W2","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV15NeedToReloadWC","fld":"vNEEDTORELOADWC"},{"av":"AV7WWPFormElement","fld":"vWWPFORMELEMENT"},{"av":"AV17ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true},{"av":"AV16WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true},{"av":"Gx_date","fld":"vTODAY","hsh":true}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV6WWPForm","fld":"vWWPFORM"},{"av":"AV7WWPFormElement","fld":"vWWPFORMELEMENT"},{"av":"AV15NeedToReloadWC","fld":"vNEEDTORELOADWC"},{"av":"lblDatatitle_Caption","ctrl":"DATATITLE","prop":"Caption"},{"av":"divDatatitlecell_Visible","ctrl":"DATATITLECELL","prop":"Visible"},{"av":"edtavData_Caption","ctrl":"vDATA","prop":"Caption"},{"av":"AV5Data","fld":"vDATA"},{"av":"divDatacellname_Class","ctrl":"DATACELLNAME","prop":"Class"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"}]}""");
         return  ;
      }
