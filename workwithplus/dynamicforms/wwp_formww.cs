...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_formww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV53IsAuthorized_FillOutAForm = StringUtil.StrToBool( GetPar( "IsAuthorized_FillOutAForm"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV17OrderedBy, AV18OrderedDsc, AV19FilterFullText, AV44WWPFormType, AV45WWPFormIsForDynamicValidations, AV29ManageFiltersExecutionStep, AV56Pgmname, AV35TFWWPFormReferenceName, AV36TFWWPFormReferenceName_Sel, AV37TFWWPFormTitle, AV38TFWWPFormTitle_Sel, AV51IsAuthorized_Update, AV41FilledOutForms, AV52IsAuthorized_Display, AV53IsAuthorized_FillOutAForm, AV54IsAuthorized_FilledOutForms, AV40WWPFormId, AV55IsAuthorized_Insert, A240WWPFormType) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_FILLOUTAFORM", AV53IsAuthorized_FillOutAForm);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_FILLOUTAFORM", GetSecureSignedToken( "", AV53IsAuthorized_FillOutAForm, context));
      ...
      protected void WB1W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WorkWithPlus/DynamicForms/WWP_FormWW.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnimportform_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Import Form", bttBtnimportform_Jsonclick, 7, "Import Form", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e111w1_client"+"'", TempTags, "", 2, "HLP_WorkWithPlus/DynamicForms/WWP_FormWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 37 )
         {
            ...
            wb_table1_52_1W2( true) ;
         }
         else
         {
            wb_table1_52_1W2( false) ;
         }
         return  ;
      }

      protected void wb_table1_52_1W2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_57_1W2( true) ;
         }
         else
         {
            wb_table2_57_1W2( false) ;
         }
         return  ;
      }

      protected void wb_table2_57_1W2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* User Defined Control */
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV53IsAuthorized_FillOutAForm ,
      ...
      {
         /* GeneXus formulas. */
         AV56Pgmname = "WorkWithPlus.DynamicForms.WWP_FormWW";
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         /* Using cursor H001W3 */
         pr_default.execute(0, new Object[] {AV44WWPFormType, lV19FilterFullText, lV19FilterFullText, lV35TFWWPFormReferenceName, AV36TFWWPFormReferenceName_Sel, lV37TFWWPFormTitle, AV38TFWWPFormTitle_Sel});
      ...
      protected void RF1W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV37TFWWPFormTitle = StringUtil.Concat( StringUtil.RTrim( AV37TFWWPFormTitle), "%", "");
            /* Using cursor H001W5 */
            pr_default.execute(1, new Object[] {AV44WWPFormType, lV19FilterFullText, lV19FilterFullText, lV35TFWWPFormReferenceName, AV36TFWWPFormReferenceName_Sel, lV37TFWWPFormTitle, AV38TFWWPFormTitle_Sel});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
            GRID_nEOF = 0;
            ...
            {
               A242WWPFormIsForDynamicValidations = H001W5_A242WWPFormIsForDynamicValidations[0];
               A240WWPFormType = H001W5_A240WWPFormType[0];
               AssignAttri("", false, "A240WWPFormType", StringUtil.Str( (decimal)(A240WWPFormType), 1, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_WWPFORMTYPE", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A240WWPFormType), "9"), context));
               A209WWPFormTitle = H001W5_A209WWPFormTitle[0];
               A208WWPFormReferenceName = H001W5_A208WWPFormReferenceName[0];
      ...
      private void E221W2( )
      {
         if ( ( subGrid_Islastpage == 1 ) || ( subGrid_Rows == 0 ) || ( ( GRID_nCurrentRecord >= GRID_nFirstRecordOnPage ) && ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_fnc_Recordsperpage( ) ) ) )
         {
            ...
            if ( ( AV41FilledOutForms == 0 ) && ( AV44WWPFormType == 0 ) )
            {
            ...
            if ( AV53IsAuthorized_FillOutAForm )
            {
               if ( AV44WWPFormType == 0 )
               {
            ...
            {
               if ( ( AV44WWPFormType == 0 ) && ( AV41FilledOutForms > 0 ) )
               {
      ...
      protected void E121W2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("WorkWithPlus.DynamicForms.WWP_FormWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV56Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV56Pgmname+"GridState",  AV28ManageFiltersXml) ;
      ...
      protected void E181W2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0064",(string)"","WorkWithPlus.DynamicForms.WWP_FormWW",(string)"JSON",(string)""});
      ...
      protected void S162( )
      {
         ...
         returnInSub = false;
         GXt_boolean4 = AV51IsAuthorized_Update;
         ...
         AV51IsAuthorized_Update = GXt_boolean4;
         AssignAttri("", false, "AV51IsAuthorized_Update", AV51IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( "", AV51IsAuthorized_Update, context));
         GXt_boolean4 = AV52IsAuthorized_Display;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "wwp_createdynamicform_Execute", out  GXt_boolean4) ;
         AV52IsAuthorized_Display = GXt_boolean4;
         AssignAttri("", false, "AV52IsAuthorized_Display", AV52IsAuthorized_Display);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DISPLAY", GetSecureSignedToken( "", AV52IsAuthorized_Display, context));
         GXt_boolean4 = AV53IsAuthorized_FillOutAForm;
         ...
         AV53IsAuthorized_FillOutAForm = GXt_boolean4;
         AssignAttri("", false, "AV53IsAuthorized_FillOutAForm", AV53IsAuthorized_FillOutAForm);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_FILLOUTAFORM", GetSecureSignedToken( "", AV53IsAuthorized_FillOutAForm, context));
         GXt_boolean4 = AV54IsAuthorized_FilledOutForms;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "wwp_forminstanceww_Execute", out  GXt_boolean4) ;
         AV54IsAuthorized_FilledOutForms = GXt_boolean4;
         AssignAttri("", false, "AV54IsAuthorized_FilledOutForms", AV54IsAuthorized_FilledOutForms);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_FILLEDOUTFORMS", GetSecureSignedToken( "", AV54IsAuthorized_FilledOutForms, context));
         GXt_boolean4 = AV55IsAuthorized_Insert;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "wwp_createdynamicform_Execute", out  GXt_boolean4) ;
         AV55IsAuthorized_Insert = GXt_boolean4;
         AssignAttri("", false, "AV55IsAuthorized_Insert", AV55IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV55IsAuthorized_Insert, context));
         if ( ! ( AV55IsAuthorized_Insert && ( ( AV44WWPFormType == 0 ) ) ) )
         {
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item5 = AV27ManageFiltersData;
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "WorkWithPlus.DynamicForms.WWP_FormWWFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item5) ;
         AV27ManageFiltersData = GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item5;
      }
      ...
      protected void S252( )
      {
         ...
         if ( AV53IsAuthorized_FillOutAForm )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dynamicform.aspx"+UrlEncode(StringUtil.RTrim(A208WWPFormReferenceName)) + "," + UrlEncode(StringUtil.LTrimStr(0,1,0)) + "," + UrlEncode(StringUtil.RTrim("INS"));
      ...
      protected void S272( )
      {
         ...
         {
            A207WWPFormVersionNumber = H001W7_A207WWPFormVersionNumber[0];
            A206WWPFormId = H001W7_A206WWPFormId[0];
            A40000GXC1 = H001W7_A40000GXC1[0];
            n40000GXC1 = H001W7_n40000GXC1[0];
            A40000GXC1 = H001W7_A40000GXC1[0];
            n40000GXC1 = H001W7_n40000GXC1[0];
         ...
         AV58GXV1 = 1;
         while ( AV58GXV1 <= AV5WWPForm.gxTpr_Element.Count )
         {
            AV6Element = ((GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element)AV5WWPForm.gxTpr_Element.Item(AV58GXV1));
         ...
         {
            AV60GXV3 = 1;
            AV59GXV2 = AV9NewWWPForm.GetMessages();
            while ( AV60GXV3 <= AV59GXV2.Count )
            {
               AV10Message = ((GeneXus.Utils.SdtMessages_Message)AV59GXV2.Item(AV60GXV3));
      ...
      protected void S142( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV26Session.Get(AV56Pgmname+"GridState"), "") == 0 )
         {
            AV15GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV56Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV15GridState.FromXml(AV26Session.Get(AV56Pgmname+"GridState"), null, "", "");
         }
         AV17OrderedBy = AV15GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV17OrderedBy", StringUtil.LTrimStr( (decimal)(AV17OrderedBy), 4, 0));
         AV18OrderedDsc = AV15GridState.gxTpr_Ordereddsc;
      ...
      protected void S202( )
      {
         ...
         returnInSub = false;
         AV61GXV4 = 1;
         while ( AV61GXV4 <= AV15GridState.gxTpr_Filtervalues.Count )
         {
            AV16GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV15GridState.gxTpr_Filtervalues.Item(AV61GXV4));
         ...
         GXt_char6 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV38TFWWPFormTitle_Sel)),  AV38TFWWPFormTitle_Sel, out  GXt_char6) ;
         Ddo_grid_Selectedvalue_set = GXt_char3+"|"+GXt_char6;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char6 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV35TFWWPFormReferenceName)),  AV35TFWWPFormReferenceName, out  GXt_char6) ;
         GXt_char3 = "";
         ...
         Ddo_grid_Filteredtext_set = GXt_char6+"|"+GXt_char3;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "FilteredText_set", Ddo_grid_Filteredtext_set);
      }
      ...
      protected void S172( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV56Pgmname+"GridState",  AV15GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S132( )
      {
         ...
         AV14TrnContext.gxTpr_Callerobject = AV56Pgmname;
      ...
      protected void S182( )
      {
         ...
         cV41FilledOutForms = H001W8_AV41FilledOutForms[0];
      ...
      protected void wb_table2_57_1W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_57_1W2e( true) ;
         }
         else
         {
            wb_table2_57_1W2e( false) ;
         }
      }

      protected void wb_table1_52_1W2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_52_1W2e( true) ;
         }
         else
         {
            wb_table1_52_1W2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719492088", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_formww.js", "?202492719492091", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "2:WWPFormReferenceName|3:WWPFormTitle";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV17OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV18OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV35TFWWPFormReferenceName","fld":"vTFWWPFORMREFERENCENAME"},{"av":"AV36TFWWPFormReferenceName_Sel","fld":"vTFWWPFORMREFERENCENAME_SEL"},{"av":"AV37TFWWPFormTitle","fld":"vTFWWPFORMTITLE"},{"av":"AV38TFWWPFormTitle_Sel","fld":"vTFWWPFORMTITLE_SEL"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E221W2","iparms":[{"av":"AV44WWPFormType","fld":"vWWPFORMTYPE","pic":"9","hsh":true},{"av":"A206WWPFormId","fld":"WWPFORMID","pic":"ZZZ9","hsh":true},{"av":"AV51IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV41FilledOutForms","fld":"vFILLEDOUTFORMS","pic":"ZZZ9","hsh":true},{"av":"AV52IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV53IsAuthorized_FillOutAForm","fld":"vISAUTHORIZED_FILLOUTAFORM","hsh":true},{"av":"AV54IsAuthorized_FilledOutForms","fld":"vISAUTHORIZED_FILLEDOUTFORMS","hsh":true},{"av":"AV40WWPFormId","fld":"vWWPFORMID","pic":"ZZZ9","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         H001W5_A242WWPFormIsForDynamicValidations = new bool[] {false} ;
         H001W5_A240WWPFormType = new short[1] ;
         H001W5_A209WWPFormTitle = new string[] {""} ;
         H001W5_A208WWPFormReferenceName = new string[] {""} ;
         ...
         AV9NewWWPForm = new GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form(context);
         H001W7_A207WWPFormVersionNumber = new short[1] ;
         H001W7_A206WWPFormId = new short[1] ;
         H001W7_A40000GXC1 = new int[1] ;
         H001W7_n40000GXC1 = new bool[] {false} ;
         AV6Element = new GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element(context);
         AV59GXV2 = new GXBaseCollection<GeneXus.Utils.SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         AV14TrnContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext(context);
         AV48TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         H001W8_AV41FilledOutForms = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_formww__default(),
            new Object[][] {
                new Object[] {
               H001W3_A242WWPFormIsForDynamicValidations, H001W3_A240WWPFormType, H001W3_A209WWPFormTitle, H001W3_A208WWPFormReferenceName, H001W3_A207WWPFormVersionNumber, H001W3_A40000GXC1, H001W3_n40000GXC1, H001W3_A206WWPFormId
               }
               , new Object[] {
               H001W5_A242WWPFormIsForDynamicValidations, H001W5_A240WWPFormType, H001W5_A209WWPFormTitle, H001W5_A208WWPFormReferenceName, H001W5_A207WWPFormVersionNumber, H001W5_A40000GXC1, H001W5_n40000GXC1, H001W5_A206WWPFormId
               }
               , new Object[] {
               H001W7_A207WWPFormVersionNumber, H001W7_A206WWPFormId, H001W7_A40000GXC1, H001W7_n40000GXC1
               }
               , new Object[] {
               H001W8_AV41FilledOutForms
               }
            }
         );
      ...
      private bool AV53IsAuthorized_FillOutAForm ;
      ...
      private bool[] H001W5_A242WWPFormIsForDynamicValidations ;
      private short[] H001W5_A240WWPFormType ;
      private string[] H001W5_A209WWPFormTitle ;
      private string[] H001W5_A208WWPFormReferenceName ;
      ...
      private short[] H001W7_A207WWPFormVersionNumber ;
      private short[] H001W7_A206WWPFormId ;
      private int[] H001W7_A40000GXC1 ;
      private bool[] H001W7_n40000GXC1 ;
      private GeneXus.Programs.workwithplus.dynamicforms.SdtWWP_Form_Element AV6Element ;
      private GXBaseCollection<GeneXus.Utils.SdtMessages_Message> AV59GXV2 ;
      ...
      private short[] H001W8_AV41FilledOutForms ;
 ...
 public class wwp_formww__default : DataStoreHelperBase, IDataStoreHelper
 {
    ...
    protected Object[] conditional_H001W5( IGxContext context ,
                                           string AV19FilterFullText ,
                                           string AV36TFWWPFormReferenceName_Sel ,
                                           string AV35TFWWPFormReferenceName ,
                                           string AV38TFWWPFormTitle_Sel ,
                                                   ...
                                                   Object [] dynConstraints )
    {
       switch ( cursor )
       {
             ...
             case 1 :
                   return conditional_H001W5(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] , (string)dynConstraints[7] , (string)dynConstraints[8] , (bool)dynConstraints[9] , (int)dynConstraints[10] , (short)dynConstraints[11] , (bool)dynConstraints[12] , (short)dynConstraints[13] , (short)dynConstraints[14] , (short)dynConstraints[15] );
       }
  ...
  private void cursorDefinitions( )
  {
     ...
     {
        Object[] prmH001W7;
        prmH001W7 = new Object[] {
        };
        Object[] prmH001W8;
        prmH001W8 = new Object[] {
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("H001W5", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001W5,11, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("H001W7", "SELECT T1.WWPFormVersionNumber, T1.WWPFormId, COALESCE( T2.GXC1, 0) AS GXC1 FROM (WWP_Form T1 LEFT JOIN LATERAL (SELECT COUNT(*) AS GXC1, WWPFormId, WWPFormVersionNumber FROM WWP_FormElement WHERE T1.WWPFormId = WWPFormId and T1.WWPFormVersionNumber = WWPFormVersionNumber GROUP BY WWPFormId, WWPFormVersionNumber ) T2 ON T2.WWPFormId = T1.WWPFormId AND T2.WWPFormVersionNumber = T1.WWPFormVersionNumber) ORDER BY T1.WWPFormId DESC ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001W7,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("H001W8", "SELECT COUNT(*) FROM WWP_FormInstance WHERE WWPFormId = :AV40WWPFormId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001W8,1, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
