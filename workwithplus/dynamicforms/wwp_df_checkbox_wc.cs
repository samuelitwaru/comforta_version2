...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_df_checkbox_wc : GXWebComponent
   {
      public wwp_df_checkbox_wc( )
      {
      ...
      public wwp_df_checkbox_wc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WWP_Dynamic Form_Checkbox_WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_df_checkbox_wc.aspx"+UrlEncode(StringUtil.RTrim(AV27WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV28WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV7WWPFormInstanceElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV21SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_df_checkbox_wc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "WorkWithPlus.DynamicForms.WWP_DF_Checkbox_WC" ;
      }

      public override string GetPgmdesc( )
      {
         return "WWP_Dynamic Form_Checkbox_WC" ;
      }
      ...
      protected void WB2L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_df_checkbox_wc.aspx");
            }
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDatatitle_Internalname, lblDatatitle_Caption, "", "", lblDatatitle_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DynFormDataDescription", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/DynamicForms/WWP_DF_Checkbox_WC.htm");
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavData_Internalname, StringUtil.BoolToStr( AV10Data), "", chkavData.Caption, 1, chkavData.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onblur=\""+""+";gx.evt.onblur(this,14);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START2L2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WWP_Dynamic Form_Checkbox_WC", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_df_checkbox_wc.aspx")), "workwithplus.dynamicforms.wwp_df_checkbox_wc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_df_checkbox_wc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      {
         AV10Data = StringUtil.StrToBool( StringUtil.BoolToStr( AV10Data));
      ...
      protected void STRUP2L0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV10Data = StringUtil.StrToBool( cgiGet( chkavData_Internalname));
            AssignAttri(sPrefix, false, "AV10Data", AV10Data);
      ...
      protected void E112L2( )
      {
         ...
         chkavData.Enabled = (AV12DataEnabled ? 1 : 0);
         AssignProp(sPrefix, false, chkavData_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(chkavData.Enabled), 5, 0), true);
      }
      ...
      protected void S152( )
      {
         ...
         AV13ElementInternalName = chkavData_Internalname;
         AV18IsValid = true;
      ...
      protected void S182( )
      {
         ...
         this.executeExternalObjectMethod(sPrefix, false, "WWPActions", "CheckBox_SetTitle", new Object[] {(string)chkavData_Internalname,AV26WWP_DF_BooleanMetadata.gxTpr_Checkbox.gxTpr_Controltitle}, false);
         chkavData.Caption = AV30WWPFormElementTitle;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "workwithplus\\dynamicforms\\wwp_df_checkbox_wc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198291435", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_checkbox_wc.js", "?202411198291435", false, true);
