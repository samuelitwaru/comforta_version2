...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_dfc_file_wc : GXWebComponent
   {
      public wwp_dfc_file_wc( )
      {
      ...
      public wwp_dfc_file_wc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WWP_Dynamic Form Creation_File_WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_file_wc.aspx"+UrlEncode(StringUtil.RTrim(AV11WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV14WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV9SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dfc_file_wc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vWWP_DYNAMICFORMDATATYPE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV16WWP_DynamicFormDataType), 2, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vWWP_DF_CHARCONTROLTYPE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17WWP_DF_CharControlType), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vWWP_DF_CHARCONTROLTYPE", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV17WWP_DF_CharControlType), "ZZZ9"), context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vUPLOADEDFILES", AV20UploadedFiles);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vUPLOADEDFILES", AV20UploadedFiles);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vFAILEDFILES", AV21FailedFiles);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vFAILEDFILES", AV21FailedFiles);
         }
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV11WWPDynamicFormMode", StringUtil.RTrim( wcpOAV11WWPDynamicFormMode));
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV14WWPFormElementId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV14WWPFormElementId), 4, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vWWPFORMELEMENTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14WWPFormElementId), 4, 0, ".", "")));
      ...
      {
         return "WorkWithPlus.DynamicForms.WWP_DFC_File_WC" ;
      }

      public override string GetPgmdesc( )
      {
         return "WWP_Dynamic Form Creation_File_WC" ;
      }
      ...
      protected void WB340( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_file_wc.aspx");
               context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDatatitle_Internalname, lblDatatitle_Caption, "", "", lblDatatitle_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DynFormDataDescription", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/DynamicForms/WWP_DFC_File_WC.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockdata_Internalname, lblTextblockdata_Caption, "", "", lblTextblockdata_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/DynamicForms/WWP_DFC_File_WC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_17_342( true) ;
         }
         else
         {
            wb_table1_17_342( false) ;
         }
         return  ;
      }

      protected void wb_table1_17_342e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void wb_table2_26_342e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_39_342( true) ;
         }
         else
         {
            wb_table3_39_342( false) ;
         }
         return  ;
      }

      protected void wb_table3_39_342e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void START342( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WWP_Dynamic Form Creation_File_WC", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_file_wc.aspx")), "workwithplus.dynamicforms.wwp_dfc_file_wc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_file_wc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void STRUP340( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vUPLOADEDFILES"), AV20UploadedFiles);
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vFAILEDFILES"), AV21FailedFiles);
            /* Read saved values. */
            wcpOAV11WWPDynamicFormMode = cgiGet( sPrefix+"wcpOAV11WWPDynamicFormMode");
            wcpOAV14WWPFormElementId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV14WWPFormElementId"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void S112( )
      {
         ...
         AV6DataCellNameClass += " CellDynamicFormImage";
      ...
      protected void S142( )
      {
         ...
         if ( ! AV15NeedToReloadWC && ( AV16WWP_DynamicFormDataType == 2 ) )
         {
            AV10WWP_DF_CharMetadata.FromJSonString(AV13WWPFormElement.gxTpr_Wwpformelementmetadata, null);
            AV15NeedToReloadWC = (bool)(((AV10WWP_DF_CharMetadata.gxTpr_Controltype!=AV17WWP_DF_CharControlType)||(AV10WWP_DF_CharMetadata.gxTpr_Controltype==4)&&(AV10WWP_DF_CharMetadata.gxTpr_Multipleoptions.gxTpr_Controltype!=2)));
            AssignAttri(sPrefix, false, "AV15NeedToReloadWC", AV15NeedToReloadWC);
         }
      }
      ...
      protected void wb_table3_39_342( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_39_342e( true) ;
         }
         else
         {
            wb_table3_39_342e( false) ;
         }
      }
      ...
      protected void wb_table1_17_342( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_label_element( context, edtavData_Internalname, "Data", "gx-form-item AttributeLabel", 0, true, "width: 25%;");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 21,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavData_Internalname, AV5Data, StringUtil.RTrim( context.localUtil.Format( AV5Data, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavData_Jsonclick, 0, "Attribute", "", "", "", "", edtavData_Visible, edtavData_Enabled, 0, "text", "", 80, "chr", 1, "row", 150, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WorkWithPlus/DynamicForms/WWP_DFC_File_WC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td id=\""+cellUcimagescell_Internalname+"\"  class=''>") ;
            /* User Defined Control */
            ...
            ucUcimages.SetProperty("UploadedFiles", AV20UploadedFiles);
            ucUcimages.SetProperty("FailedFiles", AV21FailedFiles);
            ucUcimages.Render(context, "fileupload", Ucimages_Internalname, sPrefix+"UCIMAGESContainer");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_17_342e( true) ;
         }
         else
         {
            wb_table1_17_342e( false) ;
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "workwithplus\\dynamicforms\\wwp_dfc_file_wc", GetJustCreated( ));
      ...
      protected void WCParametersGet( )
      {
         ...
         {
            AV14WWPFormElementId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sCtrlAV14WWPFormElementId), ".", ","), 18, MidpointRounding.ToEven));
            AssignAttri(sPrefix, false, "AV14WWPFormElementId", StringUtil.LTrimStr( (decimal)(AV14WWPFormElementId), 4, 0));
         }
         else
         {
            AV14WWPFormElementId = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"AV14WWPFormElementId_PARM"), ".", ","), 18, MidpointRounding.ToEven));
         }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV14WWPFormElementId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14WWPFormElementId), 4, 0, ".", "")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198292413", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_file_wc.js", "?202411198292413", false, true);
         context.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOMOVEUP'","""{"handler":"E16342","iparms":[{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E17342","iparms":[{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E11342","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E13342","iparms":[{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E12342","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV9SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV14WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV15NeedToReloadWC","fld":"vNEEDTORELOADWC"},{"av":"AV13WWPFormElement","fld":"vWWPFORMELEMENT"},{"av":"AV18ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true},{"av":"AV16WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true},{"av":"AV17WWP_DF_CharControlType","fld":"vWWP_DF_CHARCONTROLTYPE","pic":"ZZZ9","hsh":true},{"av":"AV10WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA"}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV12WWPForm","fld":"vWWPFORM"},{"av":"AV13WWPFormElement","fld":"vWWPFORMELEMENT"},{"av":"AV15NeedToReloadWC","fld":"vNEEDTORELOADWC"},{"av":"AV10WWP_DF_CharMetadata","fld":"vWWP_DF_CHARMETADATA"},{"av":"lblDatatitle_Caption","ctrl":"DATATITLE","prop":"Caption"},{"av":"divDatatitlecell_Visible","ctrl":"DATATITLECELL","prop":"Visible"},{"av":"lblTextblockdata_Caption","ctrl":"TEXTBLOCKDATA","prop":"Caption"},{"av":"edtavData_Visible","ctrl":"vDATA","prop":"Visible"},{"av":"divDatacellname_Class","ctrl":"DATACELLNAME","prop":"Class"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         GXKey = "";
         GXEncryptionTmp = "";
         AV20UploadedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Comforta_version2");
         AV21FailedFiles = new GXBaseCollection<SdtFileUploadData>( context, "FileUploadData", "Comforta_version2");
      ...
      private GXBaseCollection<SdtFileUploadData> AV20UploadedFiles ;
      private GXBaseCollection<SdtFileUploadData> AV21FailedFiles ;
