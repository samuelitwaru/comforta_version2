...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_form_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void CheckExtendedTable0T40( )
      {
         ...
         {
            GX_msglist.addItem("The Reference name must be unique.", 1, "");
            AnyError = 1;
         }
         if ( ! ( ( A216WWPFormResume == 0 ) || ( A216WWPFormResume == 1 ) || ( A216WWPFormResume == 2 ) ) )
         {
            GX_msglist.addItem("Field WWPForm Resume is out of range", "OutOfRange", 1, "");
            AnyError = 1;
         }
         if ( ! ( ( A240WWPFormType == 0 ) || ( A240WWPFormType == 1 ) ) )
         {
            GX_msglist.addItem("Field WWPForm Type is out of range", "OutOfRange", 1, "");
            AnyError = 1;
         }
      }
      ...
      public void ScanKeyStart0T40( )
      {
         ...
         {
            RcdFound40 = 1;
            A206WWPFormId = BC000T15_A206WWPFormId[0];
            A207WWPFormVersionNumber = BC000T15_A207WWPFormVersionNumber[0];
            A208WWPFormReferenceName = BC000T15_A208WWPFormReferenceName[0];
            A209WWPFormTitle = BC000T15_A209WWPFormTitle[0];
            A231WWPFormDate = BC000T15_A231WWPFormDate[0];
            A232WWPFormIsWizard = BC000T15_A232WWPFormIsWizard[0];
            A216WWPFormResume = BC000T15_A216WWPFormResume[0];
            A235WWPFormResumeMessage = BC000T15_A235WWPFormResumeMessage[0];
            A233WWPFormValidations = BC000T15_A233WWPFormValidations[0];
            A234WWPFormInstantiated = BC000T15_A234WWPFormInstantiated[0];
            A240WWPFormType = BC000T15_A240WWPFormType[0];
            A241WWPFormSectionRefElements = BC000T15_A241WWPFormSectionRefElements[0];
            A242WWPFormIsForDynamicValidations = BC000T15_A242WWPFormIsForDynamicValidations[0];
         }
      ...
      protected void Load0T41( )
      {
         ...
         {
            RcdFound41 = 1;
            A237WWPFormElementCaption = BC000T16_A237WWPFormElementCaption[0];
            A229WWPFormElementTitle = BC000T16_A229WWPFormElementTitle[0];
            A217WWPFormElementType = BC000T16_A217WWPFormElementType[0];
            A212WWPFormElementOrderIndex = BC000T16_A212WWPFormElementOrderIndex[0];
            A218WWPFormElementDataType = BC000T16_A218WWPFormElementDataType[0];
            A228WWPFormElementParentName = BC000T16_A228WWPFormElementParentName[0];
            A230WWPFormElementParentType = BC000T16_A230WWPFormElementParentType[0];
            A236WWPFormElementMetadata = BC000T16_A236WWPFormElementMetadata[0];
            A213WWPFormElementReferenceId = BC000T16_A213WWPFormElementReferenceId[0];
            A238WWPFormElementExcludeFromExpor = BC000T16_A238WWPFormElementExcludeFromExpor[0];
            A211WWPFormElementParentId = BC000T16_A211WWPFormElementParentId[0];
            n211WWPFormElementParentId = BC000T16_n211WWPFormElementParentId[0];
            ZM0T41( -11) ;
         }
         pr_default.close(14);
         OnLoadActions0T41( ) ;
      ...
      protected void CheckExtendedTable0T41( )
      {
         ...
         {
            GX_msglist.addItem("Field WWPForm Element Type is out of range", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("Field WWPForm Element Data Type is out of range", "OutOfRange", 1, "");
            AnyError = 1;
         }
         if ( ! ( ( A237WWPFormElementCaption == 1 ) || ( A237WWPFormElementCaption == 2 ) || ( A237WWPFormElementCaption == 3 ) ) )
         {
            GX_msglist.addItem("Field WWPForm Element Caption is out of range", "OutOfRange", 1, "");
            AnyError = 1;
         }
      }
      ...
      protected void OnDeleteControls0T41( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            A228WWPFormElementParentName = BC000T21_A228WWPFormElementParentName[0];
            A230WWPFormElementParentType = BC000T21_A230WWPFormElementParentType[0];
            pr_default.close(19);
         }
         if ( AnyError == 0 )
         {
      ...
      public void ScanKeyStart0T41( )
      {
         ...
         {
            RcdFound41 = 1;
            A210WWPFormElementId = BC000T23_A210WWPFormElementId[0];
            A237WWPFormElementCaption = BC000T23_A237WWPFormElementCaption[0];
            A229WWPFormElementTitle = BC000T23_A229WWPFormElementTitle[0];
            A217WWPFormElementType = BC000T23_A217WWPFormElementType[0];
            A212WWPFormElementOrderIndex = BC000T23_A212WWPFormElementOrderIndex[0];
            A218WWPFormElementDataType = BC000T23_A218WWPFormElementDataType[0];
            A228WWPFormElementParentName = BC000T23_A228WWPFormElementParentName[0];
            A230WWPFormElementParentType = BC000T23_A230WWPFormElementParentType[0];
            A236WWPFormElementMetadata = BC000T23_A236WWPFormElementMetadata[0];
            A213WWPFormElementReferenceId = BC000T23_A213WWPFormElementReferenceId[0];
            A238WWPFormElementExcludeFromExpor = BC000T23_A238WWPFormElementExcludeFromExpor[0];
            A211WWPFormElementParentId = BC000T23_A211WWPFormElementParentId[0];
            n211WWPFormElementParentId = BC000T23_n211WWPFormElementParentId[0];
         }
         /* Load Subordinate Levels */
      }
      ...
      public override void initialize( )
      {
         ...
         BC000T12_A395LocationDynamicFormId = new Guid[] {Guid.Empty} ;
         BC000T12_A11OrganisationId = new Guid[] {Guid.Empty} ;
         BC000T12_A29LocationId = new Guid[] {Guid.Empty} ;
         BC000T13_A214WWPFormInstanceId = new int[1] ;
         BC000T14_A206WWPFormId = new short[1] ;
         BC000T14_A207WWPFormVersionNumber = new short[1] ;
         BC000T14_A211WWPFormElementParentId = new short[1] ;
         BC000T14_n211WWPFormElementParentId = new bool[] {false} ;
         BC000T15_A206WWPFormId = new short[1] ;
         BC000T15_A207WWPFormVersionNumber = new short[1] ;
         BC000T15_A208WWPFormReferenceName = new string[] {""} ;
         BC000T15_A209WWPFormTitle = new string[] {""} ;
         BC000T15_A231WWPFormDate = new DateTime[] {DateTime.MinValue} ;
         BC000T15_A232WWPFormIsWizard = new bool[] {false} ;
         BC000T15_A216WWPFormResume = new short[1] ;
         BC000T15_A235WWPFormResumeMessage = new string[] {""} ;
         BC000T15_A233WWPFormValidations = new string[] {""} ;
         BC000T15_A234WWPFormInstantiated = new bool[] {false} ;
         BC000T15_A240WWPFormType = new short[1] ;
         BC000T15_A241WWPFormSectionRefElements = new string[] {""} ;
         BC000T15_A242WWPFormIsForDynamicValidations = new bool[] {false} ;
         Z213WWPFormElementReferenceId = "";
         A213WWPFormElementReferenceId = "";
         ...
         BC000T16_A237WWPFormElementCaption = new short[1] ;
         BC000T16_A229WWPFormElementTitle = new string[] {""} ;
         BC000T16_A217WWPFormElementType = new short[1] ;
         BC000T16_A212WWPFormElementOrderIndex = new short[1] ;
         BC000T16_A218WWPFormElementDataType = new short[1] ;
         BC000T16_A228WWPFormElementParentName = new string[] {""} ;
         BC000T16_A230WWPFormElementParentType = new short[1] ;
         BC000T16_A236WWPFormElementMetadata = new string[] {""} ;
         BC000T16_A213WWPFormElementReferenceId = new string[] {""} ;
         BC000T16_A238WWPFormElementExcludeFromExpor = new bool[] {false} ;
         BC000T16_A206WWPFormId = new short[1] ;
         BC000T16_A207WWPFormVersionNumber = new short[1] ;
         BC000T16_A211WWPFormElementParentId = new short[1] ;
         BC000T16_n211WWPFormElementParentId = new bool[] {false} ;
         BC000T4_A228WWPFormElementParentName = new string[] {""} ;
         BC000T4_A230WWPFormElementParentType = new short[1] ;
         BC000T17_A206WWPFormId = new short[1] ;
         BC000T17_A207WWPFormVersionNumber = new short[1] ;
         BC000T17_A210WWPFormElementId = new short[1] ;
         ...
         BC000T21_A228WWPFormElementParentName = new string[] {""} ;
         BC000T21_A230WWPFormElementParentType = new short[1] ;
         ...
         BC000T23_A210WWPFormElementId = new short[1] ;
         BC000T23_A237WWPFormElementCaption = new short[1] ;
         BC000T23_A229WWPFormElementTitle = new string[] {""} ;
         BC000T23_A217WWPFormElementType = new short[1] ;
         BC000T23_A212WWPFormElementOrderIndex = new short[1] ;
         BC000T23_A218WWPFormElementDataType = new short[1] ;
         BC000T23_A228WWPFormElementParentName = new string[] {""} ;
         BC000T23_A230WWPFormElementParentType = new short[1] ;
         BC000T23_A236WWPFormElementMetadata = new string[] {""} ;
         BC000T23_A213WWPFormElementReferenceId = new string[] {""} ;
         BC000T23_A238WWPFormElementExcludeFromExpor = new bool[] {false} ;
         BC000T23_A206WWPFormId = new short[1] ;
         BC000T23_A207WWPFormVersionNumber = new short[1] ;
         BC000T23_A211WWPFormElementParentId = new short[1] ;
         BC000T23_n211WWPFormElementParentId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.workwithplus.dynamicforms.wwp_form_bc__default(),
            new Object[][] {
               ...
               , new Object[] {
               BC000T12_A395LocationDynamicFormId, BC000T12_A11OrganisationId, BC000T12_A29LocationId
               }
               , new Object[] {
               BC000T13_A214WWPFormInstanceId
               }
               , new Object[] {
               BC000T14_A206WWPFormId, BC000T14_A207WWPFormVersionNumber, BC000T14_A211WWPFormElementParentId
               }
               , new Object[] {
               BC000T15_A206WWPFormId, BC000T15_A207WWPFormVersionNumber, BC000T15_A208WWPFormReferenceName, BC000T15_A209WWPFormTitle, BC000T15_A231WWPFormDate, BC000T15_A232WWPFormIsWizard, BC000T15_A216WWPFormResume, BC000T15_A235WWPFormResumeMessage, BC000T15_A233WWPFormValidations, BC000T15_A234WWPFormInstantiated,
               BC000T15_A240WWPFormType, BC000T15_A241WWPFormSectionRefElements, BC000T15_A242WWPFormIsForDynamicValidations
               }
               , new Object[] {
               BC000T16_A210WWPFormElementId, BC000T16_A237WWPFormElementCaption, BC000T16_A229WWPFormElementTitle, BC000T16_A217WWPFormElementType, BC000T16_A212WWPFormElementOrderIndex, BC000T16_A218WWPFormElementDataType, BC000T16_A228WWPFormElementParentName, BC000T16_A230WWPFormElementParentType, BC000T16_A236WWPFormElementMetadata, BC000T16_A213WWPFormElementReferenceId,
               BC000T16_A238WWPFormElementExcludeFromExpor, BC000T16_A206WWPFormId, BC000T16_A207WWPFormVersionNumber, BC000T16_A211WWPFormElementParentId, BC000T16_n211WWPFormElementParentId
               }
               , new Object[] {
               BC000T17_A206WWPFormId, BC000T17_A207WWPFormVersionNumber, BC000T17_A210WWPFormElementId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               BC000T21_A228WWPFormElementParentName, BC000T21_A230WWPFormElementParentType
               }
               , new Object[] {
               BC000T22_A206WWPFormId, BC000T22_A207WWPFormVersionNumber, BC000T22_A211WWPFormElementParentId
               }
               , new Object[] {
               BC000T23_A210WWPFormElementId, BC000T23_A237WWPFormElementCaption, BC000T23_A229WWPFormElementTitle, BC000T23_A217WWPFormElementType, BC000T23_A212WWPFormElementOrderIndex, BC000T23_A218WWPFormElementDataType, BC000T23_A228WWPFormElementParentName, BC000T23_A230WWPFormElementParentType, BC000T23_A236WWPFormElementMetadata, BC000T23_A213WWPFormElementReferenceId,
               BC000T23_A238WWPFormElementExcludeFromExpor, BC000T23_A206WWPFormId, BC000T23_A207WWPFormVersionNumber, BC000T23_A211WWPFormElementParentId, BC000T23_n211WWPFormElementParentId
               }
            }
         );
      ...
      private Guid[] BC000T12_A395LocationDynamicFormId ;
      private Guid[] BC000T12_A11OrganisationId ;
      private Guid[] BC000T12_A29LocationId ;
      private int[] BC000T13_A214WWPFormInstanceId ;
      private short[] BC000T14_A206WWPFormId ;
      private short[] BC000T14_A207WWPFormVersionNumber ;
      private short[] BC000T14_A211WWPFormElementParentId ;
      private bool[] BC000T14_n211WWPFormElementParentId ;
      private short[] BC000T15_A206WWPFormId ;
      private short[] BC000T15_A207WWPFormVersionNumber ;
      private string[] BC000T15_A208WWPFormReferenceName ;
      private string[] BC000T15_A209WWPFormTitle ;
      private DateTime[] BC000T15_A231WWPFormDate ;
      private bool[] BC000T15_A232WWPFormIsWizard ;
      private short[] BC000T15_A216WWPFormResume ;
      private string[] BC000T15_A235WWPFormResumeMessage ;
      private string[] BC000T15_A233WWPFormValidations ;
      private bool[] BC000T15_A234WWPFormInstantiated ;
      private short[] BC000T15_A240WWPFormType ;
      private string[] BC000T15_A241WWPFormSectionRefElements ;
      private bool[] BC000T15_A242WWPFormIsForDynamicValidations ;
      private short[] BC000T16_A210WWPFormElementId ;
      private short[] BC000T16_A237WWPFormElementCaption ;
      private string[] BC000T16_A229WWPFormElementTitle ;
      private short[] BC000T16_A217WWPFormElementType ;
      private short[] BC000T16_A212WWPFormElementOrderIndex ;
      private short[] BC000T16_A218WWPFormElementDataType ;
      private string[] BC000T16_A228WWPFormElementParentName ;
      private short[] BC000T16_A230WWPFormElementParentType ;
      private string[] BC000T16_A236WWPFormElementMetadata ;
      private string[] BC000T16_A213WWPFormElementReferenceId ;
      private bool[] BC000T16_A238WWPFormElementExcludeFromExpor ;
      private short[] BC000T16_A206WWPFormId ;
      private short[] BC000T16_A207WWPFormVersionNumber ;
      private short[] BC000T16_A211WWPFormElementParentId ;
      private bool[] BC000T16_n211WWPFormElementParentId ;
      private string[] BC000T4_A228WWPFormElementParentName ;
      private short[] BC000T4_A230WWPFormElementParentType ;
      private short[] BC000T17_A206WWPFormId ;
      private short[] BC000T17_A207WWPFormVersionNumber ;
      ...
      private string[] BC000T21_A228WWPFormElementParentName ;
      private short[] BC000T21_A230WWPFormElementParentType ;
      ...
      private short[] BC000T23_A210WWPFormElementId ;
      private short[] BC000T23_A237WWPFormElementCaption ;
      private string[] BC000T23_A229WWPFormElementTitle ;
      private short[] BC000T23_A217WWPFormElementType ;
      private short[] BC000T23_A212WWPFormElementOrderIndex ;
      private short[] BC000T23_A218WWPFormElementDataType ;
      private string[] BC000T23_A228WWPFormElementParentName ;
      private short[] BC000T23_A230WWPFormElementParentType ;
      private string[] BC000T23_A236WWPFormElementMetadata ;
      private string[] BC000T23_A213WWPFormElementReferenceId ;
      private bool[] BC000T23_A238WWPFormElementExcludeFromExpor ;
      private short[] BC000T23_A206WWPFormId ;
      private short[] BC000T23_A207WWPFormVersionNumber ;
      private short[] BC000T23_A211WWPFormElementParentId ;
      private bool[] BC000T23_n211WWPFormElementParentId ;
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("BC000T12", "SELECT LocationDynamicFormId, OrganisationId, LocationId FROM Trn_LocationDynamicForm WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000T12,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("BC000T13", "SELECT WWPFormInstanceId FROM WWP_FormInstance WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000T13,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("BC000T14", "SELECT WWPFormId, WWPFormVersionNumber, WWPFormElementId AS WWPFormElementParentId FROM WWP_FormElement WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000T14,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("BC000T15", "SELECT TM1.WWPFormId, TM1.WWPFormVersionNumber, TM1.WWPFormReferenceName, TM1.WWPFormTitle, TM1.WWPFormDate, TM1.WWPFormIsWizard, TM1.WWPFormResume, TM1.WWPFormResumeMessage, TM1.WWPFormValidations, TM1.WWPFormInstantiated, TM1.WWPFormType, TM1.WWPFormSectionRefElements, TM1.WWPFormIsForDynamicValidations FROM WWP_Form TM1 WHERE TM1.WWPFormId = :WWPFormId and TM1.WWPFormVersionNumber = :WWPFormVersionNumber ORDER BY TM1.WWPFormId, TM1.WWPFormVersionNumber ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000T15,100, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("BC000T16", "SELECT T1.WWPFormElementId, T1.WWPFormElementCaption, T1.WWPFormElementTitle, T1.WWPFormElementType, T1.WWPFormElementOrderIndex, T1.WWPFormElementDataType, T2.WWPFormElementTitle AS WWPFormElementParentName, T2.WWPFormElementType AS WWPFormElementParentType, T1.WWPFormElementMetadata, T1.WWPFormElementReferenceId, T1.WWPFormElementExcludeFromExpor, T1.WWPFormId, T1.WWPFormVersionNumber, T1.WWPFormElementParentId AS WWPFormElementParentId FROM (WWP_FormElement T1 LEFT JOIN WWP_FormElement T2 ON T2.WWPFormId = T1.WWPFormId AND T2.WWPFormVersionNumber = T1.WWPFormVersionNumber AND T2.WWPFormElementId = T1.WWPFormElementParentId) WHERE T1.WWPFormId = :WWPFormId and T1.WWPFormVersionNumber = :WWPFormVersionNumber and T1.WWPFormElementId = :WWPFormElementId ORDER BY T1.WWPFormId, T1.WWPFormVersionNumber, T1.WWPFormElementId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000T16,11, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("BC000T17", "SELECT WWPFormId, WWPFormVersionNumber, WWPFormElementId FROM WWP_FormElement WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber AND WWPFormElementId = :WWPFormElementId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000T17,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("BC000T18", "SAVEPOINT gxupdate;INSERT INTO WWP_FormElement(WWPFormElementId, WWPFormElementCaption, WWPFormElementTitle, WWPFormElementType, WWPFormElementOrderIndex, WWPFormElementDataType, WWPFormElementMetadata, WWPFormElementReferenceId, WWPFormElementExcludeFromExpor, WWPFormId, WWPFormVersionNumber, WWPFormElementParentId) VALUES(:WWPFormElementId, :WWPFormElementCaption, :WWPFormElementTitle, :WWPFormElementType, :WWPFormElementOrderIndex, :WWPFormElementDataType, :WWPFormElementMetadata, :WWPFormElementReferenceId, :WWPFormElementExcludeFromExpor, :WWPFormId, :WWPFormVersionNumber, :WWPFormElementParentId);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmBC000T18)
           ,new CursorDef("BC000T19", "SAVEPOINT gxupdate;UPDATE WWP_FormElement SET WWPFormElementCaption=:WWPFormElementCaption, WWPFormElementTitle=:WWPFormElementTitle, WWPFormElementType=:WWPFormElementType, WWPFormElementOrderIndex=:WWPFormElementOrderIndex, WWPFormElementDataType=:WWPFormElementDataType, WWPFormElementMetadata=:WWPFormElementMetadata, WWPFormElementReferenceId=:WWPFormElementReferenceId, WWPFormElementExcludeFromExpor=:WWPFormElementExcludeFromExpor, WWPFormElementParentId=:WWPFormElementParentId  WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber AND WWPFormElementId = :WWPFormElementId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmBC000T19)
           ,new CursorDef("BC000T20", "SAVEPOINT gxupdate;DELETE FROM WWP_FormElement  WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber AND WWPFormElementId = :WWPFormElementId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmBC000T20)
           ,new CursorDef("BC000T21", "SELECT WWPFormElementTitle AS WWPFormElementParentName, WWPFormElementType AS WWPFormElementParentType FROM WWP_FormElement WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber AND WWPFormElementId = :WWPFormElementParentId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000T21,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("BC000T22", "SELECT WWPFormId, WWPFormVersionNumber, WWPFormElementId AS WWPFormElementParentId FROM WWP_FormElement WHERE WWPFormId = :WWPFormId AND WWPFormVersionNumber = :WWPFormVersionNumber AND WWPFormElementParentId = :WWPFormElementId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000T22,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("BC000T23", "SELECT T1.WWPFormElementId, T1.WWPFormElementCaption, T1.WWPFormElementTitle, T1.WWPFormElementType, T1.WWPFormElementOrderIndex, T1.WWPFormElementDataType, T2.WWPFormElementTitle AS WWPFormElementParentName, T2.WWPFormElementType AS WWPFormElementParentType, T1.WWPFormElementMetadata, T1.WWPFormElementReferenceId, T1.WWPFormElementExcludeFromExpor, T1.WWPFormId, T1.WWPFormVersionNumber, T1.WWPFormElementParentId AS WWPFormElementParentId FROM (WWP_FormElement T1 LEFT JOIN WWP_FormElement T2 ON T2.WWPFormId = T1.WWPFormId AND T2.WWPFormVersionNumber = T1.WWPFormVersionNumber AND T2.WWPFormElementId = T1.WWPFormElementParentId) WHERE T1.WWPFormId = :WWPFormId and T1.WWPFormVersionNumber = :WWPFormVersionNumber ORDER BY T1.WWPFormId, T1.WWPFormVersionNumber, T1.WWPFormElementId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000T23,11, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
