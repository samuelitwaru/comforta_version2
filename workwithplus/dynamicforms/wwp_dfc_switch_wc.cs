...
namespace GeneXus.Programs.workwithplus.dynamicforms {
   public class wwp_dfc_switch_wc : GXWebComponent
   {
      public wwp_dfc_switch_wc( )
      {
      ...
      public wwp_dfc_switch_wc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WWP_Dynamic Form Creation_Switch_WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "workwithplus.dynamicforms.wwp_dfc_switch_wc.aspx"+UrlEncode(StringUtil.RTrim(AV10WWPDynamicFormMode)) + "," + UrlEncode(StringUtil.LTrimStr(AV9WWPFormElementId,4,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV8SessionId,4,0));
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("workwithplus.dynamicforms.wwp_dfc_switch_wc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vDATA", AV5Data);
      ...
      {
         return "WorkWithPlus.DynamicForms.WWP_DFC_Switch_WC" ;
      }

      public override string GetPgmdesc( )
      {
         return "WWP_Dynamic Form Creation_Switch_WC" ;
      }
      ...
      protected void WB2V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "workwithplus.dynamicforms.wwp_dfc_switch_wc.aspx");
               context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
               context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDatatitle_Internalname, lblDatatitle_Caption, "", "", lblDatatitle_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "DynFormDataDescription", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/DynamicForms/WWP_DFC_Switch_WC.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockdata_Internalname, lblTextblockdata_Caption, "", "", lblTextblockdata_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/DynamicForms/WWP_DFC_Switch_WC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
      ...
      protected void wb_table1_17_2V2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table2_26_2V2( true) ;
         }
         else
         {
            wb_table2_26_2V2( false) ;
         }
         return  ;
      }

      protected void wb_table2_26_2V2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_39_2V2( true) ;
         }
         else
         {
            wb_table3_39_2V2( false) ;
         }
         return  ;
      }

      protected void wb_table3_39_2V2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table4_44_2V2( true) ;
         }
         else
         {
            wb_table4_44_2V2( false) ;
         }
         return  ;
      }

      protected void wb_table4_44_2V2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* Div Control */
      ...
      protected void START2V2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WWP_Dynamic Form Creation_Switch_WC", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_switch_wc.aspx")), "workwithplus.dynamicforms.wwp_dfc_switch_wc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "workwithplus.dynamicforms.wwp_dfc_switch_wc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void STRUP2V0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV5Data = StringUtil.StrToBool( cgiGet( sPrefix+"vDATA"));
      ...
      protected void E132V2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)sPrefix+"W0050",(string)"",(string)"UPD",(short)0,(short)AV9WWPFormElementId,(short)AV8SessionId});
      ...
      protected void S112( )
      {
         ...
         lblTextblockdata_Caption = AV7WWPFormElement.gxTpr_Wwpformelementtitle;
      ...
      protected void wb_table4_44_2V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table4_44_2V2e( true) ;
         }
         else
         {
            wb_table4_44_2V2e( false) ;
         }
      }

      protected void wb_table3_39_2V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_39_2V2e( true) ;
         }
         else
         {
            wb_table3_39_2V2e( false) ;
         }
      }

      protected void wb_table2_26_2V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_26_2V2e( true) ;
         }
         else
         {
            wb_table2_26_2V2e( false) ;
         }
      }

      protected void wb_table1_17_2V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDummytext_Internalname, " ", "", "", lblDummytext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/DynamicForms/WWP_DFC_Switch_WC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "workwithplus\\dynamicforms\\wwp_dfc_switch_wc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719451932", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_dfc_switch_wc.js", "?202492719451932", false, true);
         context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
         context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOMOVEUP'","""{"handler":"E162V2","iparms":[{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]}""");
         setEventMetadata("'DOMOVEDOWN'","""{"handler":"E172V2","iparms":[{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]}""");
         setEventMetadata("DVELOP_CONFIRMPANEL_BTNDELETEELEMENT.CLOSE","""{"handler":"E112V2","iparms":[{"av":"Dvelop_confirmpanel_btndeleteelement_Result","ctrl":"DVELOP_CONFIRMPANEL_BTNDELETEELEMENT","prop":"Result"},{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"}]""");
         ...
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT","""{"handler":"E132V2","iparms":[{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9"}]""");
         setEventMetadata("SETTINGS_MODAL.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("SETTINGS_MODAL.CLOSE","""{"handler":"E122V2","iparms":[{"av":"Settings_modal_Result","ctrl":"SETTINGS_MODAL","prop":"Result"},{"av":"AV8SessionId","fld":"vSESSIONID","pic":"ZZZ9"},{"av":"AV9WWPFormElementId","fld":"vWWPFORMELEMENTID","pic":"ZZZ9"},{"av":"AV15NeedToReloadWC","fld":"vNEEDTORELOADWC"},{"av":"AV7WWPFormElement","fld":"vWWPFORMELEMENT"},{"av":"AV17ParentIsGridMultipleData","fld":"vPARENTISGRIDMULTIPLEDATA","hsh":true},{"av":"AV16WWP_DynamicFormDataType","fld":"vWWP_DYNAMICFORMDATATYPE","pic":"Z9","hsh":true}]""");
         setEventMetadata("SETTINGS_MODAL.CLOSE",""","oparms":[{"av":"AV6WWPForm","fld":"vWWPFORM"},{"av":"AV7WWPFormElement","fld":"vWWPFORMELEMENT"},{"av":"AV15NeedToReloadWC","fld":"vNEEDTORELOADWC"},{"av":"lblDatatitle_Caption","ctrl":"DATATITLE","prop":"Caption"},{"av":"divDatatitlecell_Visible","ctrl":"DATATITLECELL","prop":"Visible"},{"av":"AV5Data","fld":"vDATA"},{"av":"lblTextblockdata_Caption","ctrl":"TEXTBLOCKDATA","prop":"Caption"},{"av":"divDatacellname_Class","ctrl":"DATACELLNAME","prop":"Class"},{"av":"divDatatitlecell_Class","ctrl":"DATATITLECELL","prop":"Class"}]}""");
         return  ;
      }
