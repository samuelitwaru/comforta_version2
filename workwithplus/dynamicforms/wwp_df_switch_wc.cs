   ...
   public class wwp_df_switch_wc : GXWebComponent
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WWP_Dynamic Form_Switch_WC") ;
      ...
      {
         return "WWP_Dynamic Form_Switch_WC" ;
      }
      ...
      protected void START2M2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "WWP_Dynamic Form_Switch_WC", 0) ;
            context.wjLoc = "";
      ...
      protected void S152( )
      {
         ...
         AV13ElementInternalName = "a no va el title?";
         AV18IsValid = true;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198291334", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/dynamicforms/wwp_df_switch_wc.js", "?202411198291335", false, true);
         context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
         context.AddJavascriptSource("Switch/switch.min.js", "", false, true);
