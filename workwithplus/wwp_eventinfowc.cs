   ...
   public class wwp_eventinfowc : GXWebComponent
   {
      ...
      protected void wb_table2_34_5E2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockeventtype_Internalname, "Type", "", "", lblTextblockeventtype_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/WWP_EventInfoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
      ...
      protected void wb_table5_88_5E2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockrecurringevent_Internalname, "Recurring", "", "", lblTextblockrecurringevent_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/WWP_EventInfoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
      ...
      protected void wb_table6_103_5E2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTextblockcombo_addressgroup_cell_Internalname, 1, 0, "px", 0, "px", divTextblockcombo_addressgroup_cell_Class, "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_addressgroup_Internalname, "Residents", "", "", lblTextblockcombo_addressgroup_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WorkWithPlus/WWP_EventInfoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "start", "top", "", "", "div");
            wb_table7_121_5E2( true) ;
         }
         else
         {
            wb_table7_121_5E2( false) ;
         }
         return  ;
      }

      protected void wb_table7_121_5E2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuacancel_Internalname, "", "Cancel", bttBtnuacancel_Jsonclick, 7, "Cancel", "", StyleString, ClassString, bttBtnuacancel_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e115e1_client"+"'", TempTags, "", 2, "HLP_WorkWithPlus/WWP_EventInfoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "BtnDefault";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuadelete_Internalname, "", "Delete", bttBtnuadelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, bttBtnuadelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e125e1_client"+"'", TempTags, "", 2, "HLP_WorkWithPlus/WWP_EventInfoWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table8_143_5E2( true) ;
         }
         else
         {
            wb_table8_143_5E2( false) ;
         }
         return  ;
      }

      protected void wb_table8_143_5E2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void GXDSVvRECURINGEVENTTYPE_data5E2( DateTime AV12CurrentDate )
      {
         ...
         gxdynajaxctrldescr.Add("Select Recurring Type");
      ...
      protected void E145E2( )
      {
         ...
         if ( ( StringUtil.StrCmp(Gx_mode, "DSP") == 0 ) || ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 ) )
         {
            ...
            {
               AV44AddressGroup = (GxSimpleCollection<Guid>)(new GxSimpleCollection<Guid>());
            }
         }
         else
         {
         ...
         S122 ();
         if (returnInSub) return;
         GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3 = AV37DDO_TitleSettingsIcons;
         ...
         AV37DDO_TitleSettingsIcons = GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons3;
      ...
      protected void S182( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "From", "", "", "", "", "", "", "", ""),  "error",  edtavCurrentdate_Internalname,  "true",  ""));
            AV11CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV11CheckRequiredFieldsResult", AV11CheckRequiredFieldsResult);
         }
         if ( (DateTime.MinValue==AV16EndDate) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "To", "", "", "", "", "", "", "", ""),  "error",  edtavEnddate_Internalname,  "true",  ""));
            AV11CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV11CheckRequiredFieldsResult", AV11CheckRequiredFieldsResult);
         }
      }
      ...
      protected void S142( )
      {
         ...
         if ( ! ( ( StringUtil.StrCmp(Gx_mode, "DSP") != 0 ) ) )
         {
            ...
            cellCombo_addressgroup_cell_Class = "Invisible";
            AssignProp(sPrefix, false, cellCombo_addressgroup_cell_Internalname, "Class", cellCombo_addressgroup_cell_Class, true);
            divTextblockcombo_addressgroup_cell_Class = "Invisible";
            AssignProp(sPrefix, false, divTextblockcombo_addressgroup_cell_Internalname, "Class", divTextblockcombo_addressgroup_cell_Class, true);
         }
         else
         {
            Combo_addressgroup_Visible = true;
            ucCombo_addressgroup.SendProperty(context, sPrefix, false, Combo_addressgroup_Internalname, "Visible", StringUtil.BoolToStr( Combo_addressgroup_Visible));
            cellCombo_addressgroup_cell_Class = "MergeDataCell";
            AssignProp(sPrefix, false, cellCombo_addressgroup_cell_Internalname, "Class", cellCombo_addressgroup_cell_Class, true);
            divTextblockcombo_addressgroup_cell_Class = "col-sm-3 MergeLabelCell";
            AssignProp(sPrefix, false, divTextblockcombo_addressgroup_cell_Internalname, "Class", divTextblockcombo_addressgroup_cell_Class, true);
         }
         if ( ! ( ( StringUtil.StrCmp(Gx_mode, "DSP") != 0 ) ) )
         {
            chkavAddrsvp.Visible = 0;
            AssignProp(sPrefix, false, chkavAddrsvp_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavAddrsvp.Visible), 5, 0), true);
            cellAddrsvp_cell_Class = "Invisible";
            AssignProp(sPrefix, false, cellAddrsvp_cell_Internalname, "Class", cellAddrsvp_cell_Class, true);
         }
         else
         {
            chkavAddrsvp.Visible = 1;
            AssignProp(sPrefix, false, chkavAddrsvp_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavAddrsvp.Visible), 5, 0), true);
            cellAddrsvp_cell_Class = "DataContentCell";
            AssignProp(sPrefix, false, cellAddrsvp_cell_Internalname, "Class", cellAddrsvp_cell_Class, true);
         }
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         AV54GXV2 = 1;
         GXt_objcol_SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem4 = AV53GXV1;
         new dp_locationresident(context ).execute( out  GXt_objcol_SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem4) ;
         AV53GXV1 = GXt_objcol_SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem4;
         while ( AV54GXV2 <= AV53GXV1.Count )
         {
            AV48AddressGroup_DPItem = ((SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem)AV53GXV1.Item(AV54GXV2));
            AV38Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
      ...
      protected void E195E2( )
      {
         ...
         {
            if ( new GeneXus.Programs.workwithplus.wwp_calendar_editevent(context).executeUdp(  Gx_mode,  AV18Title,  AV12CurrentDate,  AV17FromTime,  AV19ToTime,  AV7AllDay,  AV16EndDate,  AV8CalendarEventId,  AV40EventType,  AV42RecurringEvent,  AV43RecuringEventType,  AV41AddRSVP,  AV44AddressGroup, out  AV6ErrorMessages) )
            {
            ...
            {
               AV55GXV3 = 1;
               while ( AV55GXV3 <= AV6ErrorMessages.Count )
               {
                  AV5Message = ((GeneXus.Utils.SdtMessages_Message)AV6ErrorMessages.Item(AV55GXV3));
      ...
      protected void S112( )
      {
         ...
         AV56GXV4 = 1;
         while ( AV56GXV4 <= AV14DisabledDays.Count )
         {
            AV13DisabledDay = AV14DisabledDays.GetDatetime(AV56GXV4);
      ...
      protected void wb_table8_143_5E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table8_143_5E2e( true) ;
         }
         else
         {
            wb_table8_143_5E2e( false) ;
         }
      }

      protected void wb_table7_121_5E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTablemergedaddressgroup_Internalname, tblTablemergedaddressgroup_Internalname, "", "TableMerged", 0, "", "", 0, 0, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td id=\""+cellCombo_addressgroup_cell_Internalname+"\"  class='"+cellCombo_addressgroup_cell_Class+"'>") ;
            /* User Defined Control */
            ...
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td id=\""+cellAddrsvp_cell_Internalname+"\"  class='"+cellAddrsvp_cell_Class+"'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", chkavAddrsvp.Visible, 0, "px", 0, "px", "form-group gx-form-group gx-default-form-group", "start", "top", ""+" data-gx-for=\""+chkavAddrsvp_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavAddrsvp_Internalname, " ", "gx-form-item AttributeCheckBoxLabel", 1, true, "width: 25%;");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAddrsvp_Internalname, StringUtil.BoolToStr( AV41AddRSVP), "", " ", chkavAddrsvp.Visible, chkavAddrsvp.Enabled, "true", "RSVP", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(128, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,128);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table7_121_5E2e( true) ;
         }
         else
         {
            wb_table7_121_5E2e( false) ;
         }
      }
      ...
      protected void wb_table6_103_5E2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavRecurringevent_Internalname, "Recurring Event", "gx-form-item AttributeCheckBoxLabel", 0, true, "width: 25%;");
            /* Check box */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 107,'" + sPrefix + "',false,'',0)\"";
            ClassString = "AttributeCheckBox";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavRecurringevent_Internalname, StringUtil.BoolToStr( AV42RecurringEvent), "", "Recurring Event", chkavRecurringevent.Visible, chkavRecurringevent.Enabled, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(107, this, 'true', 'false',"+"'"+sPrefix+"'"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,107);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, dynavRecuringeventtype_Internalname, "Recuring Event Type", "col-sm-3 AttributeLabel", 0, true, "");
      ...
      protected void wb_table5_88_5E2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavEnddate_Internalname, context.localUtil.Format(AV16EndDate, "99/99/99"), context.localUtil.Format( AV16EndDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'eng',false,0);"+";gx.evt.onblur(this,92);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavEnddate_Jsonclick, 0, "AttributeDate", "", "", "", "", edtavEnddate_Visible, edtavEnddate_Enabled, 1, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WorkWithPlus/WWP_EventInfoWC.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTotime_Internalname, context.localUtil.TToC( AV19ToTime, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( AV19ToTime, "99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 0,'DMY',5,24,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 0,'DMY',5,24,'eng',false,0);"+";gx.evt.onblur(this,95);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTotime_Jsonclick, 0, "AttributeDateTime", "", "", "", "", edtavTotime_Visible, edtavTotime_Enabled, 1, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Time", "end", false, "", "HLP_WorkWithPlus/WWP_EventInfoWC.htm");
      ...
      protected void wb_table4_73_5E2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavCurrentdate_Internalname, context.localUtil.Format(AV12CurrentDate, "99/99/99"), context.localUtil.Format( AV12CurrentDate, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'eng',false,0);"+";gx.evt.onblur(this,77);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCurrentdate_Jsonclick, 0, "AttributeDate", "", "", "", "", edtavCurrentdate_Visible, edtavCurrentdate_Enabled, 1, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "", "end", false, "", "HLP_WorkWithPlus/WWP_EventInfoWC.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavFromtime_Internalname, context.localUtil.TToC( AV17FromTime, 10, 8, 0, 3, "/", ":", " "), context.localUtil.Format( AV17FromTime, "99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 0,'DMY',5,24,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 0,'DMY',5,24,'eng',false,0);"+";gx.evt.onblur(this,80);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFromtime_Jsonclick, 0, "AttributeDateTime", "", "", "", "", edtavFromtime_Visible, edtavFromtime_Enabled, 1, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Time", "end", false, "", "HLP_WorkWithPlus/WWP_EventInfoWC.htm");
      ...
      protected void wb_table3_58_5E2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavEventtype_Internalname, "Event Type", "gx-form-item AttributeLabel", 0, true, "width: 25%;");
            ...
            ClassString = "AttributeCheckBox";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavAllday_Internalname, StringUtil.BoolToStr( AV7AllDay), "", "All Day", chkavAllday.Visible, chkavAllday.Enabled, "true", "All day event", StyleString, ClassString, "", "", TempTags+" onblur=\""+""+";gx.evt.onblur(this,65);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198291046", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("workwithplus/wwp_eventinfowc.js", "?202411198291046", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         chkavRecurringevent.Caption = "Recurring Event";
      ...
      protected void init_default_properties( )
      {
         ...
         divTextblockcombo_addressgroup_cell_Internalname = sPrefix+"TEXTBLOCKCOMBO_ADDRESSGROUP_CELL";
         Combo_addressgroup_Internalname = sPrefix+"COMBO_ADDRESSGROUP";
         cellCombo_addressgroup_cell_Internalname = sPrefix+"COMBO_ADDRESSGROUP_CELL";
         chkavAddrsvp_Internalname = sPrefix+"vADDRSVP";
         cellAddrsvp_cell_Internalname = sPrefix+"ADDRSVP_CELL";
         tblTablemergedaddressgroup_Internalname = sPrefix+"TABLEMERGEDADDRESSGROUP";
      ...
      public override void initialize_properties( )
      {
         ...
         chkavAddrsvp.Enabled = 1;
         cellAddrsvp_cell_Class = "";
         Combo_addressgroup_Caption = "";
         cellCombo_addressgroup_cell_Class = "";
         lblTodatedisplay_tags_Caption = "";
         lblFromdatedisplay_tags_Caption = "";
         edtavTotime_Visible = 1;
         edtavEnddate_Visible = 1;
         ...
         bttBtnenter_Enabled = 1;
         bttBtnenter_Visible = 1;
         divTextblockcombo_addressgroup_cell_Class = "col-xs-12 col-sm-3";
      ...
      public override void initialize( )
      {
         ...
         AV45AddressGroup_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         AV53GXV1 = new GXBaseCollection<SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem>( context, "SDT_ResidentAddressBookItem", "Comforta_version2");
         GXt_objcol_SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem4 = new GXBaseCollection<SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem>( context, "SDT_ResidentAddressBookItem", "Comforta_version2");
      ...
      private string divTextblockcombo_addressgroup_cell_Internalname ;
      private string divTextblockcombo_addressgroup_cell_Class ;
      ...
      private string cellCombo_addressgroup_cell_Class ;
      private string cellCombo_addressgroup_cell_Internalname ;
      private string cellAddrsvp_cell_Class ;
      private string cellAddrsvp_cell_Internalname ;
      ...
      private string tblTablemergedaddressgroup_Internalname ;
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV45AddressGroup_Data ;
      ...
      private GXBaseCollection<SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem> AV53GXV1 ;
      private GXBaseCollection<SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem> GXt_objcol_SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem4 ;
      private SdtSDT_ResidentAddressBook_SDT_ResidentAddressBookItem AV48AddressGroup_DPItem ;
      private GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item AV38Combo_DataItem ;
