...
namespace GeneXus.Programs {
   public class gamwwroleroles : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "gamwwroleroles.aspx"+UrlEncode(StringUtil.LTrimStr(AV20RoleId,12,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV21RoleIdAux,12,0));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamwwroleroles.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vLISTCOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV53ListCount), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "gamwwroleroles.aspx"+UrlEncode(StringUtil.LTrimStr(AV20RoleId,12,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV21RoleIdAux,12,0));
         return formatLink("gamwwroleroles.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      {
         return context.GetMessage( "WWP_GAM_RolesRole", "") ;
      }
      ...
      protected void WB8V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnback_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(45), 2, 0)+","+"null"+");", context.GetMessage( "WWP_GAM_Back", ""), bttBtnback_Jsonclick, 5, context.GetMessage( "WWP_GAM_Back", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBACK\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMWWRoleRoles.htm");
            ...
            wb_table1_21_8V2( true) ;
         }
         else
         {
            wb_table1_21_8V2( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_8V2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START8V2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "WWP_GAM_RolesRole", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA8V2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "gamwwroleroles.aspx")), "gamwwroleroles.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "gamwwroleroles.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E168V2( )
      {
         ...
         Form.Caption = context.GetMessage( "WWP_GAM_RolesRole", "");
         ...
         Form.Caption = StringUtil.Format( context.GetMessage( "WWP_GAM_RolesOfRole", ""), AV12GAMRole.gxTpr_Name, "", "", "", "", "", "", "", "");
         AssignProp("", false, "FORM", "Caption", Form.Caption, true);
      ...
      protected void E178V2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV55Pgmname, out  GXt_char1) ;
      ...
      private void E188V2( )
      {
         ...
         while ( AV56GXV1 <= AV23Roles.Count )
         {
            ...
            {
               GXKey = Crypto.GetSiteKey( );
               GXEncryptionTmp = "gamroleentry.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(AV14Id,12,0));
      ...
      protected void E118V2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            if (returnInSub) return;
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMWWRoleRolesFilters")) + "," + UrlEncode(StringUtil.RTrim(AV55Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("GAMWWRoleRolesFilters"));
         ...
         else
         {
            ...
            else
            {
               ...
               S162 ();
               if (returnInSub) return;
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV55Pgmname+"GridState",  AV37ManageFiltersXml) ;
      ...
      protected void E148V2( )
      {
         ...
         if ( AV53ListCount <= 1 )
         {
            AV47WebSession.Remove(context.GetMessage( "RoleList", ""));
         ...
         else
         {
            ...
            AV47WebSession.Set(context.GetMessage( "RoleList", ""), AV48RoleList.ToJSonString(false));
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "gamwwroleroles.aspx"+UrlEncode(StringUtil.LTrimStr(AV20RoleId,12,0)) + "," + UrlEncode(StringUtil.LTrimStr(AV54RoleIdList,12,0));
            CallWebObject(formatLink("gamwwroleroles.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         /*  Sending Event outputs  */
      ...
      protected void E158V2( )
      {
         ...
         if ( AV46IsAuthorized_Insert )
         {
            ...
            CallWebObject(formatLink("gamroleselect.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "gamroleentry_Execute", out  GXt_boolean2) ;
      ...
      protected void S122( )
      {
         ...
         {
            AV33GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV55Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S172( )
      {
         ...
         {
            AV34GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV33GridState.gxTpr_Filtervalues.Item(AV57GXV2));
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV33GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV10FilName)),  0,  AV10FilName,  AV10FilName,  false,  "",  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV33GridState,  "FILEXTERNALID",  context.GetMessage( "WWP_GAM_ExternalId", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV9FilExternalId)),  0,  AV9FilExternalId,  AV9FilExternalId,  false,  "",  "") ;
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV55Pgmname+"GridState",  AV33GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void S132( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vLISTCOUNT", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV53ListCount), "ZZZ9"), context));
         AV49StrJson = AV47WebSession.Get(context.GetMessage( "RoleList", ""));
      ...
      protected void wb_table1_21_8V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_26_8V2( true) ;
         }
         else
         {
            wb_table2_26_8V2( false) ;
         }
         return  ;
      }

      protected void wb_table2_26_8V2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_21_8V2e( true) ;
         }
         else
         {
            wb_table1_21_8V2e( false) ;
         }
      }

      protected void wb_table2_26_8V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_26_8V2e( true) ;
         }
         else
         {
            wb_table2_26_8V2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411211547598", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwroleroles.js", "?20241121154760", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E188V2","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV21RoleIdAux","fld":"vROLEIDAUX","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV10FilName","fld":"vFILNAME"},{"av":"AV52SearchFilter","fld":"vSEARCHFILTER","hsh":true},{"av":"AV9FilExternalId","fld":"vFILEXTERNALID"},{"av":"AV51IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.gamwwroleroles__datastore1(),
            new Object[][] {
            }
         );
   ...
   public class gamwwroleroles__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
