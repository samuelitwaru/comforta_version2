...
namespace GeneXus.Programs {
   public class trn_suppliergentypeview : GXDataArea
   {
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Trn_suppliergenwc == null ) )
         {
            WebComp_Trn_suppliergenwc.componentjscripts();
         }
      ...
      {
         return "Trn_Supplier Gen Type View" ;
      }
      ...
      protected void WB520( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Back", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierGenTypeView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_suppliergentypegeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrn_suppliergen_title_Internalname, "General Suppliers", "", "", lblTrn_suppliergen_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierGenTypeView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Trn_SupplierGen") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtabletrn_suppliergen_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0037"+"", StringUtil.RTrim( WebComp_Trn_suppliergenwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0037"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Trn_suppliergenwc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldTrn_suppliergenwc), StringUtil.Lower( WebComp_Trn_suppliergenwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
                  }
                  WebComp_Trn_suppliergenwc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldTrn_suppliergenwc), StringUtil.Lower( WebComp_Trn_suppliergenwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START522( )
      {
         ...
         Form.Meta.addItem("description", "Trn_Supplier Gen Type View", 0) ;
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldTrn_suppliergenwc = cgiGet( "W0037");
                           if ( ( StringUtil.Len( OldTrn_suppliergenwc) == 0 ) || ( StringUtil.StrCmp(OldTrn_suppliergenwc, WebComp_Trn_suppliergenwc_Component) != 0 ) )
                           {
                              WebComp_Trn_suppliergenwc = getWebComponent(GetType(), "GeneXus.Programs", OldTrn_suppliergenwc, new Object[] {context} );
                              WebComp_Trn_suppliergenwc.ComponentInit();
                              WebComp_Trn_suppliergenwc.Name = "OldTrn_suppliergenwc";
                              WebComp_Trn_suppliergenwc_Component = OldTrn_suppliergenwc;
                           }
                           if ( StringUtil.Len( WebComp_Trn_suppliergenwc_Component) != 0 )
                           {
                              WebComp_Trn_suppliergenwc.componentprocess("W0037", "", sEvt);
                           }
                           WebComp_Trn_suppliergenwc_Component = OldTrn_suppliergenwc;
                        }
                        else if ( nCmpId == 42 )
      ...
      protected void RF522( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Trn_suppliergenwc_Component) != 0 )
               {
                  WebComp_Trn_suppliergenwc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A282SupplierGenTypeId = H00522_A282SupplierGenTypeId[0];
               /* Execute user event: Load */
               E16522 ();
      ...
      protected void E14522( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_suppliergentypeww.aspx") ;
         ...
         {
            A282SupplierGenTypeId = H00523_A282SupplierGenTypeId[0];
            A290SupplierGenTypeName = H00523_A290SupplierGenTypeName[0];
            AV16GXLvl9 = 1;
            Form.Caption = A290SupplierGenTypeName;
      ...
      protected void E15522( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_SupplierGenType",  StringUtil.Trim( A282SupplierGenTypeId.ToString())) )
         {
      ...
      protected void E11522( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Trn_SupplierGenType",(short)2,StringUtil.Trim( A282SupplierGenTypeId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12522( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Trn_SupplierGenType",StringUtil.Trim( A282SupplierGenTypeId.ToString()),(string)AV14RecordDescription,formatLink("trn_suppliergentypeview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_SupplierGenTypeGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_suppliergentypegeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_SupplierGenTypeGeneral";
            WebComp_Webcomponent_general_Component = "Trn_SupplierGenTypeGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10SupplierGenTypeId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Trn_SupplierGen") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Trn_suppliergenwc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Trn_suppliergenwc_Component), StringUtil.Lower( "Trn_SupplierGenTypeTrn_SupplierGenWC")) != 0 )
            {
               WebComp_Trn_suppliergenwc = getWebComponent(GetType(), "GeneXus.Programs", "trn_suppliergentypetrn_suppliergenwc", new Object[] {context} );
               WebComp_Trn_suppliergenwc.ComponentInit();
               WebComp_Trn_suppliergenwc.Name = "Trn_SupplierGenTypeTrn_SupplierGenWC";
               WebComp_Trn_suppliergenwc_Component = "Trn_SupplierGenTypeTrn_SupplierGenWC";
            }
            if ( StringUtil.Len( WebComp_Trn_suppliergenwc_Component) != 0 )
            {
               WebComp_Trn_suppliergenwc.setjustcreated();
               WebComp_Trn_suppliergenwc.componentprepare(new Object[] {(string)"W0037",(string)"",(Guid)AV10SupplierGenTypeId});
               WebComp_Trn_suppliergenwc.componentbind(new Object[] {(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Trn_suppliergenwc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
               WebComp_Trn_suppliergenwc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Trn_suppliergenwc == null ) )
         {
            if ( StringUtil.Len( WebComp_Trn_suppliergenwc_Component) != 0 )
            {
               WebComp_Trn_suppliergenwc.componentthemes();
            }
         }
         if ( ! ( WebComp_Wwpaux_wc == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198373540", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_suppliergentypeview.js", "?202411198373540", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_suppliergentypegeneral_cell_Internalname = "TRN_SUPPLIERGENTYPEGENERAL_CELL";
         lblTrn_suppliergen_title_Internalname = "TRN_SUPPLIERGEN_TITLE";
         divUnnamedtabletrn_suppliergen_Internalname = "UNNAMEDTABLETRN_SUPPLIERGEN";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Trn_Supplier Gen Type View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A282SupplierGenTypeId","fld":"SUPPLIERGENTYPEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV10SupplierGenTypeId","fld":"vSUPPLIERGENTYPEID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11522","iparms":[{"av":"A282SupplierGenTypeId","fld":"SUPPLIERGENTYPEID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12522","iparms":[{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A282SupplierGenTypeId","fld":"SUPPLIERGENTYPEID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13522","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10SupplierGenTypeId","fld":"vSUPPLIERGENTYPEID","hsh":true}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"ctrl":"TRN_SUPPLIERGENWC"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         lblTrn_suppliergen_title_Jsonclick = "";
         WebComp_Trn_suppliergenwc_Component = "";
         OldTrn_suppliergenwc = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00522_A282SupplierGenTypeId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00523_A282SupplierGenTypeId = new Guid[] {Guid.Empty} ;
         H00523_A290SupplierGenTypeName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_suppliergentypeview__default(),
            new Object[][] {
                new Object[] {
               H00522_A282SupplierGenTypeId
               }
               , new Object[] {
               H00523_A282SupplierGenTypeId, H00523_A290SupplierGenTypeName
               }
            }
         );
         WebComp_Webcomponent_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Trn_suppliergenwc = new GeneXus.Http.GXNullWebComponent();
      ...
      private string divTrn_suppliergentypegeneral_cell_Internalname ;
      ...
      private string lblTrn_suppliergen_title_Internalname ;
      private string lblTrn_suppliergen_title_Jsonclick ;
      private string divUnnamedtabletrn_suppliergen_Internalname ;
      private string WebComp_Trn_suppliergenwc_Component ;
      private string OldTrn_suppliergenwc ;
      ...
      private bool bDynCreated_Trn_suppliergenwc ;
      ...
      private GXWebComponent WebComp_Trn_suppliergenwc ;
      ...
      private Guid[] H00522_A282SupplierGenTypeId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00523_A282SupplierGenTypeId ;
      private string[] H00523_A290SupplierGenTypeName ;
   ...
   public class trn_suppliergentypeview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00522", "SELECT SupplierGenTypeId FROM Trn_SupplierGenType WHERE SupplierGenTypeId = :AV10SupplierGenTypeId ORDER BY SupplierGenTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00522,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00523", "SELECT SupplierGenTypeId, SupplierGenTypeName FROM Trn_SupplierGenType WHERE SupplierGenTypeId = :AV10SupplierGenTypeId ORDER BY SupplierGenTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00523,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
