...
namespace GeneXus.Programs {
   public class trn_colview : GXDataArea
   {
      public trn_colview( )
      {
      ...
      public trn_colview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_Trn_ColId ,
                           string aP1_TabCode )
      {
         this.AV10Trn_ColId = aP0_Trn_ColId;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_colview.aspx"+UrlEncode(AV10Trn_ColId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_colview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTRN_COLID", AV10Trn_ColId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_COLID", GetSecureSignedToken( "", AV10Trn_ColId, context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "trn_colview.aspx"+UrlEncode(AV10Trn_ColId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_colview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      {
         return context.GetMessage( "Trn_Col View", "") ;
      }
      ...
      protected void WB5T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Trn_Col", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_ColView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_colgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void START5T2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Col View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA5T2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_colview.aspx")), "trn_colview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_colview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10Trn_ColId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10Trn_ColId", AV10Trn_ColId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vTRN_COLID", GetSecureSignedToken( "", AV10Trn_ColId, context));
      ...
      protected void RF5T2( )
      {
         ...
         {
            /* Using cursor H005T2 */
            pr_default.execute(0, new Object[] {AV10Trn_ColId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A328Trn_ColId = H005T2_A328Trn_ColId[0];
               /* Execute user event: Load */
               E155T2 ();
      ...
      protected void E135T2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_colww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H005T3 */
         pr_default.execute(1, new Object[] {AV10Trn_ColId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A328Trn_ColId = H005T3_A328Trn_ColId[0];
            A327Trn_ColName = H005T3_A327Trn_ColName[0];
            AV16GXLvl9 = 1;
            Form.Caption = A327Trn_ColName;
      ...
      protected void E145T2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Col",  StringUtil.Trim( A328Trn_ColId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Col",  2) )
         {
      ...
      protected void E115T2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Col",(short)2,StringUtil.Trim( A328Trn_ColId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E125T2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Col",StringUtil.Trim( A328Trn_ColId.ToString()),(string)AV14RecordDescription,formatLink("trn_colview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_ColGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_colgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_ColGeneral";
            WebComp_Webcomponent_general_Component = "Trn_ColGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10Trn_ColId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10Trn_ColId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10Trn_ColId", AV10Trn_ColId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_COLID", GetSecureSignedToken( "", AV10Trn_ColId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202410285295621", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_colview.js", "?202410285295621", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_colgeneral_cell_Internalname = "TRN_COLGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Col View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A328Trn_ColId","fld":"TRN_COLID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV10Trn_ColId","fld":"vTRN_COLID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E115T2","iparms":[{"av":"A328Trn_ColId","fld":"TRN_COLID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E125T2","iparms":[{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A328Trn_ColId","fld":"TRN_COLID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H005T2_A328Trn_ColId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H005T3_A328Trn_ColId = new Guid[] {Guid.Empty} ;
         H005T3_A327Trn_ColName = new string[] {""} ;
         A327Trn_ColName = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_colview__default(),
            new Object[][] {
                new Object[] {
               H005T2_A328Trn_ColId
               }
               , new Object[] {
               H005T3_A328Trn_ColId, H005T3_A327Trn_ColName
               }
            }
         );
      ...
      private string divTrn_colgeneral_cell_Internalname ;
      ...
      private Guid AV10Trn_ColId ;
      private Guid wcpOAV10Trn_ColId ;
      ...
      private Guid[] H005T2_A328Trn_ColId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H005T3_A328Trn_ColId ;
      private string[] H005T3_A327Trn_ColName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_colview__default : DataStoreHelperBase, IDataStoreHelper
   {
