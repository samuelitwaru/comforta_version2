...
namespace GeneXus.Programs {
   public class trn_manager_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void CheckExtendedTable035( )
      {
         ...
         {
            GX_msglist.addItem("Field Manager Email does not match the specified pattern", "OutOfRange", 1, "");
            AnyError = 1;
         }
      ...
      protected void CheckOptimisticConcurrency035( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z28ManagerGAMGUID, BC00032_A28ManagerGAMGUID[0]) != 0 ) || ( StringUtil.StrCmp(Z24ManagerInitials, BC00032_A24ManagerInitials[0]) != 0 ) || ( StringUtil.StrCmp(Z22ManagerGivenName, BC00032_A22ManagerGivenName[0]) != 0 ) || ( StringUtil.StrCmp(Z23ManagerLastName, BC00032_A23ManagerLastName[0]) != 0 ) || ( StringUtil.StrCmp(Z25ManagerEmail, BC00032_A25ManagerEmail[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( StringUtil.StrCmp(Z26ManagerPhone, BC00032_A26ManagerPhone[0]) != 0 ) || ( StringUtil.StrCmp(Z27ManagerGender, BC00032_A27ManagerGender[0]) != 0 ) )
            {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(5, new Object[] {A21ManagerId, A28ManagerGAMGUID, A24ManagerInitials, A22ManagerGivenName, A23ManagerLastName, A25ManagerEmail, A26ManagerPhone, A27ManagerGender, A11OrganisationId});
                     pr_default.close(5);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(6, new Object[] {A28ManagerGAMGUID, A24ManagerInitials, A22ManagerGivenName, A23ManagerLastName, A25ManagerEmail, A26ManagerPhone, A27ManagerGender, A21ManagerId, A11OrganisationId});
                     pr_default.close(6);
                     pr_default.SmartCacheProvider.SetUpdated("Trn_Manager");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_manager_bc__default(),
            new Object[][] {
                new Object[] {
               BC00032_A21ManagerId, BC00032_A28ManagerGAMGUID, BC00032_A24ManagerInitials, BC00032_A22ManagerGivenName, BC00032_A23ManagerLastName, BC00032_A25ManagerEmail, BC00032_A26ManagerPhone, BC00032_A27ManagerGender, BC00032_A11OrganisationId
               }
               , new Object[] {
               BC00033_A21ManagerId, BC00033_A28ManagerGAMGUID, BC00033_A24ManagerInitials, BC00033_A22ManagerGivenName, BC00033_A23ManagerLastName, BC00033_A25ManagerEmail, BC00033_A26ManagerPhone, BC00033_A27ManagerGender, BC00033_A11OrganisationId
               }
               , new Object[] {
               BC00034_A11OrganisationId
               }
               , new Object[] {
               BC00035_A21ManagerId, BC00035_A28ManagerGAMGUID, BC00035_A24ManagerInitials, BC00035_A22ManagerGivenName, BC00035_A23ManagerLastName, BC00035_A25ManagerEmail, BC00035_A26ManagerPhone, BC00035_A27ManagerGender, BC00035_A11OrganisationId
               }
               , new Object[] {
               ...
               , new Object[] {
               BC000310_A21ManagerId, BC000310_A28ManagerGAMGUID, BC000310_A24ManagerInitials, BC000310_A22ManagerGivenName, BC000310_A23ManagerLastName, BC000310_A25ManagerEmail, BC000310_A26ManagerPhone, BC000310_A27ManagerGender, BC000310_A11OrganisationId
               }
               , new Object[] {
