   ...
   public class prc_pageapi : GXProcedure
   {
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_pageapi__default(),
            new Object[][] {
                new Object[] {
               P009C2_A11OrganisationId, P009C2_A29LocationId, P009C2_A310Trn_PageId, P009C2_A431PageJsonContent, P009C2_A318Trn_PageName, P009C2_A434PageIsPublished, P009C2_A439PageIsContentPage
               }
            }
         );
         /* GeneXus formulas. */
