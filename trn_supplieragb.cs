...
namespace GeneXus.Programs {
   public class trn_supplieragb : GXDataArea
   {
      ...
      protected void CheckExtendedTable0711( )
      {
         ...
         {
            GX_msglist.addItem(context.GetMessage( "AGB number contains 8 digits", ""), 1, "SUPPLIERAGBNUMBER");
            AnyError = 1;
            GX_FocusControl = edtSupplierAgbNumber_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem(context.GetMessage( "KVK number contains 8 digits", ""), 1, "SUPPLIERAGBKVKNUMBER");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem(context.GetMessage( "Phone contains 9 digits", ""), 1, "SUPPLIERAGBPHONENUMBER");
            AnyError = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024101016423143", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_supplieragb.js", "?2024101016423145", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
