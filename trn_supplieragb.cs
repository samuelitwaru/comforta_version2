...
namespace GeneXus.Programs {
   public class trn_supplieragb : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel15"+"_"+"SUPPLIERAGBPHONE") == 0 )
         {
            ...
            GX15ASASUPPLIERAGBPHONE0711( A377SupplierAgbPhoneCode, A378SupplierAgbPhoneNumber) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_29") == 0 )
         {
            ...
            gxLoad_29( A283SupplierAgbTypeId) ;
            return  ;
         }
      ...
      protected void DrawControls( )
      {
         ...
         /* Control Group */
         GxWebStd.gx_group_start( context, grpUnnamedgroup2_Internalname, "Supplier Information", 1, 0, "px", 0, "px", "Group", "", "HLP_Trn_SupplierAgb.htm");
         /* Div Control */
         ...
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblocksupplieragbtypeid_Internalname, "Category", "", "", lblTextblocksupplieragbtypeid_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         ...
         ucCombo_supplieragbtypeid.SetProperty("IncludeAddNewOption", Combo_supplieragbtypeid_Includeaddnewoption);
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierAgbNumber_Internalname, "AGB Number", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 35,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbNumber_Internalname, A50SupplierAgbNumber, StringUtil.RTrim( context.localUtil.Format( A50SupplierAgbNumber, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "01234567", edtSupplierAgbNumber_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierAgbNumber_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, -1, true, "AgbNumber", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierAgbName_Internalname, "Name", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierAgbKvkNumber_Internalname, "KvK Number", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 45,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbKvkNumber_Internalname, A52SupplierAgbKvkNumber, StringUtil.RTrim( context.localUtil.Format( A52SupplierAgbKvkNumber, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,45);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "12345678", edtSupplierAgbKvkNumber_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierAgbKvkNumber_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 0, -1, -1, true, "KvkNumber", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierAgbContactName_Internalname, "Contact Name", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "start", "top", "", "", "div");
         /* Text block */
         GxWebStd.gx_label_ctrl( context, lblTextblocksupplieragbphonecode_Internalname, "Phone", "", "", lblTextblocksupplieragbphonecode_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "start", "top", "", "", "div");
         /* Table start */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierAgbPhoneCode_Internalname, "Supplier Agb Phone Code", "gx-form-item AttributeLabel", 0, true, "width: 25%;");
         /* Single line edit */
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierAgbPhoneNumber_Internalname, "Supplier Agb Phone Number", "gx-form-item AttributePhoneNumberLabel", 0, true, "width: 25%;");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 67,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbPhoneNumber_Internalname, A378SupplierAgbPhoneNumber, StringUtil.RTrim( context.localUtil.Format( A378SupplierAgbPhoneNumber, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,67);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "0229123456", edtSupplierAgbPhoneNumber_Jsonclick, 0, "AttributePhoneNumber", "", "", "", "", 1, edtSupplierAgbPhoneNumber_Enabled, 0, "text", "", 9, "chr", 1, "row", 9, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         context.WriteHtmlText( "</td>") ;
         context.WriteHtmlText( "</tr>") ;
         /* End of table */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierAgbEmail_Internalname, "Email", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 72,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbEmail_Internalname, A57SupplierAgbEmail, StringUtil.RTrim( context.localUtil.Format( A57SupplierAgbEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,72);\"", "'"+""+"'"+",false,"+"'"+""+"'", "mailto:"+A57SupplierAgbEmail, "", "", "johndoe@gmail.com", edtSupplierAgbEmail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierAgbEmail_Enabled, 0, "email", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Email", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "start", "top", "", "", "div");
         /* Control Group */
         GxWebStd.gx_group_start( context, grpUnnamedgroup4_Internalname, "Address Information", 1, 0, "px", 0, "px", "Group", "", "HLP_Trn_SupplierAgb.htm");
         /* Div Control */
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierAgbAddressLine1_Internalname, "Address Line 1", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 85,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbAddressLine1_Internalname, A333SupplierAgbAddressLine1, StringUtil.RTrim( context.localUtil.Format( A333SupplierAgbAddressLine1, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,85);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierAgbAddressLine1_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierAgbAddressLine1_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierAgbAddressCity_Internalname, "City", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 95,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbAddressCity_Internalname, A299SupplierAgbAddressCity, StringUtil.RTrim( context.localUtil.Format( A299SupplierAgbAddressCity, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,95);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierAgbAddressCity_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierAgbAddressCity_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         /* Attribute/Variable Label */
         GxWebStd.gx_label_element( context, edtSupplierAgbAddressZipCode_Internalname, "Zip Code", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 100,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbAddressZipCode_Internalname, A298SupplierAgbAddressZipCode, StringUtil.RTrim( context.localUtil.Format( A298SupplierAgbAddressZipCode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,100);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierAgbAddressZipCode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierAgbAddressZipCode_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierAGBAddressCountry_Internalname, A332SupplierAGBAddressCountry, StringUtil.RTrim( context.localUtil.Format( A332SupplierAGBAddressCountry, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,111);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierAGBAddressCountry_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplierAGBAddressCountry_Visible, edtSupplierAGBAddressCountry_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtavCombosupplieragbaddresscountry_Internalname, AV24ComboSupplierAGBAddressCountry, StringUtil.RTrim( context.localUtil.Format( AV24ComboSupplierAGBAddressCountry, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,129);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCombosupplieragbaddresscountry_Jsonclick, 0, "Attribute", "", "", "", "", edtavCombosupplieragbaddresscountry_Visible, edtavCombosupplieragbaddresscountry_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 130,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbId_Internalname, A49SupplierAgbId.ToString(), A49SupplierAgbId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,130);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierAgbId_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplierAgbId_Visible, edtSupplierAgbId_Enabled, 1, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_SupplierAgb.htm");
         /* Single line edit */
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbPhone_Internalname, StringUtil.RTrim( A56SupplierAgbPhone), StringUtil.RTrim( context.localUtil.Format( A56SupplierAgbPhone, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,131);\"", "'"+""+"'"+",false,"+"'"+""+"'", gxphoneLink, "", "", "", edtSupplierAgbPhone_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplierAgbPhone_Visible, edtSupplierAgbPhone_Enabled, 0, "tel", "", 20, "chr", 1, "row", 20, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Phone", "start", true, "", "HLP_Trn_SupplierAgb.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z440SupplierAgbWebsite = cgiGet( "Z440SupplierAgbWebsite");
               ...
               Combo_supplieragbphonecode_Datalistupdateminimumcharacters = (int)(Math.Round(context.localUtil.CToN( cgiGet( "COMBO_SUPPLIERAGBPHONECODE_Datalistupdateminimumcharacters"), ".", ","), 18, MidpointRounding.ToEven));
               ...
               Combo_supplieragbphonecode_Gxcontroltype = (int)(Math.Round(context.localUtil.CToN( cgiGet( "COMBO_SUPPLIERAGBPHONECODE_Gxcontroltype"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      protected void E12072( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(Combo_supplieragbtypeid_Selectedvalue_get, "<#NEW#>") == 0 )
         {
            AV30DefaultSupplierAgbTypeName = Combo_supplieragbtypeid_Selectedtext_get;
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
            {
               gxcookieaux = context.SetCookie( "GX_SESSION_ID", Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", (short)(context.GetHttpSecure( )));
            }
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wp_createnewsupplieragbtype.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(A283SupplierAgbTypeId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV30DefaultSupplierAgbTypeName));
            context.PopUp(formatLink("wp_createnewsupplieragbtype.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey), new Object[] {});
         }
         else if ( StringUtil.StrCmp(Combo_supplieragbtypeid_Selectedvalue_get, "<#POPUP_CLOSED#>") == 0 )
         {
            GXt_objcol_SdtDVB_SDTComboData_Item3 = AV15SupplierAgbTypeId_Data;
            new trn_supplieragbloaddvcombo(context ).execute(  "SupplierAgbTypeId",  "NEW",  AV7SupplierAgbId, out  AV17ComboSelectedValue, out  AV18ComboSelectedText, out  GXt_objcol_SdtDVB_SDTComboData_Item3) ;
            AV15SupplierAgbTypeId_Data = GXt_objcol_SdtDVB_SDTComboData_Item3;
            AV17ComboSelectedValue = AV12WebSession.Get("SUPPLIERAGBTYPEID");
            AV12WebSession.Remove("SUPPLIERAGBTYPEID");
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV15SupplierAgbTypeId_Data", AV15SupplierAgbTypeId_Data);
      }
      ...
      protected void S112( )
      {
         ...
         Combo_supplieragbtypeid_Includeaddnewoption = GXt_boolean4;
         ucCombo_supplieragbtypeid.SendProperty(context, "", false, Combo_supplieragbtypeid_Internalname, "IncludeAddNewOption", StringUtil.BoolToStr( Combo_supplieragbtypeid_Includeaddnewoption));
         GXt_objcol_SdtDVB_SDTComboData_Item3 = AV15SupplierAgbTypeId_Data;
      ...
      protected void ZM0711( short GX_JID )
      {
         if ( ( GX_JID == 28 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               ...
               Z440SupplierAgbWebsite = T00073_A440SupplierAgbWebsite[0];
      ...
      protected void Load0711( )
      {
         ...
         if ( (pr_default.getStatus(3) != 101) )
         {
            ...
            AssignAttri("", false, "A57SupplierAgbEmail", A57SupplierAgbEmail);
            A440SupplierAgbWebsite = T00075_A440SupplierAgbWebsite[0];
            AssignAttri("", false, "A440SupplierAgbWebsite", A440SupplierAgbWebsite);
      ...
      protected void CheckExtendedTable0711( )
      {
         ...
         {
            GX_msglist.addItem("AGB Number should contain 8 digits", 1, "SUPPLIERAGBNUMBER");
            AnyError = 1;
            GX_FocusControl = edtSupplierAgbNumber_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("KvK number should contain 8 digits", "OutOfRange", 1, "SUPPLIERAGBKVKNUMBER");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("KvK Number should contain 8 digits", 1, "SUPPLIERAGBKVKNUMBER");
            AnyError = 1;
            GX_FocusControl = edtSupplierAgbKvkNumber_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Supplier AGBAddress Country", "", "", "", "", "", "", "", ""), 1, "SUPPLIERAGBADDRESSCOUNTRY");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Supplier Agb Address City", "", "", "", "", "", "", "", ""), 1, "SUPPLIERAGBADDRESSCITY");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Supplier Agb Address Zip Code", "", "", "", "", "", "", "", ""), 1, "SUPPLIERAGBADDRESSZIPCODE");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Supplier Agb Address Line1", "", "", "", "", "", "", "", ""), 1, "SUPPLIERAGBADDRESSLINE1");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("Phone contains 9 digits", "OutOfRange", 1, "SUPPLIERAGBPHONENUMBER");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("Phone should contain 9 digits", 1, "SUPPLIERAGBPHONENUMBER");
            AnyError = 1;
            GX_FocusControl = edtSupplierAgbPhoneNumber_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      protected void gxLoad_29( Guid A283SupplierAgbTypeId )
      {
         /* Using cursor T00076 */
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ...
            AssignAttri("", false, "A57SupplierAgbEmail", A57SupplierAgbEmail);
            A440SupplierAgbWebsite = T00073_A440SupplierAgbWebsite[0];
            AssignAttri("", false, "A440SupplierAgbWebsite", A440SupplierAgbWebsite);
      ...
      protected void CheckOptimisticConcurrency0711( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( Gx_longc || ( StringUtil.StrCmp(Z55SupplierAgbContactName, T00072_A55SupplierAgbContactName[0]) != 0 ) || ( StringUtil.StrCmp(Z378SupplierAgbPhoneNumber, T00072_A378SupplierAgbPhoneNumber[0]) != 0 ) || ( StringUtil.StrCmp(Z57SupplierAgbEmail, T00072_A57SupplierAgbEmail[0]) != 0 ) || ( StringUtil.StrCmp(Z440SupplierAgbWebsite, T00072_A440SupplierAgbWebsite[0]) != 0 ) || ( Z283SupplierAgbTypeId != T00072_A283SupplierAgbTypeId[0] ) )
            {
               ...
               if ( StringUtil.StrCmp(Z440SupplierAgbWebsite, T00072_A440SupplierAgbWebsite[0]) != 0 )
               {
                  GXUtil.WriteLog("trn_supplieragb:[seudo value changed for attri]"+"SupplierAgbWebsite");
                  GXUtil.WriteLogRaw("Old: ",Z440SupplierAgbWebsite);
                  GXUtil.WriteLogRaw("Current: ",T00072_A440SupplierAgbWebsite[0]);
               }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z440SupplierAgbWebsite", Z440SupplierAgbWebsite);
         ...
         GxWebStd.gx_hidden_field( context, "COMBO_SUPPLIERAGBTYPEID_Includeaddnewoption", StringUtil.BoolToStr( Combo_supplieragbtypeid_Includeaddnewoption));
      ...
      public override void initialize_properties( )
      {
         ...
         Combo_supplieragbtypeid_Includeaddnewoption = Convert.ToBoolean( -1);
      ...
      protected void GX15ASASUPPLIERAGBPHONE0711( string A377SupplierAgbPhoneCode ,
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("COMBO_SUPPLIERAGBTYPEID.ONOPTIONCLICKED","""{"handler":"E12072","iparms":[{"av":"Combo_supplieragbtypeid_Selectedvalue_get","ctrl":"COMBO_SUPPLIERAGBTYPEID","prop":"SelectedValue_get"},{"av":"Combo_supplieragbtypeid_Selectedtext_get","ctrl":"COMBO_SUPPLIERAGBTYPEID","prop":"SelectedText_get"},{"av":"A283SupplierAgbTypeId","fld":"SUPPLIERAGBTYPEID"},{"av":"AV7SupplierAgbId","fld":"vSUPPLIERAGBID","hsh":true}]""");
         setEventMetadata("COMBO_SUPPLIERAGBTYPEID.ONOPTIONCLICKED",""","oparms":[{"av":"Combo_supplieragbtypeid_Selectedvalue_set","ctrl":"COMBO_SUPPLIERAGBTYPEID","prop":"SelectedValue_set"},{"av":"AV15SupplierAgbTypeId_Data","fld":"vSUPPLIERAGBTYPEID_DATA"},{"av":"AV20ComboSupplierAgbTypeId","fld":"vCOMBOSUPPLIERAGBTYPEID"}]}""");
         ...
         setEventMetadata("VALID_SUPPLIERAGBPHONENUMBER","""{"handler":"Valid_Supplieragbphonenumber","iparms":[{"av":"A378SupplierAgbPhoneNumber","fld":"SUPPLIERAGBPHONENUMBER"},{"av":"A377SupplierAgbPhoneCode","fld":"SUPPLIERAGBPHONECODE"},{"av":"A56SupplierAgbPhone","fld":"SUPPLIERAGBPHONE"}]""");
         ...
         setEventMetadata("VALID_SUPPLIERAGBWEBSITE","""{"handler":"Valid_Supplieragbwebsite","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         AV30DefaultSupplierAgbTypeName = "";
         GXEncryptionTmp = "";
         ...
         T00075_A440SupplierAgbWebsite = new string[] {""} ;
         ...
         T00073_A440SupplierAgbWebsite = new string[] {""} ;
         ...
         T00072_A440SupplierAgbWebsite = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_supplieragb__default(),
            new Object[][] {
               ...
               T00072_A334SupplierAgbAddressLine2, T00072_A55SupplierAgbContactName, T00072_A378SupplierAgbPhoneNumber, T00072_A57SupplierAgbEmail, T00072_A440SupplierAgbWebsite, T00072_A283SupplierAgbTypeId
               }
               , new Object[] {
               ...
               T00073_A334SupplierAgbAddressLine2, T00073_A55SupplierAgbContactName, T00073_A378SupplierAgbPhoneNumber, T00073_A57SupplierAgbEmail, T00073_A440SupplierAgbWebsite, T00073_A283SupplierAgbTypeId
               }
               , new Object[] {
               ...
               T00075_A333SupplierAgbAddressLine1, T00075_A334SupplierAgbAddressLine2, T00075_A55SupplierAgbContactName, T00075_A378SupplierAgbPhoneNumber, T00075_A57SupplierAgbEmail, T00075_A440SupplierAgbWebsite, T00075_A283SupplierAgbTypeId
               }
               , new Object[] {
      ...
      private string AV30DefaultSupplierAgbTypeName ;
      ...
      private string[] T00075_A440SupplierAgbWebsite ;
      ...
      private string[] T00073_A440SupplierAgbWebsite ;
      ...
      private string[] T00072_A440SupplierAgbWebsite ;
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("T000710", "SAVEPOINT gxupdate;INSERT INTO Trn_SupplierAGB(SupplierAgbId, SupplierAGBAddressCountry, SupplierAgbPhoneCode, SupplierAgbPhone, SupplierAgbNumber, SupplierAgbName, SupplierAgbKvkNumber, SupplierAgbAddressCity, SupplierAgbAddressZipCode, SupplierAgbAddressLine1, SupplierAgbAddressLine2, SupplierAgbContactName, SupplierAgbPhoneNumber, SupplierAgbEmail, SupplierAgbWebsite, SupplierAgbTypeId) VALUES(:SupplierAgbId, :SupplierAGBAddressCountry, :SupplierAgbPhoneCode, :SupplierAgbPhone, :SupplierAgbNumber, :SupplierAgbName, :SupplierAgbKvkNumber, :SupplierAgbAddressCity, :SupplierAgbAddressZipCode, :SupplierAgbAddressLine1, :SupplierAgbAddressLine2, :SupplierAgbContactName, :SupplierAgbPhoneNumber, :SupplierAgbEmail, :SupplierAgbWebsite, :SupplierAgbTypeId);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmT000710)
           ,new CursorDef("T000711", "SAVEPOINT gxupdate;UPDATE Trn_SupplierAGB SET SupplierAGBAddressCountry=:SupplierAGBAddressCountry, SupplierAgbPhoneCode=:SupplierAgbPhoneCode, SupplierAgbPhone=:SupplierAgbPhone, SupplierAgbNumber=:SupplierAgbNumber, SupplierAgbName=:SupplierAgbName, SupplierAgbKvkNumber=:SupplierAgbKvkNumber, SupplierAgbAddressCity=:SupplierAgbAddressCity, SupplierAgbAddressZipCode=:SupplierAgbAddressZipCode, SupplierAgbAddressLine1=:SupplierAgbAddressLine1, SupplierAgbAddressLine2=:SupplierAgbAddressLine2, SupplierAgbContactName=:SupplierAgbContactName, SupplierAgbPhoneNumber=:SupplierAgbPhoneNumber, SupplierAgbEmail=:SupplierAgbEmail, SupplierAgbWebsite=:SupplierAgbWebsite, SupplierAgbTypeId=:SupplierAgbTypeId  WHERE SupplierAgbId = :SupplierAgbId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT000711)
