...
namespace GeneXus.Programs {
   public class trn_tileloaddvcombo : GXProcedure
   {
      ...
      public string executeUdp( string aP0_ComboName ,
                                ...
                                out string aP8_SelectedText )
      {
         execute(aP0_ComboName, aP1_TrnMode, aP2_IsDynamicCall, aP3_Trn_TileId, aP4_Cond_LocationId, aP5_Cond_OrganisationId, aP6_SearchTxtParms, out aP7_SelectedValue, out aP8_SelectedText, out aP9_Combo_DataJson);
      ...
      protected void S111( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            /* Using cursor P006A2 */
            pr_default.execute(0, new Object[] {AV36Cond_LocationId, AV37Cond_OrganisationId, lV14SearchTxt, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A29LocationId = P006A2_A29LocationId[0];
               n29LocationId = P006A2_n29LocationId[0];
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  ...
                  {
                     A29LocationId = P006A3_A29LocationId[0];
                     n29LocationId = P006A3_n29LocationId[0];
               ...
               else
               {
                  ...
                  /* Using cursor P006A4 */
                  pr_default.execute(2, new Object[] {AV32ProductServiceId, AV36Cond_LocationId, AV37Cond_OrganisationId});
                  while ( (pr_default.getStatus(2) != 101) )
                  {
                     A11OrganisationId = P006A4_A11OrganisationId[0];
                     n11OrganisationId = P006A4_n11OrganisationId[0];
                     A29LocationId = P006A4_A29LocationId[0];
                     n29LocationId = P006A4_n29LocationId[0];
      ...
      protected void S121( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            {
               A13OrganisationName = P006A5_A13OrganisationName[0];
            ...
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  ...
                  while ( (pr_default.getStatus(4) != 101) )
                  {
                     ...
                     A13OrganisationName = P006A6_A13OrganisationName[0];
                     A13OrganisationName = P006A6_A13OrganisationName[0];
               ...
               else
               {
                  ...
                  /* Using cursor P006A7 */
                  pr_default.execute(5, new Object[] {AV33OrganisationId});
                  while ( (pr_default.getStatus(5) != 101) )
                  {
                     A11OrganisationId = P006A7_A11OrganisationId[0];
                     n11OrganisationId = P006A7_n11OrganisationId[0];
                     A13OrganisationName = P006A7_A13OrganisationName[0];
                     AV23SelectedText = A13OrganisationName;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      protected void S131( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            lV14SearchTxt = StringUtil.Concat( StringUtil.RTrim( AV14SearchTxt), "%", "");
            /* Using cursor P006A8 */
            pr_default.execute(6, new Object[] {AV37Cond_OrganisationId, lV14SearchTxt, GXPagingFrom8, GXPagingTo8, GXPagingTo8});
            while ( (pr_default.getStatus(6) != 101) )
            {
               A11OrganisationId = P006A8_A11OrganisationId[0];
               n11OrganisationId = P006A8_n11OrganisationId[0];
               A31LocationName = P006A8_A31LocationName[0];
               A29LocationId = P006A8_A29LocationId[0];
               n29LocationId = P006A8_n29LocationId[0];
               AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               ...
               {
                  /* Using cursor P006A9 */
                  pr_default.execute(7, new Object[] {AV20Trn_TileId});
                  while ( (pr_default.getStatus(7) != 101) )
                  {
                     A11OrganisationId = P006A9_A11OrganisationId[0];
                     n11OrganisationId = P006A9_n11OrganisationId[0];
                     A264Trn_TileId = P006A9_A264Trn_TileId[0];
                     A29LocationId = P006A9_A29LocationId[0];
                     n29LocationId = P006A9_n29LocationId[0];
                     A31LocationName = P006A9_A31LocationName[0];
                     A31LocationName = P006A9_A31LocationName[0];
               ...
               else
               {
                  ...
                  pr_default.execute(8, new Object[] {AV34LocationId, AV37Cond_OrganisationId});
                  while ( (pr_default.getStatus(8) != 101) )
                  {
                     A11OrganisationId = P006A10_A11OrganisationId[0];
                     n11OrganisationId = P006A10_n11OrganisationId[0];
                     A29LocationId = P006A10_A29LocationId[0];
                     n29LocationId = P006A10_n29LocationId[0];
                     A31LocationName = P006A10_A31LocationName[0];
                     AV23SelectedText = A31LocationName;
                     /* Exit For each command. Update data (if necessary), close cursors & exit. */
                     if (true) break;
                     /* Exiting from a For First loop. */
      ...
      protected void S141( )
      {
         ...
         if ( AV19IsDynamicCall )
         {
            ...
            {
               A318Trn_PageName = P006A11_A318Trn_PageName[0];
               A310Trn_PageId = P006A11_A310Trn_PageId[0];
               AV16Combo_DataItem = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item(context);
         ...
         else
         {
            if ( StringUtil.StrCmp(AV18TrnMode, "INS") != 0 )
            {
               if ( StringUtil.StrCmp(AV18TrnMode, "GET") != 0 )
               {
                  ...
                  pr_default.execute(10, new Object[] {AV20Trn_TileId});
                  while ( (pr_default.getStatus(10) != 101) )
                  {
                     A264Trn_TileId = P006A12_A264Trn_TileId[0];
                     A329SG_ToPageId = P006A12_A329SG_ToPageId[0];
               ...
               pr_default.execute(11, new Object[] {AV35Trn_PageId});
               while ( (pr_default.getStatus(11) != 101) )
               {
                  A310Trn_PageId = P006A13_A310Trn_PageId[0];
                  A318Trn_PageName = P006A13_A318Trn_PageName[0];
      ...
      public override void initialize( )
      {
         ...
         P006A2_A29LocationId = new Guid[] {Guid.Empty} ;
         P006A2_n29LocationId = new bool[] {false} ;
         ...
         P006A3_A29LocationId = new Guid[] {Guid.Empty} ;
         P006A3_n29LocationId = new bool[] {false} ;
         ...
         P006A4_A29LocationId = new Guid[] {Guid.Empty} ;
         P006A4_n29LocationId = new bool[] {false} ;
         ...
         A13OrganisationName = "";
         P006A5_A13OrganisationName = new string[] {""} ;
         ...
         P006A6_A13OrganisationName = new string[] {""} ;
         AV33OrganisationId = Guid.Empty;
         P006A7_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P006A7_n11OrganisationId = new bool[] {false} ;
         P006A7_A13OrganisationName = new string[] {""} ;
         A31LocationName = "";
         P006A8_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P006A8_n11OrganisationId = new bool[] {false} ;
         P006A8_A31LocationName = new string[] {""} ;
         P006A8_A29LocationId = new Guid[] {Guid.Empty} ;
         P006A8_n29LocationId = new bool[] {false} ;
         P006A9_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P006A9_n11OrganisationId = new bool[] {false} ;
         P006A9_A264Trn_TileId = new Guid[] {Guid.Empty} ;
         P006A9_A29LocationId = new Guid[] {Guid.Empty} ;
         P006A9_n29LocationId = new bool[] {false} ;
         P006A9_A31LocationName = new string[] {""} ;
         AV34LocationId = Guid.Empty;
         P006A10_A11OrganisationId = new Guid[] {Guid.Empty} ;
         P006A10_n11OrganisationId = new bool[] {false} ;
         P006A10_A29LocationId = new Guid[] {Guid.Empty} ;
         P006A10_n29LocationId = new bool[] {false} ;
         P006A10_A31LocationName = new string[] {""} ;
         A318Trn_PageName = "";
         P006A11_A318Trn_PageName = new string[] {""} ;
         P006A11_A310Trn_PageId = new Guid[] {Guid.Empty} ;
         A310Trn_PageId = Guid.Empty;
         P006A12_A264Trn_TileId = new Guid[] {Guid.Empty} ;
         P006A12_A329SG_ToPageId = new Guid[] {Guid.Empty} ;
         A329SG_ToPageId = Guid.Empty;
         AV35Trn_PageId = Guid.Empty;
         P006A13_A310Trn_PageId = new Guid[] {Guid.Empty} ;
         P006A13_A318Trn_PageName = new string[] {""} ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_tileloaddvcombo__default(),
            new Object[][] {
                new Object[] {
               P006A2_A29LocationId, P006A2_A11OrganisationId, P006A2_A59ProductServiceName, P006A2_A58ProductServiceId
               }
               , new Object[] {
               P006A3_A29LocationId, P006A3_n29LocationId, P006A3_A11OrganisationId, P006A3_n11OrganisationId, P006A3_A264Trn_TileId, P006A3_A58ProductServiceId, P006A3_n58ProductServiceId, P006A3_A59ProductServiceName
               }
               , new Object[] {
               P006A4_A11OrganisationId, P006A4_A29LocationId, P006A4_A58ProductServiceId, P006A4_A59ProductServiceName
               }
               , new Object[] {
               P006A5_A13OrganisationName, P006A5_A11OrganisationId
               }
               , new Object[] {
               P006A6_A264Trn_TileId, P006A6_A11OrganisationId, P006A6_n11OrganisationId, P006A6_A13OrganisationName
               }
               , new Object[] {
               P006A7_A11OrganisationId, P006A7_A13OrganisationName
               }
               , new Object[] {
               P006A8_A11OrganisationId, P006A8_A31LocationName, P006A8_A29LocationId
               }
               , new Object[] {
               P006A9_A11OrganisationId, P006A9_n11OrganisationId, P006A9_A264Trn_TileId, P006A9_A29LocationId, P006A9_n29LocationId, P006A9_A31LocationName
               }
               , new Object[] {
               P006A10_A11OrganisationId, P006A10_A29LocationId, P006A10_A31LocationName
               }
               , new Object[] {
               P006A11_A318Trn_PageName, P006A11_A310Trn_PageId
               }
               , new Object[] {
               P006A12_A264Trn_TileId, P006A12_A329SG_ToPageId
               }
               , new Object[] {
               P006A13_A310Trn_PageId, P006A13_A318Trn_PageName
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P006A2_A29LocationId ;
      private bool[] P006A2_n29LocationId ;
      ...
      private Guid[] P006A3_A29LocationId ;
      private bool[] P006A3_n29LocationId ;
      ...
      private Guid[] P006A4_A29LocationId ;
      private bool[] P006A4_n29LocationId ;
      ...
      private string[] P006A5_A13OrganisationName ;
      ...
      private string[] P006A6_A13OrganisationName ;
      private Guid[] P006A7_A11OrganisationId ;
      private bool[] P006A7_n11OrganisationId ;
      private string[] P006A7_A13OrganisationName ;
      private Guid[] P006A8_A11OrganisationId ;
      private bool[] P006A8_n11OrganisationId ;
      private string[] P006A8_A31LocationName ;
      private Guid[] P006A8_A29LocationId ;
      private bool[] P006A8_n29LocationId ;
      private Guid[] P006A9_A11OrganisationId ;
      private bool[] P006A9_n11OrganisationId ;
      private Guid[] P006A9_A264Trn_TileId ;
      private Guid[] P006A9_A29LocationId ;
      private bool[] P006A9_n29LocationId ;
      private string[] P006A9_A31LocationName ;
      private Guid[] P006A10_A11OrganisationId ;
      private bool[] P006A10_n11OrganisationId ;
      private Guid[] P006A10_A29LocationId ;
      private bool[] P006A10_n29LocationId ;
      private string[] P006A10_A31LocationName ;
      private string[] P006A11_A318Trn_PageName ;
      private Guid[] P006A11_A310Trn_PageId ;
      private Guid[] P006A12_A264Trn_TileId ;
      private Guid[] P006A12_A329SG_ToPageId ;
      private Guid[] P006A13_A310Trn_PageId ;
      private string[] P006A13_A318Trn_PageName ;
   ...
   public class trn_tileloaddvcombo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P006A2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] );
               case 3 :
                     return conditional_P006A5(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
               case 6 :
                     return conditional_P006A8(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] );
               case 9 :
                     return conditional_P006A11(context, (string)dynConstraints[0] , (string)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P006A6", "SELECT T1.Trn_TileId, T1.OrganisationId, T2.OrganisationName FROM (Trn_Tile T1 LEFT JOIN Trn_Organisation T2 ON T2.OrganisationId = T1.OrganisationId) WHERE T1.Trn_TileId = :AV20Trn_TileId ORDER BY T1.Trn_TileId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP006A6,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P006A7", "SELECT OrganisationId, OrganisationName FROM Trn_Organisation WHERE OrganisationId = :AV33OrganisationId ORDER BY OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP006A7,1, GxCacheFrequency.OFF ,false,true )
             ...
             ,new CursorDef("P006A9", "SELECT T1.OrganisationId, T1.Trn_TileId, T1.LocationId, T2.LocationName FROM (Trn_Tile T1 LEFT JOIN Trn_Location T2 ON T2.LocationId = T1.LocationId AND T2.OrganisationId = T1.OrganisationId) WHERE T1.Trn_TileId = :AV20Trn_TileId ORDER BY T1.Trn_TileId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP006A9,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P006A10", "SELECT OrganisationId, LocationId, LocationName FROM Trn_Location WHERE LocationId = :AV34LocationId and OrganisationId = :AV37Cond_OrganisationId ORDER BY LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP006A10,1, GxCacheFrequency.OFF ,false,true )
             ...
             ,new CursorDef("P006A12", "SELECT Trn_TileId, SG_ToPageId FROM Trn_Tile WHERE Trn_TileId = :AV20Trn_TileId ORDER BY Trn_TileId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP006A12,1, GxCacheFrequency.OFF ,false,true )
             ,new CursorDef("P006A13", "SELECT Trn_PageId, Trn_PageName FROM Trn_Page WHERE Trn_PageId = :AV35Trn_PageId ORDER BY Trn_PageId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP006A13,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
