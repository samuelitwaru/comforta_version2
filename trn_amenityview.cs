...
namespace GeneXus.Programs {
   public class trn_amenityview : GXDataArea
   {
      public trn_amenityview( )
      {
      ...
      public trn_amenityview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_AmenityId ,
                           ...
                           string aP3_TabCode )
      {
         this.AV10AmenityId = aP0_AmenityId;
         this.AV11LocationId = aP1_LocationId;
         this.AV17OrganisationId = aP2_OrganisationId;
      ...
      {
         get {
            return "trn_amenityview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_amenityview.aspx"+UrlEncode(AV10AmenityId.ToString()) + "," + UrlEncode(AV11LocationId.ToString()) + "," + UrlEncode(AV17OrganisationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_amenityview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vAMENITYID", AV10AmenityId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vAMENITYID", GetSecureSignedToken( "", AV10AmenityId, context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "trn_amenityview.aspx"+UrlEncode(AV10AmenityId.ToString()) + "," + UrlEncode(AV11LocationId.ToString()) + "," + UrlEncode(AV17OrganisationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_amenityview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_AmenityView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Amenity View", "") ;
      }
      ...
      protected void WB4M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_AmenityView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_amenitygeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void START4M2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Amenity View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA4M2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_amenityview.aspx")), "trn_amenityview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_amenityview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10AmenityId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10AmenityId", AV10AmenityId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vAMENITYID", GetSecureSignedToken( "", AV10AmenityId, context));
      ...
      protected void RF4M2( )
      {
         ...
         {
            /* Using cursor H004M2 */
            pr_default.execute(0, new Object[] {AV10AmenityId, AV11LocationId, AV17OrganisationId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A11OrganisationId = H004M2_A11OrganisationId[0];
               A29LocationId = H004M2_A29LocationId[0];
               A39AmenityId = H004M2_A39AmenityId[0];
               /* Execute user event: Load */
               E154M2 ();
      ...
      protected void E134M2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_amenityww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV18GXLvl9 = 0;
         /* Using cursor H004M3 */
         pr_default.execute(1, new Object[] {AV10AmenityId, AV11LocationId, AV17OrganisationId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A11OrganisationId = H004M3_A11OrganisationId[0];
            A29LocationId = H004M3_A29LocationId[0];
            A39AmenityId = H004M3_A39AmenityId[0];
            A40AmenityName = H004M3_A40AmenityName[0];
            AV18GXLvl9 = 1;
            Form.Caption = A40AmenityName;
      ...
      protected void E144M2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Amenity",  StringUtil.Trim( A39AmenityId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Amenity",  2) )
         {
      ...
      protected void E114M2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Amenity",(short)2,StringUtil.Trim( A39AmenityId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString()),(string)AV15RecordDescription});
      ...
      protected void E124M2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Amenity",StringUtil.Trim( A39AmenityId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString()),(string)AV15RecordDescription,formatLink("trn_amenityview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_AmenityGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_amenitygeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_AmenityGeneral";
            WebComp_Webcomponent_general_Component = "Trn_AmenityGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10AmenityId,(Guid)AV11LocationId,(Guid)AV17OrganisationId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10AmenityId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10AmenityId", AV10AmenityId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vAMENITYID", GetSecureSignedToken( "", AV10AmenityId, context));
         AV11LocationId = (Guid)getParm(obj,1);
         AssignAttri("", false, "AV11LocationId", AV11LocationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vLOCATIONID", GetSecureSignedToken( "", AV11LocationId, context));
         AV17OrganisationId = (Guid)getParm(obj,2);
         AssignAttri("", false, "AV17OrganisationId", AV17OrganisationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vORGANISATIONID", GetSecureSignedToken( "", AV17OrganisationId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024101016441895", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_amenityview.js", "?2024101016441895", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_amenitygeneral_cell_Internalname = "TRN_AMENITYGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Amenity View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A39AmenityId","fld":"AMENITYID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV10AmenityId","fld":"vAMENITYID","hsh":true},{"av":"AV11LocationId","fld":"vLOCATIONID","hsh":true},{"av":"AV17OrganisationId","fld":"vORGANISATIONID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E114M2","iparms":[{"av":"A39AmenityId","fld":"AMENITYID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E124M2","iparms":[{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A39AmenityId","fld":"AMENITYID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H004M2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H004M2_A29LocationId = new Guid[] {Guid.Empty} ;
         H004M2_A39AmenityId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H004M3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H004M3_A29LocationId = new Guid[] {Guid.Empty} ;
         H004M3_A39AmenityId = new Guid[] {Guid.Empty} ;
         H004M3_A40AmenityName = new string[] {""} ;
         A40AmenityName = "";
         AV16Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_amenityview__default(),
            new Object[][] {
                new Object[] {
               H004M2_A11OrganisationId, H004M2_A29LocationId, H004M2_A39AmenityId
               }
               , new Object[] {
               H004M3_A11OrganisationId, H004M3_A29LocationId, H004M3_A39AmenityId, H004M3_A40AmenityName
               }
            }
         );
      ...
      private string divTrn_amenitygeneral_cell_Internalname ;
      ...
      private Guid[] H004M2_A11OrganisationId ;
      private Guid[] H004M2_A29LocationId ;
      private Guid[] H004M2_A39AmenityId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H004M3_A11OrganisationId ;
      private Guid[] H004M3_A29LocationId ;
      private Guid[] H004M3_A39AmenityId ;
      private string[] H004M3_A40AmenityName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_amenityview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10AmenityId",GXType.UniqueIdentifier,36,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H004M2", "SELECT OrganisationId, LocationId, AmenityId FROM Trn_Amenity WHERE AmenityId = :AV10AmenityId and LocationId = :AV11LocationId and OrganisationId = :AV17OrganisationId ORDER BY AmenityId, LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004M2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H004M3", "SELECT OrganisationId, LocationId, AmenityId, AmenityName FROM Trn_Amenity WHERE (AmenityId = :AV10AmenityId and LocationId = :AV11LocationId and OrganisationId = :AV17OrganisationId) AND (AmenityId = :AV10AmenityId and LocationId = :AV11LocationId and OrganisationId = :AV17OrganisationId) ORDER BY AmenityId, LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004M3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
