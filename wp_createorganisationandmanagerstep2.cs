...
namespace GeneXus.Programs {
   public class wp_createorganisationandmanagerstep2 : GXWebComponent
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_71", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_71), 8, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void WB4H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpUnnamedgroup4_Internalname, "Manager Information", 1, 0, "px", 0, "px", "Group", "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavManagergivenname_Internalname, "First Name", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavManagerlastname_Internalname, "Last Name", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavManagergender_Internalname, "Gender", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavManageremail_Internalname, "Email", "col-sm-4 AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 41,'" + sPrefix + "',false,'" + sGXsfl_71_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavManageremail_Internalname, AV18ManagerEmail, StringUtil.RTrim( context.localUtil.Format( AV18ManagerEmail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,41);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "johndoe@gmail.com", edtavManageremail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavManageremail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "", "start", true, "", "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockcombo_managerphonecode_Internalname, "Phone ", "", "", lblTextblockcombo_managerphonecode_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WP_CreateOrganisationAndManagerStep2.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
      ...
      protected void wb_table1_49_4H2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavManagerismainmanager_Internalname, "Is Main Manager?", "col-sm-4 AttributeCheckBoxLabel BootstrapTooltipRightLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
            /* Check box */
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 22), "GRIDSDT_MANAGERSS.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "VUDELETE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "VUEDIT.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 12), "VUEDIT.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 14), "VUDELETE.CLICK") == 0 ) )
                           {
                              ...
                              AV68GXV1 = (int)(nGXsfl_71_idx+GRIDSDT_MANAGERSS_nFirstRecordOnPage);
                              if ( ( AV35SDT_Managers.Count >= AV68GXV1 ) && ( AV68GXV1 > 0 ) )
                              {
                                 AV35SDT_Managers.CurrentItem = ((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV68GXV1));
      ...
      protected void STRUP4H0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            /* Read saved values. */
            nRC_GXsfl_71 = (int)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_71"), ".", ","), 18, MidpointRounding.ToEven));
            ...
            while ( nGXsfl_71_fel_idx < nRC_GXsfl_71 )
            {
               ...
               AV68GXV1 = (int)(nGXsfl_71_fel_idx+GRIDSDT_MANAGERSS_nFirstRecordOnPage);
               if ( ( AV35SDT_Managers.Count >= AV68GXV1 ) && ( AV68GXV1 > 0 ) )
               {
                  AV35SDT_Managers.CurrentItem = ((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV68GXV1));
                  AV55UEdit = cgiGet( edtavUedit_Internalname);
      ...
      protected void E154H2( )
      {
         ...
         S112 ();
         if (returnInSub) return;
         chkavManagerismainmanager.TooltipText = "Has permissions to add/edit/delete fellow managers";
      ...
      private void E164H2( )
      {
         ...
         returnInSub = false;
         AV68GXV1 = 1;
         while ( AV68GXV1 <= AV35SDT_Managers.Count )
         {
            AV35SDT_Managers.CurrentItem = ((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV68GXV1));
      ...
      {
         AV68GXV1 = (int)(nGXsfl_71_idx+GRIDSDT_MANAGERSS_nFirstRecordOnPage);
         if ( ( AV68GXV1 > 0 ) && ( AV35SDT_Managers.Count >= AV68GXV1 ) )
         {
            AV35SDT_Managers.CurrentItem = ((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV68GXV1));
         }
         /* Enter Routine */
      ...
      protected void E134H2( )
      {
         ...
         if ( AV5CheckRequiredFieldsResult && ! AV12HasValidationErrors )
         {
            ...
            if ( StringUtil.StrCmp(AV40WebSession.Get("isLastIndex"), "true") == 0 )
            {
               AV35SDT_Managers.Clear();
               gx_BV71 = true;
               if ( AV35SDT_Managers.FromJSonString(AV40WebSession.Get("Managers"), null) )
               {
                  AV40WebSession.Set("isLastIndex", "false");
                  AV40WebSession.Remove("Managers");
               }
            }
            AV81GXV14 = 1;
            while ( AV81GXV14 <= AV35SDT_Managers.Count )
            {
               AV34SDT_Manager = ((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV81GXV14));
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Core.genexus.common.SdtLog(context).info("Organisation ID: "+AV37Trn_Organisation.gxTpr_Organisationid.ToString()) ;
         AV60count = 0;
         ...
         if ( AV17isOrganisationInserted )
         {
            ...
            AV82GXV15 = 1;
            while ( AV82GXV15 <= AV35SDT_Managers.Count )
            {
               AV34SDT_Manager = ((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV82GXV15));
               ...
               {
                  AV84GXV17 = 1;
                  AV83GXV16 = AV36Trn_Manager.GetMessages();
                  while ( AV84GXV17 <= AV83GXV16.Count )
                  {
                     AV7Error = ((GeneXus.Utils.SdtMessages_Message)AV83GXV16.Item(AV84GXV17));
                     AV8ErrorMessages.Add(AV7Error, 0);
                     AV84GXV17 = (int)(AV84GXV17+1);
                  }
               }
               else
               {
                  ...
                  AV85GXV18 = 1;
                  while ( AV85GXV18 <= AV61GAMErrorCollection.Count )
                  {
                     AV62GAMErrorItem = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV61GAMErrorCollection.Item(AV85GXV18));
                     ...
                     AV8ErrorMessages.Add(AV7Error, 0);
                     AV85GXV18 = (int)(AV85GXV18+1);
                  }
               }
               AV82GXV15 = (int)(AV82GXV15+1);
            }
            /* Execute user subroutine: 'CLEARFORMVALUES' */
            S162 ();
            if (returnInSub) return;
      ...
      protected void S132( )
      {
         ...
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "First Name", "", "", "", "", "", "", "", ""),  "error",  edtavManagergivenname_Internalname,  "true",  ""));
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         AV87GXV20 = 1;
         GXt_objcol_SdtSDT_Country_SDT_CountryItem3 = AV86GXV19;
         new dp_country(context ).execute( out  GXt_objcol_SdtSDT_Country_SDT_CountryItem3) ;
         AV86GXV19 = GXt_objcol_SdtSDT_Country_SDT_CountryItem3;
         while ( AV87GXV20 <= AV86GXV19.Count )
         {
            AV51ManagerPhoneCode_DPItem = ((SdtSDT_Country_SDT_CountryItem)AV86GXV19.Item(AV87GXV20));
      ...
      protected void E184H2( )
      {
         ...
         if ( AV57IndexToDelete == AV35SDT_Managers.Count )
         {
            ...
            gx_BV71 = true;
            AV40WebSession.Set("isLastIndex", "true");
            AV40WebSession.Set("Managers", AV35SDT_Managers.ToJSonString(false));
         }
         else
         {
            AV35SDT_Managers.RemoveItem(AV57IndexToDelete);
      ...
      protected void E144H2( )
      {
         ...
         returnInSub = false;
         if ( ! GxRegex.IsMatch(AV18ManagerEmail,"^((\\w+([-+.']\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*)|(\\s*))$") )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "Error!",  "Email is incorrect",  "error",  edtavManageremail_Internalname,  "true",  ""));
            AV5CheckRequiredFieldsResult = false;
            AssignAttri(sPrefix, false, "AV5CheckRequiredFieldsResult", AV5CheckRequiredFieldsResult);
         }
         /*  Sending Event outputs  */
      ...
      protected void S172( )
      {
         ...
         returnInSub = false;
         AV88GXV21 = 1;
         while ( AV88GXV21 <= AV8ErrorMessages.Count )
         {
            AV7Error = ((GeneXus.Utils.SdtMessages_Message)AV8ErrorMessages.Item(AV88GXV21));
      ...
      protected void wb_table1_49_4H2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavManagerphonenumber_Internalname, "Manager Phone Number", "gx-form-item AttributePhoneNumberLabel", 0, true, "width: 25%;");
            /* Single line edit */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241120891591", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_createorganisationandmanagerstep2.js", "?20241120891593", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
      ...
      protected void sendrow_712( )
      {
         ...
         if ( ( subGridsdt_managerss_Rows * 1 == 0 ) || ( nGXsfl_71_idx <= subGridsdt_managerss_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            if ( ( cmbavSdt_managers__managergender.ItemCount == 0 ) && isAjaxCallMode( ) )
            {
               ...
               {
                  if ( ( AV68GXV1 > 0 ) && ( AV35SDT_Managers.Count >= AV68GXV1 ) && String.IsNullOrEmpty(StringUtil.RTrim( ((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV68GXV1)).gxTpr_Managergender)) )
                  {
                     ((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV68GXV1)).gxTpr_Managergender = cmbavSdt_managers__managergender.getValidValue(((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV68GXV1)).gxTpr_Managergender);
                  }
               }
            }
            /* ComboBox */
            Gridsdt_managerssRow.AddColumnProperties("combobox", 2, isAjaxCallMode( ), new Object[] {(GXCombobox)cmbavSdt_managers__managergender,(string)cmbavSdt_managers__managergender_Internalname,StringUtil.RTrim( ((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV68GXV1)).gxTpr_Managergender),(short)1,(string)cmbavSdt_managers__managergender_Jsonclick,(short)0,(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"svchar",(string)"",(short)-1,cmbavSdt_managers__managergender.Enabled,(short)0,(short)0,(short)0,(string)"px",(short)0,(string)"px",(string)"",(string)"Attribute",(string)"WWColumn",(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,81);\"",(string)"",(bool)true,(short)0});
            cmbavSdt_managers__managergender.CurrentValue = StringUtil.RTrim( ((SdtSDT_Managers_SDT_ManagersItem)AV35SDT_Managers.Item(AV68GXV1)).gxTpr_Managergender);
            ...
            ROClassString = "Attribute";
            Gridsdt_managerssRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavUdelete_Internalname,StringUtil.RTrim( AV38UDelete),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,85);\"","'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EVUDELETE.CLICK."+sGXsfl_71_idx+"'",(string)"",(string)"",(string)"Delete item",(string)"",(string)edtavUdelete_Jsonclick,(short)5,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWIconActionColumn",(string)"",(short)-1,(int)edtavUdelete_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)71,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
      ...
      protected void init_web_controls( )
      {
         ...
         chkavManagerismainmanager.Caption = "Is Main Manager?";
      ...
      protected void StartGridControl71( )
      {
         if ( Gridsdt_managerssContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            context.SendWebValue( "Manager Phone Code") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            context.SendWebValue( "Manager Phone Number") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Gender") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            context.SendWebValue( "Manager GAMGUID") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"AttributeCheckBox"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Is Main Manager") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
      ...
      public override void initialize( )
      {
         ...
         AV34SDT_Manager = new SdtSDT_Managers_SDT_ManagersItem(context);
         AV37Trn_Organisation = new SdtTrn_Organisation(context);
         AV83GXV16 = new GXBaseCollection<GeneXus.Utils.SdtMessages_Message>( context, "Message", "GeneXus");
         AV7Error = new GeneXus.Utils.SdtMessages_Message(context);
         GXt_char2 = "";
         ...
         AV86GXV19 = new GXBaseCollection<SdtSDT_Country_SDT_CountryItem>( context, "SDT_CountryItem", "Comforta_version2");
      ...
      private int AV82GXV15 ;
      private int AV84GXV17 ;
      private int AV85GXV18 ;
      private int AV87GXV20 ;
      ...
      private GXBaseCollection<GeneXus.Utils.SdtMessages_Message> AV83GXV16 ;
      ...
      private GXBaseCollection<SdtSDT_Country_SDT_CountryItem> AV86GXV19 ;
