...
namespace GeneXus.Programs {
   public class aprc_uploadmedia : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         AV14BC_Trn_Media.gxTpr_Mediaurl = StringUtil.StringReplace( AV8HttpRequest.BaseURL, context.GetMessage( "api/media", ""), AV12MediaName);
         AV14BC_Trn_Media.Save();
         if ( AV14BC_Trn_Media.Success() )
         {
            new SdtEO_Base64Image(context).saveimage(AV18MediaImageData, AV12MediaName) ;
         ...
         {
            AV23GXV2 = 1;
            AV22GXV1 = AV14BC_Trn_Media.GetMessages();
            while ( AV23GXV2 <= AV22GXV1.Count )
            {
               AV17Message = ((GeneXus.Utils.SdtMessages_Message)AV22GXV1.Item(AV23GXV2));
