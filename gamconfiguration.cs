...
namespace GeneXus.Programs {
   public class gamconfiguration : GXDataArea
   {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112115492324", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamconfiguration.js", "?2024112115492327", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E129M2","iparms":[{"av":"cmbavEnabletracing"},{"av":"AV7EnableTracing","fld":"vENABLETRACING","pic":"ZZZ9"},{"av":"AV6EmailRegularExpression","fld":"vEMAILREGULAREXPRESSION"},{"av":"cmbavDefaultrepository"},{"av":"AV5DefaultRepository","fld":"vDEFAULTREPOSITORY"}]}""");
