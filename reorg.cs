...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateTrn_Page( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_Page (Trn_PageId CHAR(36) NOT NULL , Trn_PageName VARCHAR(100) NOT NULL , PageJsonContent TEXT NOT NULL , PageGJSHtml TEXT NOT NULL , PageGJSJson TEXT NOT NULL , PageIsPublished BOOLEAN NOT NULL , PageIsContentPage BOOLEAN NOT NULL , PageChildren TEXT , OrganisationId CHAR(36) NOT NULL , LocationId CHAR(36) NOT NULL , ProductServiceId CHAR(36) , PRIMARY KEY(Trn_PageId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         try
         {
            cmdBuffer=" CREATE UNIQUE INDEX UTRN_PAGE ON Trn_Page (Trn_PageName ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTrn_ThemeIcon( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_ThemeIcon (Trn_ThemeId CHAR(36) NOT NULL , IconId CHAR(36) NOT NULL , IconName VARCHAR(100) NOT NULL , IconSVG TEXT NOT NULL , IconCategory CHAR(20) NOT NULL , PRIMARY KEY(Trn_ThemeId, IconId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTrn_Resident( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_Resident (ResidentId CHAR(36) NOT NULL , LocationId CHAR(36) NOT NULL , OrganisationId CHAR(36) NOT NULL , ResidentSalutation CHAR(20) NOT NULL , ResidentBsnNumber VARCHAR(9) NOT NULL , ResidentGivenName VARCHAR(100) NOT NULL , ResidentLastName VARCHAR(100) NOT NULL , ResidentInitials CHAR(20) NOT NULL , ResidentEmail VARCHAR(100) NOT NULL , ResidentGender VARCHAR(40) NOT NULL , ResidentPhone CHAR(20) NOT NULL , ResidentBirthDate date NOT NULL , ResidentGUID VARCHAR(100) NOT NULL , ResidentTypeId CHAR(36) NOT NULL , MedicalIndicationId CHAR(36) NOT NULL , ResidentCountry VARCHAR(100) NOT NULL , ResidentCity VARCHAR(100) NOT NULL , ResidentZipCode VARCHAR(100) NOT NULL , ResidentAddressLine1 VARCHAR(100) NOT NULL , ResidentAddressLine2 VARCHAR(100) NOT NULL , ResidentPhoneCode VARCHAR(40) NOT NULL , ResidentPhoneNumber VARCHAR(9) NOT NULL , ResidentHomePhone CHAR(20) NOT NULL , ResidentHomePhoneCode VARCHAR(40) NOT NULL , ResidentHomePhoneNumber VARCHAR(9) NOT NULL , PRIMARY KEY(ResidentId, LocationId, OrganisationId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void CreateTrn_Location( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_Location (LocationId CHAR(36) NOT NULL , OrganisationId CHAR(36) NOT NULL , LocationName VARCHAR(100) NOT NULL , LocationEmail VARCHAR(100) NOT NULL , LocationPhone CHAR(20) NOT NULL , LocationDescription TEXT NOT NULL , LocationCity VARCHAR(100) NOT NULL , LocationZipCode VARCHAR(100) NOT NULL , LocationAddressLine1 VARCHAR(100) NOT NULL , LocationAddressLine2 VARCHAR(100) NOT NULL , LocationCountry VARCHAR(100) NOT NULL , LocationPhoneCode VARCHAR(40) NOT NULL , LocationPhoneNumber VARCHAR(9) NOT NULL , Trn_ThemeId CHAR(36) NOT NULL , PRIMARY KEY(LocationId, OrganisationId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void RITrn_PageTrn_Location( )
      {
         ...
         try
         {
            cmdBuffer=" ALTER TABLE Trn_Page ADD CONSTRAINT GX_002H000B000T FOREIGN KEY (LocationId, OrganisationId) REFERENCES Trn_Location (LocationId, OrganisationId) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" ALTER TABLE Trn_Page DROP CONSTRAINT GX_002H000B000T "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateTrn_AgendaEventGroup" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "CreateTrn_Page" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "CreateTrn_ThemeIcon" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 4 ,  "CreateTrn_PreferredGenSupplier" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 5 ,  "CreateTrn_PreferredAgbSupplier" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 6 ,  "CreateTrn_Audit" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 7 ,  "CreateTrn_Media" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 8 ,  "CreateTrn_CallToAction" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 9 ,  "CreateTrn_LocationDynamicForm" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 10 ,  "CreateTrn_Device" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 11 ,  "CreateTrn_ProductService" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 12 ,  "CreateTrn_Receptionist" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 13 ,  "CreateTrn_AgendaCalendar" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 14 ,  "CreateTrn_SupplierGenType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 15 ,  "CreateTrn_SupplierAgbType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 16 ,  "CreateTrn_Template" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 17 ,  "CreateTrn_ThemeColor" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 18 ,  "CreateTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 19 ,  "CreateUserCustomizations" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 20 ,  "CreateWWP_FormInstanceElement" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 21 ,  "CreateWWP_FormInstance" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 22 ,  "CreateWWP_FormElement" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 23 ,  "CreateWWP_Form" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 24 ,  "CreateWWP_DiscussionMessageMention" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 25 ,  "CreateWWP_DiscussionMessage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 26 ,  "CreateWWP_MailAttachments" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 27 ,  "CreateWWP_Mail" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 28 ,  "CreateWWP_MailTemplate" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 29 ,  "CreateWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 30 ,  "CreateWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 31 ,  "CreateWWP_WebClient" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 32 ,  "CreateWWP_WebNotification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 33 ,  "CreateWWP_SMS" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 34 ,  "CreateWWP_Subscription" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 35 ,  "CreateWWP_Entity" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 36 ,  "CreateWWP_Parameter" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 37 ,  "CreateWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 38 ,  "CreateTrn_OrganisationSetting" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 39 ,  "CreateTrn_MedicalIndication" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 40 ,  "CreateTrn_ResidentNetworkIndividual" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 41 ,  "CreateTrn_ResidentType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 42 ,  "CreateTrn_ResidentNetworkCompany" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 43 ,  "CreateTrn_NetworkCompany" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 44 ,  "CreateTrn_NetworkIndividual" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 45 ,  "CreateTrn_Resident" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 46 ,  "CreateTrn_SupplierAGB" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 47 ,  "CreateTrn_SupplierGen" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 48 ,  "CreateTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 49 ,  "CreateTrn_Manager" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 50 ,  "CreateTrn_OrganisationType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 51 ,  "CreateTrn_Organisation" , new Object[]{ });
      }

      private void ExecuteOnlyRisReorganization( )
      {
         ReorgExecute.RegisterBlockForSubmit( 52 ,  "RITrn_OrganisationTrn_OrganisationType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 53 ,  "RITrn_ManagerTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 54 ,  "RITrn_LocationTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 55 ,  "RITrn_LocationTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 56 ,  "RITrn_SupplierGenTrn_SupplierGenType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 57 ,  "RITrn_SupplierGenTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 58 ,  "RITrn_SupplierAGBTrn_SupplierAgbType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 59 ,  "RITrn_ResidentTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 60 ,  "RITrn_ResidentTrn_ResidentType" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 61 ,  "RITrn_ResidentTrn_MedicalIndication" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 62 ,  "RITrn_ResidentNetworkCompanyTrn_NetworkCompany" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 63 ,  "RITrn_ResidentNetworkCompanyTrn_Resident" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 64 ,  "RITrn_ResidentNetworkIndividualTrn_Resident" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 65 ,  "RITrn_ResidentNetworkIndividualTrn_NetworkIndividual" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 66 ,  "RITrn_OrganisationSettingTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 67 ,  "RIWWP_SubscriptionWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 68 ,  "RIWWP_SubscriptionWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 69 ,  "RIWWP_SMSWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 70 ,  "RIWWP_WebNotificationWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 71 ,  "RIWWP_WebClientWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 72 ,  "RIWWP_NotificationDefinitionWWP_Entity" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 73 ,  "RIWWP_NotificationWWP_NotificationDefinition" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 74 ,  "RIWWP_NotificationWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 75 ,  "RIWWP_MailWWP_Notification" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 76 ,  "RIWWP_MailAttachmentsWWP_Mail" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 77 ,  "RIWWP_DiscussionMessageWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 78 ,  "RIWWP_DiscussionMessageWWP_Entity" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 79 ,  "RIWWP_DiscussionMessageWWP_DiscussionMessage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 80 ,  "RIWWP_DiscussionMessageMentionWWP_DiscussionMessage" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 81 ,  "RIWWP_DiscussionMessageMentionWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 82 ,  "RIWWP_FormElementWWP_FormElement" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 83 ,  "RIWWP_FormInstanceWWP_Form" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 84 ,  "RIWWP_FormInstanceWWP_UserExtended" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 85 ,  "RIWWP_FormInstanceElementWWP_FormInstance" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 86 ,  "RITrn_ThemeColorTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 87 ,  "RITrn_AgendaCalendarTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 88 ,  "RITrn_ReceptionistTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 89 ,  "RITrn_ProductServiceTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 90 ,  "RITrn_ProductServiceTrn_SupplierGen" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 91 ,  "RITrn_ProductServiceTrn_SupplierAGB" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 92 ,  "RITrn_LocationDynamicFormTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 93 ,  "RITrn_LocationDynamicFormWWP_Form" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 94 ,  "RITrn_CallToActionTrn_ProductService" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 95 ,  "RITrn_CallToActionTrn_LocationDynamicForm" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 96 ,  "RITrn_AuditTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 97 ,  "RITrn_ThemeIconTrn_Theme" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 98 ,  "RITrn_PageTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 99 ,  "RITrn_PageTrn_ProductService" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 100 ,  "RITrn_AgendaEventGroupTrn_AgendaCalendar" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AgendaEventGroup", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_AgendaEventGroup" ,  "CreateTrn_AgendaCalendar" );
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Page", ""}) );
         ...
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ThemeIcon", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ThemeIcon" ,  "CreateTrn_Theme" );
         GXReorganization.SetMsg( 4 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_PreferredGenSupplier", ""}) );
         GXReorganization.SetMsg( 5 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_PreferredAgbSupplier", ""}) );
         GXReorganization.SetMsg( 6 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Audit", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Audit" ,  "CreateTrn_Organisation" );
         GXReorganization.SetMsg( 7 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Media", ""}) );
         GXReorganization.SetMsg( 8 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_CallToAction", ""}) );
         ...
         GXReorganization.SetMsg( 9 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_LocationDynamicForm", ""}) );
         ...
         GXReorganization.SetMsg( 10 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Device", ""}) );
         GXReorganization.SetMsg( 11 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ProductService", ""}) );
         ...
         GXReorganization.SetMsg( 12 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Receptionist", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Receptionist" ,  "CreateTrn_Location" );
         GXReorganization.SetMsg( 13 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_AgendaCalendar", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_AgendaCalendar" ,  "CreateTrn_Location" );
         GXReorganization.SetMsg( 14 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_SupplierGenType", ""}) );
         GXReorganization.SetMsg( 15 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_SupplierAgbType", ""}) );
         GXReorganization.SetMsg( 16 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Template", ""}) );
         GXReorganization.SetMsg( 17 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ThemeColor", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_ThemeColor" ,  "CreateTrn_Theme" );
         GXReorganization.SetMsg( 18 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Theme", ""}) );
         GXReorganization.SetMsg( 19 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"UserCustomizations", ""}) );
         GXReorganization.SetMsg( 20 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_FormInstanceElement", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_FormInstanceElement" ,  "CreateWWP_FormInstance" );
         GXReorganization.SetMsg( 21 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_FormInstance", ""}) );
         ...
         GXReorganization.SetMsg( 22 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_FormElement", ""}) );
         GXReorganization.SetMsg( 23 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Form", ""}) );
         GXReorganization.SetMsg( 24 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_DiscussionMessageMention", ""}) );
         ...
         GXReorganization.SetMsg( 25 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_DiscussionMessage", ""}) );
         ...
         GXReorganization.SetMsg( 26 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_MailAttachments", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_MailAttachments" ,  "CreateWWP_Mail" );
         GXReorganization.SetMsg( 27 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Mail", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_Mail" ,  "CreateWWP_Notification" );
         GXReorganization.SetMsg( 28 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_MailTemplate", ""}) );
         GXReorganization.SetMsg( 29 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Notification", ""}) );
         ...
         GXReorganization.SetMsg( 30 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_NotificationDefinition", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_NotificationDefinition" ,  "CreateWWP_Entity" );
         GXReorganization.SetMsg( 31 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_WebClient", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_WebClient" ,  "CreateWWP_UserExtended" );
         GXReorganization.SetMsg( 32 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_WebNotification", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_WebNotification" ,  "CreateWWP_Notification" );
         GXReorganization.SetMsg( 33 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_SMS", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateWWP_SMS" ,  "CreateWWP_Notification" );
         GXReorganization.SetMsg( 34 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Subscription", ""}) );
         ...
         GXReorganization.SetMsg( 35 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Entity", ""}) );
         GXReorganization.SetMsg( 36 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_Parameter", ""}) );
         GXReorganization.SetMsg( 37 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"WWP_UserExtended", ""}) );
         GXReorganization.SetMsg( 38 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_OrganisationSetting", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_OrganisationSetting" ,  "CreateTrn_Organisation" );
         GXReorganization.SetMsg( 39 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_MedicalIndication", ""}) );
         GXReorganization.SetMsg( 40 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ResidentNetworkIndividual", ""}) );
         ...
         GXReorganization.SetMsg( 41 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ResidentType", ""}) );
         GXReorganization.SetMsg( 42 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_ResidentNetworkCompany", ""}) );
         ...
         GXReorganization.SetMsg( 43 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_NetworkCompany", ""}) );
         GXReorganization.SetMsg( 44 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_NetworkIndividual", ""}) );
         GXReorganization.SetMsg( 45 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Resident", ""}) );
         ...
         GXReorganization.SetMsg( 46 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_SupplierAGB", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_SupplierAGB" ,  "CreateTrn_SupplierAgbType" );
         GXReorganization.SetMsg( 47 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_SupplierGen", ""}) );
         ...
         GXReorganization.SetMsg( 48 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Location", ""}) );
         ...
         GXReorganization.SetMsg( 49 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Manager", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Manager" ,  "CreateTrn_Organisation" );
         GXReorganization.SetMsg( 50 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_OrganisationType", ""}) );
         GXReorganization.SetMsg( 51 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Organisation", ""}) );
         ReorgExecute.RegisterPrecedence( "CreateTrn_Organisation" ,  "CreateTrn_OrganisationType" );
      }

      private void SetPrecedenceris( )
      {
         GXReorganization.SetMsg( 52 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATION1"}) );
         ...
         GXReorganization.SetMsg( 53 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_MANAGER1"}) );
         ...
         GXReorganization.SetMsg( 54 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION1"}) );
         ...
         GXReorganization.SetMsg( 55 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION2"}) );
         ...
         GXReorganization.SetMsg( 57 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERGEN2"}) );
         ...
         GXReorganization.SetMsg( 58 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_SUPPLIERAGB1"}) );
         ...
         GXReorganization.SetMsg( 59 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT3"}) );
         ...
         GXReorganization.SetMsg( 60 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT2"}) );
         ...
         GXReorganization.SetMsg( 61 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENT1"}) );
         ...
         GXReorganization.SetMsg( 62 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENTNETWORKCOMPANY1"}) );
         ...
         GXReorganization.SetMsg( 63 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENTNETWORKCOMPANY2"}) );
         ...
         GXReorganization.SetMsg( 64 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENTNETWORKINDIVIDUA2"}) );
         ...
         GXReorganization.SetMsg( 65 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RESIDENTNETWORKINDIVIDUA1"}) );
         ...
         GXReorganization.SetMsg( 66 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_ORGANISATIONSETTING1"}) );
         ...
         GXReorganization.SetMsg( 67 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SUBSCRIPTION2"}) );
         ...
         GXReorganization.SetMsg( 68 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SUBSCRIPTION1"}) );
         ...
         GXReorganization.SetMsg( 69 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_SMS1"}) );
         ...
         GXReorganization.SetMsg( 70 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_WEBNOTIFICATION1"}) );
         ...
         GXReorganization.SetMsg( 71 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_WEBCLIENT1"}) );
         ...
         GXReorganization.SetMsg( 72 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATIONDEFINITION1"}) );
         ...
         GXReorganization.SetMsg( 73 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATION2"}) );
         ...
         GXReorganization.SetMsg( 74 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_NOTIFICATION1"}) );
         ...
         GXReorganization.SetMsg( 75 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_MAIL1"}) );
         ...
         GXReorganization.SetMsg( 76 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_MAILATTACHMENTS1"}) );
         ...
         GXReorganization.SetMsg( 77 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGE3"}) );
         ...
         GXReorganization.SetMsg( 78 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGE2"}) );
         ...
         GXReorganization.SetMsg( 79 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGE1"}) );
         ReorgExecute.RegisterPrecedence( "RIWWP_DiscussionMessageWWP_DiscussionMessage" ,  "CreateWWP_DiscussionMessage" );
         ReorgExecute.RegisterPrecedence( "RIWWP_DiscussionMessageWWP_DiscussionMessage" ,  "CreateWWP_DiscussionMessage" );
         GXReorganization.SetMsg( 80 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGEMENTION2"}) );
         ...
         GXReorganization.SetMsg( 81 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_DISCUSSIONMESSAGEMENTION1"}) );
         ...
         GXReorganization.SetMsg( 82 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWPFORMELEMENT1"}) );
         ReorgExecute.RegisterPrecedence( "RIWWP_FormElementWWP_FormElement" ,  "CreateWWP_FormElement" );
         ReorgExecute.RegisterPrecedence( "RIWWP_FormElementWWP_FormElement" ,  "CreateWWP_FormElement" );
         GXReorganization.SetMsg( 83 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWPFORMINSTANCE1"}) );
         ...
         GXReorganization.SetMsg( 84 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWP_FORMINSTANCE"}) );
         ...
         GXReorganization.SetMsg( 85 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"IWWPFORMINSTANCEELEMENT1"}) );
         ...
         GXReorganization.SetMsg( 86 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_THEMECOLOR1"}) );
         ...
         GXReorganization.SetMsg( 87 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_AGENDACALENDAR1"}) );
         ...
         GXReorganization.SetMsg( 88 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RECEPTIONIST1"}) );
         ...
         GXReorganization.SetMsg( 89 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PRODUCTSERVICE3"}) );
         ...
         GXReorganization.SetMsg( 90 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PRODUCTSERVICE2"}) );
         ...
         GXReorganization.SetMsg( 91 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PRODUCTSERVICE1"}) );
         ...
         GXReorganization.SetMsg( 92 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATIONDYNAMICFORM2"}) );
         ...
         GXReorganization.SetMsg( 93 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATIONDYNAMICFORM1"}) );
         ...
         GXReorganization.SetMsg( 94 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_CALLTOACTION2"}) );
         ...
         GXReorganization.SetMsg( 95 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_CALLTOACTION1"}) );
         ...
         GXReorganization.SetMsg( 96 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_AUDIT"}) );
         ...
         GXReorganization.SetMsg( 97 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_THEMEICON1"}) );
         ...
         GXReorganization.SetMsg( 98 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"GX_002H000B000T"}) );
         ...
         GXReorganization.SetMsg( 99 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PAGE1"}) );
         ...
         GXReorganization.SetMsg( 100 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_AGENDAEVENTGROUP1"}) );
