...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeTrn_Location( )
      {
         ...
         cmdBuffer=" ALTER TABLE Trn_Location ADD Trn_ThemeId CHAR(36) NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000' "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" ALTER TABLE Trn_Location ALTER COLUMN Trn_ThemeId DROP DEFAULT "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
         RGZ.Drop();
         cmdBuffer=" INSERT INTO Trn_Theme (Trn_ThemeId, Trn_ThemeName, Trn_ThemeFontFamily, Trn_ThemeFontSize) SELECT '00000000-0000-0000-0000-000000000000', ' ', ' ', 0 FROM Trn_Location WHERE NOT EXISTS (SELECT 1 FROM Trn_Theme WHERE Trn_ThemeId='00000000-0000-0000-0000-000000000000') LIMIT 1 "
         ;
         RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
         RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
         RGZ.ExecuteStmt() ;
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("Trn_Location",sSchemaVar,"Trn_ThemeId") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"Trn_ThemeId", "Trn_Location"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "RITrn_LocationTrn_Theme" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATION2"}) );
