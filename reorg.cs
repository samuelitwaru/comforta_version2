...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateTrn_Tile( )
      {
         ...
         try
         {
            cmdBuffer=" CREATE TABLE Trn_Tile (Trn_TileId CHAR(36) NOT NULL , ProductServiceId CHAR(36) , Trn_TileName VARCHAR(100) NOT NULL , Trn_TileColor CHAR(20) , Trn_TileBGImageUrl VARCHAR(1000) , OrganisationId CHAR(36) , LocationId CHAR(36) , SG_ToPageId CHAR(36) NOT NULL , Trn_TileIcon TEXT , PRIMARY KEY(Trn_TileId))  "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         try
         {
            cmdBuffer=" CREATE INDEX ITRN_TILE2 ON Trn_Tile (SG_ToPageId ) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      public void RITrn_TileTrn_Organisation( )
      {
         ...
         try
         {
            cmdBuffer=" ALTER TABLE Trn_Tile ADD CONSTRAINT GX_001Z000B FOREIGN KEY (OrganisationId) REFERENCES Trn_Organisation (OrganisationId) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" ALTER TABLE Trn_Tile DROP CONSTRAINT GX_001Z000B "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      public void RITrn_TileTrn_Location( )
      {
         string cmdBuffer;
         try
         {
            cmdBuffer=" ALTER TABLE Trn_Tile ADD CONSTRAINT GX_001Z000B000T FOREIGN KEY (LocationId, OrganisationId) REFERENCES Trn_Location (LocationId, OrganisationId) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
         ...
         catch
         {
            try
            {
               cmdBuffer=" ALTER TABLE Trn_Tile DROP CONSTRAINT GX_001Z000B000T "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_MASKNOTFOUND | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
      ...
      public void RITrn_TileTrn_Page( )
      {
         ...
         try
         {
            cmdBuffer=" ALTER TABLE Trn_Tile ADD CONSTRAINT ITRN_TILE2 FOREIGN KEY (SG_ToPageId) REFERENCES Trn_Page (Trn_PageId) "
            ;
            RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
            RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
            RGZ.ExecuteStmt() ;
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateTrn_CallToAction" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "CreateTrn_LocationDynamicForm" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 3 ,  "CreateTrn_Device" , new Object[]{ });
      ...
      private void ExecuteOnlyRisReorganization( )
      {
         ...
         ReorgExecute.RegisterBlockForSubmit( 89 ,  "RITrn_TileTrn_Organisation" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 90 ,  "RITrn_TileTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 91 ,  "RITrn_TileTrn_ProductService" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 92 ,  "RITrn_TileTrn_Page" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 93 ,  "RITrn_Col1Trn_Row" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 94 ,  "RITrn_Col1Trn_Tile" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 95 ,  "RITrn_AmenityTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 96 ,  "RITrn_ReceptionistTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 97 ,  "RITrn_ProductServiceTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 98 ,  "RITrn_ProductServiceTrn_SupplierGen" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 99 ,  "RITrn_ProductServiceTrn_SupplierAGB" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 100 ,  "RITrn_LocationDynamicFormTrn_Location" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 101 ,  "RITrn_LocationDynamicFormWWP_Form" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 102 ,  "RITrn_CallToActionTrn_ProductService" , new Object[]{ });
         ReorgExecute.RegisterBlockForSubmit( 103 ,  "RITrn_CallToActionTrn_LocationDynamicForm" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_CallToAction", ""}) );
         ...
         GXReorganization.SetMsg( 2 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_LocationDynamicForm", ""}) );
         ...
         GXReorganization.SetMsg( 3 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"Trn_Device", ""}) );
         ...
         ReorgExecute.RegisterPrecedence( "CreateTrn_Tile" ,  "CreateTrn_Location" );
      ...
      private void SetPrecedenceris( )
      {
         ...
         GXReorganization.SetMsg( 89 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"GX_001Z000B"}) );
         ...
         GXReorganization.SetMsg( 90 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"GX_001Z000B000T"}) );
         ReorgExecute.RegisterPrecedence( "RITrn_TileTrn_Location" ,  "CreateTrn_Tile" );
         ReorgExecute.RegisterPrecedence( "RITrn_TileTrn_Location" ,  "CreateTrn_Location" );
         GXReorganization.SetMsg( 91 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_TILE1"}) );
         ...
         GXReorganization.SetMsg( 92 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_TILE2"}) );
         ...
         GXReorganization.SetMsg( 93 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_COL5"}) );
         ...
         GXReorganization.SetMsg( 94 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_COL6"}) );
         ...
         GXReorganization.SetMsg( 95 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_AMENITY1"}) );
         ...
         GXReorganization.SetMsg( 96 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_RECEPTIONIST1"}) );
         ...
         GXReorganization.SetMsg( 97 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PRODUCTSERVICE3"}) );
         ...
         GXReorganization.SetMsg( 98 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PRODUCTSERVICE2"}) );
         ...
         GXReorganization.SetMsg( 99 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_PRODUCTSERVICE1"}) );
         ...
         GXReorganization.SetMsg( 100 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATIONDYNAMICFORM2"}) );
         ...
         GXReorganization.SetMsg( 101 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_LOCATIONDYNAMICFORM1"}) );
         ...
         GXReorganization.SetMsg( 102 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_CALLTOACTION2"}) );
         ...
         GXReorganization.SetMsg( 103 ,  GXResourceManager.GetMessage("GXM_refintcrea", new   object[]  {"ITRN_CALLTOACTION1"}) );
