...
namespace GeneXus.Programs {
   public class gamwwsecuritypolicy : GXDataArea
   {
      ...
      protected void WB9E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_19_9E2( true) ;
         }
         else
         {
            wb_table1_19_9E2( false) ;
         }
         return  ;
      }

      protected void wb_table1_19_9E2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void E119E2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            if (returnInSub) return;
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMWWSecurityPolicyFilters")) + "," + UrlEncode(StringUtil.RTrim(AV52Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               S152 ();
               if (returnInSub) return;
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV52Pgmname+"GridState",  AV38ManageFiltersXml) ;
      ...
      protected void S122( )
      {
         ...
         {
            AV34GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV52Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S162( )
      {
         ...
         {
            AV35GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV34GridState.gxTpr_Filtervalues.Item(AV54GXV2));
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV34GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV11FilName)),  0,  AV11FilName,  AV11FilName,  false,  "",  "") ;
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV52Pgmname+"GridState",  AV34GridState.ToXml(false, true, "", "")) ;
      }

      protected void E189E2( )
      {
      ...
      protected void wb_table1_19_9E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_24_9E2( true) ;
         }
         else
         {
            wb_table2_24_9E2( false) ;
         }
         return  ;
      }

      protected void wb_table2_24_9E2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_19_9E2e( true) ;
         }
         else
         {
            wb_table1_19_9E2e( false) ;
         }
      }

      protected void wb_table2_24_9E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_24_9E2e( true) ;
         }
         else
         {
            wb_table2_24_9E2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112115485981", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwsecuritypolicy.js", "?2024112115485984", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.gamwwsecuritypolicy__datastore1(),
            new Object[][] {
            }
         );
   ...
   public class gamwwsecuritypolicy__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
