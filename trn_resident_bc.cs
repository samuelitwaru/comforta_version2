   ...
   public class trn_resident_bc : GxSilentTrn, IGxSilentTrn
   {
      ...
      protected void CheckOptimisticConcurrency0916( )
      {
         if ( ! IsIns( ) )
         {
            ...
            Gx_longc = false;
            if ( (pr_default.getStatus(6) == 101) || ( StringUtil.StrCmp(Z71ResidentGUID, BC00098_A71ResidentGUID[0]) != 0 ) || ( StringUtil.StrCmp(Z66ResidentInitials, BC00098_A66ResidentInitials[0]) != 0 ) || ( StringUtil.StrCmp(Z72ResidentSalutation, BC00098_A72ResidentSalutation[0]) != 0 ) || ( StringUtil.StrCmp(Z63ResidentBsnNumber, BC00098_A63ResidentBsnNumber[0]) != 0 ) || ( StringUtil.StrCmp(Z64ResidentGivenName, BC00098_A64ResidentGivenName[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( StringUtil.StrCmp(Z65ResidentLastName, BC00098_A65ResidentLastName[0]) != 0 ) || ( StringUtil.StrCmp(Z67ResidentEmail, BC00098_A67ResidentEmail[0]) != 0 ) || ( StringUtil.StrCmp(Z68ResidentGender, BC00098_A68ResidentGender[0]) != 0 ) || ( StringUtil.StrCmp(Z354ResidentCountry, BC00098_A354ResidentCountry[0]) != 0 ) || ( StringUtil.StrCmp(Z355ResidentCity, BC00098_A355ResidentCity[0]) != 0 ) )
            {
               Gx_longc = true;
            }
            if ( Gx_longc || ( StringUtil.StrCmp(Z356ResidentZipCode, BC00098_A356ResidentZipCode[0]) != 0 ) || ( StringUtil.StrCmp(Z357ResidentAddressLine1, BC00098_A357ResidentAddressLine1[0]) != 0 ) || ( StringUtil.StrCmp(Z358ResidentAddressLine2, BC00098_A358ResidentAddressLine2[0]) != 0 ) || ( StringUtil.StrCmp(Z70ResidentPhone, BC00098_A70ResidentPhone[0]) != 0 ) || ( DateTimeUtil.ResetTime ( Z73ResidentBirthDate ) != DateTimeUtil.ResetTime ( BC00098_A73ResidentBirthDate[0] ) ) )
            {
               Gx_longc = true;
            }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(13, new Object[] {A62ResidentId, A71ResidentGUID, A66ResidentInitials, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A67ResidentEmail, A68ResidentGender, A354ResidentCountry, A355ResidentCity, A356ResidentZipCode, A357ResidentAddressLine1, A358ResidentAddressLine2, A70ResidentPhone, A73ResidentBirthDate, A29LocationId, A11OrganisationId, A96ResidentTypeId, A98MedicalIndicationId});
                     pr_default.close(13);
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.execute(14, new Object[] {A71ResidentGUID, A66ResidentInitials, A72ResidentSalutation, A63ResidentBsnNumber, A64ResidentGivenName, A65ResidentLastName, A67ResidentEmail, A68ResidentGender, A354ResidentCountry, A355ResidentCity, A356ResidentZipCode, A357ResidentAddressLine1, A358ResidentAddressLine2, A70ResidentPhone, A73ResidentBirthDate, A96ResidentTypeId, A98MedicalIndicationId, A62ResidentId, A29LocationId, A11OrganisationId});
                     pr_default.close(14);
                     pr_default.SmartCacheProvider.SetUpdated("Trn_Resident");
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_resident_bc__default(),
            new Object[][] {
               ...
               , new Object[] {
               BC00098_A62ResidentId, BC00098_A71ResidentGUID, BC00098_A66ResidentInitials, BC00098_A72ResidentSalutation, BC00098_A63ResidentBsnNumber, BC00098_A64ResidentGivenName, BC00098_A65ResidentLastName, BC00098_A67ResidentEmail, BC00098_A68ResidentGender, BC00098_A354ResidentCountry,
               BC00098_A355ResidentCity, BC00098_A356ResidentZipCode, BC00098_A357ResidentAddressLine1, BC00098_A358ResidentAddressLine2, BC00098_A70ResidentPhone, BC00098_A73ResidentBirthDate, BC00098_A29LocationId, BC00098_A11OrganisationId, BC00098_A96ResidentTypeId, BC00098_A98MedicalIndicationId
               }
               , new Object[] {
               BC00099_A62ResidentId, BC00099_A71ResidentGUID, BC00099_A66ResidentInitials, BC00099_A72ResidentSalutation, BC00099_A63ResidentBsnNumber, BC00099_A64ResidentGivenName, BC00099_A65ResidentLastName, BC00099_A67ResidentEmail, BC00099_A68ResidentGender, BC00099_A354ResidentCountry,
               BC00099_A355ResidentCity, BC00099_A356ResidentZipCode, BC00099_A357ResidentAddressLine1, BC00099_A358ResidentAddressLine2, BC00099_A70ResidentPhone, BC00099_A73ResidentBirthDate, BC00099_A29LocationId, BC00099_A11OrganisationId, BC00099_A96ResidentTypeId, BC00099_A98MedicalIndicationId
               }
               , new Object[] {
               ...
               , new Object[] {
               BC000913_A62ResidentId, BC000913_A71ResidentGUID, BC000913_A66ResidentInitials, BC000913_A72ResidentSalutation, BC000913_A63ResidentBsnNumber, BC000913_A64ResidentGivenName, BC000913_A65ResidentLastName, BC000913_A67ResidentEmail, BC000913_A68ResidentGender, BC000913_A354ResidentCountry,
               BC000913_A355ResidentCity, BC000913_A356ResidentZipCode, BC000913_A357ResidentAddressLine1, BC000913_A358ResidentAddressLine2, BC000913_A70ResidentPhone, BC000913_A73ResidentBirthDate, BC000913_A97ResidentTypeName, BC000913_A99MedicalIndicationName, BC000913_A29LocationId, BC000913_A11OrganisationId,
               BC000913_A96ResidentTypeId, BC000913_A98MedicalIndicationId
               }
               , new Object[] {
               ...
               , new Object[] {
               BC000920_A62ResidentId, BC000920_A71ResidentGUID, BC000920_A66ResidentInitials, BC000920_A72ResidentSalutation, BC000920_A63ResidentBsnNumber, BC000920_A64ResidentGivenName, BC000920_A65ResidentLastName, BC000920_A67ResidentEmail, BC000920_A68ResidentGender, BC000920_A354ResidentCountry,
               BC000920_A355ResidentCity, BC000920_A356ResidentZipCode, BC000920_A357ResidentAddressLine1, BC000920_A358ResidentAddressLine2, BC000920_A70ResidentPhone, BC000920_A73ResidentBirthDate, BC000920_A97ResidentTypeName, BC000920_A99MedicalIndicationName, BC000920_A29LocationId, BC000920_A11OrganisationId,
               BC000920_A96ResidentTypeId, BC000920_A98MedicalIndicationId
               }
               , new Object[] {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("BC00098", "SELECT ResidentId, ResidentGUID, ResidentInitials, ResidentSalutation, ResidentBsnNumber, ResidentGivenName, ResidentLastName, ResidentEmail, ResidentGender, ResidentCountry, ResidentCity, ResidentZipCode, ResidentAddressLine1, ResidentAddressLine2, ResidentPhone, ResidentBirthDate, LocationId, OrganisationId, ResidentTypeId, MedicalIndicationId FROM Trn_Resident WHERE ResidentId = :ResidentId AND LocationId = :LocationId AND OrganisationId = :OrganisationId  FOR UPDATE OF Trn_Resident",true, GxErrorMask.GX_NOMASK, false, this,prmBC00098,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("BC00099", "SELECT ResidentId, ResidentGUID, ResidentInitials, ResidentSalutation, ResidentBsnNumber, ResidentGivenName, ResidentLastName, ResidentEmail, ResidentGender, ResidentCountry, ResidentCity, ResidentZipCode, ResidentAddressLine1, ResidentAddressLine2, ResidentPhone, ResidentBirthDate, LocationId, OrganisationId, ResidentTypeId, MedicalIndicationId FROM Trn_Resident WHERE ResidentId = :ResidentId AND LocationId = :LocationId AND OrganisationId = :OrganisationId ",true, GxErrorMask.GX_NOMASK, false, this,prmBC00099,1, GxCacheFrequency.OFF ,true,false )
