...
namespace GeneXus.Programs {
   public class gamapppermissionentry : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "gamapppermissionentry.aspx"+UrlEncode(StringUtil.RTrim(Gx_mode)) + "," + UrlEncode(StringUtil.LTrimStr(AV7ApplicationId,12,0)) + "," + UrlEncode(StringUtil.RTrim(AV12GUID));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamapppermissionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "gamapppermissionentry.aspx"+UrlEncode(StringUtil.RTrim(Gx_mode)) + "," + UrlEncode(StringUtil.LTrimStr(AV7ApplicationId,12,0)) + "," + UrlEncode(StringUtil.RTrim(AV12GUID));
         return formatLink("gamapppermissionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      {
         return context.GetMessage( "WWP_GAM_Permission", "") ;
      }
      ...
      protected void WB900( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavName_Internalname, StringUtil.RTrim( AV14Name), StringUtil.RTrim( context.localUtil.Format( AV14Name, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavName_Enabled, 1, "text", "", 0, "px", 1, "row", 254, 0, 0, 0, 0, -1, -1, true, "GeneXusSecurityCommon\\GAMDescriptionLong", "start", true, "", "HLP_GAMAppPermissionEntry.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 DataContentCell DscTop", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+cmbavAccesstype_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavAccesstype_Internalname, context.GetMessage( "WWP_GAM_AccessType", ""), " AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 40,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavAccesstype, cmbavAccesstype_Internalname, StringUtil.RTrim( AV15AccessType), 1, cmbavAccesstype_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbavAccesstype.Enabled, 1, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,40);\"", "", true, 0, "HLP_GAMAppPermissionEntry.htm");
            cmbavAccesstype.CurrentValue = StringUtil.RTrim( AV15AccessType);
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 DataContentCell DscTop", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "start", "top", ""+" data-gx-for=\""+chkavIsparent_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, chkavIsparent_Internalname, " ", " AttributeCheckBoxLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Check box */
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavIsparent_Internalname, StringUtil.BoolToStr( AV13IsParent), "", " ", 1, chkavIsparent.Enabled, "true", context.GetMessage( "WWP_GAM_IsaParentPermission", ""), StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(44, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,44);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", bttBtnenter_Caption, bttBtnenter_Jsonclick, 5, context.GetMessage( "GX_BtnEnter", ""), "", StyleString, ClassString, bttBtnenter_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMAppPermissionEntry.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", context.GetMessage( "GX_BtnCancel", ""), bttBtncancel_Jsonclick, 1, context.GetMessage( "GX_BtnCancel", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMAppPermissionEntry.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START902( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "WWP_GAM_Permission", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA902( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "gamapppermissionentry.aspx")), "gamapppermissionentry.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "gamapppermissionentry.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void fix_multi_value_controls( )
      {
         if ( cmbavAccesstype.ItemCount > 0 )
         {
            ...
            AssignAttri("", false, "AV15AccessType", AV15AccessType);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavAccesstype.CurrentValue = StringUtil.RTrim( AV15AccessType);
         ...
         AssignAttri("", false, "AV13IsParent", AV13IsParent);
      }
      ...
      protected void STRUP900( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV15AccessType = cgiGet( cmbavAccesstype_Internalname);
            AssignAttri("", false, "AV15AccessType", AV15AccessType);
            AV13IsParent = StringUtil.StrToBool( cgiGet( chkavIsparent_Internalname));
            AssignAttri("", false, "AV13IsParent", AV13IsParent);
      ...
      protected void E11902( )
      {
         ...
         AV8ApplicationPermission = AV5GAMApplication.getpermissionbyguid(AV12GUID, out  AV11Errors);
         if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
         {
            AV14Name = AV8ApplicationPermission.gxTpr_Name;
            AssignAttri("", false, "AV14Name", AV14Name);
            AV9Dsc = AV8ApplicationPermission.gxTpr_Description;
            AssignAttri("", false, "AV9Dsc", AV9Dsc);
            AV15AccessType = AV8ApplicationPermission.gxTpr_Accesstype;
            AssignAttri("", false, "AV15AccessType", AV15AccessType);
            AV13IsParent = AV8ApplicationPermission.gxTpr_Isparent;
            AssignAttri("", false, "AV13IsParent", AV13IsParent);
         }
      ...
      protected void E12902( )
      {
         ...
         if ( StringUtil.StrCmp(Gx_mode, "INS") == 0 )
         {
            AV8ApplicationPermission.gxTpr_Name = AV14Name;
            AV8ApplicationPermission.gxTpr_Description = AV9Dsc;
            AV8ApplicationPermission.gxTpr_Accesstype = AV15AccessType;
            AV6isOK = AV5GAMApplication.addpermission(AV8ApplicationPermission, out  AV11Errors);
         ...
         else if ( StringUtil.StrCmp(Gx_mode, "UPD") == 0 )
         {
            ...
            AV8ApplicationPermission.gxTpr_Description = AV9Dsc;
            AV8ApplicationPermission.gxTpr_Accesstype = AV15AccessType;
            AV6isOK = AV5GAMApplication.updatepermission(AV8ApplicationPermission, out  AV11Errors);
            AssignAttri("", false, "AV6isOK", AV6isOK);
         }
         else if ( StringUtil.StrCmp(Gx_mode, "DLT") == 0 )
         {
            AV6isOK = AV5GAMApplication.deletepermission(AV8ApplicationPermission, out  AV11Errors);
            AssignAttri("", false, "AV6isOK", AV6isOK);
         }
         if ( AV6isOK )
         {
            context.CommitDataStores("gamapppermissionentry",pr_default);
            context.setWebReturnParms(new Object[] {(string)Gx_mode,(long)AV7ApplicationId,(string)AV12GUID});
            context.setWebReturnParmsMetadata(new Object[] {"Gx_mode","AV7ApplicationId","AV12GUID"});
         ...
         {
            AV23GXV2 = 1;
            while ( AV23GXV2 <= AV11Errors.Count )
            {
               AV10Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV11Errors.Item(AV23GXV2));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112115472750", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamapppermissionentry.js", "?2024112115472751", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_tableattributes_Title = context.GetMessage( "WWP_GAM_Permission", "");
         ...
         Form.Caption = context.GetMessage( "WWP_GAM_Permission", "");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E12902","iparms":[{"av":"AV7ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9","hsh":true},{"av":"AV12GUID","fld":"vGUID","hsh":true},{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV14Name","fld":"vNAME"},{"av":"AV9Dsc","fld":"vDSC"},{"av":"cmbavAccesstype"},{"av":"AV15AccessType","fld":"vACCESSTYPE"},{"av":"AV6isOK","fld":"vISOK"}]""");
      ...
      public override void initialize( )
      {
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.gamapppermissionentry__datastore1(),
            new Object[][] {
            }
         );
   ...
   public class gamapppermissionentry__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
