...
namespace GeneXus.Programs {
   public class trn_productserviceww : GXDataArea
   {
      ...
      protected void WB5A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(47), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_ProductServiceWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsubscriptions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(47), 2, 0)+","+"null"+");", "", bttBtnsubscriptions_Jsonclick, 0, "Subscriptions", "", StyleString, ClassString, bttBtnsubscriptions_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_ProductServiceWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF5A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV79Trn_productservicewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV79Trn_productservicewwds_1_filterfulltext), "%", "");
            lV79Trn_productservicewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV79Trn_productservicewwds_1_filterfulltext), "%", "");
            lV79Trn_productservicewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV79Trn_productservicewwds_1_filterfulltext), "%", "");
            lV79Trn_productservicewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV79Trn_productservicewwds_1_filterfulltext), "%", "");
            lV79Trn_productservicewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV79Trn_productservicewwds_1_filterfulltext), "%", "");
            ...
            /* Using cursor H005A3 */
            pr_default.execute(1, new Object[] {AV77OrganisationId, lV79Trn_productservicewwds_1_filterfulltext, lV79Trn_productservicewwds_1_filterfulltext, lV79Trn_productservicewwds_1_filterfulltext, lV79Trn_productservicewwds_1_filterfulltext, lV79Trn_productservicewwds_1_filterfulltext, lV79Trn_productservicewwds_1_filterfulltext, lV80Trn_productservicewwds_2_tfproductservicename, AV81Trn_productservicewwds_3_tfproductservicename_sel, lV82Trn_productservicewwds_4_tfproductservicetilename, AV83Trn_productservicewwds_5_tfproductservicetilename_sel, AV61LocationId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_47_idx = 1;
            sGXsfl_47_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_47_idx), 4, 0), 4, "0");
            SubsflControlProps_472( ) ;
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV82Trn_productservicewwds_4_tfproductservicetilename = StringUtil.PadR( StringUtil.RTrim( AV82Trn_productservicewwds_4_tfproductservicetilename), 20, "%");
         /* Using cursor H005A4 */
         pr_default.execute(2, new Object[] {AV77OrganisationId, lV79Trn_productservicewwds_1_filterfulltext, lV79Trn_productservicewwds_1_filterfulltext, lV79Trn_productservicewwds_1_filterfulltext, lV79Trn_productservicewwds_1_filterfulltext, lV79Trn_productservicewwds_1_filterfulltext, lV79Trn_productservicewwds_1_filterfulltext, lV80Trn_productservicewwds_2_tfproductservicename, AV81Trn_productservicewwds_3_tfproductservicename_sel, lV82Trn_productservicewwds_4_tfproductservicetilename, AV83Trn_productservicewwds_5_tfproductservicetilename_sel, AV61LocationId});
         GRID_nRecordCount = H005A4_AGRID_nRecordCount[0];
         pr_default.close(2);
      ...
      protected void STRUP5A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            nGXsfl_47_idx = (int)(Math.Round(context.localUtil.CToN( cgiGet( subGrid_Internalname+"_ROW"), ".", ","), 18, MidpointRounding.ToEven));
            sGXsfl_47_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_47_idx), 4, 0), 4, "0");
            SubsflControlProps_472( ) ;
            if ( nGXsfl_47_idx > 0 )
            {
      ...
      protected void S162( )
      {
         ...
         AV45AuxText = ((AV59TFProductServiceClass_Sels.Count==1) ? "["+((string)AV59TFProductServiceClass_Sels.Item(1))+"]" : "multiple values");
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV11GridState,  "TFPRODUCTSERVICECLASS_SEL",  "Class",  !(AV59TFProductServiceClass_Sels.Count==0),  0,  AV59TFProductServiceClass_Sels.ToJSonString(false),  ((StringUtil.StrCmp(AV45AuxText, "")==0) ? "" : StringUtil.StringReplace( StringUtil.StringReplace( StringUtil.StringReplace( AV45AuxText, "[My Living]", "My Living"), "[My Care]", "My Care"), "[My Services]", "My Services")),  false,  "",  "") ;
         ...
         Ddo_grid_Filteredtext_set = "Filtered by WWP";
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "FilteredText_set", Ddo_grid_Filteredtext_set);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198382013", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_productserviceww.js", "?202411198382015", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         lV79Trn_productservicewwds_1_filterfulltext = "";
         ...
         H005A4_AGRID_nRecordCount = new long[1] ;
      ...
      private string lV79Trn_productservicewwds_1_filterfulltext ;
      ...
      private long[] H005A4_AGRID_nRecordCount ;
   ...
   public class trn_productserviceww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV77OrganisationId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.SupplierAgbName, T1.SupplierAgbId, T3.SupplierGenCompanyName, T1.SupplierGenId, T1.ProductServiceGroup, T1.ProductServiceImage_GXI, T1.ProductServiceClass, T1.ProductServiceDescription, T1.ProductServiceTileName, T1.ProductServiceName, T1.OrganisationId, T1.LocationId, T1.ProductServiceId, T1.ProductServiceImage";
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV79Trn_productservicewwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.ProductServiceName like '%' || :lV79Trn_productservicewwds_1_filterfulltext) or ( T1.ProductServiceTileName like '%' || :lV79Trn_productservicewwds_1_filterfulltext) or ( 'select category' like '%' || LOWER(:lV79Trn_productservicewwds_1_filterfulltext) and (char_length(trim(trailing ' ' from T1.ProductServiceClass))=0)) or ( 'my living' like '%' || LOWER(:lV79Trn_productservicewwds_1_filterfulltext) and T1.ProductServiceClass = ( 'My Living')) or ( 'my care' like '%' || LOWER(:lV79Trn_productservicewwds_1_filterfulltext) and T1.ProductServiceClass = ( 'My Care')) or ( 'my services' like '%' || LOWER(:lV79Trn_productservicewwds_1_filterfulltext) and T1.ProductServiceClass = ( 'My Services')))");
         }
         else
         {
            GXv_int9[1] = 1;
         ...
         {
            sOrderString += " ORDER BY T1.ProductServiceName, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceName DESC, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceTileName, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceTileName DESC, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ProductServiceClass, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceClass DESC, T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T1.LocationId, T1.OrganisationId";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 1 :
                     return conditional_H005A3(context, (string)dynConstraints[0] , (GxSimpleCollection<string>)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (int)dynConstraints[7] , (Guid)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (Guid)dynConstraints[11] , (short)dynConstraints[12] , (bool)dynConstraints[13] , (Guid)dynConstraints[14] , (Guid)dynConstraints[15] );
               case 2 :
                     return conditional_H005A4(context, (string)dynConstraints[0] , (GxSimpleCollection<string>)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (int)dynConstraints[7] , (Guid)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (Guid)dynConstraints[11] , (short)dynConstraints[12] , (bool)dynConstraints[13] , (Guid)dynConstraints[14] , (Guid)dynConstraints[15] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV79Trn_productservicewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV79Trn_productservicewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV79Trn_productservicewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV79Trn_productservicewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV79Trn_productservicewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H005A4", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005A4,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
