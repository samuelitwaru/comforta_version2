...
namespace GeneXus.Programs {
   public class GxFullTextSearchReindexer
   {
      public static int Reindex( IGxContext context )
      {
         ...
         trn = obj.getTransaction();
         result = trn.Reindex();
         obj = new SdtTrn_SupplierAgbType(context);
         trn = obj.getTransaction();
         result = trn.Reindex();
         obj = new SdtTrn_SupplierGenType(context);
         trn = obj.getTransaction();
         result = trn.Reindex();
         ...
         trn = obj.getTransaction();
         result = trn.Reindex();
         obj = new SdtTrn_AppNotification(context);
         trn = obj.getTransaction();
         result = trn.Reindex();
         obj = new SdtTrn_ResidentNotification(context);
         trn = obj.getTransaction();
         result = trn.Reindex();
