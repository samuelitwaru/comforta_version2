...
namespace GeneXus.Programs {
   public class gamupdateregisteruser : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vCHECKREQUIREDFIELDSRESULT", AV104CheckRequiredFieldsResult);
         GxWebStd.gx_hidden_field( context, "vIDP_STATE", StringUtil.RTrim( AV18IDP_State));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDP_STATE", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV18IDP_State, "")), context));
      }
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavName_Internalname, AV22Name, StringUtil.RTrim( context.localUtil.Format( AV22Name, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, 0, 0, true, "GeneXusSecurityCommon\\GAMUserIdentification", "start", true, "", "HLP_GAMUpdateRegisterUser.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavEmail_Internalname, AV8EMail, StringUtil.RTrim( context.localUtil.Format( AV8EMail, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,31);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Email", edtavEmail_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavEmail_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, 0, true, "GeneXusSecurityCommon\\GAMEMail", "start", true, "", "HLP_GAMUpdateRegisterUser.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBirthday_Internalname, context.localUtil.Format(AV6Birthday, "99/99/9999"), context.localUtil.Format( AV6Birthday, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'MDY',0,12,'eng',false,0);"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBirthday_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavBirthday_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 0, -1, 0, true, "GeneXusSecurityCommon\\GAMDate", "end", false, "", "HLP_GAMUpdateRegisterUser.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavGender, cmbavGender_Internalname, StringUtil.RTrim( AV17Gender), 1, cmbavGender_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbavGender.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,51);\"", "", true, 0, "HLP_GAMUpdateRegisterUser.htm");
      ...
      protected void E110T2( )
      {
         ...
         AV113User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getuserbykeytocompleteuserdata(out  AV107Errors);
         if ( AV107Errors.Count > 0 )
         {
         ...
         {
            AV107Errors = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getlasterrors();
            /* Execute user subroutine: 'DISPLAYMESSAGES' */
            S112 ();
            if (returnInSub) return;
            AV22Name = AV113User.gxTpr_Name;
            AssignAttri("", false, "AV22Name", AV22Name);
            AV8EMail = AV113User.gxTpr_Email;
            AssignAttri("", false, "AV8EMail", AV8EMail);
            AV9FirstName = AV113User.gxTpr_Firstname;
            AssignAttri("", false, "AV9FirstName", AV9FirstName);
            AV21LastName = AV113User.gxTpr_Lastname;
            AssignAttri("", false, "AV21LastName", AV21LastName);
            AV6Birthday = AV113User.gxTpr_Birthday;
            AssignAttri("", false, "AV6Birthday", context.localUtil.Format(AV6Birthday, "99/99/9999"));
            AV17Gender = AV113User.gxTpr_Gender;
            AssignAttri("", false, "AV17Gender", AV17Gender);
         }
         AV111Repository = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).get();
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         AV104CheckRequiredFieldsResult = true;
         AssignAttri("", false, "AV104CheckRequiredFieldsResult", AV104CheckRequiredFieldsResult);
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV22Name)) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "User name", "", "", "", "", "", "", "", ""),  "error",  edtavName_Internalname,  "true",  ""));
            AV104CheckRequiredFieldsResult = false;
            AssignAttri("", false, "AV104CheckRequiredFieldsResult", AV104CheckRequiredFieldsResult);
         }
         if ( ( AV111Repository.gxTpr_Requiredemail ) && String.IsNullOrEmpty(StringUtil.RTrim( AV8EMail)) )
         {
         ...
         if ( ( AV111Repository.gxTpr_Requiredfirstname ) && String.IsNullOrEmpty(StringUtil.RTrim( AV9FirstName)) )
         {
         ...
         if ( ( AV111Repository.gxTpr_Requiredlastname ) && String.IsNullOrEmpty(StringUtil.RTrim( AV21LastName)) )
         {
         ...
         if ( ( AV111Repository.gxTpr_Requiredbirthday ) && (DateTime.MinValue==AV6Birthday) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Birthday", "", "", "", "", "", "", "", ""),  "error",  edtavBirthday_Internalname,  "true",  ""));
            AV104CheckRequiredFieldsResult = false;
            AssignAttri("", false, "AV104CheckRequiredFieldsResult", AV104CheckRequiredFieldsResult);
         }
         if ( ( AV111Repository.gxTpr_Requiredgender ) && String.IsNullOrEmpty(StringUtil.RTrim( AV17Gender)) )
         {
            GX_msglist.addItem(new GeneXus.Programs.wwpbaseobjects.dvmessagegetbasicnotificationmsg(context).executeUdp(  "",  StringUtil.Format( "%1 is required.", "Gender", "", "", "", "", "", "", "", ""),  "error",  cmbavGender_Internalname,  "true",  ""));
            AV104CheckRequiredFieldsResult = false;
            AssignAttri("", false, "AV104CheckRequiredFieldsResult", AV104CheckRequiredFieldsResult);
         }
      }
      ...
      protected void S122( )
      {
         ...
         returnInSub = false;
         if ( AV111Repository.gxTpr_Requiredemail )
         {
         ...
         if ( AV111Repository.gxTpr_Requiredfirstname )
         {
         ...
         if ( AV111Repository.gxTpr_Requiredlastname )
         {
         ...
         if ( AV111Repository.gxTpr_Requiredbirthday )
         {
         ...
         if ( AV111Repository.gxTpr_Requiredgender )
         {
      ...
      protected void E120T2( )
      {
         ...
         S132 ();
         if (returnInSub) return;
         if ( AV104CheckRequiredFieldsResult )
         {
            AV113User = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getuserbykeytocompleteuserdata(out  AV107Errors);
            AV113User.load( AV113User.gxTpr_Guid);
            AV113User.gxTpr_Name = AV22Name;
            AV113User.gxTpr_Email = AV8EMail;
            AV113User.gxTpr_Firstname = AV9FirstName;
            AV113User.gxTpr_Lastname = AV21LastName;
            AV113User.gxTpr_Birthday = AV6Birthday;
            AV113User.gxTpr_Gender = AV17Gender;
            AV19isOK = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).updateuserbykeytocompleteuserdata(AV113User, out  AV107Errors);
            if ( AV19isOK )
            {
               if ( AV107Errors.Count > 0 )
               {
      ...
      protected void S112( )
      {
         ...
         returnInSub = false;
         AV114GXV1 = 1;
         while ( AV114GXV1 <= AV107Errors.Count )
         {
            AV106Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV107Errors.Item(AV114GXV1));
            GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV106Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV106Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719485621", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamupdateregisteruser.js", "?202492719485626", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","""{"handler":"E120T2","iparms":[{"av":"AV104CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT"},{"av":"AV22Name","fld":"vNAME"},{"av":"AV8EMail","fld":"vEMAIL"},{"av":"AV9FirstName","fld":"vFIRSTNAME"},{"av":"AV21LastName","fld":"vLASTNAME"},{"av":"AV6Birthday","fld":"vBIRTHDAY"},{"av":"cmbavGender"},{"av":"AV17Gender","fld":"vGENDER"},{"av":"AV18IDP_State","fld":"vIDP_STATE","hsh":true}]""");
         setEventMetadata("ENTER",""","oparms":[{"av":"AV104CheckRequiredFieldsResult","fld":"vCHECKREQUIREDFIELDSRESULT"}]}""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         AV113User = new GeneXus.Programs.genexussecurity.SdtGAMUser(context);
         AV107Errors = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError>( context, "GeneXus.Programs.genexussecurity.SdtGAMError", "GeneXus.Programs");
         AV111Repository = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context);
         AV27URL = "";
         AV106Error = new GeneXus.Programs.genexussecurity.SdtGAMError(context);
      ...
      private bool AV104CheckRequiredFieldsResult ;
      private bool wbLoad ;
      private bool Rfr0gs ;
      private bool wbErr ;
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMUser AV113User ;
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV107Errors ;
      private GeneXus.Programs.genexussecurity.SdtGAMRepository AV111Repository ;
      private GeneXus.Programs.genexussecurity.SdtGAMError AV106Error ;
