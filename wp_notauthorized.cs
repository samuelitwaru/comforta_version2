...
namespace GeneXus.Programs {
   public class wp_notauthorized : GXDataArea
   {
      public wp_notauthorized( )
      {
      ...
      public wp_notauthorized( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_notauthorized.aspx") +"\">") ;
      ...
      {
         return formatLink("wp_notauthorized.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WP_NotAuthorized" ;
      }
      ...
      protected void WB3D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table1_15_3D2( true) ;
         }
         else
         {
            wb_table1_15_3D2( false) ;
         }
         return  ;
      }

      protected void wb_table1_15_3D2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            wb_table2_24_3D2( true) ;
         }
         else
         {
            wb_table2_24_3D2( false) ;
         }
         return  ;
      }

      protected void wb_table2_24_3D2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table3_33_3D2( true) ;
         }
         else
         {
            wb_table3_33_3D2( false) ;
         }
         return  ;
      }

      protected void wb_table3_33_3D2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            wb_table4_42_3D2( true) ;
         }
         else
         {
            wb_table4_42_3D2( false) ;
         }
         return  ;
      }

      protected void wb_table4_42_3D2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 CellWizardActions", "Center", "top", "", "", "div");
            /* Div Control */
      ...
      protected void E113D2( )
      {
         ...
         tblTable2_Height = 10;
         AssignProp("", false, tblTable2_Internalname, "Height", StringUtil.LTrimStr( (decimal)(tblTable2_Height), 9, 0), true);
         tblTable1_Height = 50;
         ...
         {
            this.executeExternalObjectMethod("", false, "gx.core.ds", "setOption", new Object[] {(string)"base-color",AV9SDT_OrganisationSetting.gxTpr_Organisationsettingbasecolor}, false);
         }
      }
      ...
      protected void wb_table4_42_3D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            sStyleString += " height: " + StringUtil.LTrimStr( (decimal)(tblTable3_Height), 10, 0) + "px" + ";";
            GxWebStd.gx_table_start( context, tblTable3_Internalname, tblTable3_Internalname, "", "Table", 0, "", "", 1, 2, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock5_Internalname, " ", "", "", lblTextblock5_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WP_NotAuthorized.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_42_3D2e( true) ;
         }
         else
         {
            wb_table4_42_3D2e( false) ;
         }
      }

      protected void wb_table3_33_3D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            sStyleString += " height: " + StringUtil.LTrimStr( (decimal)(tblTable2_Height), 10, 0) + "px" + ";";
            GxWebStd.gx_table_start( context, tblTable2_Internalname, tblTable2_Internalname, "", "Table", 0, "", "", 1, 2, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, " ", "", "", lblTextblock4_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WP_NotAuthorized.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_33_3D2e( true) ;
         }
         else
         {
            wb_table3_33_3D2e( false) ;
         }
      }

      protected void wb_table2_24_3D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            sStyleString += " height: " + StringUtil.LTrimStr( (decimal)(tblTable1_Height), 10, 0) + "px" + ";";
            GxWebStd.gx_table_start( context, tblTable1_Internalname, tblTable1_Internalname, "", "Table", 0, "", "", 1, 1, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, " ", "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WP_NotAuthorized.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_24_3D2e( true) ;
         }
         else
         {
            wb_table2_24_3D2e( false) ;
         }
      }

      protected void wb_table1_15_3D2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            sStyleString += " height: " + StringUtil.LTrimStr( (decimal)(tblTable0_Height), 10, 0) + "px" + ";";
            GxWebStd.gx_table_start( context, tblTable0_Internalname, tblTable0_Internalname, "", "Table", 0, "", "", 1, 2, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock6_Internalname, " ", "", "", lblTextblock6_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_WP_NotAuthorized.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_15_3D2e( true) ;
         }
         else
         {
            wb_table1_15_3D2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102518432021", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_notauthorized.js", "?2024102518432023", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         tblTable0_Internalname = "TABLE0";
         lblHourglass_Internalname = "HOURGLASS";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOLOGIN'","""{"handler":"E123D2","iparms":[]}""");
         setEventMetadata("'DORETURN'","""{"handler":"E133D2","iparms":[]}""");
         return  ;
      }
      ...
      private string lblHourglass_Internalname ;
      private string lblHourglass_Jsonclick ;
      ...
      private string tblTable0_Internalname ;
