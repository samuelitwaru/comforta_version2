...
namespace GeneXus.Programs {
   public class gamwweventsubscriptions : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV50ColumnsSelector, AV68Pgmname, AV63IsAuthorized_Display, AV65IsAuthorized_Update, AV66IsAuthorized_Delete, AV29IsAuthorized_Description, AV67IsAuthorized_Insert) ;
      ...
      protected void WB9G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_21_9G2( true) ;
         }
         else
         {
            wb_table1_21_9G2( false) ;
         }
         return  ;
      }

      protected void wb_table1_21_9G2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      private void E179G2( )
      {
         ...
         while ( AV69GXV1 <= AV23GAMEventSubscriptions.Count )
         {
            ...
            if ( AV63IsAuthorized_Display )
            {
               ...
               edtavDisplay_Link = formatLink("gameventsubscriptionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            ...
            if ( AV65IsAuthorized_Update )
            {
               ...
               edtavUpdate_Link = formatLink("gameventsubscriptionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            ...
            if ( AV66IsAuthorized_Delete )
            {
               ...
               edtavDelete_Link = formatLink("gameventsubscriptionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
      ...
      protected void E139G2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "GAMWWEventSubscriptionsColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV38ColumnsSelectorXML)) ? "" : AV50ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void S112( )
      {
         ...
         {
            AV36GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV68Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S132( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV68Pgmname+"GridState",  AV36GridState.ToXml(false, true, "", "")) ;
      }
      ...
      protected void wb_table1_21_9G2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_21_9G2e( true) ;
         }
         else
         {
            wb_table1_21_9G2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112115492034", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwweventsubscriptions.js", "?2024112115492039", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV50ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV68Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV63IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV65IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV66IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV29IsAuthorized_Description","fld":"vISAUTHORIZED_DESCRIPTION","hsh":true},{"av":"AV67IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV50ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtavDescription_Visible","ctrl":"vDESCRIPTION","prop":"Visible"},{"av":"cmbavStatus"},{"av":"cmbavEvent"},{"av":"edtavFilename_Visible","ctrl":"vFILENAME","prop":"Visible"},{"av":"edtavClassname_Visible","ctrl":"vCLASSNAME","prop":"Visible"},{"av":"edtavMethodname_Visible","ctrl":"vMETHODNAME","prop":"Visible"},{"av":"AV57GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV61GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV63IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV65IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV66IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV67IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E119G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV50ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV68Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV63IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV65IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV66IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV29IsAuthorized_Description","fld":"vISAUTHORIZED_DESCRIPTION","hsh":true},{"av":"AV67IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E129G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV50ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV68Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV63IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV65IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV66IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV29IsAuthorized_Description","fld":"vISAUTHORIZED_DESCRIPTION","hsh":true},{"av":"AV67IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E179G2","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV63IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV65IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV66IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV29IsAuthorized_Description","fld":"vISAUTHORIZED_DESCRIPTION","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV58GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV14Id","fld":"vID","hsh":true},{"av":"AV8Description","fld":"vDESCRIPTION","hsh":true},{"av":"cmbavStatus"},{"av":"AV16Status","fld":"vSTATUS"},{"av":"cmbavEvent"},{"av":"AV10Event","fld":"vEVENT"},{"av":"AV13FileName","fld":"vFILENAME"},{"av":"AV7ClassName","fld":"vCLASSNAME"},{"av":"AV15MethodName","fld":"vMETHODNAME"},{"av":"AV62Display","fld":"vDISPLAY"},{"av":"edtavDisplay_Link","ctrl":"vDISPLAY","prop":"Link"},{"av":"AV64Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV5Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"AV24Subscribe","fld":"vSUBSCRIBE"},{"av":"edtavDescription_Link","ctrl":"vDESCRIPTION","prop":"Link"},{"av":"edtavSubscribe_Tooltiptext","ctrl":"vSUBSCRIBE","prop":"Tooltiptext"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E139G2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV50ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV68Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV63IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV65IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV66IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV29IsAuthorized_Description","fld":"vISAUTHORIZED_DESCRIPTION","hsh":true},{"av":"AV67IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
      ...
      public override void initialize( )
      {
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.gamwweventsubscriptions__datastore1(),
            new Object[][] {
            }
         );
   ...
   public class gamwweventsubscriptions__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
