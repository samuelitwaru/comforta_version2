...
namespace GeneXus.Programs {
   public class trn_tileww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         ajax_req_read_hidden_sdt(GetNextPar( ), AV23TFTrn_TileWidth_Sels);
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV15FilterFullText, AV19ManageFiltersExecutionStep, AV54Pgmname, AV20TFTrn_TileName, AV21TFTrn_TileName_Sel, AV23TFTrn_TileWidth_Sels, AV25TFTrn_TileColor_Sels, AV26TFTrn_TileBGImageUrl, AV27TFTrn_TileBGImageUrl_Sel, AV28TFProductServiceName, AV29TFProductServiceName_Sel, AV30TFProductServiceDescription, AV31TFProductServiceDescription_Sel, AV51TFSG_ToPageName, AV52TFSG_ToPageName_Sel, AV45IsAuthorized_Display, AV47IsAuthorized_Update, AV49IsAuthorized_Delete, AV41IsAuthorized_Trn_TileName, AV42IsAuthorized_ProductServiceName, AV53IsAuthorized_SG_ToPageName, AV50IsAuthorized_Insert) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vTFTRN_TILEWIDTH_SELS", AV23TFTrn_TileWidth_Sels);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vTFTRN_TILEWIDTH_SELS", AV23TFTrn_TileWidth_Sels);
         }
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vTFTRN_TILEWIDTH_SELSJSON", AV22TFTrn_TileWidth_SelsJson);
      ...
      protected void WB5Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_TileWW.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsubscriptions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "", bttBtnsubscriptions_Jsonclick, 0, "Subscriptions", "", StyleString, ClassString, bttBtnsubscriptions_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_TileWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       GxSimpleCollection<short> AV23TFTrn_TileWidth_Sels ,
      ...
      protected void RF5Z2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 A268Trn_TileWidth ,
                                                 AV58Trn_tilewwds_4_tftrn_tilewidth_sels ,
                                                 A270Trn_TileColor ,
                                                 AV59Trn_tilewwds_5_tftrn_tilecolor_sels ,
                                                 AV55Trn_tilewwds_1_filterfulltext ,
                                                 AV57Trn_tilewwds_3_tftrn_tilename_sel ,
                                                 AV56Trn_tilewwds_2_tftrn_tilename ,
                                                 AV58Trn_tilewwds_4_tftrn_tilewidth_sels.Count ,
                                                 AV59Trn_tilewwds_5_tftrn_tilecolor_sels.Count ,
                                                 AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel ,
                                                 AV60Trn_tilewwds_6_tftrn_tilebgimageurl ,
                                                 AV63Trn_tilewwds_9_tfproductservicename_sel ,
                                                 AV62Trn_tilewwds_8_tfproductservicename ,
                                                 AV65Trn_tilewwds_11_tfproductservicedescription_sel ,
                                                 AV64Trn_tilewwds_10_tfproductservicedescription ,
                                                 AV67Trn_tilewwds_13_tfsg_topagename_sel ,
                                                 AV66Trn_tilewwds_12_tfsg_topagename ,
                                                 A265Trn_TileName ,
                                                 ...
                                                 AV14OrderedDsc } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.INT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.BOOLEAN
                                                 }
            });
            lV55Trn_tilewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV55Trn_tilewwds_1_filterfulltext), "%", "");
            lV55Trn_tilewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV55Trn_tilewwds_1_filterfulltext), "%", "");
            lV55Trn_tilewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV55Trn_tilewwds_1_filterfulltext), "%", "");
            lV55Trn_tilewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV55Trn_tilewwds_1_filterfulltext), "%", "");
            lV55Trn_tilewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV55Trn_tilewwds_1_filterfulltext), "%", "");
            ...
            lV55Trn_tilewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV55Trn_tilewwds_1_filterfulltext), "%", "");
            lV55Trn_tilewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV55Trn_tilewwds_1_filterfulltext), "%", "");
            lV56Trn_tilewwds_2_tftrn_tilename = StringUtil.Concat( StringUtil.RTrim( AV56Trn_tilewwds_2_tftrn_tilename), "%", "");
            lV60Trn_tilewwds_6_tftrn_tilebgimageurl = StringUtil.Concat( StringUtil.RTrim( AV60Trn_tilewwds_6_tftrn_tilebgimageurl), "%", "");
            lV62Trn_tilewwds_8_tfproductservicename = StringUtil.Concat( StringUtil.RTrim( AV62Trn_tilewwds_8_tfproductservicename), "%", "");
            lV64Trn_tilewwds_10_tfproductservicedescription = StringUtil.Concat( StringUtil.RTrim( AV64Trn_tilewwds_10_tfproductservicedescription), "%", "");
            lV66Trn_tilewwds_12_tfsg_topagename = StringUtil.Concat( StringUtil.RTrim( AV66Trn_tilewwds_12_tfsg_topagename), "%", "");
            /* Using cursor H005Z2 */
            pr_default.execute(0, new Object[] {lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV56Trn_tilewwds_2_tftrn_tilename, AV57Trn_tilewwds_3_tftrn_tilename_sel, lV60Trn_tilewwds_6_tftrn_tilebgimageurl, AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel, lV62Trn_tilewwds_8_tfproductservicename, AV63Trn_tilewwds_9_tfproductservicename_sel, lV64Trn_tilewwds_10_tfproductservicedescription, AV65Trn_tilewwds_11_tfproductservicedescription_sel, lV66Trn_tilewwds_12_tfsg_topagename, AV67Trn_tilewwds_13_tfsg_topagename_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               ...
               A268Trn_TileWidth = H005Z2_A268Trn_TileWidth[0];
      ...
      {
         AV55Trn_tilewwds_1_filterfulltext = AV15FilterFullText;
         AV56Trn_tilewwds_2_tftrn_tilename = AV20TFTrn_TileName;
         AV57Trn_tilewwds_3_tftrn_tilename_sel = AV21TFTrn_TileName_Sel;
         AV58Trn_tilewwds_4_tftrn_tilewidth_sels = AV23TFTrn_TileWidth_Sels;
         AV59Trn_tilewwds_5_tftrn_tilecolor_sels = AV25TFTrn_TileColor_Sels;
         AV60Trn_tilewwds_6_tftrn_tilebgimageurl = AV26TFTrn_TileBGImageUrl;
         AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel = AV27TFTrn_TileBGImageUrl_Sel;
         AV62Trn_tilewwds_8_tfproductservicename = AV28TFProductServiceName;
         AV63Trn_tilewwds_9_tfproductservicename_sel = AV29TFProductServiceName_Sel;
         AV64Trn_tilewwds_10_tfproductservicedescription = AV30TFProductServiceDescription;
         AV65Trn_tilewwds_11_tfproductservicedescription_sel = AV31TFProductServiceDescription_Sel;
         AV66Trn_tilewwds_12_tfsg_topagename = AV51TFSG_ToPageName;
         AV67Trn_tilewwds_13_tfsg_topagename_sel = AV52TFSG_ToPageName_Sel;
         ...
         lV66Trn_tilewwds_12_tfsg_topagename = StringUtil.Concat( StringUtil.RTrim( AV66Trn_tilewwds_12_tfsg_topagename), "%", "");
         /* Using cursor H005Z3 */
         pr_default.execute(1, new Object[] {lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV55Trn_tilewwds_1_filterfulltext, lV56Trn_tilewwds_2_tftrn_tilename, AV57Trn_tilewwds_3_tftrn_tilename_sel, lV60Trn_tilewwds_6_tftrn_tilebgimageurl, AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel, lV62Trn_tilewwds_8_tfproductservicename, AV63Trn_tilewwds_9_tfproductservicename_sel, lV64Trn_tilewwds_10_tfproductservicedescription, AV65Trn_tilewwds_11_tfproductservicedescription_sel, lV66Trn_tilewwds_12_tfsg_topagename, AV67Trn_tilewwds_13_tfsg_topagename_sel});
      ...
      protected void E155Z2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_grid_Activeeventkey, "<#Filter#>") == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "Trn_TileWidth") == 0 )
            {
               AV22TFTrn_TileWidth_SelsJson = Ddo_grid_Selectedvalue_get;
               AssignAttri("", false, "AV22TFTrn_TileWidth_SelsJson", AV22TFTrn_TileWidth_SelsJson);
               AV23TFTrn_TileWidth_Sels.FromJSonString(StringUtil.StringReplace( AV22TFTrn_TileWidth_SelsJson, "\"", ""), null);
            }
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV23TFTrn_TileWidth_Sels", AV23TFTrn_TileWidth_Sels);
      }
      ...
      protected void E115Z2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_TileWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV54Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV54Pgmname+"GridState",  AV18ManageFiltersXml) ;
      ...
      protected void S172( )
      {
         ...
         AssignAttri("", false, "AV21TFTrn_TileName_Sel", AV21TFTrn_TileName_Sel);
         AV23TFTrn_TileWidth_Sels = (GxSimpleCollection<short>)(new GxSimpleCollection<short>());
      ...
      protected void S132( )
      {
         ...
         {
            AV11GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV54Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV16Session.Get(AV54Pgmname+"GridState"), null, "", "");
         }
         AV13OrderedBy = AV11GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV13OrderedBy", StringUtil.LTrimStr( (decimal)(AV13OrderedBy), 4, 0));
         AV14OrderedDsc = AV11GridState.gxTpr_Ordereddsc;
      ...
      protected void S182( )
      {
         ...
         {
            AV12GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV68GXV1));
            ...
            else if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "TFTRN_TILEWIDTH_SEL") == 0 )
            {
               AV22TFTrn_TileWidth_SelsJson = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV22TFTrn_TileWidth_SelsJson", AV22TFTrn_TileWidth_SelsJson);
               AV23TFTrn_TileWidth_Sels.FromJSonString(AV22TFTrn_TileWidth_SelsJson, null);
            }
         ...
         GXt_char5 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  (AV25TFTrn_TileColor_Sels.Count==0),  AV24TFTrn_TileColor_SelsJson, out  GXt_char5) ;
         GXt_char6 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV27TFTrn_TileBGImageUrl_Sel)),  AV27TFTrn_TileBGImageUrl_Sel, out  GXt_char6) ;
         GXt_char7 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV29TFProductServiceName_Sel)),  AV29TFProductServiceName_Sel, out  GXt_char7) ;
         GXt_char8 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV31TFProductServiceDescription_Sel)),  AV31TFProductServiceDescription_Sel, out  GXt_char8) ;
         GXt_char9 = "";
         ...
         Ddo_grid_Selectedvalue_set = "|"+GXt_char3+"|"+((AV23TFTrn_TileWidth_Sels.Count==0) ? "" : AV22TFTrn_TileWidth_SelsJson)+"|"+GXt_char5+"|"+GXt_char6+"||"+GXt_char7+"|"+GXt_char8+"||"+GXt_char9;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char9 = "";
         ...
         GXt_char8 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV26TFTrn_TileBGImageUrl)),  AV26TFTrn_TileBGImageUrl, out  GXt_char8) ;
         GXt_char7 = "";
         ...
         GXt_char6 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV30TFProductServiceDescription)),  AV30TFProductServiceDescription, out  GXt_char6) ;
         GXt_char5 = "";
      ...
      protected void SubsflControlProps_372( )
      {
         ...
         cmbTrn_TileWidth_Internalname = "TRN_TILEWIDTH_"+sGXsfl_37_idx;
      ...
      protected void SubsflControlProps_fel_372( )
      {
         ...
         cmbTrn_TileWidth_Internalname = "TRN_TILEWIDTH_"+sGXsfl_37_fel_idx;
      ...
      protected void sendrow_372( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "TRN_TILEWIDTH_" + sGXsfl_37_idx;
            ...
            AssignProp("", false, cmbTrn_TileWidth_Internalname, "Values", (string)(cmbTrn_TileWidth.ToJavascriptSource()), !bGXsfl_37_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl37( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Service Name") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Service Description") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Service Image") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Page Id") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Page Name") ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Datalistfixedvalues = "||1:Small,2:Medium,3:Large|||||||";
         Ddo_grid_Allowmultipleselection = "||T|T||||||";
         Ddo_grid_Datalisttype = "|Dynamic|FixedValues|FixedValues|Dynamic||Dynamic|Dynamic||Dynamic";
         ...
         Ddo_grid_Columnids = "0:Trn_TileId|1:Trn_TileName|2:Trn_TileWidth|3:Trn_TileColor|4:Trn_TileBGImageUrl|5:ProductServiceId|6:ProductServiceName|7:ProductServiceDescription|9:SG_ToPageId|10:SG_ToPageName";
      ...
      public override void initialize( )
      {
         ...
         AV20TFTrn_TileName = "";
         AV21TFTrn_TileName_Sel = "";
         AV23TFTrn_TileWidth_Sels = new GxSimpleCollection<short>();
         ...
         AV46Update = "";
         AV48Delete = "";
         AV58Trn_tilewwds_4_tftrn_tilewidth_sels = new GxSimpleCollection<short>();
         AV59Trn_tilewwds_5_tftrn_tilecolor_sels = new GxSimpleCollection<string>();
         lV55Trn_tilewwds_1_filterfulltext = "";
         lV56Trn_tilewwds_2_tftrn_tilename = "";
         lV60Trn_tilewwds_6_tftrn_tilebgimageurl = "";
         lV62Trn_tilewwds_8_tfproductservicename = "";
         lV64Trn_tilewwds_10_tfproductservicedescription = "";
         lV66Trn_tilewwds_12_tfsg_topagename = "";
         AV55Trn_tilewwds_1_filterfulltext = "";
         AV57Trn_tilewwds_3_tftrn_tilename_sel = "";
         AV56Trn_tilewwds_2_tftrn_tilename = "";
         AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel = "";
         ...
         H005Z2_A268Trn_TileWidth = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_tileww__default(),
            new Object[][] {
                new Object[] {
               H005Z2_A330SG_ToPageName, H005Z2_A329SG_ToPageId, H005Z2_A40000ProductServiceImage_GXI, H005Z2_A60ProductServiceDescription, H005Z2_A59ProductServiceName, H005Z2_A58ProductServiceId, H005Z2_n58ProductServiceId, H005Z2_A271Trn_TileBGImageUrl, H005Z2_A270Trn_TileColor, H005Z2_A268Trn_TileWidth,
               H005Z2_A265Trn_TileName, H005Z2_A264Trn_TileId, H005Z2_A61ProductServiceImage
               }
               , new Object[] {
      ...
      private int AV58Trn_tilewwds_4_tftrn_tilewidth_sels_Count ;
      private int AV59Trn_tilewwds_5_tftrn_tilecolor_sels_Count ;
      ...
      private string AV56Trn_tilewwds_2_tftrn_tilename ;
      private string AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel ;
      ...
      private GxSimpleCollection<short> AV23TFTrn_TileWidth_Sels ;
      ...
      private GxSimpleCollection<short> AV58Trn_tilewwds_4_tftrn_tilewidth_sels ;
      private GxSimpleCollection<string> AV59Trn_tilewwds_5_tftrn_tilecolor_sels ;
      ...
      private short[] H005Z2_A268Trn_TileWidth ;
   ...
   public class trn_tileww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H005Z2( IGxContext context ,
                                             ...
                                             GxSimpleCollection<short> AV58Trn_tilewwds_4_tftrn_tilewidth_sels ,
                                             string A270Trn_TileColor ,
                                             GxSimpleCollection<string> AV59Trn_tilewwds_5_tftrn_tilecolor_sels ,
                                             string AV55Trn_tilewwds_1_filterfulltext ,
                                             string AV57Trn_tilewwds_3_tftrn_tilename_sel ,
                                             string AV56Trn_tilewwds_2_tftrn_tilename ,
                                             int AV58Trn_tilewwds_4_tftrn_tilewidth_sels_Count ,
                                             int AV59Trn_tilewwds_5_tftrn_tilecolor_sels_Count ,
                                             string AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel ,
                                             string AV60Trn_tilewwds_6_tftrn_tilebgimageurl ,
                                             string AV63Trn_tilewwds_9_tfproductservicename_sel ,
                                             string AV62Trn_tilewwds_8_tfproductservicename ,
                                             string AV65Trn_tilewwds_11_tfproductservicedescription_sel ,
                                             string AV64Trn_tilewwds_10_tfproductservicedescription ,
                                             string AV67Trn_tilewwds_13_tfsg_topagename_sel ,
                                             string AV66Trn_tilewwds_12_tfsg_topagename ,
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         string scmdbuf;
         short[] GXv_int10 = new short[22];
         Object[] GXv_Object11 = new Object[2];
         string sSelectString;
         string sFromString;
         string sOrderString;
         sSelectString = " T2.Trn_PageName AS SG_ToPageName, T1.SG_ToPageId AS SG_ToPageId, T3.ProductServiceImage_GXI, T3.ProductServiceDescription, T3.ProductServiceName, T1.ProductServiceId, T1.Trn_TileBGImageUrl, T1.Trn_TileColor, T1.Trn_TileWidth, T1.Trn_TileName, T1.Trn_TileId, T3.ProductServiceImage";
         sFromString = " FROM ((Trn_Col T1 INNER JOIN Trn_Page T2 ON T2.Trn_PageId = T1.SG_ToPageId) LEFT JOIN Trn_ProductService T3 ON T3.ProductServiceId = T1.ProductServiceId)";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV55Trn_tilewwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.Trn_TileName like '%' || :lV55Trn_tilewwds_1_filterfulltext) or ( 'small' like '%' || LOWER(:lV55Trn_tilewwds_1_filterfulltext) and T1.Trn_TileWidth = 1) or ( 'medium' like '%' || LOWER(:lV55Trn_tilewwds_1_filterfulltext) and T1.Trn_TileWidth = 2) or ( 'large' like '%' || LOWER(:lV55Trn_tilewwds_1_filterfulltext) and T1.Trn_TileWidth = 3) or ( T1.Trn_TileColor like '%' || :lV55Trn_tilewwds_1_filterfulltext) or ( T1.Trn_TileBGImageUrl like '%' || :lV55Trn_tilewwds_1_filterfulltext) or ( T3.ProductServiceName like '%' || :lV55Trn_tilewwds_1_filterfulltext) or ( T3.ProductServiceDescription like '%' || :lV55Trn_tilewwds_1_filterfulltext) or ( T2.Trn_PageName like '%' || :lV55Trn_tilewwds_1_filterfulltext))");
         }
         else
         {
            GXv_int10[0] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV57Trn_tilewwds_3_tftrn_tilename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV56Trn_tilewwds_2_tftrn_tilename)) ) )
         {
            AddWhere(sWhereString, "(T1.Trn_TileName like :lV56Trn_tilewwds_2_tftrn_tilename)");
         }
         else
         {
            GXv_int10[9] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV57Trn_tilewwds_3_tftrn_tilename_sel)) && ! ( StringUtil.StrCmp(AV57Trn_tilewwds_3_tftrn_tilename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.Trn_TileName = ( :AV57Trn_tilewwds_3_tftrn_tilename_sel))");
         }
         else
         {
            GXv_int10[10] = 1;
         }
         if ( StringUtil.StrCmp(AV57Trn_tilewwds_3_tftrn_tilename_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.Trn_TileName))=0))");
         }
         if ( AV58Trn_tilewwds_4_tftrn_tilewidth_sels_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV58Trn_tilewwds_4_tftrn_tilewidth_sels, "T1.Trn_TileWidth IN (", ")")+")");
         }
         if ( AV59Trn_tilewwds_5_tftrn_tilecolor_sels_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV59Trn_tilewwds_5_tftrn_tilecolor_sels, "T1.Trn_TileColor IN (", ")")+")");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV60Trn_tilewwds_6_tftrn_tilebgimageurl)) ) )
         {
            AddWhere(sWhereString, "(T1.Trn_TileBGImageUrl like :lV60Trn_tilewwds_6_tftrn_tilebgimageurl)");
         }
         else
         {
            GXv_int10[11] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel)) && ! ( StringUtil.StrCmp(AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.Trn_TileBGImageUrl = ( :AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel))");
         }
         else
         {
            GXv_int10[12] = 1;
         }
         if ( StringUtil.StrCmp(AV61Trn_tilewwds_7_tftrn_tilebgimageurl_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.Trn_TileBGImageUrl))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV63Trn_tilewwds_9_tfproductservicename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV62Trn_tilewwds_8_tfproductservicename)) ) )
         {
            AddWhere(sWhereString, "(T3.ProductServiceName like :lV62Trn_tilewwds_8_tfproductservicename)");
         }
         else
         {
            GXv_int10[13] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV63Trn_tilewwds_9_tfproductservicename_sel)) && ! ( StringUtil.StrCmp(AV63Trn_tilewwds_9_tfproductservicename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T3.ProductServiceName = ( :AV63Trn_tilewwds_9_tfproductservicename_sel))");
         }
         else
         {
            GXv_int10[14] = 1;
         }
         if ( StringUtil.StrCmp(AV63Trn_tilewwds_9_tfproductservicename_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "(T3.ProductServiceName IS NULL or (char_length(trim(trailing ' ' from T3.ProductServiceName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV65Trn_tilewwds_11_tfproductservicedescription_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV64Trn_tilewwds_10_tfproductservicedescription)) ) )
         {
            AddWhere(sWhereString, "(T3.ProductServiceDescription like :lV64Trn_tilewwds_10_tfproductservicedescription)");
         }
         else
         {
            GXv_int10[15] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV65Trn_tilewwds_11_tfproductservicedescription_sel)) && ! ( StringUtil.StrCmp(AV65Trn_tilewwds_11_tfproductservicedescription_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T3.ProductServiceDescription = ( :AV65Trn_tilewwds_11_tfproductservicedescription_sel))");
         }
         else
         {
            GXv_int10[16] = 1;
         }
         if ( StringUtil.StrCmp(AV65Trn_tilewwds_11_tfproductservicedescription_sel, "<#Empty#>") == 0 )
         {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV67Trn_tilewwds_13_tfsg_topagename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV66Trn_tilewwds_12_tfsg_topagename)) ) )
         {
            AddWhere(sWhereString, "(T2.Trn_PageName like :lV66Trn_tilewwds_12_tfsg_topagename)");
         }
         else
         {
            GXv_int10[17] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV67Trn_tilewwds_13_tfsg_topagename_sel)) && ! ( StringUtil.StrCmp(AV67Trn_tilewwds_13_tfsg_topagename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.Trn_PageName = ( :AV67Trn_tilewwds_13_tfsg_topagename_sel))");
         }
         else
         {
            GXv_int10[18] = 1;
         }
         if ( StringUtil.StrCmp(AV67Trn_tilewwds_13_tfsg_topagename_sel, "<#Empty#>") == 0 )
         {
         ...
         {
            sOrderString += " ORDER BY T1.Trn_TileId DESC";
         }
         else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY T1.Trn_TileWidth, T1.Trn_TileId";
         }
         else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.Trn_TileWidth DESC, T1.Trn_TileId";
         }
         ...
         {
            sOrderString += " ORDER BY T1.ProductServiceId, T1.Trn_TileId";
         }
         else if ( ( AV13OrderedBy == 6 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ProductServiceId DESC, T1.Trn_TileId";
         }
         ...
         {
            sOrderString += " ORDER BY T3.ProductServiceDescription, T1.Trn_TileId";
         }
         else if ( ( AV13OrderedBy == 8 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY T3.ProductServiceDescription DESC, T1.Trn_TileId";
         }
                                             ...
                                             bool AV14OrderedDsc )
      {
         System.Text.StringBuilder sWhereString = new System.Text.StringBuilder();
         string scmdbuf;
         short[] GXv_int12 = new short[19];
         Object[] GXv_Object13 = new Object[2];
         scmdbuf = "SELECT COUNT(*) FROM ((Trn_Col T1 INNER JOIN Trn_Page T3 ON T3.Trn_PageId = T1.SG_ToPageId) LEFT JOIN Trn_ProductService T2 ON T2.ProductServiceId = T1.ProductServiceId)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV55Trn_tilewwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.Trn_TileName like '%' || :lV55Trn_tilewwds_1_filterfulltext) or ( 'small' like '%' || LOWER(:lV55Trn_tilewwds_1_filterfulltext) and T1.Trn_TileWidth = 1) or ( 'medium' like '%' || LOWER(:lV55Trn_tilewwds_1_filterfulltext) and T1.Trn_TileWidth = 2) or ( 'large' like '%' || LOWER(:lV55Trn_tilewwds_1_filterfulltext) and T1.Trn_TileWidth = 3) or ( T1.Trn_TileColor like '%' || :lV55Trn_tilewwds_1_filterfulltext) or ( T1.Trn_TileBGImageUrl like '%' || :lV55Trn_tilewwds_1_filterfulltext) or ( T2.ProductServiceName like '%' || :lV55Trn_tilewwds_1_filterfulltext) or ( T2.ProductServiceDescription like '%' || :lV55Trn_tilewwds_1_filterfulltext) or ( T3.Trn_PageName like '%' || :lV55Trn_tilewwds_1_filterfulltext))");
         }
         else
         {
            GXv_int12[0] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV63Trn_tilewwds_9_tfproductservicename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV62Trn_tilewwds_8_tfproductservicename)) ) )
         {
            AddWhere(sWhereString, "(T2.ProductServiceName like :lV62Trn_tilewwds_8_tfproductservicename)");
         }
         else
         {
            GXv_int12[13] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV63Trn_tilewwds_9_tfproductservicename_sel)) && ! ( StringUtil.StrCmp(AV63Trn_tilewwds_9_tfproductservicename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.ProductServiceName = ( :AV63Trn_tilewwds_9_tfproductservicename_sel))");
         }
         else
         {
            GXv_int12[14] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV65Trn_tilewwds_11_tfproductservicedescription_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV64Trn_tilewwds_10_tfproductservicedescription)) ) )
         {
            AddWhere(sWhereString, "(T2.ProductServiceDescription like :lV64Trn_tilewwds_10_tfproductservicedescription)");
         }
         else
         {
            GXv_int12[15] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV65Trn_tilewwds_11_tfproductservicedescription_sel)) && ! ( StringUtil.StrCmp(AV65Trn_tilewwds_11_tfproductservicedescription_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.ProductServiceDescription = ( :AV65Trn_tilewwds_11_tfproductservicedescription_sel))");
         }
         else
         {
            GXv_int12[16] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV67Trn_tilewwds_13_tfsg_topagename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV66Trn_tilewwds_12_tfsg_topagename)) ) )
         {
            AddWhere(sWhereString, "(T3.Trn_PageName like :lV66Trn_tilewwds_12_tfsg_topagename)");
         }
         else
         {
            GXv_int12[17] = 1;
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV67Trn_tilewwds_13_tfsg_topagename_sel)) && ! ( StringUtil.StrCmp(AV67Trn_tilewwds_13_tfsg_topagename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T3.Trn_PageName = ( :AV67Trn_tilewwds_13_tfsg_topagename_sel))");
         }
         else
         {
            GXv_int12[18] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005Z2(context, (short)dynConstraints[0] , (GxSimpleCollection<short>)dynConstraints[1] , (string)dynConstraints[2] , (GxSimpleCollection<string>)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (int)dynConstraints[7] , (int)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (string)dynConstraints[17] , (string)dynConstraints[18] , (string)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (short)dynConstraints[22] , (bool)dynConstraints[23] );
               case 1 :
                     return conditional_H005Z3(context, (short)dynConstraints[0] , (GxSimpleCollection<short>)dynConstraints[1] , (string)dynConstraints[2] , (GxSimpleCollection<string>)dynConstraints[3] , (string)dynConstraints[4] , (string)dynConstraints[5] , (string)dynConstraints[6] , (int)dynConstraints[7] , (int)dynConstraints[8] , (string)dynConstraints[9] , (string)dynConstraints[10] , (string)dynConstraints[11] , (string)dynConstraints[12] , (string)dynConstraints[13] , (string)dynConstraints[14] , (string)dynConstraints[15] , (string)dynConstraints[16] , (string)dynConstraints[17] , (string)dynConstraints[18] , (string)dynConstraints[19] , (string)dynConstraints[20] , (string)dynConstraints[21] , (short)dynConstraints[22] , (bool)dynConstraints[23] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV55Trn_tilewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV55Trn_tilewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV55Trn_tilewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV55Trn_tilewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV55Trn_tilewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          ...
          new ParDef("lV55Trn_tilewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV55Trn_tilewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV56Trn_tilewwds_2_tftrn_tilename",GXType.VarChar,100,0) ,
          new ParDef("AV57Trn_tilewwds_3_tftrn_tilename_sel",GXType.VarChar,100,0) ,
          new ParDef("lV60Trn_tilewwds_6_tftrn_tilebgimageurl",GXType.VarChar,1000,0) ,
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[12])[0] = rslt.getMultimediaFile(12, rslt.getVarchar(3));
                return;
             case 1 :
