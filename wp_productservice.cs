...
namespace GeneXus.Programs {
   public class wp_productservice : GXDataArea
   {
      public wp_productservice( )
      {
      ...
      public wp_productservice( IGxContext context )
      {
      ...
      {
         get {
            return "wp_productservice_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wp_productservice.aspx"+UrlEncode(StringUtil.RTrim(AV10PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV11CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV9GoingBack));
      ...
      {
         return "WP_ProductService" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "WP_Product Service", "") ;
      }
      ...
      protected void WB6Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWizardstepdescription_Internalname, lblWizardstepdescription_Caption, "", "", lblWizardstepdescription_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "WizardStepDescription", 0, "", 1, 1, 0, 0, "HLP_WP_ProductService.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
      ...
      protected void START6Z2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "WP_Product Service", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA6Z2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wp_productservice.aspx")), "wp_productservice.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wp_productservice.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void E116Z2( )
      {
         ...
         AV14WizardStep.gxTpr_Title = context.GetMessage( "Product/Service", "");
         AV14WizardStep.gxTpr_Description = " ";
         AV13WizardSteps.Add(AV14WizardStep, 0);
         AV14WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV14WizardStep.gxTpr_Code = "Step2";
         AV14WizardStep.gxTpr_Title = context.GetMessage( "Call To Action", "");
         AV14WizardStep.gxTpr_Description = " ";
         AV13WizardSteps.Add(AV14WizardStep, 0);
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step1") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WP_ProductServiceStep1")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wp_productservicestep1", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WP_ProductServiceStep1";
               WebComp_Wizardstepwc_Component = "WP_ProductServiceStep1";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
               WebComp_Wizardstepwc.componentprepare(new Object[] {(string)"W0018",(string)"",(string)AV16Pgmname+"_Data",(string)AV10PreviousStep,(bool)AV9GoingBack});
         ...
         else if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step2") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WP_ProductServiceStep2")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wp_productservicestep2", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WP_ProductServiceStep2";
               WebComp_Wizardstepwc_Component = "WP_ProductServiceStep2";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102518441163", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_productservice.js", "?2024102518441163", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "WP_Product Service", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
