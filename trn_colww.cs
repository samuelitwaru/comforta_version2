...
namespace GeneXus.Programs {
   public class trn_colww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV15FilterFullText, AV19ManageFiltersExecutionStep, AV38Pgmname, AV20TFTrn_ColName, AV21TFTrn_ColName_Sel, AV31IsAuthorized_Display, AV33IsAuthorized_Update, AV35IsAuthorized_Delete, AV29IsAuthorized_Trn_ColName, AV36IsAuthorized_Insert) ;
      ...
      protected void RF5U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV39Trn_colwwds_1_filterfulltext ,
                                                 AV41Trn_colwwds_3_tftrn_colname_sel ,
                                                 AV40Trn_colwwds_2_tftrn_colname ,
                                                 A327Trn_ColName ,
                                                 AV13OrderedBy ,
                                                 AV14OrderedDsc } ,
                                                 new int[]{
            ...
            lV39Trn_colwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV39Trn_colwwds_1_filterfulltext), "%", "");
            lV40Trn_colwwds_2_tftrn_colname = StringUtil.Concat( StringUtil.RTrim( AV40Trn_colwwds_2_tftrn_colname), "%", "");
            /* Using cursor H005U2 */
            pr_default.execute(0, new Object[] {lV39Trn_colwwds_1_filterfulltext, lV40Trn_colwwds_2_tftrn_colname, AV41Trn_colwwds_3_tftrn_colname_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
      ...
      {
         AV39Trn_colwwds_1_filterfulltext = AV15FilterFullText;
         AV40Trn_colwwds_2_tftrn_colname = AV20TFTrn_ColName;
         AV41Trn_colwwds_3_tftrn_colname_sel = AV21TFTrn_ColName_Sel;
         ...
         lV40Trn_colwwds_2_tftrn_colname = StringUtil.Concat( StringUtil.RTrim( AV40Trn_colwwds_2_tftrn_colname), "%", "");
         /* Using cursor H005U3 */
         pr_default.execute(1, new Object[] {lV39Trn_colwwds_1_filterfulltext, lV40Trn_colwwds_2_tftrn_colname, AV41Trn_colwwds_3_tftrn_colname_sel});
      ...
      protected void E115U2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_ColWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV38Pgmname+"GridState"));
      ...
      protected void E145U2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0052",(string)"",(string)"Trn_Col",(short)1,(string)"",(string)""});
      ...
      protected void S192( )
      {
         ...
         if ( AV31IsAuthorized_Display )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "trn_colview.aspx"+UrlEncode(A328Trn_ColId.ToString()) + "," + UrlEncode(StringUtil.RTrim(""));
            CallWebObject(formatLink("trn_colview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411411421964", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_colww.js", "?202411411421966", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E195U2","iparms":[{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV29IsAuthorized_Trn_ColName","fld":"vISAUTHORIZED_TRN_COLNAME","hsh":true},{"av":"A328Trn_ColId","fld":"TRN_COLID","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV37ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"edtTrn_ColName_Link","ctrl":"TRN_COLNAME","prop":"Link"}]}""");
      ...
      public override void initialize( )
      {
         ...
         A327Trn_ColName = "";
         lV39Trn_colwwds_1_filterfulltext = "";
         lV40Trn_colwwds_2_tftrn_colname = "";
         AV39Trn_colwwds_1_filterfulltext = "";
         AV41Trn_colwwds_3_tftrn_colname_sel = "";
         AV40Trn_colwwds_2_tftrn_colname = "";
      ...
      private string lV39Trn_colwwds_1_filterfulltext ;
      private string lV40Trn_colwwds_2_tftrn_colname ;
      private string AV39Trn_colwwds_1_filterfulltext ;
      private string AV41Trn_colwwds_3_tftrn_colname_sel ;
      private string AV40Trn_colwwds_2_tftrn_colname ;
   ...
   public class trn_colww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H005U2( IGxContext context ,
                                             string AV39Trn_colwwds_1_filterfulltext ,
                                             string AV41Trn_colwwds_3_tftrn_colname_sel ,
                                             string AV40Trn_colwwds_2_tftrn_colname ,
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV39Trn_colwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( Trn_ColName like '%' || :lV39Trn_colwwds_1_filterfulltext))");
         }
         else
         {
            GXv_int5[0] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV41Trn_colwwds_3_tftrn_colname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV40Trn_colwwds_2_tftrn_colname)) ) )
         {
            AddWhere(sWhereString, "(Trn_ColName like :lV40Trn_colwwds_2_tftrn_colname)");
         }
         else
         {
            GXv_int5[1] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV41Trn_colwwds_3_tftrn_colname_sel)) && ! ( StringUtil.StrCmp(AV41Trn_colwwds_3_tftrn_colname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(Trn_ColName = ( :AV41Trn_colwwds_3_tftrn_colname_sel))");
         }
         else
         {
            GXv_int5[2] = 1;
         }
         if ( StringUtil.StrCmp(AV41Trn_colwwds_3_tftrn_colname_sel, "<#Empty#>") == 0 )
         {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV39Trn_colwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV40Trn_colwwds_2_tftrn_colname",GXType.VarChar,100,0) ,
          new ParDef("AV41Trn_colwwds_3_tftrn_colname_sel",GXType.VarChar,100,0) ,
