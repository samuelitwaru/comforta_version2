...
namespace GeneXus.Programs {
   public class trn_rowview : GXDataArea
   {
      public trn_rowview( )
      {
      ...
      public trn_rowview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_Trn_RowId ,
                           string aP1_TabCode )
      {
         this.AV10Trn_RowId = aP0_Trn_RowId;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_rowview.aspx"+UrlEncode(AV10Trn_RowId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_rowview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTRN_ROWID", AV10Trn_RowId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_ROWID", GetSecureSignedToken( "", AV10Trn_RowId, context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "trn_rowview.aspx"+UrlEncode(AV10Trn_RowId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_rowview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      {
         return context.GetMessage( "Trn_Row View", "") ;
      }
      ...
      protected void WB600( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Go to Trn_Row", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_RowView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_rowgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrn_col_title_Internalname, context.GetMessage( "Trn_Col", ""), "", "", lblTrn_col_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_RowView.htm");
            /* Div Control */
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0037"+"", StringUtil.RTrim( WebComp_Trn_colwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void START602( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Row View", ""), 0) ;
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 37 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Trn_colwc_Component) != 0 )
                           {
                              WebComp_Trn_colwc.componentprocess("W0037", "", sEvt);
                           }
                           WebComp_Trn_colwc_Component = OldTrn_colwc;
                        }
                        else if ( nCmpId == 42 )
      ...
      protected void PA602( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_rowview.aspx")), "trn_rowview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_rowview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10Trn_RowId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10Trn_RowId", AV10Trn_RowId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vTRN_ROWID", GetSecureSignedToken( "", AV10Trn_RowId, context));
      ...
      protected void RF602( )
      {
         ...
         {
            /* Using cursor H00602 */
            pr_default.execute(0, new Object[] {AV10Trn_RowId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A319Trn_RowId = H00602_A319Trn_RowId[0];
               /* Execute user event: Load */
               E16602 ();
      ...
      protected void E14602( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_rowww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl9 = 0;
         /* Using cursor H00603 */
         pr_default.execute(1, new Object[] {AV10Trn_RowId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A319Trn_RowId = H00603_A319Trn_RowId[0];
            A320Trn_RowName = H00603_A320Trn_RowName[0];
            AV16GXLvl9 = 1;
            Form.Caption = A320Trn_RowName;
      ...
      protected void E15602( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Row",  StringUtil.Trim( A319Trn_RowId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Row",  2) )
         {
      ...
      protected void E11602( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Trn_Row",(short)2,StringUtil.Trim( A319Trn_RowId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12602( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0042",(string)"",(string)"Trn_Row",StringUtil.Trim( A319Trn_RowId.ToString()),(string)AV14RecordDescription,formatLink("trn_rowview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_RowGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_rowgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_RowGeneral";
            WebComp_Webcomponent_general_Component = "Trn_RowGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10Trn_RowId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV12SelectedTabCode, "Trn_Col") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Trn_colwc_Component), StringUtil.Lower( "Trn_RowTrn_ColWC")) != 0 )
            {
               WebComp_Trn_colwc = getWebComponent(GetType(), "GeneXus.Programs", "trn_rowtrn_colwc", new Object[] {context} );
               WebComp_Trn_colwc.ComponentInit();
               WebComp_Trn_colwc.Name = "Trn_RowTrn_ColWC";
               WebComp_Trn_colwc_Component = "Trn_RowTrn_ColWC";
            }
            if ( StringUtil.Len( WebComp_Trn_colwc_Component) != 0 )
            {
               WebComp_Trn_colwc.setjustcreated();
               WebComp_Trn_colwc.componentprepare(new Object[] {(string)"W0037",(string)"",(Guid)AV10Trn_RowId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10Trn_RowId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10Trn_RowId", AV10Trn_RowId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vTRN_ROWID", GetSecureSignedToken( "", AV10Trn_RowId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024101016445040", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_rowview.js", "?2024101016445041", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_rowgeneral_cell_Internalname = "TRN_ROWGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Row View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A319Trn_RowId","fld":"TRN_ROWID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV10Trn_RowId","fld":"vTRN_ROWID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11602","iparms":[{"av":"A319Trn_RowId","fld":"TRN_ROWID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12602","iparms":[{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A319Trn_RowId","fld":"TRN_ROWID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E13602","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10Trn_RowId","fld":"vTRN_ROWID","hsh":true}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV12SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV11LoadAllTabs","fld":"vLOADALLTABS"},{"ctrl":"TRN_COLWC"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H00602_A319Trn_RowId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00603_A319Trn_RowId = new Guid[] {Guid.Empty} ;
         H00603_A320Trn_RowName = new string[] {""} ;
         A320Trn_RowName = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_rowview__default(),
            new Object[][] {
                new Object[] {
               H00602_A319Trn_RowId
               }
               , new Object[] {
               H00603_A319Trn_RowId, H00603_A320Trn_RowName
               }
            }
         );
      ...
      private string divTrn_rowgeneral_cell_Internalname ;
      ...
      private Guid AV10Trn_RowId ;
      private Guid wcpOAV10Trn_RowId ;
      ...
      private Guid[] H00602_A319Trn_RowId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00603_A319Trn_RowId ;
      private string[] H00603_A320Trn_RowName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_rowview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10Trn_RowId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH00603;
          ...
          def= new CursorDef[] {
              new CursorDef("H00602", "SELECT Trn_RowId FROM Trn_Row WHERE Trn_RowId = :AV10Trn_RowId ORDER BY Trn_RowId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00602,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00603", "SELECT Trn_RowId, Trn_RowName FROM Trn_Row WHERE Trn_RowId = :AV10Trn_RowId ORDER BY Trn_RowId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00603,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
