...
namespace GeneXus.Programs {
   public class trn_tilegeneral : GXWebComponent
   {
      ...
      {
         this.A264Trn_TileId = aP0_Trn_TileId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)A264Trn_TileId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_tilegeneral.aspx"+UrlEncode(A264Trn_TileId.ToString());
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("Trn_TileBGImageUrl", StringUtil.RTrim( context.localUtil.Format( A271Trn_TileBGImageUrl, "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA264Trn_TileId", wcpOA264Trn_TileId.ToString());
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV12IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV12IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV13IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV13IsAuthorized_Delete, context));
      ...
      protected void WB4A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtTrn_TileId_Internalname, A264Trn_TileId.ToString(), A264Trn_TileId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTrn_TileId_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtTrn_TileId_Enabled, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_TileGeneral.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtTrn_TileName_Internalname, A265Trn_TileName, StringUtil.RTrim( context.localUtil.Format( A265Trn_TileName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,19);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtTrn_TileName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtTrn_TileName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_TileGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbTrn_TileColor, cmbTrn_TileColor_Internalname, StringUtil.RTrim( A270Trn_TileColor), 1, cmbTrn_TileColor_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbTrn_TileColor.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,24);\"", "", true, 0, "HLP_Trn_TileGeneral.htm");
            cmbTrn_TileColor.CurrentValue = StringUtil.RTrim( A270Trn_TileColor);
            AssignProp(sPrefix, false, cmbTrn_TileColor_Internalname, "Values", (string)(cmbTrn_TileColor.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtTrn_TileBGImageUrl_Internalname, A271Trn_TileBGImageUrl, StringUtil.RTrim( context.localUtil.Format( A271Trn_TileBGImageUrl, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtTrn_TileBGImageUrl_Link, edtTrn_TileBGImageUrl_Linktarget, "", "", edtTrn_TileBGImageUrl_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtTrn_TileBGImageUrl_Enabled, 0, "url", "", 80, "chr", 1, "row", 1000, 0, 0, 0, 0, -1, 0, true, "GeneXus\\Url", "start", true, "", "HLP_Trn_TileGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtProductServiceName_Internalname, A59ProductServiceName, StringUtil.RTrim( context.localUtil.Format( A59ProductServiceName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtProductServiceName_Link, "", "", "", edtProductServiceName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtProductServiceName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_TileGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtOrganisationName_Internalname, A13OrganisationName, StringUtil.RTrim( context.localUtil.Format( A13OrganisationName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,39);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtOrganisationName_Link, "", "", "", edtOrganisationName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtOrganisationName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_TileGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtLocationName_Internalname, A31LocationName, StringUtil.RTrim( context.localUtil.Format( A31LocationName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtLocationName_Link, "", "", "", edtLocationName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtLocationName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_TileGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtSG_ToPageName_Internalname, A330SG_ToPageName, StringUtil.RTrim( context.localUtil.Format( A330SG_ToPageName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,59);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", edtSG_ToPageName_Link, "", "", "", edtSG_ToPageName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSG_ToPageName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_TileGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtTrn_TileIcon_Internalname, A393Trn_TileIcon, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,64);\"", 0, 1, edtTrn_TileIcon_Enabled, 0, 80, "chr", 10, "row", 0, StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "", "HLP_Trn_TileGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void fix_multi_value_controls( )
      {
         if ( cmbTrn_TileColor.ItemCount > 0 )
         {
            ...
            AssignAttri(sPrefix, false, "A270Trn_TileColor", A270Trn_TileColor);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbTrn_TileColor.CurrentValue = StringUtil.RTrim( A270Trn_TileColor);
            AssignProp(sPrefix, false, cmbTrn_TileColor_Internalname, "Values", cmbTrn_TileColor.ToJavascriptSource(), true);
         }
      }
      ...
      protected void RF4A2( )
      {
         ...
         {
            /* Using cursor H004A2 */
            pr_default.execute(0, new Object[] {A264Trn_TileId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A393Trn_TileIcon = H004A2_A393Trn_TileIcon[0];
               n393Trn_TileIcon = H004A2_n393Trn_TileIcon[0];
               AssignAttri(sPrefix, false, "A393Trn_TileIcon", A393Trn_TileIcon);
               ...
               A31LocationName = H004A2_A31LocationName[0];
               ...
               A59ProductServiceName = H004A2_A59ProductServiceName[0];
               AssignAttri(sPrefix, false, "A59ProductServiceName", A59ProductServiceName);
               A271Trn_TileBGImageUrl = H004A2_A271Trn_TileBGImageUrl[0];
               n271Trn_TileBGImageUrl = H004A2_n271Trn_TileBGImageUrl[0];
               AssignAttri(sPrefix, false, "A271Trn_TileBGImageUrl", A271Trn_TileBGImageUrl);
               A270Trn_TileColor = H004A2_A270Trn_TileColor[0];
               n270Trn_TileColor = H004A2_n270Trn_TileColor[0];
               AssignAttri(sPrefix, false, "A270Trn_TileColor", A270Trn_TileColor);
               A265Trn_TileName = H004A2_A265Trn_TileName[0];
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, cmbTrn_TileColor_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(cmbTrn_TileColor.Enabled), 5, 0), true);
         edtTrn_TileBGImageUrl_Enabled = 0;
         AssignProp(sPrefix, false, edtTrn_TileBGImageUrl_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtTrn_TileBGImageUrl_Enabled), 5, 0), true);
         ...
         AssignProp(sPrefix, false, edtTrn_TileIcon_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtTrn_TileIcon_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP4A0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA264Trn_TileId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA264Trn_TileId"));
      ...
      protected void E124A2( )
      {
         ...
         AssignProp(sPrefix, false, edtTrn_TileBGImageUrl_Internalname, "Linktarget", edtTrn_TileBGImageUrl_Linktarget, true);
         edtTrn_TileBGImageUrl_Link = A271Trn_TileBGImageUrl;
         AssignProp(sPrefix, false, edtTrn_TileBGImageUrl_Internalname, "Link", edtTrn_TileBGImageUrl_Link, true);
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA264Trn_TileId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         {
            A264Trn_TileId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "A264Trn_TileId", A264Trn_TileId.ToString());
         }
         wcpOA264Trn_TileId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA264Trn_TileId"));
         if ( ! GetJustCreated( ) && ( ( A264Trn_TileId != wcpOA264Trn_TileId ) ) )
         {
            setjustcreated();
         }
         wcpOA264Trn_TileId = A264Trn_TileId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA264Trn_TileId = cgiGet( sPrefix+"A264Trn_TileId_CTRL");
         if ( StringUtil.Len( sCtrlA264Trn_TileId) > 0 )
         {
            A264Trn_TileId = StringUtil.StrToGuid( cgiGet( sCtrlA264Trn_TileId));
            AssignAttri(sPrefix, false, "A264Trn_TileId", A264Trn_TileId.ToString());
         }
         else
         {
            A264Trn_TileId = StringUtil.StrToGuid( cgiGet( sPrefix+"A264Trn_TileId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A264Trn_TileId_PARM", A264Trn_TileId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA264Trn_TileId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A264Trn_TileId_CTRL", StringUtil.RTrim( sCtrlA264Trn_TileId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241016178885", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_tilegeneral.js", "?20241016178885", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         edtTrn_TileIcon_Internalname = sPrefix+"TRN_TILEICON";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A264Trn_TileId","fld":"TRN_TILEID"},{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A271Trn_TileBGImageUrl","fld":"TRN_TILEBGIMAGEURL"}]}""");
         setEventMetadata("'DOUPDATE'","""{"handler":"E134A2","iparms":[{"av":"AV12IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A264Trn_TileId","fld":"TRN_TILEID"}]""");
         setEventMetadata("'DOUPDATE'",""","oparms":[{"ctrl":"BTNUPDATE","prop":"Visible"}]}""");
         setEventMetadata("'DODELETE'","""{"handler":"E144A2","iparms":[{"av":"AV13IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"A264Trn_TileId","fld":"TRN_TILEID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H004A2_A264Trn_TileId = new Guid[] {Guid.Empty} ;
         ...
         H004A2_A393Trn_TileIcon = new string[] {""} ;
         H004A2_n393Trn_TileIcon = new bool[] {false} ;
         ...
         H004A2_A31LocationName = new string[] {""} ;
         H004A2_A13OrganisationName = new string[] {""} ;
         H004A2_A59ProductServiceName = new string[] {""} ;
         H004A2_A271Trn_TileBGImageUrl = new string[] {""} ;
         H004A2_n271Trn_TileBGImageUrl = new bool[] {false} ;
         H004A2_A270Trn_TileColor = new string[] {""} ;
         H004A2_n270Trn_TileColor = new bool[] {false} ;
         H004A2_A265Trn_TileName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_tilegeneral__default(),
            new Object[][] {
                new Object[] {
               H004A2_A264Trn_TileId, H004A2_A11OrganisationId, H004A2_n11OrganisationId, H004A2_A29LocationId, H004A2_n29LocationId, H004A2_A58ProductServiceId, H004A2_n58ProductServiceId, H004A2_A329SG_ToPageId, H004A2_A393Trn_TileIcon, H004A2_n393Trn_TileIcon,
               H004A2_A330SG_ToPageName, H004A2_A40000ProductServiceImage_GXI, H004A2_A60ProductServiceDescription, H004A2_A31LocationName, H004A2_A13OrganisationName, H004A2_A59ProductServiceName, H004A2_A271Trn_TileBGImageUrl, H004A2_n271Trn_TileBGImageUrl, H004A2_A270Trn_TileColor, H004A2_n270Trn_TileColor,
               H004A2_A265Trn_TileName, H004A2_A61ProductServiceImage
               }
            }
         );
         AV15Pgmname = "Trn_TileGeneral";
      ...
      private string hsh ;
      private string sCtrlA264Trn_TileId ;
      ...
      private Guid wcpOA264Trn_TileId ;
      ...
      private Guid[] H004A2_A264Trn_TileId ;
      ...
      private string[] H004A2_A393Trn_TileIcon ;
      private bool[] H004A2_n393Trn_TileIcon ;
      ...
      private string[] H004A2_A31LocationName ;
      private string[] H004A2_A13OrganisationName ;
      private string[] H004A2_A59ProductServiceName ;
      private string[] H004A2_A271Trn_TileBGImageUrl ;
      private bool[] H004A2_n271Trn_TileBGImageUrl ;
      private string[] H004A2_A270Trn_TileColor ;
      private bool[] H004A2_n270Trn_TileColor ;
      private string[] H004A2_A265Trn_TileName ;
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[11])[0] = rslt.getMultimediaUri(8);
                ...
                ((string[]) buf[21])[0] = rslt.getMultimediaFile(16, rslt.getVarchar(8));
                return;
       }
    }
