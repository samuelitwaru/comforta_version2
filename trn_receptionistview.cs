...
namespace GeneXus.Programs {
   public class trn_receptionistview : GXDataArea
   {
      public trn_receptionistview( )
      {
      ...
      public trn_receptionistview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_ReceptionistId ,
                           ...
                           string aP3_TabCode )
      {
         this.AV10ReceptionistId = aP0_ReceptionistId;
         this.AV17OrganisationId = aP1_OrganisationId;
         this.AV11LocationId = aP2_LocationId;
      ...
      {
         get {
            return "trn_receptionistview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_receptionistview.aspx"+UrlEncode(AV10ReceptionistId.ToString()) + "," + UrlEncode(AV17OrganisationId.ToString()) + "," + UrlEncode(AV11LocationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_receptionistview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vRECEPTIONISTID", AV10ReceptionistId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vRECEPTIONISTID", GetSecureSignedToken( "", AV10ReceptionistId, context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_receptionistview.aspx"+UrlEncode(AV10ReceptionistId.ToString()) + "," + UrlEncode(AV17OrganisationId.ToString()) + "," + UrlEncode(AV11LocationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_receptionistview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_ReceptionistView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Receptionist View", "") ;
      }
      ...
      protected void WB4Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_ReceptionistView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_receptionistgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void START4Z2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Receptionist View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA4Z2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_receptionistview.aspx")), "trn_receptionistview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_receptionistview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10ReceptionistId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10ReceptionistId", AV10ReceptionistId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vRECEPTIONISTID", GetSecureSignedToken( "", AV10ReceptionistId, context));
      ...
      protected void RF4Z2( )
      {
         ...
         {
            /* Using cursor H004Z2 */
            pr_default.execute(0, new Object[] {AV10ReceptionistId, AV17OrganisationId, AV11LocationId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A29LocationId = H004Z2_A29LocationId[0];
               A11OrganisationId = H004Z2_A11OrganisationId[0];
               A89ReceptionistId = H004Z2_A89ReceptionistId[0];
               /* Execute user event: Load */
               E154Z2 ();
      ...
      protected void E134Z2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("wp_locationreceptionists.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV19GXLvl9 = 0;
         /* Using cursor H004Z3 */
         pr_default.execute(1, new Object[] {AV10ReceptionistId, AV17OrganisationId, AV11LocationId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A29LocationId = H004Z3_A29LocationId[0];
            A11OrganisationId = H004Z3_A11OrganisationId[0];
            A89ReceptionistId = H004Z3_A89ReceptionistId[0];
            A90ReceptionistGivenName = H004Z3_A90ReceptionistGivenName[0];
            AV19GXLvl9 = 1;
            Form.Caption = A90ReceptionistGivenName;
      ...
      protected void E144Z2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Receptionist",  StringUtil.Trim( A89ReceptionistId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Receptionist",  2) )
         {
      ...
      protected void E114Z2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Receptionist",(short)2,StringUtil.Trim( A89ReceptionistId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString()),(string)AV15RecordDescription});
      ...
      protected void E124Z2( )
      {
         ...
         if ( AV18IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Receptionist",StringUtil.Trim( A89ReceptionistId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString())+";"+StringUtil.Trim( A29LocationId.ToString()),(string)AV15RecordDescription,formatLink("trn_receptionistview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_ReceptionistGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_receptionistgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_ReceptionistGeneral";
            WebComp_Webcomponent_general_Component = "Trn_ReceptionistGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10ReceptionistId,(Guid)AV17OrganisationId,(Guid)AV11LocationId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10ReceptionistId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10ReceptionistId", AV10ReceptionistId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vRECEPTIONISTID", GetSecureSignedToken( "", AV10ReceptionistId, context));
         AV17OrganisationId = (Guid)getParm(obj,1);
         AssignAttri("", false, "AV17OrganisationId", AV17OrganisationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vORGANISATIONID", GetSecureSignedToken( "", AV17OrganisationId, context));
         AV11LocationId = (Guid)getParm(obj,2);
         AssignAttri("", false, "AV11LocationId", AV11LocationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vLOCATIONID", GetSecureSignedToken( "", AV11LocationId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411261513135", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_receptionistview.js", "?202411261513135", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_receptionistgeneral_cell_Internalname = "TRN_RECEPTIONISTGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Receptionist View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A89ReceptionistId","fld":"RECEPTIONISTID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV18IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10ReceptionistId","fld":"vRECEPTIONISTID","hsh":true},{"av":"AV17OrganisationId","fld":"vORGANISATIONID","hsh":true},{"av":"AV11LocationId","fld":"vLOCATIONID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E114Z2","iparms":[{"av":"A89ReceptionistId","fld":"RECEPTIONISTID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E124Z2","iparms":[{"av":"AV18IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A89ReceptionistId","fld":"RECEPTIONISTID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"A29LocationId","fld":"LOCATIONID"}]""");
      ...
      {
         wcpOAV10ReceptionistId = Guid.Empty;
         ...
         sEvtType = "";
         GXDecQS = "";
         H004Z2_A29LocationId = new Guid[] {Guid.Empty} ;
         H004Z2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H004Z2_A89ReceptionistId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H004Z3_A29LocationId = new Guid[] {Guid.Empty} ;
         H004Z3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H004Z3_A89ReceptionistId = new Guid[] {Guid.Empty} ;
         H004Z3_A90ReceptionistGivenName = new string[] {""} ;
         A90ReceptionistGivenName = "";
         AV16Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_receptionistview__default(),
            new Object[][] {
                new Object[] {
               H004Z2_A29LocationId, H004Z2_A11OrganisationId, H004Z2_A89ReceptionistId
               }
               , new Object[] {
               H004Z3_A29LocationId, H004Z3_A11OrganisationId, H004Z3_A89ReceptionistId, H004Z3_A90ReceptionistGivenName
               }
            }
         );
      ...
      private string divTrn_receptionistgeneral_cell_Internalname ;
      ...
      private Guid AV10ReceptionistId ;
      private Guid AV17OrganisationId ;
      private Guid AV11LocationId ;
      private Guid wcpOAV10ReceptionistId ;
      ...
      private Guid[] H004Z2_A29LocationId ;
      private Guid[] H004Z2_A11OrganisationId ;
      private Guid[] H004Z2_A89ReceptionistId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H004Z3_A29LocationId ;
      private Guid[] H004Z3_A11OrganisationId ;
      private Guid[] H004Z3_A89ReceptionistId ;
      private string[] H004Z3_A90ReceptionistGivenName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_receptionistview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10ReceptionistId",GXType.UniqueIdentifier,36,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H004Z2", "SELECT LocationId, OrganisationId, ReceptionistId FROM Trn_Receptionist WHERE ReceptionistId = :AV10ReceptionistId and OrganisationId = :AV17OrganisationId and LocationId = :AV11LocationId ORDER BY ReceptionistId, OrganisationId, LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004Z2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H004Z3", "SELECT LocationId, OrganisationId, ReceptionistId, ReceptionistGivenName FROM Trn_Receptionist WHERE (ReceptionistId = :AV10ReceptionistId and OrganisationId = :AV17OrganisationId and LocationId = :AV11LocationId) AND (ReceptionistId = :AV10ReceptionistId and OrganisationId = :AV17OrganisationId and LocationId = :AV11LocationId) ORDER BY ReceptionistId, OrganisationId, LocationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004Z3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
