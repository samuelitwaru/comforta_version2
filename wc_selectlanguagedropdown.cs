...
namespace GeneXus.Programs {
   public class wc_selectlanguagedropdown : GXWebComponent
   {
      public wc_selectlanguagedropdown( )
      {
      ...
      public wc_selectlanguagedropdown( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wc_selectlanguagedropdown.aspx") +"\">") ;
      ...
      {
         return "WC_SelectLanguageDropdown" ;
      }
      ...
      protected void WB3F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wc_selectlanguagedropdown.aspx");
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
               context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            }
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'ONSELECTDUTCH'") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP3F0( ) ;
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    /* Execute user event: 'onSelectDutch' */
                                    E113F2 ();
                                 }
                              }
                           }
                           else if ( StringUtil.StrCmp(sEvt, "'ONSELECTENGLISH'") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP3F0( ) ;
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    /* Execute user event: 'onSelectEnglish' */
                                    E123F2 ();
                                 }
                              }
                           }
      ...
      {
         /* 'onSelectDutch' Routine */
         returnInSub = false;
         AV5NumericValue = (short)(context.SetLanguage( "Dutch"));
         context.DoAjaxRefreshCmp(sPrefix);
      }

      protected void E123F2( )
      {
         /* 'onSelectEnglish' Routine */
         returnInSub = false;
         AV5NumericValue = (short)(context.SetLanguage( "English"));
         context.DoAjaxRefreshCmp(sPrefix);
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wc_selectlanguagedropdown", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411156322396", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wc_selectlanguagedropdown.js", "?202411156322396", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
            context.AddJavascriptSource("UserControls/WWP_IconButtonRender.js", "", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'ONSELECTDUTCH'","""{"handler":"E113F2","iparms":[]}""");
         setEventMetadata("'ONSELECTENGLISH'","""{"handler":"E123F2","iparms":[]}""");
         return  ;
      }
