...
namespace GeneXus.Programs {
   public class trn_auditview : GXDataArea
   {
      public trn_auditview( )
      {
      ...
      public trn_auditview( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_auditview.aspx"+UrlEncode(AV10AuditId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_auditview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vAUDITID", AV10AuditId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vAUDITID", GetSecureSignedToken( "", AV10AuditId, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_auditview.aspx"+UrlEncode(AV10AuditId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_auditview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_AuditView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Audit View", "") ;
      }
      ...
      protected void WB7I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_AuditView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_auditgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void START7I2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Audit View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA7I2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_auditview.aspx")), "trn_auditview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_auditview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10AuditId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10AuditId", AV10AuditId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vAUDITID", GetSecureSignedToken( "", AV10AuditId, context));
      ...
      protected void RF7I2( )
      {
         ...
         {
            /* Using cursor H007I2 */
            pr_default.execute(0, new Object[] {AV10AuditId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A415AuditId = H007I2_A415AuditId[0];
               /* Execute user event: Load */
               E157I2 ();
      ...
      protected void E137I2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_auditww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H007I3 */
         pr_default.execute(1, new Object[] {AV10AuditId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A415AuditId = H007I3_A415AuditId[0];
            A416AuditDate = H007I3_A416AuditDate[0];
            AV17GXLvl9 = 1;
            Form.Caption = context.localUtil.TToC( A416AuditDate, 8, 5, (short)(((StringUtil.StrCmp(context.GetLanguageProperty( "time_fmt"), "12")==0) ? 1 : 0)), (short)(DateTimeUtil.MapDateTimeFormat( context.GetLanguageProperty( "date_fmt"))), "/", ":", " ");
      ...
      protected void E147I2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Audit",  StringUtil.Trim( A415AuditId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Audit",  2) )
         {
      ...
      protected void E117I2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Audit",(short)2,StringUtil.Trim( A415AuditId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E127I2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Audit",StringUtil.Trim( A415AuditId.ToString()),(string)AV14RecordDescription,formatLink("trn_auditview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_AuditGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_auditgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_AuditGeneral";
            WebComp_Webcomponent_general_Component = "Trn_AuditGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10AuditId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10AuditId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10AuditId", AV10AuditId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vAUDITID", GetSecureSignedToken( "", AV10AuditId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112914312899", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_auditview.js", "?2024112914312899", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_auditgeneral_cell_Internalname = "TRN_AUDITGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Audit View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A415AuditId","fld":"AUDITID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10AuditId","fld":"vAUDITID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E117I2","iparms":[{"av":"A415AuditId","fld":"AUDITID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E127I2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A415AuditId","fld":"AUDITID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H007I2_A415AuditId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H007I3_A415AuditId = new Guid[] {Guid.Empty} ;
         H007I3_A416AuditDate = new DateTime[] {DateTime.MinValue} ;
         A416AuditDate = (DateTime)(DateTime.MinValue);
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_auditview__default(),
            new Object[][] {
                new Object[] {
               H007I2_A415AuditId
               }
               , new Object[] {
               H007I3_A415AuditId, H007I3_A416AuditDate
               }
            }
         );
      ...
      private string divTrn_auditgeneral_cell_Internalname ;
      ...
      private Guid AV10AuditId ;
      private Guid wcpOAV10AuditId ;
      ...
      private Guid[] H007I2_A415AuditId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H007I3_A415AuditId ;
      private DateTime[] H007I3_A416AuditDate ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_auditview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10AuditId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH007I3;
          ...
          def= new CursorDef[] {
              new CursorDef("H007I2", "SELECT AuditId FROM Trn_Audit WHERE AuditId = :AV10AuditId ORDER BY AuditId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007I2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H007I3", "SELECT AuditId, AuditDate FROM Trn_Audit WHERE AuditId = :AV10AuditId ORDER BY AuditId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007I3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
