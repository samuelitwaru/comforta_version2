...
namespace GeneXus.Programs {
   public class trn_residentnetworkindividualwc : GXWebComponent
   {
      public trn_residentnetworkindividualwc( )
      {
      ...
      public trn_residentnetworkindividualwc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV25Pgmname = "Trn_ResidentNetworkIndividualWC";
               WS682( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Trn_Resident Network Individual WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_residentnetworkindividualwc.aspx"+UrlEncode(AV8ResidentId.ToString()) + "," + UrlEncode(AV9LocationId.ToString()) + "," + UrlEncode(AV10OrganisationId.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_residentnetworkindividualwc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDCURRENTPAGE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV22GridCurrentPage), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV23GridPageCount), 10, 0, ".", "")));
      ...
      {
         return "Trn_ResidentNetworkIndividualWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Trn_Resident Network Individual WC" ;
      }
      ...
      protected void WB680( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_residentnetworkindividualwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 15 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtResidentId_Internalname, A62ResidentId.ToString(), A62ResidentId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResidentId_Jsonclick, 0, "Attribute", "", "", "", "", edtResidentId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ResidentNetworkIndividualWC.htm");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtLocationId_Internalname, A29LocationId.ToString(), A29LocationId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLocationId_Jsonclick, 0, "Attribute", "", "", "", "", edtLocationId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ResidentNetworkIndividualWC.htm");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtOrganisationId_Internalname, A11OrganisationId.ToString(), A11OrganisationId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtOrganisationId_Jsonclick, 0, "Attribute", "", "", "", "", edtOrganisationId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ResidentNetworkIndividualWC.htm");
            /* User Defined Control */
      ...
      protected void START682( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Trn_Resident Network Individual WC", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_residentnetworkindividualwc.aspx")), "trn_residentnetworkindividualwc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_residentnetworkindividualwc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF682( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A62ResidentId = H00682_A62ResidentId[0];
               AssignAttri(sPrefix, false, "A62ResidentId", A62ResidentId.ToString());
               A29LocationId = H00682_A29LocationId[0];
               AssignAttri(sPrefix, false, "A29LocationId", A29LocationId.ToString());
               A11OrganisationId = H00682_A11OrganisationId[0];
               AssignAttri(sPrefix, false, "A11OrganisationId", A11OrganisationId.ToString());
               A348NetworkIndividualAddressLine2 = H00682_A348NetworkIndividualAddressLine2[0];
               A347NetworkIndividualAddressLine1 = H00682_A347NetworkIndividualAddressLine1[0];
               A346NetworkIndividualZipCode = H00682_A346NetworkIndividualZipCode[0];
               A345NetworkIndividualCity = H00682_A345NetworkIndividualCity[0];
               A344NetworkIndividualCountry = H00682_A344NetworkIndividualCountry[0];
               A81NetworkIndividualGender = H00682_A81NetworkIndividualGender[0];
               A79NetworkIndividualPhone = H00682_A79NetworkIndividualPhone[0];
               A78NetworkIndividualEmail = H00682_A78NetworkIndividualEmail[0];
               A77NetworkIndividualLastName = H00682_A77NetworkIndividualLastName[0];
               A76NetworkIndividualGivenName = H00682_A76NetworkIndividualGivenName[0];
               A75NetworkIndividualBsnNumber = H00682_A75NetworkIndividualBsnNumber[0];
               A74NetworkIndividualId = H00682_A74NetworkIndividualId[0];
               A348NetworkIndividualAddressLine2 = H00682_A348NetworkIndividualAddressLine2[0];
               A347NetworkIndividualAddressLine1 = H00682_A347NetworkIndividualAddressLine1[0];
               A346NetworkIndividualZipCode = H00682_A346NetworkIndividualZipCode[0];
               A345NetworkIndividualCity = H00682_A345NetworkIndividualCity[0];
      ...
      protected void STRUP680( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV22GridCurrentPage = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDCURRENTPAGE"), ".", ","), 18, MidpointRounding.ToEven));
            AV23GridPageCount = (long)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGECOUNT"), ".", ","), 18, MidpointRounding.ToEven));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_residentnetworkindividualwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719463065", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_residentnetworkindividualwc.js", "?202492719463065", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtNetworkIndividualId_Internalname = sPrefix+"NETWORKINDIVIDUALID_"+sGXsfl_15_idx;
         edtNetworkIndividualBsnNumber_Internalname = sPrefix+"NETWORKINDIVIDUALBSNNUMBER_"+sGXsfl_15_idx;
         edtNetworkIndividualGivenName_Internalname = sPrefix+"NETWORKINDIVIDUALGIVENNAME_"+sGXsfl_15_idx;
         edtNetworkIndividualLastName_Internalname = sPrefix+"NETWORKINDIVIDUALLASTNAME_"+sGXsfl_15_idx;
         edtNetworkIndividualEmail_Internalname = sPrefix+"NETWORKINDIVIDUALEMAIL_"+sGXsfl_15_idx;
         edtNetworkIndividualPhone_Internalname = sPrefix+"NETWORKINDIVIDUALPHONE_"+sGXsfl_15_idx;
         cmbNetworkIndividualGender_Internalname = sPrefix+"NETWORKINDIVIDUALGENDER_"+sGXsfl_15_idx;
         edtNetworkIndividualCountry_Internalname = sPrefix+"NETWORKINDIVIDUALCOUNTRY_"+sGXsfl_15_idx;
         edtNetworkIndividualCity_Internalname = sPrefix+"NETWORKINDIVIDUALCITY_"+sGXsfl_15_idx;
         edtNetworkIndividualZipCode_Internalname = sPrefix+"NETWORKINDIVIDUALZIPCODE_"+sGXsfl_15_idx;
         edtNetworkIndividualAddressLine1_Internalname = sPrefix+"NETWORKINDIVIDUALADDRESSLINE1_"+sGXsfl_15_idx;
         edtNetworkIndividualAddressLine2_Internalname = sPrefix+"NETWORKINDIVIDUALADDRESSLINE2_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtNetworkIndividualId_Internalname = sPrefix+"NETWORKINDIVIDUALID_"+sGXsfl_15_fel_idx;
         edtNetworkIndividualBsnNumber_Internalname = sPrefix+"NETWORKINDIVIDUALBSNNUMBER_"+sGXsfl_15_fel_idx;
         edtNetworkIndividualGivenName_Internalname = sPrefix+"NETWORKINDIVIDUALGIVENNAME_"+sGXsfl_15_fel_idx;
         edtNetworkIndividualLastName_Internalname = sPrefix+"NETWORKINDIVIDUALLASTNAME_"+sGXsfl_15_fel_idx;
         edtNetworkIndividualEmail_Internalname = sPrefix+"NETWORKINDIVIDUALEMAIL_"+sGXsfl_15_fel_idx;
         edtNetworkIndividualPhone_Internalname = sPrefix+"NETWORKINDIVIDUALPHONE_"+sGXsfl_15_fel_idx;
         cmbNetworkIndividualGender_Internalname = sPrefix+"NETWORKINDIVIDUALGENDER_"+sGXsfl_15_fel_idx;
         edtNetworkIndividualCountry_Internalname = sPrefix+"NETWORKINDIVIDUALCOUNTRY_"+sGXsfl_15_fel_idx;
         edtNetworkIndividualCity_Internalname = sPrefix+"NETWORKINDIVIDUALCITY_"+sGXsfl_15_fel_idx;
         edtNetworkIndividualZipCode_Internalname = sPrefix+"NETWORKINDIVIDUALZIPCODE_"+sGXsfl_15_fel_idx;
         edtNetworkIndividualAddressLine1_Internalname = sPrefix+"NETWORKINDIVIDUALADDRESSLINE1_"+sGXsfl_15_fel_idx;
         edtNetworkIndividualAddressLine2_Internalname = sPrefix+"NETWORKINDIVIDUALADDRESSLINE2_"+sGXsfl_15_fel_idx;
      }
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtNetworkIndividualBsnNumber_Internalname,(string)A75NetworkIndividualBsnNumber,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtNetworkIndividualBsnNumber_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)40,(short)0,(short)0,(short)15,(short)0,(short)-1,(short)-1,(bool)true,(string)"BsnNumber",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtNetworkIndividualLastName_Internalname,(string)A77NetworkIndividualLastName,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtNetworkIndividualLastName_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)15,(short)0,(short)-1,(short)-1,(bool)true,(string)"Name",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtNetworkIndividualCity_Internalname,(string)A345NetworkIndividualCity,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtNetworkIndividualCity_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)15,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtNetworkIndividualZipCode_Internalname,(string)A346NetworkIndividualZipCode,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtNetworkIndividualZipCode_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)15,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtNetworkIndividualAddressLine1_Internalname,(string)A347NetworkIndividualAddressLine1,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtNetworkIndividualAddressLine1_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)15,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtNetworkIndividualAddressLine2_Internalname,(string)A348NetworkIndividualAddressLine2,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtNetworkIndividualAddressLine2_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)100,(short)0,(short)0,(short)15,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
      ...
      protected void StartGridControl15( )
      {
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A74NetworkIndividualId.ToString()));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A75NetworkIndividualBsnNumber));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A76NetworkIndividualGivenName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A77NetworkIndividualLastName));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A78NetworkIndividualEmail));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( A79NetworkIndividualPhone)));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A81NetworkIndividualGender));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A344NetworkIndividualCountry));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A345NetworkIndividualCity));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A346NetworkIndividualZipCode));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A347NetworkIndividualAddressLine1));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A348NetworkIndividualAddressLine2));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      {
         edtNetworkIndividualId_Internalname = sPrefix+"NETWORKINDIVIDUALID";
         edtNetworkIndividualBsnNumber_Internalname = sPrefix+"NETWORKINDIVIDUALBSNNUMBER";
         edtNetworkIndividualGivenName_Internalname = sPrefix+"NETWORKINDIVIDUALGIVENNAME";
         edtNetworkIndividualLastName_Internalname = sPrefix+"NETWORKINDIVIDUALLASTNAME";
         edtNetworkIndividualEmail_Internalname = sPrefix+"NETWORKINDIVIDUALEMAIL";
         edtNetworkIndividualPhone_Internalname = sPrefix+"NETWORKINDIVIDUALPHONE";
         cmbNetworkIndividualGender_Internalname = sPrefix+"NETWORKINDIVIDUALGENDER";
         edtNetworkIndividualCountry_Internalname = sPrefix+"NETWORKINDIVIDUALCOUNTRY";
         edtNetworkIndividualCity_Internalname = sPrefix+"NETWORKINDIVIDUALCITY";
         edtNetworkIndividualZipCode_Internalname = sPrefix+"NETWORKINDIVIDUALZIPCODE";
         edtNetworkIndividualAddressLine1_Internalname = sPrefix+"NETWORKINDIVIDUALADDRESSLINE1";
         edtNetworkIndividualAddressLine2_Internalname = sPrefix+"NETWORKINDIVIDUALADDRESSLINE2";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "1:NetworkIndividualBsnNumber|2:NetworkIndividualGivenName|3:NetworkIndividualLastName|4:NetworkIndividualEmail|5:NetworkIndividualPhone|6:NetworkIndividualGender";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E16682","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         H00682_A62ResidentId = new Guid[] {Guid.Empty} ;
         H00682_A29LocationId = new Guid[] {Guid.Empty} ;
         H00682_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00682_A348NetworkIndividualAddressLine2 = new string[] {""} ;
         H00682_A347NetworkIndividualAddressLine1 = new string[] {""} ;
         H00682_A346NetworkIndividualZipCode = new string[] {""} ;
         H00682_A345NetworkIndividualCity = new string[] {""} ;
         H00682_A344NetworkIndividualCountry = new string[] {""} ;
         H00682_A81NetworkIndividualGender = new string[] {""} ;
         H00682_A79NetworkIndividualPhone = new string[] {""} ;
         H00682_A78NetworkIndividualEmail = new string[] {""} ;
         H00682_A77NetworkIndividualLastName = new string[] {""} ;
         H00682_A76NetworkIndividualGivenName = new string[] {""} ;
         H00682_A75NetworkIndividualBsnNumber = new string[] {""} ;
         H00682_A74NetworkIndividualId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residentnetworkindividualwc__default(),
            new Object[][] {
                new Object[] {
               H00682_A62ResidentId, H00682_A29LocationId, H00682_A11OrganisationId, H00682_A348NetworkIndividualAddressLine2, H00682_A347NetworkIndividualAddressLine1, H00682_A346NetworkIndividualZipCode, H00682_A345NetworkIndividualCity, H00682_A344NetworkIndividualCountry, H00682_A81NetworkIndividualGender, H00682_A79NetworkIndividualPhone,
               H00682_A78NetworkIndividualEmail, H00682_A77NetworkIndividualLastName, H00682_A76NetworkIndividualGivenName, H00682_A75NetworkIndividualBsnNumber, H00682_A74NetworkIndividualId
               }
               , new Object[] {
      ...
      private Guid[] H00682_A62ResidentId ;
      private Guid[] H00682_A29LocationId ;
      private Guid[] H00682_A11OrganisationId ;
      private string[] H00682_A348NetworkIndividualAddressLine2 ;
      private string[] H00682_A347NetworkIndividualAddressLine1 ;
      private string[] H00682_A346NetworkIndividualZipCode ;
      private string[] H00682_A345NetworkIndividualCity ;
      private string[] H00682_A344NetworkIndividualCountry ;
      private string[] H00682_A81NetworkIndividualGender ;
      private string[] H00682_A79NetworkIndividualPhone ;
      private string[] H00682_A78NetworkIndividualEmail ;
      private string[] H00682_A77NetworkIndividualLastName ;
      private string[] H00682_A76NetworkIndividualGivenName ;
      private string[] H00682_A75NetworkIndividualBsnNumber ;
      private Guid[] H00682_A74NetworkIndividualId ;
   ...
   public class trn_residentnetworkindividualwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid A11OrganisationId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.ResidentId, T1.LocationId, T1.OrganisationId, T2.NetworkIndividualAddressLine2, T2.NetworkIndividualAddressLine1, T2.NetworkIndividualZipCode, T2.NetworkIndividualCity, T2.NetworkIndividualCountry, T2.NetworkIndividualGender, T2.NetworkIndividualPhone, T2.NetworkIndividualEmail, T2.NetworkIndividualLastName, T2.NetworkIndividualGivenName, T2.NetworkIndividualBsnNumber, T1.NetworkIndividualId";
         sFromString = " FROM (Trn_ResidentNetworkIndividual T1 INNER JOIN Trn_NetworkIndividual T2 ON T2.NetworkIndividualId = T1.NetworkIndividualId)";
         sOrderString = "";
         AddWhere(sWhereString, "(T1.ResidentId = :AV8ResidentId and T1.LocationId = :AV9LocationId and T1.OrganisationId = :AV10OrganisationId)");
         if ( ( AV16OrderedBy == 1 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ResidentId, T1.LocationId, T1.OrganisationId, T2.NetworkIndividualBsnNumber, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 1 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ResidentId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T2.NetworkIndividualBsnNumber DESC, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 2 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ResidentId, T1.LocationId, T1.OrganisationId, T2.NetworkIndividualGivenName, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 2 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ResidentId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T2.NetworkIndividualGivenName DESC, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 3 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ResidentId, T1.LocationId, T1.OrganisationId, T2.NetworkIndividualLastName, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 3 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ResidentId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T2.NetworkIndividualLastName DESC, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 4 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ResidentId, T1.LocationId, T1.OrganisationId, T2.NetworkIndividualEmail, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 4 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ResidentId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T2.NetworkIndividualEmail DESC, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 5 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ResidentId, T1.LocationId, T1.OrganisationId, T2.NetworkIndividualPhone, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 5 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ResidentId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T2.NetworkIndividualPhone DESC, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 6 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY T1.ResidentId, T1.LocationId, T1.OrganisationId, T2.NetworkIndividualGender, T1.NetworkIndividualId";
         }
         else if ( ( AV16OrderedBy == 6 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY T1.ResidentId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T2.NetworkIndividualGender DESC, T1.NetworkIndividualId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY T1.ResidentId, T1.LocationId, T1.OrganisationId, T1.NetworkIndividualId";
         }
                                             ...
                                             Guid A11OrganisationId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (Trn_ResidentNetworkIndividual T1 INNER JOIN Trn_NetworkIndividual T2 ON T2.NetworkIndividualId = T1.NetworkIndividualId)";
         AddWhere(sWhereString, "(T1.ResidentId = :AV8ResidentId and T1.LocationId = :AV9LocationId and T1.OrganisationId = :AV10OrganisationId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00682(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
               case 1 :
                     return conditional_H00683(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00683", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00683,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
