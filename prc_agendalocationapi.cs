   ...
   public class prc_agendalocationapi : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            A62ResidentId = P008T3_A62ResidentId[0];
            ...
            /* Using cursor P008T4 */
            pr_default.execute(2, new Object[] {AV14AgendaCalendaId});
            while ( (pr_default.getStatus(2) != 101) )
            {
               A303AgendaCalendarId = P008T4_A303AgendaCalendarId[0];
      ...
      public override void initialize( )
      {
         ...
         P008T3_A62ResidentId = new Guid[] {Guid.Empty} ;
         ...
         P008T4_A303AgendaCalendarId = new Guid[] {Guid.Empty} ;
         AV10SDT_AgendaLocation = new SdtSDT_AgendaLocation(context);
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.prc_agendalocationapi__default(),
            new Object[][] {
               ...
               , new Object[] {
               P008T3_A304AgendaCalendarTitle, P008T3_A454AgendaCalendarType, P008T3_A305AgendaCalendarStartDate, P008T3_A306AgendaCalendarEndDate, P008T3_A307AgendaCalendarAllDay, P008T3_A450AgendaCalendarRecurring, P008T3_A451AgendaCalendarRecurringType, P008T3_A452AgendaCalendarAddRSVP, P008T3_A29LocationId, P008T3_A11OrganisationId,
               P008T3_A62ResidentId, P008T3_A303AgendaCalendarId
               }
               , new Object[] {
               P008T4_A303AgendaCalendarId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private Guid[] P008T3_A62ResidentId ;
      private Guid[] P008T3_A303AgendaCalendarId ;
      private Guid[] P008T4_A303AgendaCalendarId ;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("P008T3", "SELECT T2.AgendaCalendarTitle, T2.AgendaCalendarType, T2.AgendaCalendarStartDate, T2.AgendaCalendarEndDate, T2.AgendaCalendarAllDay, T2.AgendaCalendarRecurring, T2.AgendaCalendarRecurringType, T2.AgendaCalendarAddRSVP, T2.LocationId, T2.OrganisationId, T1.ResidentId, T1.AgendaCalendarId FROM (Trn_AgendaEventGroup T1 INNER JOIN Trn_AgendaCalendar T2 ON T2.AgendaCalendarId = T1.AgendaCalendarId) WHERE T1.ResidentId = :AV15AgendaResidentId ORDER BY T1.AgendaCalendarId, T1.ResidentId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008T3,100, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("P008T4", "SELECT AgendaCalendarId FROM Trn_AgendaCalendar WHERE AgendaCalendarId = :AV14AgendaCalendaId ORDER BY AgendaCalendarId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP008T4,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
