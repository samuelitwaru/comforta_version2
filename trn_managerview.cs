...
namespace GeneXus.Programs {
   public class trn_managerview : GXDataArea
   {
      public trn_managerview( )
      {
      ...
      public trn_managerview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_ManagerId ,
                           ...
                           string aP2_TabCode )
      {
         this.AV10ManagerId = aP0_ManagerId;
      ...
      {
         get {
            return "trn_managerview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_managerview.aspx"+UrlEncode(AV10ManagerId.ToString()) + "," + UrlEncode(AV11OrganisationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_managerview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vMANAGERID", AV10ManagerId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vMANAGERID", GetSecureSignedToken( "", AV10ManagerId, context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_managerview.aspx"+UrlEncode(AV10ManagerId.ToString()) + "," + UrlEncode(AV11OrganisationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_managerview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_ManagerView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Manager View", "") ;
      }
      ...
      protected void WB3G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_ManagerView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_managergeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void START3G2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Manager View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA3G2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_managerview.aspx")), "trn_managerview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_managerview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10ManagerId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10ManagerId", AV10ManagerId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vMANAGERID", GetSecureSignedToken( "", AV10ManagerId, context));
      ...
      protected void RF3G2( )
      {
         ...
         {
            /* Using cursor H003G2 */
            pr_default.execute(0, new Object[] {AV10ManagerId, AV11OrganisationId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A11OrganisationId = H003G2_A11OrganisationId[0];
               A21ManagerId = H003G2_A21ManagerId[0];
               /* Execute user event: Load */
               E153G2 ();
      ...
      protected void E133G2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_managerww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV18GXLvl9 = 0;
         /* Using cursor H003G3 */
         pr_default.execute(1, new Object[] {AV10ManagerId, AV11OrganisationId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A11OrganisationId = H003G3_A11OrganisationId[0];
            A21ManagerId = H003G3_A21ManagerId[0];
            A22ManagerGivenName = H003G3_A22ManagerGivenName[0];
            AV18GXLvl9 = 1;
            Form.Caption = A22ManagerGivenName;
      ...
      protected void E143G2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Manager",  StringUtil.Trim( A21ManagerId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Manager",  2) )
         {
      ...
      protected void E113G2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Manager",(short)2,StringUtil.Trim( A21ManagerId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString()),(string)AV15RecordDescription});
      ...
      protected void E123G2( )
      {
         ...
         if ( AV17IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_Manager",StringUtil.Trim( A21ManagerId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString()),(string)AV15RecordDescription,formatLink("trn_managerview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_ManagerGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_managergeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_ManagerGeneral";
            WebComp_Webcomponent_general_Component = "Trn_ManagerGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10ManagerId,(Guid)AV11OrganisationId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10ManagerId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10ManagerId", AV10ManagerId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vMANAGERID", GetSecureSignedToken( "", AV10ManagerId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112714173549", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_managerview.js", "?2024112714173549", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_managergeneral_cell_Internalname = "TRN_MANAGERGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Manager View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A21ManagerId","fld":"MANAGERID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV17IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10ManagerId","fld":"vMANAGERID","hsh":true},{"av":"AV11OrganisationId","fld":"vORGANISATIONID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E113G2","iparms":[{"av":"A21ManagerId","fld":"MANAGERID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E123G2","iparms":[{"av":"AV17IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A21ManagerId","fld":"MANAGERID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"}]""");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         GXDecQS = "";
         H003G2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H003G2_A21ManagerId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H003G3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H003G3_A21ManagerId = new Guid[] {Guid.Empty} ;
         H003G3_A22ManagerGivenName = new string[] {""} ;
         A22ManagerGivenName = "";
         AV16Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_managerview__default(),
            new Object[][] {
                new Object[] {
               H003G2_A11OrganisationId, H003G2_A21ManagerId
               }
               , new Object[] {
               H003G3_A11OrganisationId, H003G3_A21ManagerId, H003G3_A22ManagerGivenName
               }
            }
         );
      ...
      private string divTrn_managergeneral_cell_Internalname ;
      ...
      private Guid AV10ManagerId ;
      private Guid AV11OrganisationId ;
      private Guid wcpOAV10ManagerId ;
      ...
      private Guid[] H003G2_A11OrganisationId ;
      private Guid[] H003G2_A21ManagerId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H003G3_A11OrganisationId ;
      private Guid[] H003G3_A21ManagerId ;
      private string[] H003G3_A22ManagerGivenName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_managerview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10ManagerId",GXType.UniqueIdentifier,36,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H003G2", "SELECT OrganisationId, ManagerId FROM Trn_Manager WHERE ManagerId = :AV10ManagerId and OrganisationId = :AV11OrganisationId ORDER BY ManagerId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003G2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H003G3", "SELECT OrganisationId, ManagerId, ManagerGivenName FROM Trn_Manager WHERE (ManagerId = :AV10ManagerId and OrganisationId = :AV11OrganisationId) AND (ManagerId = :AV10ManagerId and OrganisationId = :AV11OrganisationId) ORDER BY ManagerId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003G3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
