...
namespace GeneXus.Programs {
   public class trn_medicalindicationview : GXDataArea
   {
      public trn_medicalindicationview( )
      {
      ...
      public trn_medicalindicationview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_MedicalIndicationId ,
                           string aP1_TabCode )
      {
         this.AV10MedicalIndicationId = aP0_MedicalIndicationId;
      ...
      {
         get {
            return "trn_medicalindicationview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_medicalindicationview.aspx"+UrlEncode(AV10MedicalIndicationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_medicalindicationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vMEDICALINDICATIONID", AV10MedicalIndicationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vMEDICALINDICATIONID", GetSecureSignedToken( "", AV10MedicalIndicationId, context));
         GXKey = Crypto.GetSiteKey( );
      }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_medicalindicationview.aspx"+UrlEncode(AV10MedicalIndicationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_medicalindicationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_MedicalIndicationView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Medical Indication View", "") ;
      }
      ...
      protected void WB6B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_MedicalIndicationView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_medicalindicationgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void START6B2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Medical Indication View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA6B2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_medicalindicationview.aspx")), "trn_medicalindicationview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_medicalindicationview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10MedicalIndicationId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10MedicalIndicationId", AV10MedicalIndicationId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vMEDICALINDICATIONID", GetSecureSignedToken( "", AV10MedicalIndicationId, context));
      ...
      protected void RF6B2( )
      {
         ...
         {
            /* Using cursor H006B2 */
            pr_default.execute(0, new Object[] {AV10MedicalIndicationId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A98MedicalIndicationId = H006B2_A98MedicalIndicationId[0];
               /* Execute user event: Load */
               E156B2 ();
      ...
      protected void E136B2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_medicalindicationww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H006B3 */
         pr_default.execute(1, new Object[] {AV10MedicalIndicationId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A98MedicalIndicationId = H006B3_A98MedicalIndicationId[0];
            A99MedicalIndicationName = H006B3_A99MedicalIndicationName[0];
            AV17GXLvl9 = 1;
            Form.Caption = A99MedicalIndicationName;
      ...
      protected void E146B2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_MedicalIndication",  StringUtil.Trim( A98MedicalIndicationId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_MedicalIndication",  2) )
         {
      ...
      protected void E116B2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_MedicalIndication",(short)2,StringUtil.Trim( A98MedicalIndicationId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E126B2( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_MedicalIndication",StringUtil.Trim( A98MedicalIndicationId.ToString()),(string)AV14RecordDescription,formatLink("trn_medicalindicationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_MedicalIndicationGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_medicalindicationgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_MedicalIndicationGeneral";
            WebComp_Webcomponent_general_Component = "Trn_MedicalIndicationGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10MedicalIndicationId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10MedicalIndicationId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10MedicalIndicationId", AV10MedicalIndicationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vMEDICALINDICATIONID", GetSecureSignedToken( "", AV10MedicalIndicationId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411289424661", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_medicalindicationview.js", "?202411289424661", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_medicalindicationgeneral_cell_Internalname = "TRN_MEDICALINDICATIONGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Medical Indication View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10MedicalIndicationId","fld":"vMEDICALINDICATIONID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E116B2","iparms":[{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E126B2","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID"}]""");
      ...
      {
         wcpOAV10MedicalIndicationId = Guid.Empty;
         wcpOAV8TabCode = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sDynURL = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H006B2_A98MedicalIndicationId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H006B3_A98MedicalIndicationId = new Guid[] {Guid.Empty} ;
         H006B3_A99MedicalIndicationName = new string[] {""} ;
         A99MedicalIndicationName = "";
         AV15Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_medicalindicationview__default(),
            new Object[][] {
                new Object[] {
               H006B2_A98MedicalIndicationId
               }
               , new Object[] {
               H006B3_A98MedicalIndicationId, H006B3_A99MedicalIndicationName
               }
            }
         );
      ...
      private string divTrn_medicalindicationgeneral_cell_Internalname ;
      ...
      private Guid AV10MedicalIndicationId ;
      private Guid wcpOAV10MedicalIndicationId ;
      ...
      private Guid[] H006B2_A98MedicalIndicationId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H006B3_A98MedicalIndicationId ;
      private string[] H006B3_A99MedicalIndicationName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_medicalindicationview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV10MedicalIndicationId",GXType.UniqueIdentifier,36,0)
          };
          Object[] prmH006B3;
          ...
          def= new CursorDef[] {
              new CursorDef("H006B2", "SELECT MedicalIndicationId FROM Trn_MedicalIndication WHERE MedicalIndicationId = :AV10MedicalIndicationId ORDER BY MedicalIndicationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006B2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H006B3", "SELECT MedicalIndicationId, MedicalIndicationName FROM Trn_MedicalIndication WHERE MedicalIndicationId = :AV10MedicalIndicationId ORDER BY MedicalIndicationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006B3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
