...
namespace GeneXus.Programs {
   public class trn_productservicetrn_tilewc : GXWebComponent
   {
      ...
      protected int subGridclient_rec_count_fnc( )
      {
         ...
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              ...
                                              A330SG_ToPageName } ,
                                              new int[]{
                                              TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN, TypeConstants.BOOLEAN
                                              }
         });
         /* Using cursor H00832 */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024118939144", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_productservicetrn_tilewc.js", "?2024118939145", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_productservicetrn_tilewc__default(),
            new Object[][] {
                new Object[] {
               H00832_A58ProductServiceId, H00832_n58ProductServiceId, H00832_A29LocationId, H00832_A11OrganisationId, H00832_A330SG_ToPageName, H00832_A329SG_ToPageId, H00832_n329SG_ToPageId, H00832_A406TileIconAlignment, H00832_A405TileTextAlignment, H00832_A404TileTextColor,
               H00832_A403TileBGImageUrl, H00832_n403TileBGImageUrl, H00832_A402TileBGColor, H00832_n402TileBGColor, H00832_A401TileIcon, H00832_n401TileIcon, H00832_A400TileName, H00832_A407TileId
               }
               , new Object[] {
               H00833_A58ProductServiceId, H00833_n58ProductServiceId, H00833_A29LocationId, H00833_A11OrganisationId, H00833_A330SG_ToPageName, H00833_A329SG_ToPageId, H00833_n329SG_ToPageId, H00833_A406TileIconAlignment, H00833_A405TileTextAlignment, H00833_A404TileTextColor,
               H00833_A403TileBGImageUrl, H00833_n403TileBGImageUrl, H00833_A402TileBGColor, H00833_n402TileBGColor, H00833_A401TileIcon, H00833_n401TileIcon, H00833_A400TileName, H00833_A407TileId
               }
            }
         );
         AV38Pgmname = "Trn_ProductServiceTrn_TileWC";
   ...
   public class trn_productservicetrn_tilewc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A330SG_ToPageName )
      {
         ...
         scmdbuf = "SELECT T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T2.Trn_PageName AS SG_ToPageName, T1.SG_ToPageId AS SG_ToPageId, T1.TileIconAlignment, T1.TileTextAlignment, T1.TileTextColor, T1.TileBGImageUrl, T1.TileBGColor, T1.TileIcon, T1.TileName, T1.TileId FROM (Trn_Tile T1 LEFT JOIN Trn_Page T2 ON T2.Trn_PageId = T1.SG_ToPageId)";
         AddWhere(sWhereString, "(T2.ProductServiceId = :AV8ProductServiceId)");
         AddWhere(sWhereString, "(T1.LocationId = :AV9LocationId)");
         AddWhere(sWhereString, "(T1.OrganisationId = :AV10OrganisationId)");
         scmdbuf += sWhereString;
         if ( ( AV16OrderedBy == 1 ) && ! AV17OrderedDsc )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T1.TileName, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 1 ) && ( AV17OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T1.TileName DESC, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 2 ) && ! AV17OrderedDsc )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 2 ) && ( AV17OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T1.TileId DESC";
         }
         else if ( ( AV16OrderedBy == 3 ) && ! AV17OrderedDsc )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T1.TileIcon, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 3 ) && ( AV17OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T1.TileIcon DESC, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 4 ) && ! AV17OrderedDsc )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T1.TileBGColor, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 4 ) && ( AV17OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T1.TileBGColor DESC, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 5 ) && ! AV17OrderedDsc )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T1.TileBGImageUrl, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 5 ) && ( AV17OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T1.TileBGImageUrl DESC, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 6 ) && ! AV17OrderedDsc )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T1.TileTextColor, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 6 ) && ( AV17OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T1.TileTextColor DESC, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 7 ) && ! AV17OrderedDsc )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T1.TileTextAlignment, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 7 ) && ( AV17OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T1.TileTextAlignment DESC, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 8 ) && ! AV17OrderedDsc )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T1.TileIconAlignment, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 8 ) && ( AV17OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T1.TileIconAlignment DESC, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 9 ) && ! AV17OrderedDsc )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T1.SG_ToPageId, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 9 ) && ( AV17OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T1.SG_ToPageId DESC, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 10 ) && ! AV17OrderedDsc )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId, T1.LocationId, T1.OrganisationId, T2.Trn_PageName, T1.TileId";
         }
         else if ( ( AV16OrderedBy == 10 ) && ( AV17OrderedDsc ) )
         {
            scmdbuf += " ORDER BY T2.ProductServiceId DESC, T1.LocationId DESC, T1.OrganisationId DESC, T2.Trn_PageName DESC, T1.TileId";
         }
