...
namespace GeneXus.Programs {
   public class trn_supplieragbtypeview : GXDataArea
   {
      ...
      {
         return "Trn_Supplier Agb Type View" ;
      }
      ...
      protected void WB530( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Back", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierAgbTypeView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrn_supplieragb_title_Internalname, "Agb Suppliers", "", "", lblTrn_supplieragb_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierAgbTypeView.htm");
            /* Div Control */
      ...
      protected void START532( )
      {
         ...
         Form.Meta.addItem("description", "Trn_Supplier Agb Type View", 0) ;
         context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198373676", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_supplieragbtypeview.js", "?202411198373676", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Trn_Supplier Agb Type View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
