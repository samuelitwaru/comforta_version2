...
namespace GeneXus.Programs {
   public class trn_residenttypegeneral : GXWebComponent
   {
      public trn_residenttypegeneral( )
      {
      ...
      public trn_residenttypegeneral( IGxContext context )
      {
      ...
      {
         this.A96ResidentTypeId = aP0_ResidentTypeId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)A96ResidentTypeId});
                  componentstart();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV14Pgmname = "Trn_ResidentTypeGeneral";
               WS6D2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Trn_Resident Type General") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_residenttypegeneral.aspx"+UrlEncode(A96ResidentTypeId.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_residenttypegeneral.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "Trn_ResidentTypeGeneral" ;
      }

      public override string GetPgmdesc( )
      {
         return "Trn_Resident Type General" ;
      }
      ...
      protected void WB6D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_residenttypegeneral.aspx");
            }
            ...
            GxWebStd.gx_label_element( context, edtResidentTypeName_Internalname, "Type Name", " AttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "start", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 14,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtResidentTypeName_Internalname, A97ResidentTypeName, StringUtil.RTrim( context.localUtil.Format( A97ResidentTypeName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResidentTypeName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtResidentTypeName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_ResidentTypeGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 5, "Update", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOUPDATE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_ResidentTypeGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 5, "Delete", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DODELETE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_ResidentTypeGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtResidentTypeId_Internalname, A96ResidentTypeId.ToString(), A96ResidentTypeId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtResidentTypeId_Jsonclick, 0, "Attribute", "", "", "", "", edtResidentTypeId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ResidentTypeGeneral.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START6D2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Trn_Resident Type General", 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_residenttypegeneral.aspx")), "trn_residenttypegeneral.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_residenttypegeneral.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF6D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A97ResidentTypeName = H006D2_A97ResidentTypeName[0];
      ...
      protected void STRUP6D0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            wcpOA96ResidentTypeId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA96ResidentTypeId"));
      ...
      protected void S112( )
      {
         ...
         AV8TrnContext.gxTpr_Transactionname = "Trn_ResidentType";
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA96ResidentTypeId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_residenttypegeneral", GetJustCreated( ));
         ...
         {
            A96ResidentTypeId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "A96ResidentTypeId", A96ResidentTypeId.ToString());
         }
         wcpOA96ResidentTypeId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOA96ResidentTypeId"));
         if ( ! GetJustCreated( ) && ( ( A96ResidentTypeId != wcpOA96ResidentTypeId ) ) )
         {
            setjustcreated();
         }
         wcpOA96ResidentTypeId = A96ResidentTypeId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA96ResidentTypeId = cgiGet( sPrefix+"A96ResidentTypeId_CTRL");
         if ( StringUtil.Len( sCtrlA96ResidentTypeId) > 0 )
         {
            A96ResidentTypeId = StringUtil.StrToGuid( cgiGet( sCtrlA96ResidentTypeId));
            AssignAttri(sPrefix, false, "A96ResidentTypeId", A96ResidentTypeId.ToString());
         }
         else
         {
            A96ResidentTypeId = StringUtil.StrToGuid( cgiGet( sPrefix+"A96ResidentTypeId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A96ResidentTypeId_PARM", A96ResidentTypeId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA96ResidentTypeId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A96ResidentTypeId_CTRL", StringUtil.RTrim( sCtrlA96ResidentTypeId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719464240", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_residenttypegeneral.js", "?202492719464240", false, true);
      ...
      {
         wcpOA96ResidentTypeId = Guid.Empty;
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV14Pgmname = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H006D2_A96ResidentTypeId = new Guid[] {Guid.Empty} ;
         H006D2_A97ResidentTypeName = new string[] {""} ;
         ...
         sCtrlA96ResidentTypeId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_residenttypegeneral__default(),
            new Object[][] {
                new Object[] {
               H006D2_A96ResidentTypeId, H006D2_A97ResidentTypeName
               }
            }
         );
         AV14Pgmname = "Trn_ResidentTypeGeneral";
      ...
      private Guid[] H006D2_A96ResidentTypeId ;
      private string[] H006D2_A97ResidentTypeName ;
   ...
   public class trn_residenttypegeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006D2", "SELECT ResidentTypeId, ResidentTypeName FROM Trn_ResidentType WHERE ResidentTypeId = :ResidentTypeId ORDER BY ResidentTypeId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006D2,1, GxCacheFrequency.OFF ,true,true )
          };
       }
    }
