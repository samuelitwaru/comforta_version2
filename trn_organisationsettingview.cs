...
namespace GeneXus.Programs {
   public class trn_organisationsettingview : GXDataArea
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_organisationsettingview.aspx"+UrlEncode(AV10OrganisationSettingid.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
      ...
      {
         return "Trn_Organisation Setting View" ;
      }
      ...
      protected void WB3W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "Back", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_OrganisationSettingView.htm");
      ...
      protected void START3W2( )
      {
         ...
         Form.Meta.addItem("description", "Trn_Organisation Setting View", 0) ;
         context.wjLoc = "";
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            ...
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10OrganisationSettingid});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719491947", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_organisationsettingview.js", "?202492719491947", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Trn_Organisation Setting View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A100OrganisationSettingid","fld":"ORGANISATIONSETTINGID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV10OrganisationSettingid","fld":"vORGANISATIONSETTINGID","hsh":true}]""");
         ...
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E123W2","iparms":[{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A100OrganisationSettingid","fld":"ORGANISATIONSETTINGID"}]""");
