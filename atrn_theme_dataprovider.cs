...
namespace GeneXus.Programs {
   public class atrn_theme_dataprovider : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         Gxm3trn_theme_icon.gxTpr_Iconname = "PrimaryColor";
         Gxm3trn_theme_icon.gxTpr_Iconsvg = "Warm Coral";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "PrimaryColor";
         Gxm4trn_theme_color.gxTpr_Colorcode = "#ff6f61";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "SecondaryColor";
         Gxm4trn_theme_color.gxTpr_Colorcode = "#56c8d8";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "BackgroundColor";
         Gxm4trn_theme_color.gxTpr_Colorcode = "#f0f4f8";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "TextColor";
         Gxm4trn_theme_color.gxTpr_Colorcode = "#343a40";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "ButtonBgColor";
         Gxm4trn_theme_color.gxTpr_Colorcode = "#f6d365";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "ButtonTextColor";
         Gxm4trn_theme_color.gxTpr_Colorcode = "#ffffff";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "CardBgColor";
         Gxm4trn_theme_color.gxTpr_Colorcode = "#ffffff";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "CardTextColor";
         Gxm4trn_theme_color.gxTpr_Colorcode = "#343a40";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "AccentColor";
         Gxm4trn_theme_color.gxTpr_Colorcode = "#6a5acd";
         Gxm1trn_theme = new SdtTrn_Theme(context);
         Gxm2rootcol.Add(Gxm1trn_theme, 0);
         Gxm1trn_theme.gxTpr_Trn_themename = "Calm";
         Gxm1trn_theme.gxTpr_Trn_themefontfamily = "Arial";
         Gxm3trn_theme_icon = new SdtTrn_Theme_Icon(context);
         Gxm1trn_theme.gxTpr_Icon.Add(Gxm3trn_theme_icon, 0);
         Gxm3trn_theme_icon.gxTpr_Iconname = "PrimaryColor";
         Gxm3trn_theme_icon.gxTpr_Iconsvg = "Soft Blue";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "PrimaryColor";
         ...
         Gxm1trn_theme = new SdtTrn_Theme(context);
         Gxm2rootcol.Add(Gxm1trn_theme, 0);
         Gxm1trn_theme.gxTpr_Trn_themename = "Vibrant";
         Gxm1trn_theme.gxTpr_Trn_themefontfamily = "Comic Sans MS";
         Gxm3trn_theme_icon = new SdtTrn_Theme_Icon(context);
         Gxm1trn_theme.gxTpr_Icon.Add(Gxm3trn_theme_icon, 0);
         Gxm3trn_theme_icon.gxTpr_Iconname = "PrimaryColor";
         Gxm3trn_theme_icon.gxTpr_Iconsvg = "Bright Red-Orange";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "PrimaryColor";
         ...
         Gxm1trn_theme = new SdtTrn_Theme(context);
         Gxm2rootcol.Add(Gxm1trn_theme, 0);
         Gxm1trn_theme.gxTpr_Trn_themename = "Minimal";
         Gxm1trn_theme.gxTpr_Trn_themefontfamily = "Merriweather, serif";
         Gxm3trn_theme_icon = new SdtTrn_Theme_Icon(context);
         Gxm1trn_theme.gxTpr_Icon.Add(Gxm3trn_theme_icon, 0);
         Gxm3trn_theme_icon.gxTpr_Iconname = "PrimaryColor";
         Gxm3trn_theme_icon.gxTpr_Iconsvg = "Muted Sky Blue";
         Gxm4trn_theme_color = new SdtTrn_Theme_Color(context);
         Gxm1trn_theme.gxTpr_Color.Add(Gxm4trn_theme_color, 0);
         Gxm4trn_theme_color.gxTpr_Colorname = "PrimaryColor";
