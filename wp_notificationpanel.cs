...
namespace GeneXus.Programs {
   public class wp_notificationpanel : GXDataArea
   {
      public wp_notificationpanel( )
      {
      ...
      public wp_notificationpanel( IGxContext context )
      {
      ...
      {
         get {
            return "wp_notificationpanel_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_notificationpanel.aspx") +"\">") ;
      ...
      {
         return formatLink("wp_notificationpanel.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WP_NotificationPanel" ;
      }
      ...
      protected void WB820( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavIstoallusers_Internalname, StringUtil.BoolToStr( AV9isToAllUsers), "", "", chkavIstoallusers.Visible, 1, "true", "", StyleString, ClassString, "", "", TempTags+" onclick="+"\"gx.fn.checkboxClick(35, this, 'true', 'false',"+"''"+");"+"gx.evt.onchange(this, event);\""+" onblur=\""+""+";gx.evt.onblur(this,35);\"");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         AssignAttri("", false, "AV9isToAllUsers", AV9isToAllUsers);
      }
      ...
      protected void E11822( )
      {
         ...
         AssignProp("", false, chkavIstoallusers_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(chkavIstoallusers.Visible), 5, 0), true);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411422344998", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_notificationpanel.js", "?202411422344998", false, true);
      ...
      protected void init_web_controls( )
      {
         ...
         AssignProp("", false, chkavIstoallusers_Internalname, "TitleCaption", chkavIstoallusers.Caption, true);
      ...
      protected void init_default_properties( )
      {
         ...
         bttBtnsendnotification_Internalname = "BTNSENDNOTIFICATION";
         divTablemain_Internalname = "TABLEMAIN";
         chkavIstoallusers_Internalname = "vISTOALLUSERS";
