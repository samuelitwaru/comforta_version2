...
namespace GeneXus.Programs {
   public class trn_organisationtrn_organisationsettingwc : GXWebComponent
   {
      public trn_organisationtrn_organisationsettingwc( )
      {
      ...
      public trn_organisationtrn_organisationsettingwc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV27IsAuthorized_OrganisationSettingBaseColor = StringUtil.StrToBool( GetPar( "IsAuthorized_OrganisationSettingBaseColor"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV8OrganisationId, AV20ManageFiltersExecutionStep, AV37Pgmname, AV31IsAuthorized_Display, AV33IsAuthorized_Update, AV35IsAuthorized_Delete, AV27IsAuthorized_OrganisationSettingBaseColor, AV36IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV37Pgmname = "Trn_OrganisationTrn_OrganisationSettingWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Trn_Organisation Trn_Organisation Setting WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_organisationtrn_organisationsettingwc.aspx", new object[] {UrlEncode(AV8OrganisationId.ToString())}, new string[] {"OrganisationId"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_ORGANISATIONSETTINGBASECOLOR", AV27IsAuthorized_OrganisationSettingBaseColor);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_ORGANISATIONSETTINGBASECOLOR", GetSecureSignedToken( sPrefix, AV27IsAuthorized_OrganisationSettingBaseColor, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vORGANISATIONSETTINGLANGUAGE_DATA", AV28OrganisationSettingLanguage_Data);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vORGANISATIONSETTINGLANGUAGE_DATA", AV28OrganisationSettingLanguage_Data);
         }
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Cls", StringUtil.RTrim( Combo_organisationsettinglanguage_Cls));
         GxWebStd.gx_hidden_field( context, sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Titlecontrolidtoreplace", StringUtil.RTrim( Combo_organisationsettinglanguage_Titlecontrolidtoreplace));
         GxWebStd.gx_hidden_field( context, sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Datalisttype", StringUtil.RTrim( Combo_organisationsettinglanguage_Datalisttype));
         GxWebStd.gx_hidden_field( context, sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Allowmultipleselection", StringUtil.BoolToStr( Combo_organisationsettinglanguage_Allowmultipleselection));
         GxWebStd.gx_hidden_field( context, sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Datalistfixedvalues", StringUtil.RTrim( Combo_organisationsettinglanguage_Datalistfixedvalues));
         GxWebStd.gx_hidden_field( context, sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Isgriditem", StringUtil.BoolToStr( Combo_organisationsettinglanguage_Isgriditem));
         GxWebStd.gx_hidden_field( context, sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Includeonlyselectedoption", StringUtil.BoolToStr( Combo_organisationsettinglanguage_Includeonlyselectedoption));
         GxWebStd.gx_hidden_field( context, sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Multiplevaluestype", StringUtil.RTrim( Combo_organisationsettinglanguage_Multiplevaluestype));
         GxWebStd.gx_hidden_field( context, sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Emptyitemtext", StringUtil.RTrim( Combo_organisationsettinglanguage_Emptyitemtext));
      ...
      {
         return "Trn_OrganisationTrn_OrganisationSettingWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Trn_Organisation Trn_Organisation Setting WC" ;
      }
      ...
      protected void WB450( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_organisationtrn_organisationsettingwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(35), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_OrganisationTrn_OrganisationSettingWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 35 )
         {
            ...
            ucCombo_organisationsettinglanguage.SetProperty("DropDownOptionsTitleSettingsIcons", AV21DDO_TitleSettingsIcons);
            ucCombo_organisationsettinglanguage.SetProperty("DropDownOptionsData", AV28OrganisationSettingLanguage_Data);
            ucCombo_organisationsettinglanguage.Render(context, "dvelop.gxbootstrap.ddoextendedcombo", Combo_organisationsettinglanguage_Internalname, sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGEContainer");
            /* User Defined Control */
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtOrganisationId_Internalname, A11OrganisationId.ToString(), A11OrganisationId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtOrganisationId_Jsonclick, 0, "Attribute", "", "", "", "", edtOrganisationId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_OrganisationTrn_OrganisationSettingWC.htm");
            /* User Defined Control */
      ...
      protected void START452( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Trn_Organisation Trn_Organisation Setting WC", 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp(sPrefix, false, edtOrganisationSettingLogo_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A101OrganisationSettingLogo)) ? A40000OrganisationSettingLogo_GXI : context.convertURL( context.PathToRelativeUrl( A101OrganisationSettingLogo))), !bGXsfl_35_Refreshing);
                              AssignProp(sPrefix, false, edtOrganisationSettingLogo_Internalname, "SrcSet", context.GetImageSrcSet( A101OrganisationSettingLogo), true);
                              A102OrganisationSettingFavicon = cgiGet( edtOrganisationSettingFavicon_Internalname);
                              AssignProp(sPrefix, false, edtOrganisationSettingFavicon_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A102OrganisationSettingFavicon)) ? A40001OrganisationSettingFavicon_GXI : context.convertURL( context.PathToRelativeUrl( A102OrganisationSettingFavicon))), !bGXsfl_35_Refreshing);
                              AssignProp(sPrefix, false, edtOrganisationSettingFavicon_Internalname, "SrcSet", context.GetImageSrcSet( A102OrganisationSettingFavicon), true);
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV27IsAuthorized_OrganisationSettingBaseColor ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ORGANISATIONSETTINGID", GetSecureSignedToken( sPrefix, A100OrganisationSettingid, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"ORGANISATIONSETTINGID", A100OrganisationSettingid.ToString());
      }
      ...
      protected void RF452( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H00452 */
            pr_default.execute(0, new Object[] {AV8OrganisationId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A11OrganisationId = H00452_A11OrganisationId[0];
               AssignAttri(sPrefix, false, "A11OrganisationId", A11OrganisationId.ToString());
               A105OrganisationSettingLanguage = H00452_A105OrganisationSettingLanguage[0];
               A104OrganisationSettingFontSize = H00452_A104OrganisationSettingFontSize[0];
               A103OrganisationSettingBaseColor = H00452_A103OrganisationSettingBaseColor[0];
               A40001OrganisationSettingFavicon_GXI = H00452_A40001OrganisationSettingFavicon_GXI[0];
               AssignProp(sPrefix, false, edtOrganisationSettingFavicon_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A102OrganisationSettingFavicon)) ? A40001OrganisationSettingFavicon_GXI : context.convertURL( context.PathToRelativeUrl( A102OrganisationSettingFavicon))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtOrganisationSettingFavicon_Internalname, "SrcSet", context.GetImageSrcSet( A102OrganisationSettingFavicon), true);
               A40000OrganisationSettingLogo_GXI = H00452_A40000OrganisationSettingLogo_GXI[0];
               AssignProp(sPrefix, false, edtOrganisationSettingLogo_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A101OrganisationSettingLogo)) ? A40000OrganisationSettingLogo_GXI : context.convertURL( context.PathToRelativeUrl( A101OrganisationSettingLogo))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtOrganisationSettingLogo_Internalname, "SrcSet", context.GetImageSrcSet( A101OrganisationSettingLogo), true);
               A100OrganisationSettingid = H00452_A100OrganisationSettingid[0];
               A102OrganisationSettingFavicon = H00452_A102OrganisationSettingFavicon[0];
               AssignProp(sPrefix, false, edtOrganisationSettingFavicon_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A102OrganisationSettingFavicon)) ? A40001OrganisationSettingFavicon_GXI : context.convertURL( context.PathToRelativeUrl( A102OrganisationSettingFavicon))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtOrganisationSettingFavicon_Internalname, "SrcSet", context.GetImageSrcSet( A102OrganisationSettingFavicon), true);
               A101OrganisationSettingLogo = H00452_A101OrganisationSettingLogo[0];
               AssignProp(sPrefix, false, edtOrganisationSettingLogo_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A101OrganisationSettingLogo)) ? A40000OrganisationSettingLogo_GXI : context.convertURL( context.PathToRelativeUrl( A101OrganisationSettingLogo))), !bGXsfl_35_Refreshing);
               AssignProp(sPrefix, false, edtOrganisationSettingLogo_Internalname, "SrcSet", context.GetImageSrcSet( A101OrganisationSettingLogo), true);
               /* Execute user event: Grid.Load */
               E18452 ();
      ...
      protected void send_integrity_lvl_hashes452( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV36IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV36IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ORGANISATIONSETTINGID"+"_"+sGXsfl_35_idx, GetSecureSignedToken( sPrefix+sGXsfl_35_idx, A100OrganisationSettingid, context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H00453 */
         pr_default.execute(1, new Object[] {AV8OrganisationId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
      ...
      protected void STRUP450( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vORGANISATIONSETTINGLANGUAGE_DATA"), AV28OrganisationSettingLanguage_Data);
            /* Read saved values. */
            ...
            Combo_organisationsettinglanguage_Cls = cgiGet( sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Cls");
            Combo_organisationsettinglanguage_Titlecontrolidtoreplace = cgiGet( sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Titlecontrolidtoreplace");
            Combo_organisationsettinglanguage_Datalisttype = cgiGet( sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Datalisttype");
            Combo_organisationsettinglanguage_Allowmultipleselection = StringUtil.StrToBool( cgiGet( sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Allowmultipleselection"));
            Combo_organisationsettinglanguage_Datalistfixedvalues = cgiGet( sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Datalistfixedvalues");
            Combo_organisationsettinglanguage_Isgriditem = StringUtil.StrToBool( cgiGet( sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Isgriditem"));
            Combo_organisationsettinglanguage_Includeonlyselectedoption = StringUtil.StrToBool( cgiGet( sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Includeonlyselectedoption"));
            Combo_organisationsettinglanguage_Multiplevaluestype = cgiGet( sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Multiplevaluestype");
            Combo_organisationsettinglanguage_Emptyitemtext = cgiGet( sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE_Emptyitemtext");
      ...
      protected void E16452( )
      {
         ...
         ucCombo_organisationsettinglanguage.SendProperty(context, sPrefix, false, Combo_organisationsettinglanguage_Internalname, "TitleControlIdToReplace", Combo_organisationsettinglanguage_Titlecontrolidtoreplace);
         ...
         GXt_boolean2 = AV27IsAuthorized_OrganisationSettingBaseColor;
         ...
         AV27IsAuthorized_OrganisationSettingBaseColor = GXt_boolean2;
         AssignAttri(sPrefix, false, "AV27IsAuthorized_OrganisationSettingBaseColor", AV27IsAuthorized_OrganisationSettingBaseColor);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_ORGANISATIONSETTINGBASECOLOR", GetSecureSignedToken( sPrefix, AV27IsAuthorized_OrganisationSettingBaseColor, context));
      ...
      private void E18452( )
      {
         ...
         {
            edtavDisplay_Link = formatLink("trn_organisationsettingview.aspx", new object[] {UrlEncode(A100OrganisationSettingid.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"OrganisationSettingid","TabCode"}) ;
         }
         AV32Update = "<i class=\"fa fa-pen\"></i>";
         AssignAttri(sPrefix, false, edtavUpdate_Internalname, AV32Update);
         if ( AV33IsAuthorized_Update )
         {
            edtavUpdate_Link = formatLink("trn_organisationsetting.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(A100OrganisationSettingid.ToString())}, new string[] {"Mode","OrganisationSettingid"}) ;
         }
         AV34Delete = "<i class=\"fa fa-times\"></i>";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV34Delete);
         if ( AV35IsAuthorized_Delete )
         {
            edtavDelete_Link = formatLink("trn_organisationsetting.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(A100OrganisationSettingid.ToString())}, new string[] {"Mode","OrganisationSettingid"}) ;
         }
         if ( AV27IsAuthorized_OrganisationSettingBaseColor )
         {
            edtOrganisationSettingBaseColor_Link = formatLink("trn_organisationsettingview.aspx", new object[] {UrlEncode(A100OrganisationSettingid.ToString()),UrlEncode(StringUtil.RTrim(""))}, new string[] {"OrganisationSettingid","TabCode"}) ;
         }
         /* Load Method */
         if ( wbStart != -1 )
         {
      ...
      protected void E11452( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            context.PopUp(formatLink("wwpbaseobjects.savefilteras.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_OrganisationTrn_OrganisationSettingWCFilters")),UrlEncode(StringUtil.RTrim(AV37Pgmname+"GridState"))}, new string[] {"UserKey","GridStateKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
         ...
         {
            context.PopUp(formatLink("wwpbaseobjects.managefilters.aspx", new object[] {UrlEncode(StringUtil.RTrim("Trn_OrganisationTrn_OrganisationSettingWCFilters"))}, new string[] {"UserKey"}) , new Object[] {});
            AV20ManageFiltersExecutionStep = 2;
            AssignAttri(sPrefix, false, "AV20ManageFiltersExecutionStep", StringUtil.Str( (decimal)(AV20ManageFiltersExecutionStep), 1, 0));
            context.DoAjaxRefreshCmp(sPrefix);
         }
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_OrganisationTrn_OrganisationSettingWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void E15452( )
      {
         ...
         {
            CallWebObject(formatLink("trn_organisationsetting.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(Guid.Empty.ToString())}, new string[] {"Mode","OrganisationSettingid"}) );
      ...
      protected void S162( )
      {
         ...
         returnInSub = false;
         GXt_boolean2 = AV31IsAuthorized_Display;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_organisationsettingview_Execute", out  GXt_boolean2) ;
         AV31IsAuthorized_Display = GXt_boolean2;
         ...
         GXt_boolean2 = AV33IsAuthorized_Update;
         ...
         AV33IsAuthorized_Update = GXt_boolean2;
         ...
         GXt_boolean2 = AV35IsAuthorized_Delete;
         ...
         AV35IsAuthorized_Delete = GXt_boolean2;
         ...
         GXt_boolean2 = AV36IsAuthorized_Insert;
         ...
         AV36IsAuthorized_Insert = GXt_boolean2;
      ...
      protected void S122( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_OrganisationTrn_OrganisationSettingWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S132( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Trn_OrganisationSetting";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_organisationtrn_organisationsettingwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202491914472483", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_organisationtrn_organisationsettingwc.js", "?202491914472483", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtOrganisationSettingid_Internalname = sPrefix+"ORGANISATIONSETTINGID_"+sGXsfl_35_idx;
         edtOrganisationSettingLogo_Internalname = sPrefix+"ORGANISATIONSETTINGLOGO_"+sGXsfl_35_idx;
         edtOrganisationSettingFavicon_Internalname = sPrefix+"ORGANISATIONSETTINGFAVICON_"+sGXsfl_35_idx;
         edtOrganisationSettingBaseColor_Internalname = sPrefix+"ORGANISATIONSETTINGBASECOLOR_"+sGXsfl_35_idx;
         edtOrganisationSettingFontSize_Internalname = sPrefix+"ORGANISATIONSETTINGFONTSIZE_"+sGXsfl_35_idx;
         edtOrganisationSettingLanguage_Internalname = sPrefix+"ORGANISATIONSETTINGLANGUAGE_"+sGXsfl_35_idx;
      ...
      {
         edtOrganisationSettingid_Internalname = sPrefix+"ORGANISATIONSETTINGID_"+sGXsfl_35_fel_idx;
         edtOrganisationSettingLogo_Internalname = sPrefix+"ORGANISATIONSETTINGLOGO_"+sGXsfl_35_fel_idx;
         edtOrganisationSettingFavicon_Internalname = sPrefix+"ORGANISATIONSETTINGFAVICON_"+sGXsfl_35_fel_idx;
         edtOrganisationSettingBaseColor_Internalname = sPrefix+"ORGANISATIONSETTINGBASECOLOR_"+sGXsfl_35_fel_idx;
         edtOrganisationSettingFontSize_Internalname = sPrefix+"ORGANISATIONSETTINGFONTSIZE_"+sGXsfl_35_fel_idx;
         edtOrganisationSettingLanguage_Internalname = sPrefix+"ORGANISATIONSETTINGLANGUAGE_"+sGXsfl_35_fel_idx;
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtOrganisationSettingid_Internalname,A100OrganisationSettingid.ToString(),A100OrganisationSettingid.ToString(),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtOrganisationSettingid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)36,(short)0,(short)0,(short)35,(short)0,(short)0,(short)0,(bool)true,(string)"Id",(string)"",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl35( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( "Logo") ;
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( "Favicon") ;
            context.WriteHtmlTextNl( "</th>") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtOrganisationSettingLogo_Internalname = sPrefix+"ORGANISATIONSETTINGLOGO";
         edtOrganisationSettingFavicon_Internalname = sPrefix+"ORGANISATIONSETTINGFAVICON";
         ...
         edtOrganisationSettingLanguage_Internalname = sPrefix+"ORGANISATIONSETTINGLANGUAGE";
         ...
         Combo_organisationsettinglanguage_Internalname = sPrefix+"COMBO_ORGANISATIONSETTINGLANGUAGE";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "3:OrganisationSettingBaseColor|4:OrganisationSettingFontSize|5:OrganisationSettingLanguage";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV8OrganisationId","fld":"vORGANISATIONID"},{"av":"sPrefix"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_OrganisationSettingBaseColor","fld":"vISAUTHORIZED_ORGANISATIONSETTINGBASECOLOR","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV24GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV25GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV26GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV18ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E12452","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationId","fld":"vORGANISATIONID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_OrganisationSettingBaseColor","fld":"vISAUTHORIZED_ORGANISATIONSETTINGBASECOLOR","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E13452","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationId","fld":"vORGANISATIONID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_OrganisationSettingBaseColor","fld":"vISAUTHORIZED_ORGANISATIONSETTINGBASECOLOR","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E14452","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationId","fld":"vORGANISATIONID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_OrganisationSettingBaseColor","fld":"vISAUTHORIZED_ORGANISATIONSETTINGBASECOLOR","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18452","iparms":[{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"A100OrganisationSettingid","fld":"ORGANISATIONSETTINGID","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_OrganisationSettingBaseColor","fld":"vISAUTHORIZED_ORGANISATIONSETTINGBASECOLOR","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV30Display","fld":"vDISPLAY"},{"av":"edtavDisplay_Link","ctrl":"vDISPLAY","prop":"Link"},{"av":"AV32Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV34Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtOrganisationSettingBaseColor_Link","ctrl":"ORGANISATIONSETTINGBASECOLOR","prop":"Link"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E11452","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationId","fld":"vORGANISATIONID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_OrganisationSettingBaseColor","fld":"vISAUTHORIZED_ORGANISATIONSETTINGBASECOLOR","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV12GridState","fld":"vGRIDSTATE"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV24GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV25GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV26GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV18ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E15452","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationId","fld":"vORGANISATIONID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV27IsAuthorized_OrganisationSettingBaseColor","fld":"vISAUTHORIZED_ORGANISATIONSETTINGBASECOLOR","hsh":true},{"av":"AV36IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A100OrganisationSettingid","fld":"ORGANISATIONSETTINGID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV28OrganisationSettingLanguage_Data = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item>( context, "Item", "");
         ...
         AV34Delete = "";
         lV16FilterFullText = "";
         H00452_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00452_A105OrganisationSettingLanguage = new string[] {""} ;
         H00452_A104OrganisationSettingFontSize = new string[] {""} ;
         H00452_A103OrganisationSettingBaseColor = new string[] {""} ;
         H00452_A40001OrganisationSettingFavicon_GXI = new string[] {""} ;
         H00452_A40000OrganisationSettingLogo_GXI = new string[] {""} ;
         H00452_A100OrganisationSettingid = new Guid[] {Guid.Empty} ;
         H00452_A102OrganisationSettingFavicon = new string[] {""} ;
         H00452_A101OrganisationSettingLogo = new string[] {""} ;
         H00453_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_organisationtrn_organisationsettingwc__default(),
            new Object[][] {
                new Object[] {
               H00452_A11OrganisationId, H00452_A105OrganisationSettingLanguage, H00452_A104OrganisationSettingFontSize, H00452_A103OrganisationSettingBaseColor, H00452_A40001OrganisationSettingFavicon_GXI, H00452_A40000OrganisationSettingLogo_GXI, H00452_A100OrganisationSettingid, H00452_A102OrganisationSettingFavicon, H00452_A101OrganisationSettingLogo
               }
               , new Object[] {
      ...
      private bool AV27IsAuthorized_OrganisationSettingBaseColor ;
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTComboData_Item> AV28OrganisationSettingLanguage_Data ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPGridState AV12GridState ;
      private IDataStoreProvider pr_default ;
      private Guid[] H00452_A11OrganisationId ;
      private string[] H00452_A105OrganisationSettingLanguage ;
      private string[] H00452_A104OrganisationSettingFontSize ;
      private string[] H00452_A103OrganisationSettingBaseColor ;
      private string[] H00452_A40001OrganisationSettingFavicon_GXI ;
      private string[] H00452_A40000OrganisationSettingLogo_GXI ;
      private Guid[] H00452_A100OrganisationSettingid ;
      private string[] H00452_A102OrganisationSettingFavicon ;
      private string[] H00452_A101OrganisationSettingLogo ;
      private long[] H00453_AGRID_nRecordCount ;
   ...
   public class trn_organisationtrn_organisationsettingwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV8OrganisationId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " OrganisationId, OrganisationSettingLanguage, OrganisationSettingFontSize, OrganisationSettingBaseColor, OrganisationSettingFavicon_GXI, OrganisationSettingLogo_GXI, OrganisationSettingid, OrganisationSettingFavicon, OrganisationSettingLogo";
         ...
         {
            AddWhere(sWhereString, "(( OrganisationSettingBaseColor like '%' || :lV16FilterFullText) or ( OrganisationSettingFontSize like '%' || :lV16FilterFullText) or ( OrganisationSettingLanguage like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY OrganisationId, OrganisationSettingBaseColor, OrganisationSettingid";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY OrganisationId DESC, OrganisationSettingBaseColor DESC, OrganisationSettingid";
         }
         else if ( ( AV14OrderedBy == 2 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY OrganisationId, OrganisationSettingFontSize, OrganisationSettingid";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY OrganisationId DESC, OrganisationSettingFontSize DESC, OrganisationSettingid";
         }
         else if ( ( AV14OrderedBy == 3 ) && ! AV15OrderedDsc )
         {
            sOrderString += " ORDER BY OrganisationId, OrganisationSettingLanguage, OrganisationSettingid";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY OrganisationId DESC, OrganisationSettingLanguage DESC, OrganisationSettingid";
         }
         else if ( true )
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00452(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
               case 1 :
                     return conditional_H00453(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (short)dynConstraints[4] , (bool)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
             ...
             ,new CursorDef("H00453", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00453,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
