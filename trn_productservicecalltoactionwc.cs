...
namespace GeneXus.Programs {
   public class trn_productservicecalltoactionwc : GXWebComponent
   {
      public trn_productservicecalltoactionwc( )
      {
      ...
      public trn_productservicecalltoactionwc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV16OrderedBy, AV17OrderedDsc, AV8ProductServiceId, AV9LocationId, AV10OrganisationId, AV25Pgmname, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV25Pgmname = "Trn_ProductServiceCallToActionWC";
               WS6W2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  if ( nDynComponent == 0 )
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Trn_Product Service Call To Action WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_productservicecalltoactionwc.aspx"+UrlEncode(AV8ProductServiceId.ToString()) + "," + UrlEncode(AV9LocationId.ToString()) + "," + UrlEncode(AV10OrganisationId.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_productservicecalltoactionwc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      {
         return "Trn_ProductServiceCallToActionWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Product Service Call To Action WC", "") ;
      }
      ...
      protected void WB6W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_productservicecalltoactionwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         ...
         if ( wbEnd == 15 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtProductServiceId_Internalname, A58ProductServiceId.ToString(), A58ProductServiceId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtProductServiceId_Jsonclick, 0, "Attribute", "", "", "", "", edtProductServiceId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ProductServiceCallToActionWC.htm");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtLocationId_Internalname, A29LocationId.ToString(), A29LocationId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLocationId_Jsonclick, 0, "Attribute", "", "", "", "", edtLocationId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ProductServiceCallToActionWC.htm");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtOrganisationId_Internalname, A11OrganisationId.ToString(), A11OrganisationId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtOrganisationId_Jsonclick, 0, "Attribute", "", "", "", "", edtOrganisationId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_ProductServiceCallToActionWC.htm");
            /* User Defined Control */
      ...
      protected void START6W2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "Trn_Product Service Call To Action WC", ""), 0) ;
            context.wjLoc = "";
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_productservicecalltoactionwc.aspx")), "trn_productservicecalltoactionwc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_productservicecalltoactionwc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void RF6W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H006W2 */
            pr_default.execute(0, new Object[] {AV8ProductServiceId, AV9LocationId, AV10OrganisationId, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_15_idx = 1;
            sGXsfl_15_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_15_idx), 4, 0), 4, "0");
            SubsflControlProps_152( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A58ProductServiceId = H006W2_A58ProductServiceId[0];
               AssignAttri(sPrefix, false, "A58ProductServiceId", A58ProductServiceId.ToString());
               A29LocationId = H006W2_A29LocationId[0];
               AssignAttri(sPrefix, false, "A29LocationId", A29LocationId.ToString());
               A11OrganisationId = H006W2_A11OrganisationId[0];
               AssignAttri(sPrefix, false, "A11OrganisationId", A11OrganisationId.ToString());
               A371CallToActionLink = H006W2_A371CallToActionLink[0];
               A370CallToActionPhone = H006W2_A370CallToActionPhone[0];
               A369CallToActionEmail = H006W2_A369CallToActionEmail[0];
               A368CallToActionType = H006W2_A368CallToActionType[0];
               A367CallToActionId = H006W2_A367CallToActionId[0];
               /* Execute user event: Grid.Load */
               E166W2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H006W3_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void S112( )
      {
         ...
         AV12TrnContext.gxTpr_Transactionname = "Trn_ProductService";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_productservicecalltoactionwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024101016424781", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_productservicecalltoactionwc.js", "?2024101016424782", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         edtCallToActionId_Internalname = sPrefix+"CALLTOACTIONID_"+sGXsfl_15_idx;
         cmbCallToActionType_Internalname = sPrefix+"CALLTOACTIONTYPE_"+sGXsfl_15_idx;
         edtCallToActionEmail_Internalname = sPrefix+"CALLTOACTIONEMAIL_"+sGXsfl_15_idx;
         edtCallToActionPhone_Internalname = sPrefix+"CALLTOACTIONPHONE_"+sGXsfl_15_idx;
         edtCallToActionLink_Internalname = sPrefix+"CALLTOACTIONLINK_"+sGXsfl_15_idx;
      }

      protected void SubsflControlProps_fel_152( )
      {
         edtCallToActionId_Internalname = sPrefix+"CALLTOACTIONID_"+sGXsfl_15_fel_idx;
         cmbCallToActionType_Internalname = sPrefix+"CALLTOACTIONTYPE_"+sGXsfl_15_fel_idx;
         edtCallToActionEmail_Internalname = sPrefix+"CALLTOACTIONEMAIL_"+sGXsfl_15_fel_idx;
         edtCallToActionPhone_Internalname = sPrefix+"CALLTOACTIONPHONE_"+sGXsfl_15_fel_idx;
         edtCallToActionLink_Internalname = sPrefix+"CALLTOACTIONLINK_"+sGXsfl_15_fel_idx;
      }
      ...
      protected void sendrow_152( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_15_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            {
               GXCCtl = "CALLTOACTIONTYPE_" + sGXsfl_15_idx;
            ...
            AssignProp(sPrefix, false, cmbCallToActionType_Internalname, "Values", (string)(cmbCallToActionType.ToJavascriptSource()), !bGXsfl_15_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+""+"\">") ;
      ...
      protected void StartGridControl15( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            context.SendWebValue( context.GetMessage( "Action Link", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A371CallToActionLink));
            GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void init_default_properties( )
      {
         ...
         edtCallToActionLink_Internalname = sPrefix+"CALLTOACTIONLINK";
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Columnids = "0:CallToActionId|1:CallToActionType|2:CallToActionEmail|3:CallToActionPhone|4:CallToActionLink";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E166W2","iparms":[]}""");
      ...
      public override void initialize( )
      {
         ...
         GXDecQS = "";
         H006W2_A58ProductServiceId = new Guid[] {Guid.Empty} ;
         H006W2_A29LocationId = new Guid[] {Guid.Empty} ;
         H006W2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H006W2_A371CallToActionLink = new string[] {""} ;
         H006W2_A370CallToActionPhone = new string[] {""} ;
         H006W2_A369CallToActionEmail = new string[] {""} ;
         H006W2_A368CallToActionType = new string[] {""} ;
         H006W2_A367CallToActionId = new Guid[] {Guid.Empty} ;
         H006W3_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_productservicecalltoactionwc__default(),
            new Object[][] {
                new Object[] {
               H006W2_A58ProductServiceId, H006W2_A29LocationId, H006W2_A11OrganisationId, H006W2_A371CallToActionLink, H006W2_A370CallToActionPhone, H006W2_A369CallToActionEmail, H006W2_A368CallToActionType, H006W2_A367CallToActionId
               }
               , new Object[] {
               H006W3_AGRID_nRecordCount
               }
            }
         );
         AV25Pgmname = "Trn_ProductServiceCallToActionWC";
      ...
      private Guid[] H006W2_A58ProductServiceId ;
      private Guid[] H006W2_A29LocationId ;
      private Guid[] H006W2_A11OrganisationId ;
      private string[] H006W2_A371CallToActionLink ;
      private string[] H006W2_A370CallToActionPhone ;
      private string[] H006W2_A369CallToActionEmail ;
      private string[] H006W2_A368CallToActionType ;
      private Guid[] H006W2_A367CallToActionId ;
      private long[] H006W3_AGRID_nRecordCount ;
   ...
   public class trn_productservicecalltoactionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H006W2( IGxContext context ,
                                             short AV16OrderedBy ,
                                             bool AV17OrderedDsc ,
                                             Guid AV8ProductServiceId ,
                                             Guid AV9LocationId ,
                                             ...
                                             Guid A11OrganisationId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " ProductServiceId, LocationId, OrganisationId, CallToActionLink, CallToActionPhone, CallToActionEmail, CallToActionType, CallToActionId";
         sFromString = " FROM Trn_ProductServiceCallToAction";
         sOrderString = "";
         AddWhere(sWhereString, "(ProductServiceId = :AV8ProductServiceId and LocationId = :AV9LocationId and OrganisationId = :AV10OrganisationId)");
         if ( ( AV16OrderedBy == 1 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY ProductServiceId, LocationId, OrganisationId, CallToActionId";
         }
         else if ( ( AV16OrderedBy == 1 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY ProductServiceId DESC, LocationId DESC, OrganisationId DESC, CallToActionId DESC";
         }
         else if ( ( AV16OrderedBy == 2 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY ProductServiceId, LocationId, OrganisationId, CallToActionType, CallToActionId";
         }
         else if ( ( AV16OrderedBy == 2 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY ProductServiceId DESC, LocationId DESC, OrganisationId DESC, CallToActionType DESC, CallToActionId";
         }
         else if ( ( AV16OrderedBy == 3 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY ProductServiceId, LocationId, OrganisationId, CallToActionEmail, CallToActionId";
         }
         else if ( ( AV16OrderedBy == 3 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY ProductServiceId DESC, LocationId DESC, OrganisationId DESC, CallToActionEmail DESC, CallToActionId";
         }
         else if ( ( AV16OrderedBy == 4 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY ProductServiceId, LocationId, OrganisationId, CallToActionPhone, CallToActionId";
         }
         else if ( ( AV16OrderedBy == 4 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY ProductServiceId DESC, LocationId DESC, OrganisationId DESC, CallToActionPhone DESC, CallToActionId";
         }
         else if ( ( AV16OrderedBy == 5 ) && ! AV17OrderedDsc )
         {
            sOrderString += " ORDER BY ProductServiceId, LocationId, OrganisationId, CallToActionLink, CallToActionId";
         }
         else if ( ( AV16OrderedBy == 5 ) && ( AV17OrderedDsc ) )
         {
            sOrderString += " ORDER BY ProductServiceId DESC, LocationId DESC, OrganisationId DESC, CallToActionLink DESC, CallToActionId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY ProductServiceId, LocationId, OrganisationId, CallToActionId";
      ...
      protected Object[] conditional_H006W3( IGxContext context ,
                                             short AV16OrderedBy ,
                                             bool AV17OrderedDsc ,
                                             Guid AV8ProductServiceId ,
                                             Guid AV9LocationId ,
                                             ...
                                             Guid A11OrganisationId )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM Trn_ProductServiceCallToAction";
         AddWhere(sWhereString, "(ProductServiceId = :AV8ProductServiceId and LocationId = :AV9LocationId and OrganisationId = :AV10OrganisationId)");
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H006W2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
               case 1 :
                     return conditional_H006W3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (Guid)dynConstraints[2] , (Guid)dynConstraints[3] , (Guid)dynConstraints[4] , (Guid)dynConstraints[5] , (Guid)dynConstraints[6] , (Guid)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH006W3;
          prmH006W3 = new Object[] {
          new ParDef("AV8ProductServiceId",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV9LocationId",GXType.UniqueIdentifier,36,0) ,
          new ParDef("AV10OrganisationId",GXType.UniqueIdentifier,36,0)
          };
          def= new CursorDef[] {
              new CursorDef("H006W2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006W2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H006W3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006W3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
