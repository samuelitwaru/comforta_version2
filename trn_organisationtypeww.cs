...
namespace GeneXus.Programs {
   public class trn_organisationtypeww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedDsc, AV15FilterFullText, AV19ManageFiltersExecutionStep, AV38Pgmname, AV20TFOrganisationTypeName, AV21TFOrganisationTypeName_Sel, AV31IsAuthorized_Display, AV33IsAuthorized_Update, AV35IsAuthorized_Delete, AV36IsAuthorized_Insert) ;
      ...
      {
         /* GeneXus formulas. */
         AV38Pgmname = "Trn_OrganisationTypeWW";
      }
      ...
      protected void RF3V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV39Trn_organisationtypewwds_1_filterfulltext ,
                                                 AV41Trn_organisationtypewwds_3_tforganisationtypename_sel ,
                                                 AV40Trn_organisationtypewwds_2_tforganisationtypename ,
            ...
            lV39Trn_organisationtypewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV39Trn_organisationtypewwds_1_filterfulltext), "%", "");
            lV40Trn_organisationtypewwds_2_tforganisationtypename = StringUtil.Concat( StringUtil.RTrim( AV40Trn_organisationtypewwds_2_tforganisationtypename), "%", "");
            /* Using cursor H003V2 */
            pr_default.execute(0, new Object[] {lV39Trn_organisationtypewwds_1_filterfulltext, lV40Trn_organisationtypewwds_2_tforganisationtypename, AV41Trn_organisationtypewwds_3_tforganisationtypename_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
      ...
      {
         AV39Trn_organisationtypewwds_1_filterfulltext = AV15FilterFullText;
         AV40Trn_organisationtypewwds_2_tforganisationtypename = AV20TFOrganisationTypeName;
         AV41Trn_organisationtypewwds_3_tforganisationtypename_sel = AV21TFOrganisationTypeName_Sel;
         ...
         lV40Trn_organisationtypewwds_2_tforganisationtypename = StringUtil.Concat( StringUtil.RTrim( AV40Trn_organisationtypewwds_2_tforganisationtypename), "%", "");
         /* Using cursor H003V3 */
         pr_default.execute(1, new Object[] {lV39Trn_organisationtypewwds_1_filterfulltext, lV40Trn_organisationtypewwds_2_tforganisationtypename, AV41Trn_organisationtypewwds_3_tforganisationtypename_sel});
      ...
      protected void E113V2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_OrganisationTypeWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV38Pgmname+"GridState"));
      ...
      protected void E143V2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0051",(string)"",(string)"Trn_OrganisationType",(short)1,(string)"",(string)""});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102518432868", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_organisationtypeww.js", "?2024102518432870", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E193V2","iparms":[{"av":"AV31IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV33IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV35IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         A20OrganisationTypeName = "";
         lV39Trn_organisationtypewwds_1_filterfulltext = "";
         lV40Trn_organisationtypewwds_2_tforganisationtypename = "";
         AV39Trn_organisationtypewwds_1_filterfulltext = "";
         AV41Trn_organisationtypewwds_3_tforganisationtypename_sel = "";
         AV40Trn_organisationtypewwds_2_tforganisationtypename = "";
      ...
      private string lV39Trn_organisationtypewwds_1_filterfulltext ;
      private string lV40Trn_organisationtypewwds_2_tforganisationtypename ;
      private string AV39Trn_organisationtypewwds_1_filterfulltext ;
      private string AV41Trn_organisationtypewwds_3_tforganisationtypename_sel ;
      private string AV40Trn_organisationtypewwds_2_tforganisationtypename ;
   ...
   public class trn_organisationtypeww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003V2( IGxContext context ,
                                             string AV39Trn_organisationtypewwds_1_filterfulltext ,
                                             string AV41Trn_organisationtypewwds_3_tforganisationtypename_sel ,
                                             string AV40Trn_organisationtypewwds_2_tforganisationtypename ,
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV39Trn_organisationtypewwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( OrganisationTypeName like '%' || :lV39Trn_organisationtypewwds_1_filterfulltext))");
         }
         else
         {
            GXv_int5[0] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV41Trn_organisationtypewwds_3_tforganisationtypename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV40Trn_organisationtypewwds_2_tforganisationtypename)) ) )
         {
            AddWhere(sWhereString, "(OrganisationTypeName like :lV40Trn_organisationtypewwds_2_tforganisationtypename)");
         }
         else
         {
            GXv_int5[1] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV41Trn_organisationtypewwds_3_tforganisationtypename_sel)) && ! ( StringUtil.StrCmp(AV41Trn_organisationtypewwds_3_tforganisationtypename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(OrganisationTypeName = ( :AV41Trn_organisationtypewwds_3_tforganisationtypename_sel))");
         }
         else
         {
            GXv_int5[2] = 1;
         }
         if ( StringUtil.StrCmp(AV41Trn_organisationtypewwds_3_tforganisationtypename_sel, "<#Empty#>") == 0 )
         {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV39Trn_organisationtypewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV40Trn_organisationtypewwds_2_tforganisationtypename",GXType.VarChar,100,0) ,
          new ParDef("AV41Trn_organisationtypewwds_3_tforganisationtypename_sel",GXType.VarChar,100,0) ,
