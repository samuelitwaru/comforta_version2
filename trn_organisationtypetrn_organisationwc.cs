...
namespace GeneXus.Programs {
   public class trn_organisationtypetrn_organisationwc : GXWebComponent
   {
      public trn_organisationtypetrn_organisationwc( )
      {
      ...
      public trn_organisationtypetrn_organisationwc( IGxContext context )
      {
      ...
      {
         this.AV8OrganisationTypeId = aP0_OrganisationTypeId;
         ExecuteImpl();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV8OrganisationTypeId = StringUtil.StrToGuid( GetPar( "OrganisationTypeId"));
                  AssignAttri(sPrefix, false, "AV8OrganisationTypeId", AV8OrganisationTypeId.ToString());
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(Guid)AV8OrganisationTypeId});
                  componentstart();
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV28IsAuthorized_Display = StringUtil.StrToBool( GetPar( "IsAuthorized_Display"));
         AV30IsAuthorized_Update = StringUtil.StrToBool( GetPar( "IsAuthorized_Update"));
         AV32IsAuthorized_Delete = StringUtil.StrToBool( GetPar( "IsAuthorized_Delete"));
         AV35IsAuthorized_OrganisationName = StringUtil.StrToBool( GetPar( "IsAuthorized_OrganisationName"));
         AV33IsAuthorized_Insert = StringUtil.StrToBool( GetPar( "IsAuthorized_Insert"));
         sPrefix = GetPar( "sPrefix");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV16FilterFullText, AV8OrganisationTypeId, AV20ManageFiltersExecutionStep, AV36Pgmname, AV28IsAuthorized_Display, AV30IsAuthorized_Update, AV32IsAuthorized_Delete, AV35IsAuthorized_OrganisationName, AV33IsAuthorized_Insert, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV36Pgmname = "Trn_OrganisationTypeTrn_OrganisationWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Trn_Organisation Type Trn_Organisation WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            GXEncryptionTmp = "trn_organisationtypetrn_organisationwc.aspx"+UrlEncode(AV8OrganisationTypeId.ToString());
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_organisationtypetrn_organisationwc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DISPLAY", GetSecureSignedToken( sPrefix, AV28IsAuthorized_Display, context));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Delete, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_ORGANISATIONNAME", AV35IsAuthorized_OrganisationName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_ORGANISATIONNAME", GetSecureSignedToken( sPrefix, AV35IsAuthorized_OrganisationName, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV33IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV33IsAuthorized_Insert, context));
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV8OrganisationTypeId", wcpOAV8OrganisationTypeId.ToString());
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV33IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV33IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, sPrefix+"vORGANISATIONTYPEID", AV8OrganisationTypeId.ToString());
      ...
      {
         return "Trn_OrganisationTypeTrn_OrganisationWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Trn_Organisation Type Trn_Organisation WC" ;
      }
      ...
      protected void WB410( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "trn_organisationtypetrn_organisationwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(35), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_OrganisationTypeTrn_OrganisationWC.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         if ( wbEnd == 35 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtOrganisationTypeId_Internalname, A19OrganisationTypeId.ToString(), A19OrganisationTypeId.ToString(), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtOrganisationTypeId_Jsonclick, 0, "Attribute", "", "", "", "", edtOrganisationTypeId_Visible, 0, 0, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_OrganisationTypeTrn_OrganisationWC.htm");
            /* User Defined Control */
      ...
      protected void START412( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", "Trn_Organisation Type Trn_Organisation WC", 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignAttri(sPrefix, false, edtavDisplay_Internalname, AV27Display);
                              AV29Update = cgiGet( edtavUpdate_Internalname);
                              AssignAttri(sPrefix, false, edtavUpdate_Internalname, AV29Update);
                              AV31Delete = cgiGet( edtavDelete_Internalname);
                              AssignAttri(sPrefix, false, edtavDelete_Internalname, AV31Delete);
                              sEvtType = StringUtil.Right( sEvt, 1);
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               ...
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_organisationtypetrn_organisationwc.aspx")), "trn_organisationtypetrn_organisationwc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_organisationtypetrn_organisationwc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV35IsAuthorized_OrganisationName ,
                                       bool AV33IsAuthorized_Insert ,
                                       string sPrefix )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF412( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
            /* Using cursor H00412 */
            pr_default.execute(0, new Object[] {AV8OrganisationTypeId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A19OrganisationTypeId = H00412_A19OrganisationTypeId[0];
               AssignAttri(sPrefix, false, "A19OrganisationTypeId", A19OrganisationTypeId.ToString());
               A18OrganisationVATNumber = H00412_A18OrganisationVATNumber[0];
               A17OrganisationPhone = H00412_A17OrganisationPhone[0];
               A16OrganisationEmail = H00412_A16OrganisationEmail[0];
               A12OrganisationKvkNumber = H00412_A12OrganisationKvkNumber[0];
               A13OrganisationName = H00412_A13OrganisationName[0];
               A11OrganisationId = H00412_A11OrganisationId[0];
               /* Execute user event: Grid.Load */
               E18412 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV16FilterFullText = StringUtil.Concat( StringUtil.RTrim( AV16FilterFullText), "%", "");
         /* Using cursor H00413 */
         pr_default.execute(1, new Object[] {AV8OrganisationTypeId, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText});
         GRID_nRecordCount = H00413_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void before_start_formulas( )
      {
         ...
         AssignProp(sPrefix, false, edtOrganisationTypeId_Internalname, "Enabled", StringUtil.LTrimStr( (decimal)(edtOrganisationTypeId_Enabled), 5, 0), true);
         fix_multi_value_controls( ) ;
      }
      ...
      protected void STRUP410( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV8OrganisationTypeId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8OrganisationTypeId"));
      ...
      protected void E16412( )
      {
         ...
         GXt_boolean1 = AV35IsAuthorized_OrganisationName;
         ...
         AV35IsAuthorized_OrganisationName = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV35IsAuthorized_OrganisationName", AV35IsAuthorized_OrganisationName);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_ORGANISATIONNAME", GetSecureSignedToken( sPrefix, AV35IsAuthorized_OrganisationName, context));
         Ddo_grid_Gridinternalname = subGrid_Internalname;
         ucDdo_grid.SendProperty(context, sPrefix, false, Ddo_grid_Internalname, "GridInternalName", Ddo_grid_Gridinternalname);
         edtOrganisationTypeId_Visible = 0;
         AssignProp(sPrefix, false, edtOrganisationTypeId_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtOrganisationTypeId_Visible), 5, 0), true);
      ...
      private void E18412( )
      {
         ...
         if ( AV35IsAuthorized_OrganisationName )
         {
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
      ...
      protected void E11412( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_OrganisationTypeTrn_OrganisationWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV36Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("Trn_OrganisationTypeTrn_OrganisationWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_OrganisationTypeTrn_OrganisationWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void E15412( )
      {
         ...
         if ( AV33IsAuthorized_Insert )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "trn_organisation.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(Guid.Empty.ToString());
      ...
      protected void S152( )
      {
         ...
         AssignAttri(sPrefix, false, "AV28IsAuthorized_Display", AV28IsAuthorized_Display);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DISPLAY", GetSecureSignedToken( sPrefix, AV28IsAuthorized_Display, context));
         if ( ! ( AV28IsAuthorized_Display ) )
         {
         ...
         AssignAttri(sPrefix, false, "AV32IsAuthorized_Delete", AV32IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV32IsAuthorized_Delete, context));
         if ( ! ( AV32IsAuthorized_Delete ) )
         {
         ...
         GXt_boolean1 = AV33IsAuthorized_Insert;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_organisation_Insert", out  GXt_boolean1) ;
         AV33IsAuthorized_Insert = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV33IsAuthorized_Insert", AV33IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV33IsAuthorized_Insert, context));
         if ( ! ( AV33IsAuthorized_Insert ) )
         {
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_OrganisationTypeTrn_OrganisationWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S122( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Trn_Organisation";
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "OrganisationTypeId";
         AV11TrnContextAtt.gxTpr_Attributevalue = AV8OrganisationTypeId.ToString();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8OrganisationTypeId = (Guid)getParm(obj,0);
         AssignAttri(sPrefix, false, "AV8OrganisationTypeId", AV8OrganisationTypeId.ToString());
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV8OrganisationTypeId = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "trn_organisationtypetrn_organisationwc", GetJustCreated( ));
         ...
         {
            AV8OrganisationTypeId = (Guid)getParm(obj,2);
            AssignAttri(sPrefix, false, "AV8OrganisationTypeId", AV8OrganisationTypeId.ToString());
         }
         wcpOAV8OrganisationTypeId = StringUtil.StrToGuid( cgiGet( sPrefix+"wcpOAV8OrganisationTypeId"));
         if ( ! GetJustCreated( ) && ( ( AV8OrganisationTypeId != wcpOAV8OrganisationTypeId ) ) )
         {
            setjustcreated();
         }
         wcpOAV8OrganisationTypeId = AV8OrganisationTypeId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV8OrganisationTypeId = cgiGet( sPrefix+"AV8OrganisationTypeId_CTRL");
         if ( StringUtil.Len( sCtrlAV8OrganisationTypeId) > 0 )
         {
            AV8OrganisationTypeId = StringUtil.StrToGuid( cgiGet( sCtrlAV8OrganisationTypeId));
            AssignAttri(sPrefix, false, "AV8OrganisationTypeId", AV8OrganisationTypeId.ToString());
         }
         else
         {
            AV8OrganisationTypeId = StringUtil.StrToGuid( cgiGet( sPrefix+"AV8OrganisationTypeId_PARM"));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV8OrganisationTypeId_PARM", AV8OrganisationTypeId.ToString());
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV8OrganisationTypeId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV8OrganisationTypeId_CTRL", StringUtil.RTrim( sCtrlAV8OrganisationTypeId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719454766", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("trn_organisationtypetrn_organisationwc.js", "?202492719454766", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtOrganisationName_Internalname = sPrefix+"ORGANISATIONNAME_"+sGXsfl_35_idx;
         edtOrganisationKvkNumber_Internalname = sPrefix+"ORGANISATIONKVKNUMBER_"+sGXsfl_35_idx;
         edtOrganisationEmail_Internalname = sPrefix+"ORGANISATIONEMAIL_"+sGXsfl_35_idx;
         edtOrganisationPhone_Internalname = sPrefix+"ORGANISATIONPHONE_"+sGXsfl_35_idx;
         edtOrganisationVATNumber_Internalname = sPrefix+"ORGANISATIONVATNUMBER_"+sGXsfl_35_idx;
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtOrganisationName_Internalname = sPrefix+"ORGANISATIONNAME_"+sGXsfl_35_fel_idx;
         edtOrganisationKvkNumber_Internalname = sPrefix+"ORGANISATIONKVKNUMBER_"+sGXsfl_35_fel_idx;
         edtOrganisationEmail_Internalname = sPrefix+"ORGANISATIONEMAIL_"+sGXsfl_35_fel_idx;
         edtOrganisationPhone_Internalname = sPrefix+"ORGANISATIONPHONE_"+sGXsfl_35_fel_idx;
         edtOrganisationVATNumber_Internalname = sPrefix+"ORGANISATIONVATNUMBER_"+sGXsfl_35_fel_idx;
      ...
      protected void sendrow_352( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_35_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtOrganisationVATNumber_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A18OrganisationVATNumber), 8, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A18OrganisationVATNumber), "ZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtOrganisationVATNumber_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)35,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void StartGridControl35( )
      {
         ...
         else
         {
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV27Display)));
            GridColumn.AddObjectProperty("Enabled", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavDisplay_Enabled), 5, 0, ".", "")));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtavDisplay_Link));
            GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavDisplay_Visible), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV29Update)));
      ...
      protected void init_default_properties( )
      {
         ...
         edtOrganisationTypeId_Internalname = sPrefix+"ORGANISATIONTYPEID";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV8OrganisationTypeId","fld":"vORGANISATIONTYPEID"},{"av":"sPrefix"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV30IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV32IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV33IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV24GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV25GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV26GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV28IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV30IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV32IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV33IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV18ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E12412","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationTypeId","fld":"vORGANISATIONTYPEID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV30IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV32IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV33IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E13412","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationTypeId","fld":"vORGANISATIONTYPEID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV30IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV32IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV33IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E14412","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationTypeId","fld":"vORGANISATIONTYPEID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV30IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV32IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV33IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E18412","iparms":[{"av":"AV28IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"AV30IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV32IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV27Display","fld":"vDISPLAY"},{"av":"edtavDisplay_Link","ctrl":"vDISPLAY","prop":"Link"},{"av":"AV29Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV31Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtOrganisationName_Link","ctrl":"ORGANISATIONNAME","prop":"Link"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E11412","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationTypeId","fld":"vORGANISATIONTYPEID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV30IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV32IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV33IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV12GridState","fld":"vGRIDSTATE"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV24GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV25GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV26GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV28IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV30IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV32IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV33IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV18ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E15412","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV8OrganisationTypeId","fld":"vORGANISATIONTYPEID"},{"av":"AV20ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV28IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV30IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV32IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV33IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true}]""");
      ...
      {
         wcpOAV8OrganisationTypeId = Guid.Empty;
         ...
         GXDecQS = "";
         lV16FilterFullText = "";
         H00412_A19OrganisationTypeId = new Guid[] {Guid.Empty} ;
         H00412_A18OrganisationVATNumber = new int[1] ;
         H00412_A17OrganisationPhone = new string[] {""} ;
         H00412_A16OrganisationEmail = new string[] {""} ;
         H00412_A12OrganisationKvkNumber = new string[] {""} ;
         H00412_A13OrganisationName = new string[] {""} ;
         H00412_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H00413_AGRID_nRecordCount = new long[1] ;
         ...
         sCtrlAV8OrganisationTypeId = "";
         subGrid_Linesclass = "";
         ROClassString = "";
         gxphoneLink = "";
         GridColumn = new GXWebColumn();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_organisationtypetrn_organisationwc__default(),
            new Object[][] {
                new Object[] {
               H00412_A19OrganisationTypeId, H00412_A18OrganisationVATNumber, H00412_A17OrganisationPhone, H00412_A16OrganisationEmail, H00412_A12OrganisationKvkNumber, H00412_A13OrganisationName, H00412_A11OrganisationId
               }
               , new Object[] {
               H00413_AGRID_nRecordCount
               }
            }
         );
         AV36Pgmname = "Trn_OrganisationTypeTrn_OrganisationWC";
      ...
      private string sCtrlAV8OrganisationTypeId ;
      ...
      private bool AV35IsAuthorized_OrganisationName ;
      private bool AV33IsAuthorized_Insert ;
      ...
      private Guid AV8OrganisationTypeId ;
      private Guid wcpOAV8OrganisationTypeId ;
      ...
      private Guid[] H00412_A19OrganisationTypeId ;
      private int[] H00412_A18OrganisationVATNumber ;
      private string[] H00412_A17OrganisationPhone ;
      private string[] H00412_A16OrganisationEmail ;
      private string[] H00412_A12OrganisationKvkNumber ;
      private string[] H00412_A13OrganisationName ;
      private Guid[] H00412_A11OrganisationId ;
      private long[] H00413_AGRID_nRecordCount ;
   ...
   public class trn_organisationtypetrn_organisationwc__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00412( IGxContext context ,
                                             string AV16FilterFullText ,
                                             ...
                                             Guid AV8OrganisationTypeId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " OrganisationTypeId, OrganisationVATNumber, OrganisationPhone, OrganisationEmail, OrganisationKvkNumber, OrganisationName, OrganisationId";
         ...
         {
            AddWhere(sWhereString, "(( OrganisationName like '%' || :lV16FilterFullText) or ( OrganisationKvkNumber like '%' || :lV16FilterFullText) or ( OrganisationEmail like '%' || :lV16FilterFullText) or ( OrganisationPhone like '%' || :lV16FilterFullText) or ( SUBSTR(TO_CHAR(OrganisationVATNumber,'99999999'), 2) like '%' || :lV16FilterFullText))");
         }
         else
         {
            GXv_int5[1] = 1;
         ...
         {
            sOrderString += " ORDER BY OrganisationTypeId, OrganisationName, OrganisationId";
         }
         else if ( ( AV14OrderedBy == 1 ) && ( AV15OrderedDsc ) )
         {
            sOrderString += " ORDER BY OrganisationTypeId DESC, OrganisationName DESC, OrganisationId";
         }
      ...
      protected Object[] conditional_H00413( IGxContext context ,
                                             string AV16FilterFullText ,
                                             string A13OrganisationName ,
                                             string A12OrganisationKvkNumber ,
                                             string A16OrganisationEmail ,
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00412(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (int)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] , (Guid)dynConstraints[8] , (Guid)dynConstraints[9] );
               case 1 :
                     return conditional_H00413(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (string)dynConstraints[4] , (int)dynConstraints[5] , (short)dynConstraints[6] , (bool)dynConstraints[7] , (Guid)dynConstraints[8] , (Guid)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("AV8OrganisationTypeId",GXType.UniqueIdentifier,36,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00412", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00412,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00413", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00413,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
