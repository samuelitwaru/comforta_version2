...
namespace GeneXus.Programs {
   public class wp_agendacalendar : GXDataArea
   {
      public wp_agendacalendar( )
      {
      ...
      public wp_agendacalendar( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_agendacalendar.aspx") +"\">") ;
      ...
      {
         return formatLink("wp_agendacalendar.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WP_AgendaCalendar" ;
      }

      public override string GetPgmdesc( )
      {
         return "WP_Agenda Calendar" ;
      }
      ...
      protected void WB5F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncreateevent_Internalname, "", "Create Event", bttBtncreateevent_Jsonclick, 5, "Create Event", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOCREATEEVENT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WP_AgendaCalendar.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWwp_search_Internalname, "Search", "", "", lblWwp_search_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWP", 0, "", 1, 1, 0, 0, "HLP_WP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavTitlefilter_Internalname, AV36TitleFilter, StringUtil.RTrim( context.localUtil.Format( AV36TitleFilter, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Title", edtavTitlefilter_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavTitlefilter_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 0, -1, -1, true, "", "start", true, "", "HLP_WP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockdatetypefilter_Internalname, "Date", "", "", lblTextblockdatetypefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, 0, "HLP_WP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavDatetypefilter, cmbavDatetypefilter_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV20DateTypeFilter), 4, 0)), 1, cmbavDatetypefilter_Jsonclick, 7, "'"+""+"'"+",false,"+"'"+"e115f1_client"+"'", "int", "", 1, cmbavDatetypefilter.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,29);\"", "", true, 0, "HLP_WP_AgendaCalendar.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuaclear_Internalname, "", "Clear", bttBtnuaclear_Jsonclick, 5, "Clear", "", StyleString, ClassString, bttBtnuaclear_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOUACLEAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnuasearch_Internalname, "", "Search", bttBtnuasearch_Jsonclick, 5, "Search", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOUASEARCH\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndummydelete_Internalname, "", "Dummy Delete Event", bttBtndummydelete_Jsonclick, 7, "Dummy Delete Event", "", StyleString, ClassString, bttBtndummydelete_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"e125f1_client"+"'", TempTags, "", 2, "HLP_WP_AgendaCalendar.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            GxWebStd.gx_bitmap( context, edtavDate_showingdatesfrom_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((edtavDate_showingdatesfrom_Visible==0)||(1==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WP_AgendaCalendar.htm");
            context.WriteHtmlTextNl( "</div>") ;
      ...
      protected void START5F2( )
      {
         ...
         Form.Meta.addItem("description", "WP_Agenda Calendar", 0) ;
         context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492316272874", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_agendacalendar.js", "?202492316272874", false, true);
         context.AddJavascriptSource("DVelop/Calendar/index.global.min.js", "", false, true);
         context.AddJavascriptSource("DVelop/Calendar/WWPCalendarRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/daterangepicker/locales.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/daterangepicker/wwp-daterangepicker.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "WP_Agenda Calendar";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUASEARCH'","""{"handler":"E235F2","iparms":[{"av":"Calendaruc_Filtermode","ctrl":"CALENDARUC","prop":"FilterMode"},{"av":"AV29ForceLoadDots","fld":"vFORCELOADDOTS"},{"av":"AV27EventsLoaded","fld":"vEVENTSLOADED"},{"av":"AV10CalendarLoadFromDate","fld":"vCALENDARLOADFROMDATE"},{"av":"AV11CalendarLoadToDate","fld":"vCALENDARLOADTODATE"},{"av":"cmbavDatetypefilter"},{"av":"AV20DateTypeFilter","fld":"vDATETYPEFILTER","pic":"ZZZ9"},{"av":"Gx_date","fld":"vTODAY","hsh":true},{"av":"AV14DateFilter","fld":"vDATEFILTER"},{"av":"AV15DateRangeFilter","fld":"vDATERANGEFILTER"},{"av":"AV17DateRangeFilter_To","fld":"vDATERANGEFILTER_TO"},{"av":"AV36TitleFilter","fld":"vTITLEFILTER"},{"av":"AV19DateToSearchFrom","fld":"vDATETOSEARCHFROM"},{"av":"AV18DatesToSearchTo","fld":"vDATESTOSEARCHTO"},{"av":"AV13Date_ShowingDatesFrom","fld":"vDATE_SHOWINGDATESFROM"},{"av":"AV31LoadedDotsFromDate","fld":"vLOADEDDOTSFROMDATE"},{"av":"AV32LoadedDotsToDate","fld":"vLOADEDDOTSTODATE"},{"av":"AV33LoadedFromDate","fld":"vLOADEDFROMDATE"},{"av":"AV34LoadedToDate","fld":"vLOADEDTODATE"},{"av":"Calendaruc_Defaulteventstyle","ctrl":"CALENDARUC","prop":"DefaultEventStyle"},{"av":"AV25Events","fld":"vEVENTS"}]""");
         ...
         setEventMetadata("VDATE.CONTROLVALUECHANGED","""{"handler":"E245F2","iparms":[{"av":"AV12Date","fld":"vDATE"}]""");
         ...
         setEventMetadata("VDATE_SHOWINGDATESFROM.CONTROLVALUECHANGED","""{"handler":"E255F2","iparms":[{"av":"AV27EventsLoaded","fld":"vEVENTSLOADED"},{"av":"AV13Date_ShowingDatesFrom","fld":"vDATE_SHOWINGDATESFROM"},{"av":"AV31LoadedDotsFromDate","fld":"vLOADEDDOTSFROMDATE"},{"av":"AV32LoadedDotsToDate","fld":"vLOADEDDOTSTODATE"},{"av":"AV33LoadedFromDate","fld":"vLOADEDFROMDATE"},{"av":"AV34LoadedToDate","fld":"vLOADEDTODATE"},{"av":"Calendaruc_Defaulteventstyle","ctrl":"CALENDARUC","prop":"DefaultEventStyle"},{"av":"AV25Events","fld":"vEVENTS"}]""");
