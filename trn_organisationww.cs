...
namespace GeneXus.Programs {
   public class trn_organisationww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV52IsAuthorized_OrganisationName = StringUtil.StrToBool( GetPar( "IsAuthorized_OrganisationName"));
         AV44IsAuthorized_OrganisationTypeName = StringUtil.StrToBool( GetPar( "IsAuthorized_OrganisationTypeName"));
         setAjaxCallMode();
         if ( ! IsValidAjaxCall( true) )
         {
            GxWebError = 1;
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV15FilterFullText, AV19ManageFiltersExecutionStep, AV68Pgmname, AV22TFOrganisationName, AV23TFOrganisationName_Sel, AV34TFOrganisationTypeName, AV35TFOrganisationTypeName_Sel, AV28TFOrganisationEmail, AV29TFOrganisationEmail_Sel, AV30TFOrganisationPhone, AV31TFOrganisationPhone_Sel, AV46IsAuthorized_Display, AV48IsAuthorized_Update, AV50IsAuthorized_Delete, AV52IsAuthorized_OrganisationName, AV44IsAuthorized_OrganisationTypeName) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_ORGANISATIONNAME", AV52IsAuthorized_OrganisationName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_ORGANISATIONNAME", GetSecureSignedToken( "", AV52IsAuthorized_OrganisationName, context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_ORGANISATIONTYPENAME", AV44IsAuthorized_OrganisationTypeName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_ORGANISATIONTYPENAME", GetSecureSignedToken( "", AV44IsAuthorized_OrganisationTypeName, context));
      ...
      protected void WB3U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsertorganisation_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Insert", bttBtninsertorganisation_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERTORGANISATION\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_OrganisationWW.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsubscriptions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "", bttBtnsubscriptions_Jsonclick, 0, "Subscriptions", "", StyleString, ClassString, bttBtnsubscriptions_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_OrganisationWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV52IsAuthorized_OrganisationName ,
                                       bool AV44IsAuthorized_OrganisationTypeName )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      {
         /* GeneXus formulas. */
         AV68Pgmname = "Trn_OrganisationWW";
      ...
      protected void RF3U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV69Trn_organisationwwds_1_filterfulltext ,
                                                 AV71Trn_organisationwwds_3_tforganisationname_sel ,
                                                 AV70Trn_organisationwwds_2_tforganisationname ,
                                                 AV73Trn_organisationwwds_5_tforganisationtypename_sel ,
                                                 AV72Trn_organisationwwds_4_tforganisationtypename ,
                                                 AV75Trn_organisationwwds_7_tforganisationemail_sel ,
                                                 AV74Trn_organisationwwds_6_tforganisationemail ,
                                                 AV77Trn_organisationwwds_9_tforganisationphone_sel ,
                                                 AV76Trn_organisationwwds_8_tforganisationphone ,
                                                 A13OrganisationName ,
            ...
            lV69Trn_organisationwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV69Trn_organisationwwds_1_filterfulltext), "%", "");
            lV69Trn_organisationwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV69Trn_organisationwwds_1_filterfulltext), "%", "");
            lV69Trn_organisationwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV69Trn_organisationwwds_1_filterfulltext), "%", "");
            lV69Trn_organisationwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV69Trn_organisationwwds_1_filterfulltext), "%", "");
            lV70Trn_organisationwwds_2_tforganisationname = StringUtil.Concat( StringUtil.RTrim( AV70Trn_organisationwwds_2_tforganisationname), "%", "");
            lV72Trn_organisationwwds_4_tforganisationtypename = StringUtil.Concat( StringUtil.RTrim( AV72Trn_organisationwwds_4_tforganisationtypename), "%", "");
            lV74Trn_organisationwwds_6_tforganisationemail = StringUtil.Concat( StringUtil.RTrim( AV74Trn_organisationwwds_6_tforganisationemail), "%", "");
            lV76Trn_organisationwwds_8_tforganisationphone = StringUtil.PadR( StringUtil.RTrim( AV76Trn_organisationwwds_8_tforganisationphone), 20, "%");
            /* Using cursor H003U2 */
            pr_default.execute(0, new Object[] {lV69Trn_organisationwwds_1_filterfulltext, lV69Trn_organisationwwds_1_filterfulltext, lV69Trn_organisationwwds_1_filterfulltext, lV69Trn_organisationwwds_1_filterfulltext, lV70Trn_organisationwwds_2_tforganisationname, AV71Trn_organisationwwds_3_tforganisationname_sel, lV72Trn_organisationwwds_4_tforganisationtypename, AV73Trn_organisationwwds_5_tforganisationtypename_sel, lV74Trn_organisationwwds_6_tforganisationemail, AV75Trn_organisationwwds_7_tforganisationemail_sel, lV76Trn_organisationwwds_8_tforganisationphone, AV77Trn_organisationwwds_9_tforganisationphone_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
      ...
      {
         AV69Trn_organisationwwds_1_filterfulltext = AV15FilterFullText;
         AV70Trn_organisationwwds_2_tforganisationname = AV22TFOrganisationName;
         AV71Trn_organisationwwds_3_tforganisationname_sel = AV23TFOrganisationName_Sel;
         AV72Trn_organisationwwds_4_tforganisationtypename = AV34TFOrganisationTypeName;
         AV73Trn_organisationwwds_5_tforganisationtypename_sel = AV35TFOrganisationTypeName_Sel;
         AV74Trn_organisationwwds_6_tforganisationemail = AV28TFOrganisationEmail;
         AV75Trn_organisationwwds_7_tforganisationemail_sel = AV29TFOrganisationEmail_Sel;
         AV76Trn_organisationwwds_8_tforganisationphone = AV30TFOrganisationPhone;
         AV77Trn_organisationwwds_9_tforganisationphone_sel = AV31TFOrganisationPhone_Sel;
         ...
         lV76Trn_organisationwwds_8_tforganisationphone = StringUtil.PadR( StringUtil.RTrim( AV76Trn_organisationwwds_8_tforganisationphone), 20, "%");
         /* Using cursor H003U3 */
         pr_default.execute(1, new Object[] {lV69Trn_organisationwwds_1_filterfulltext, lV69Trn_organisationwwds_1_filterfulltext, lV69Trn_organisationwwds_1_filterfulltext, lV69Trn_organisationwwds_1_filterfulltext, lV70Trn_organisationwwds_2_tforganisationname, AV71Trn_organisationwwds_3_tforganisationname_sel, lV72Trn_organisationwwds_4_tforganisationtypename, AV73Trn_organisationwwds_5_tforganisationtypename_sel, lV74Trn_organisationwwds_6_tforganisationemail, AV75Trn_organisationwwds_7_tforganisationemail_sel, lV76Trn_organisationwwds_8_tforganisationphone, AV77Trn_organisationwwds_9_tforganisationphone_sel});
      ...
      protected void E173U2( )
      {
         ...
         GXt_boolean1 = AV52IsAuthorized_OrganisationName;
         ...
         AV52IsAuthorized_OrganisationName = GXt_boolean1;
         AssignAttri("", false, "AV52IsAuthorized_OrganisationName", AV52IsAuthorized_OrganisationName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_ORGANISATIONNAME", GetSecureSignedToken( "", AV52IsAuthorized_OrganisationName, context));
         GXt_boolean1 = AV44IsAuthorized_OrganisationTypeName;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_organisationtypeview_Execute", out  GXt_boolean1) ;
         AV44IsAuthorized_OrganisationTypeName = GXt_boolean1;
         AssignAttri("", false, "AV44IsAuthorized_OrganisationTypeName", AV44IsAuthorized_OrganisationTypeName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_ORGANISATIONTYPENAME", GetSecureSignedToken( "", AV44IsAuthorized_OrganisationTypeName, context));
      ...
      private void E193U2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         GXt_char3 = AV61Address;
         new prc_concatenateaddress(context ).execute(  A331OrganisationAddressCountry,  A289OrganisationAddressCity,  A288OrganisationAddressZipCode,  A342OrganisationAddressLine1,  A343OrganisationAddressLine2, out  GXt_char3) ;
         AV61Address = GXt_char3;
         AssignAttri("", false, edtavAddress_Internalname, AV61Address);
         ...
         if ( AV52IsAuthorized_OrganisationName )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
            {
               gxcookieaux = context.SetCookie( "GX_SESSION_ID", Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", (short)(context.GetHttpSecure( )));
         ...
         if ( AV44IsAuthorized_OrganisationTypeName )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
            {
               gxcookieaux = context.SetCookie( "GX_SESSION_ID", Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", (short)(context.GetHttpSecure( )));
      ...
      protected void E113U2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_OrganisationWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV68Pgmname+"GridState"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_OrganisationWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void E143U2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0065",(string)"",(string)"Trn_Organisation",(short)1,(string)"",(string)""});
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         GXt_boolean1 = AV46IsAuthorized_Display;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_organisationview_Execute", out  GXt_boolean1) ;
         AV46IsAuthorized_Display = GXt_boolean1;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_organisation_Update", out  GXt_boolean1) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_organisation_Delete", out  GXt_boolean1) ;
      ...
      protected void S182( )
      {
         ...
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV23TFOrganisationName_Sel)),  AV23TFOrganisationName_Sel, out  GXt_char3) ;
         GXt_char5 = "";
         ...
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV30TFOrganisationPhone)),  AV30TFOrganisationPhone, out  GXt_char3) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719494454", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_organisationww.js", "?202492719494455", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_372( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtOrganisationVATNumber_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A18OrganisationVATNumber), 8, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A18OrganisationVATNumber), "ZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtOrganisationVATNumber_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn hidden-xs",(string)"",(short)0,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)37,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"start"+"\""+" style=\""+"display:none;"+"\">") ;
      ...
      protected void StartGridControl37( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlTextNl( "</th>") ;
            context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+"display:none;"+""+"\" "+">") ;
            context.SendWebValue( "Organisation Type Id") ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtOrganisationName_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( A20OrganisationTypeName));
            GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtOrganisationTypeName_Link));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            ...
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.LTrim( StringUtil.NToC( (decimal)(A18OrganisationVATNumber), 8, 0, ".", ""))));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV68Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV44IsAuthorized_OrganisationTypeName","fld":"vISAUTHORIZED_ORGANISATIONTYPENAME","hsh":true}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E123U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV68Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV44IsAuthorized_OrganisationTypeName","fld":"vISAUTHORIZED_ORGANISATIONTYPENAME","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E133U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV68Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV44IsAuthorized_OrganisationTypeName","fld":"vISAUTHORIZED_ORGANISATIONTYPENAME","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E153U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV68Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV44IsAuthorized_OrganisationTypeName","fld":"vISAUTHORIZED_ORGANISATIONTYPENAME","hsh":true},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E193U2","iparms":[{"av":"A331OrganisationAddressCountry","fld":"ORGANISATIONADDRESSCOUNTRY"},{"av":"A289OrganisationAddressCity","fld":"ORGANISATIONADDRESSCITY"},{"av":"A288OrganisationAddressZipCode","fld":"ORGANISATIONADDRESSZIPCODE"},{"av":"A342OrganisationAddressLine1","fld":"ORGANISATIONADDRESSLINE1"},{"av":"A343OrganisationAddressLine2","fld":"ORGANISATIONADDRESSLINE2"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV44IsAuthorized_OrganisationTypeName","fld":"vISAUTHORIZED_ORGANISATIONTYPENAME","hsh":true},{"av":"A19OrganisationTypeId","fld":"ORGANISATIONTYPEID"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV61Address","fld":"vADDRESS"},{"av":"AV45Display","fld":"vDISPLAY"},{"av":"edtavDisplay_Link","ctrl":"vDISPLAY","prop":"Link"},{"av":"AV47Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV49Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtOrganisationName_Link","ctrl":"ORGANISATIONNAME","prop":"Link"},{"av":"edtOrganisationTypeName_Link","ctrl":"ORGANISATIONTYPENAME","prop":"Link"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E113U2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV68Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFOrganisationName","fld":"vTFORGANISATIONNAME"},{"av":"AV23TFOrganisationName_Sel","fld":"vTFORGANISATIONNAME_SEL"},{"av":"AV34TFOrganisationTypeName","fld":"vTFORGANISATIONTYPENAME"},{"av":"AV35TFOrganisationTypeName_Sel","fld":"vTFORGANISATIONTYPENAME_SEL"},{"av":"AV28TFOrganisationEmail","fld":"vTFORGANISATIONEMAIL"},{"av":"AV29TFOrganisationEmail_Sel","fld":"vTFORGANISATIONEMAIL_SEL"},{"av":"AV30TFOrganisationPhone","fld":"vTFORGANISATIONPHONE"},{"av":"AV31TFOrganisationPhone_Sel","fld":"vTFORGANISATIONPHONE_SEL"},{"av":"AV46IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV48IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV50IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV52IsAuthorized_OrganisationName","fld":"vISAUTHORIZED_ORGANISATIONNAME","hsh":true},{"av":"AV44IsAuthorized_OrganisationTypeName","fld":"vISAUTHORIZED_ORGANISATIONTYPENAME","hsh":true},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]""");
      ...
      public override void initialize( )
      {
         ...
         AV49Delete = "";
         lV69Trn_organisationwwds_1_filterfulltext = "";
         lV70Trn_organisationwwds_2_tforganisationname = "";
         lV72Trn_organisationwwds_4_tforganisationtypename = "";
         lV74Trn_organisationwwds_6_tforganisationemail = "";
         lV76Trn_organisationwwds_8_tforganisationphone = "";
         AV69Trn_organisationwwds_1_filterfulltext = "";
         AV71Trn_organisationwwds_3_tforganisationname_sel = "";
         AV70Trn_organisationwwds_2_tforganisationname = "";
         AV73Trn_organisationwwds_5_tforganisationtypename_sel = "";
         ...
         H003U2_A18OrganisationVATNumber = new int[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_organisationww__default(),
            new Object[][] {
                new Object[] {
               H003U2_A19OrganisationTypeId, H003U2_A343OrganisationAddressLine2, H003U2_A342OrganisationAddressLine1, H003U2_A331OrganisationAddressCountry, H003U2_A288OrganisationAddressZipCode, H003U2_A289OrganisationAddressCity, H003U2_A18OrganisationVATNumber, H003U2_A17OrganisationPhone, H003U2_A16OrganisationEmail, H003U2_A12OrganisationKvkNumber,
               H003U2_A20OrganisationTypeName, H003U2_A13OrganisationName, H003U2_A11OrganisationId
               }
               , new Object[] {
      ...
      private string lV76Trn_organisationwwds_8_tforganisationphone ;
      private string AV77Trn_organisationwwds_9_tforganisationphone_sel ;
      private string AV76Trn_organisationwwds_8_tforganisationphone ;
      ...
      private bool AV52IsAuthorized_OrganisationName ;
      private bool AV44IsAuthorized_OrganisationTypeName ;
      ...
      private string lV69Trn_organisationwwds_1_filterfulltext ;
      private string lV70Trn_organisationwwds_2_tforganisationname ;
      private string lV72Trn_organisationwwds_4_tforganisationtypename ;
      private string lV74Trn_organisationwwds_6_tforganisationemail ;
      private string AV69Trn_organisationwwds_1_filterfulltext ;
      private string AV71Trn_organisationwwds_3_tforganisationname_sel ;
      private string AV70Trn_organisationwwds_2_tforganisationname ;
      private string AV73Trn_organisationwwds_5_tforganisationtypename_sel ;
      private string AV72Trn_organisationwwds_4_tforganisationtypename ;
      private string AV75Trn_organisationwwds_7_tforganisationemail_sel ;
      private string AV74Trn_organisationwwds_6_tforganisationemail ;
      ...
      private int[] H003U2_A18OrganisationVATNumber ;
   ...
   public class trn_organisationww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003U2( IGxContext context ,
                                             string AV69Trn_organisationwwds_1_filterfulltext ,
                                             string AV71Trn_organisationwwds_3_tforganisationname_sel ,
                                             string AV70Trn_organisationwwds_2_tforganisationname ,
                                             string AV73Trn_organisationwwds_5_tforganisationtypename_sel ,
                                             string AV72Trn_organisationwwds_4_tforganisationtypename ,
                                             string AV75Trn_organisationwwds_7_tforganisationemail_sel ,
                                             string AV74Trn_organisationwwds_6_tforganisationemail ,
                                             string AV77Trn_organisationwwds_9_tforganisationphone_sel ,
                                             string AV76Trn_organisationwwds_8_tforganisationphone ,
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV69Trn_organisationwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( T1.OrganisationName like '%' || :lV69Trn_organisationwwds_1_filterfulltext) or ( T2.OrganisationTypeName like '%' || :lV69Trn_organisationwwds_1_filterfulltext) or ( T1.OrganisationEmail like '%' || :lV69Trn_organisationwwds_1_filterfulltext) or ( T1.OrganisationPhone like '%' || :lV69Trn_organisationwwds_1_filterfulltext))");
         }
         else
         {
            GXv_int8[0] = 1;
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV71Trn_organisationwwds_3_tforganisationname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV70Trn_organisationwwds_2_tforganisationname)) ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationName like :lV70Trn_organisationwwds_2_tforganisationname)");
         }
         else
         {
            GXv_int8[4] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV71Trn_organisationwwds_3_tforganisationname_sel)) && ! ( StringUtil.StrCmp(AV71Trn_organisationwwds_3_tforganisationname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationName = ( :AV71Trn_organisationwwds_3_tforganisationname_sel))");
         }
         else
         {
            GXv_int8[5] = 1;
         }
         if ( StringUtil.StrCmp(AV71Trn_organisationwwds_3_tforganisationname_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.OrganisationName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV73Trn_organisationwwds_5_tforganisationtypename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV72Trn_organisationwwds_4_tforganisationtypename)) ) )
         {
            AddWhere(sWhereString, "(T2.OrganisationTypeName like :lV72Trn_organisationwwds_4_tforganisationtypename)");
         }
         else
         {
            GXv_int8[6] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV73Trn_organisationwwds_5_tforganisationtypename_sel)) && ! ( StringUtil.StrCmp(AV73Trn_organisationwwds_5_tforganisationtypename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T2.OrganisationTypeName = ( :AV73Trn_organisationwwds_5_tforganisationtypename_sel))");
         }
         else
         {
            GXv_int8[7] = 1;
         }
         if ( StringUtil.StrCmp(AV73Trn_organisationwwds_5_tforganisationtypename_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T2.OrganisationTypeName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV75Trn_organisationwwds_7_tforganisationemail_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV74Trn_organisationwwds_6_tforganisationemail)) ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationEmail like :lV74Trn_organisationwwds_6_tforganisationemail)");
         }
         else
         {
            GXv_int8[8] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV75Trn_organisationwwds_7_tforganisationemail_sel)) && ! ( StringUtil.StrCmp(AV75Trn_organisationwwds_7_tforganisationemail_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationEmail = ( :AV75Trn_organisationwwds_7_tforganisationemail_sel))");
         }
         else
         {
            GXv_int8[9] = 1;
         }
         if ( StringUtil.StrCmp(AV75Trn_organisationwwds_7_tforganisationemail_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from T1.OrganisationEmail))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV77Trn_organisationwwds_9_tforganisationphone_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV76Trn_organisationwwds_8_tforganisationphone)) ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationPhone like :lV76Trn_organisationwwds_8_tforganisationphone)");
         }
         else
         {
            GXv_int8[10] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV77Trn_organisationwwds_9_tforganisationphone_sel)) && ! ( StringUtil.StrCmp(AV77Trn_organisationwwds_9_tforganisationphone_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(T1.OrganisationPhone = ( :AV77Trn_organisationwwds_9_tforganisationphone_sel))");
         }
         else
         {
            GXv_int8[11] = 1;
         }
         if ( StringUtil.StrCmp(AV77Trn_organisationwwds_9_tforganisationphone_sel, "<#Empty#>") == 0 )
         {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV69Trn_organisationwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV69Trn_organisationwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV69Trn_organisationwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV69Trn_organisationwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV70Trn_organisationwwds_2_tforganisationname",GXType.VarChar,100,0) ,
          new ParDef("AV71Trn_organisationwwds_3_tforganisationname_sel",GXType.VarChar,100,0) ,
          new ParDef("lV72Trn_organisationwwds_4_tforganisationtypename",GXType.VarChar,100,0) ,
          new ParDef("AV73Trn_organisationwwds_5_tforganisationtypename_sel",GXType.VarChar,100,0) ,
          new ParDef("lV74Trn_organisationwwds_6_tforganisationemail",GXType.VarChar,100,0) ,
          new ParDef("AV75Trn_organisationwwds_7_tforganisationemail_sel",GXType.VarChar,100,0) ,
          new ParDef("lV76Trn_organisationwwds_8_tforganisationphone",GXType.Char,20,0) ,
          new ParDef("AV77Trn_organisationwwds_9_tforganisationphone_sel",GXType.Char,20,0) ,
