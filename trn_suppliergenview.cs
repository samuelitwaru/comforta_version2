...
namespace GeneXus.Programs {
   public class trn_suppliergenview : GXDataArea
   {
      public trn_suppliergenview( )
      {
      ...
      public trn_suppliergenview( IGxContext context )
      {
      ...
      public void execute( Guid aP0_SupplierGenId ,
                           string aP1_TabCode )
      {
         this.AV10SupplierGenId = aP0_SupplierGenId;
      ...
      {
         get {
            return "trn_suppliergenview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_suppliergenview.aspx"+UrlEncode(AV10SupplierGenId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_suppliergenview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "trn_suppliergenview.aspx"+UrlEncode(AV10SupplierGenId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_suppliergenview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_SupplierGenView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Supplier Gen View", "") ;
      }
      ...
      protected void WB510( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_SupplierGenView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_suppliergengeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
      ...
      protected void START512( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Supplier Gen View", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void PA512( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_suppliergenview.aspx")), "trn_suppliergenview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_suppliergenview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10SupplierGenId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10SupplierGenId", AV10SupplierGenId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIERGENID", GetSecureSignedToken( "", AV10SupplierGenId, context));
      ...
      protected void RF512( )
      {
         ...
         {
            /* Using cursor H00512 */
            pr_default.execute(0, new Object[] {AV10SupplierGenId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A42SupplierGenId = H00512_A42SupplierGenId[0];
               /* Execute user event: Load */
               E15512 ();
      ...
      protected void E13512( )
      {
         ...
         lblWorkwithlink_Link = formatLink("wp_organisationgeneralsuppliers.aspx") ;
         ...
         {
            A42SupplierGenId = H00513_A42SupplierGenId[0];
            A44SupplierGenCompanyName = H00513_A44SupplierGenCompanyName[0];
            AV17GXLvl9 = 1;
      ...
      protected void E14512( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_SupplierGen",  StringUtil.Trim( A42SupplierGenId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_SupplierGen",  2) )
         {
      ...
      protected void E11512( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_SupplierGen",(short)2,StringUtil.Trim( A42SupplierGenId.ToString()),(string)AV14RecordDescription});
      ...
      protected void E12512( )
      {
         ...
         if ( AV16IsAuthorized_Discussions )
         {
            ...
            if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
            {
               ...
               WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0028",(string)"",(string)"Trn_SupplierGen",StringUtil.Trim( A42SupplierGenId.ToString()),(string)AV14RecordDescription,formatLink("trn_suppliergenview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_SupplierGenGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_suppliergengeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_SupplierGenGeneral";
            WebComp_Webcomponent_general_Component = "Trn_SupplierGenGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10SupplierGenId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10SupplierGenId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10SupplierGenId", AV10SupplierGenId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vSUPPLIERGENID", GetSecureSignedToken( "", AV10SupplierGenId, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112914305366", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_suppliergenview.js", "?2024112914305366", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_suppliergengeneral_cell_Internalname = "TRN_SUPPLIERGENGENERAL_CELL";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Supplier Gen View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A42SupplierGenId","fld":"SUPPLIERGENID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV10SupplierGenId","fld":"vSUPPLIERGENID","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E11512","iparms":[{"av":"A42SupplierGenId","fld":"SUPPLIERGENID"},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E12512","iparms":[{"av":"AV16IsAuthorized_Discussions","fld":"vISAUTHORIZED_DISCUSSIONS","hsh":true},{"av":"AV14RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A42SupplierGenId","fld":"SUPPLIERGENID"}]""");
      ...
      {
         wcpOAV10SupplierGenId = Guid.Empty;
         wcpOAV8TabCode = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sDynURL = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H00512_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H00513_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H00513_A44SupplierGenCompanyName = new string[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_suppliergenview__default(),
            new Object[][] {
                new Object[] {
               H00512_A42SupplierGenId
               }
               , new Object[] {
               H00513_A42SupplierGenId, H00513_A44SupplierGenCompanyName
               }
            }
         );
      ...
      private string divTrn_suppliergengeneral_cell_Internalname ;
      ...
      private Guid wcpOAV10SupplierGenId ;
      ...
      private Guid[] H00512_A42SupplierGenId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H00513_A42SupplierGenId ;
      private string[] H00513_A44SupplierGenCompanyName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_suppliergenview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00512", "SELECT SupplierGenId FROM Trn_SupplierGen WHERE SupplierGenId = :AV10SupplierGenId ORDER BY SupplierGenId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00512,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00513", "SELECT SupplierGenId, SupplierGenCompanyName FROM Trn_SupplierGen WHERE SupplierGenId = :AV10SupplierGenId ORDER BY SupplierGenId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00513,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
