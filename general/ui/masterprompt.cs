...
namespace GeneXus.Programs.general.ui {
   public class masterprompt : GXMasterPage
   {
      public masterprompt( )
      {
      ...
      public masterprompt( IGxContext context )
      {
      ...
      protected void RenderHtmlCloseForm022( )
      {
         ...
         context.AddJavascriptSource("general/ui/masterprompt.js", "?2024102518421439", false, true);
      ...
      {
         return "General.UI.MasterPrompt" ;
      }
      ...
      protected void WB020( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divMaintable_Internalname, 1, 0, "px", 0, "px", "ContainerFluid PromptMainTable", "start", "top", "", "", "div");
            /* Div Control */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2024102518421442", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("general/ui/masterprompt.js", "?2024102518421442", false, true);
         }
