...
namespace GeneXus.Programs {
   public class trn_supplieragbtype : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
         /* Control Group */
         GxWebStd.gx_group_start( context, grpUnnamedgroup1_Internalname, "General Information", 1, 0, "px", 0, "px", "Group", "", "HLP_Trn_SupplierAgbType.htm");
         /* Div Control */
         ...
         GxWebStd.gx_label_element( context, edtSupplierAgbTypeName_Internalname, "Type Name", "col-sm-4 AttributeLabel", 1, true, "");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-8 gx-attribute", "start", "top", "", "", "div");
         /* Single line edit */
         TempTags = "  onfocus=\"gx.evt.onfocus(this, 21,'',false,'',0)\"";
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbTypeName_Internalname, A291SupplierAgbTypeName, StringUtil.RTrim( context.localUtil.Format( A291SupplierAgbTypeName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,21);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierAgbTypeName_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSupplierAgbTypeName_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 0, -1, -1, true, "Name", "start", true, "", "HLP_Trn_SupplierAgbType.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_enter_Internalname, "", "Confirm", bttBtntrn_enter_Jsonclick, 5, "Confirm", "", StyleString, ClassString, bttBtntrn_enter_Visible, bttBtntrn_enter_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_SupplierAgbType.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_cancel_Internalname, "", "Cancel", bttBtntrn_cancel_Jsonclick, 1, "Cancel", "", StyleString, ClassString, bttBtntrn_cancel_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_SupplierAgbType.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         /* Div Control */
         GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
         ...
         ClassString = "ButtonMaterialDefault";
         StyleString = "";
         GxWebStd.gx_button_ctrl( context, bttBtntrn_delete_Internalname, "", "Delete", bttBtntrn_delete_Jsonclick, 5, "Delete", "", StyleString, ClassString, bttBtntrn_delete_Visible, bttBtntrn_delete_Enabled, "standard", "'"+""+"'"+",false,"+"'"+"EDELETE."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_SupplierAgbType.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         ...
         GxWebStd.gx_single_line_edit( context, edtSupplierAgbTypeId_Internalname, A283SupplierAgbTypeId.ToString(), A283SupplierAgbTypeId.ToString(), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSupplierAgbTypeId_Jsonclick, 0, "Attribute", "", "", "", "", edtSupplierAgbTypeId_Visible, edtSupplierAgbTypeId_Enabled, 1, "text", "", 36, "chr", 1, "row", 36, 0, 0, 0, 0, 0, 0, true, "Id", "", false, "", "HLP_Trn_SupplierAgbType.htm");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
         GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               Z291SupplierAgbTypeName = cgiGet( "Z291SupplierAgbTypeName");
               ...
               hsh = cgiGet( "hsh");
               if ( ( ! ( ( A283SupplierAgbTypeId != Z283SupplierAgbTypeId ) ) || ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) ) && ! GXUtil.CheckEncryptedHash( forbiddenHiddens.ToString(), hsh, GXKey) )
               {
            ...
            else
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") == 0 )
               {
                  ...
                  {
                     A283SupplierAgbTypeId = AV7SupplierAgbTypeId;
                     AssignAttri("", false, "A283SupplierAgbTypeId", A283SupplierAgbTypeId.ToString());
                  }
                  else
                  {
                     if ( IsIns( )  && (Guid.Empty==A283SupplierAgbTypeId) && ( Gx_BScreen == 0 ) )
                     {
      ...
      protected void ZM1156( short GX_JID )
      {
         if ( ( GX_JID == 6 ) || ( GX_JID == 0 ) )
         {
            if ( ! IsIns( ) )
            {
               Z291SupplierAgbTypeName = T00113_A291SupplierAgbTypeName[0];
            }
            else
            {
      ...
      protected void Load1156( )
      {
         ...
         {
            RcdFound56 = 1;
            A291SupplierAgbTypeName = T00114_A291SupplierAgbTypeName[0];
            AssignAttri("", false, "A291SupplierAgbTypeName", A291SupplierAgbTypeName);
            ZM1156( -6) ;
         }
         pr_default.close(2);
      ...
      protected void CheckExtendedTable1156( )
      {
         ...
         {
            GX_msglist.addItem(StringUtil.Format( "%1 is required.", "Supplier Agb Type Name", "", "", "", "", "", "", "", ""), 1, "SUPPLIERAGBTYPENAME");
            AnyError = 1;
            GX_FocusControl = edtSupplierAgbTypeName_Internalname;
            AssignAttri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      protected void getByPrimaryKey( )
      {
         ...
         if ( (pr_default.getStatus(1) != 101) )
         {
            ZM1156( 6) ;
            RcdFound56 = 1;
            A283SupplierAgbTypeId = T00113_A283SupplierAgbTypeId[0];
            AssignAttri("", false, "A283SupplierAgbTypeId", A283SupplierAgbTypeId.ToString());
            A291SupplierAgbTypeName = T00113_A291SupplierAgbTypeName[0];
            AssignAttri("", false, "A291SupplierAgbTypeName", A291SupplierAgbTypeName);
            Z283SupplierAgbTypeId = A283SupplierAgbTypeId;
            sMode56 = Gx_mode;
            Gx_mode = "DSP";
      ...
      protected void move_next( )
      {
         ...
         {
            while ( (pr_default.getStatus(4) != 101) && ( ( GuidUtil.Compare(T00116_A283SupplierAgbTypeId[0], A283SupplierAgbTypeId, 0) < 0 ) ) )
            {
               pr_default.readNext(4);
            }
            if ( (pr_default.getStatus(4) != 101) && ( ( GuidUtil.Compare(T00116_A283SupplierAgbTypeId[0], A283SupplierAgbTypeId, 0) > 0 ) ) )
            {
               A283SupplierAgbTypeId = T00116_A283SupplierAgbTypeId[0];
               AssignAttri("", false, "A283SupplierAgbTypeId", A283SupplierAgbTypeId.ToString());
               RcdFound56 = 1;
            }
         }
      ...
      protected void move_previous( )
      {
         ...
         {
            while ( (pr_default.getStatus(5) != 101) && ( ( GuidUtil.Compare(T00117_A283SupplierAgbTypeId[0], A283SupplierAgbTypeId, 0) > 0 ) ) )
            {
               pr_default.readNext(5);
            }
            if ( (pr_default.getStatus(5) != 101) && ( ( GuidUtil.Compare(T00117_A283SupplierAgbTypeId[0], A283SupplierAgbTypeId, 0) < 0 ) ) )
            {
               A283SupplierAgbTypeId = T00117_A283SupplierAgbTypeId[0];
               AssignAttri("", false, "A283SupplierAgbTypeId", A283SupplierAgbTypeId.ToString());
               RcdFound56 = 1;
            }
         }
      ...
      protected void CheckOptimisticConcurrency1156( )
      {
         if ( ! IsIns( ) )
         {
            ...
            if ( (pr_default.getStatus(0) == 101) || ( StringUtil.StrCmp(Z291SupplierAgbTypeName, T00112_A291SupplierAgbTypeName[0]) != 0 ) )
            {
               if ( StringUtil.StrCmp(Z291SupplierAgbTypeName, T00112_A291SupplierAgbTypeName[0]) != 0 )
               {
                  GXUtil.WriteLog("trn_supplieragbtype:[seudo value changed for attri]"+"SupplierAgbTypeName");
                  GXUtil.WriteLogRaw("Old: ",Z291SupplierAgbTypeName);
                  GXUtil.WriteLogRaw("Current: ",T00112_A291SupplierAgbTypeName[0]);
               }
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00118 */
                     pr_default.execute(6, new Object[] {A283SupplierAgbTypeId, A291SupplierAgbTypeName});
                     pr_default.close(6);
         ...
         if ( AnyError == 0 )
         {
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  {
                     /* Using cursor T00119 */
                     pr_default.execute(7, new Object[] {A291SupplierAgbTypeName, A283SupplierAgbTypeId});
                     pr_default.close(7);
                     pr_default.SmartCacheProvider.SetUpdated("Trn_SupplierAgbType");
      ...
      protected void OnDeleteControls1156( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            {
               GX_msglist.addItem(context.GetMessage( "GXM_del", new   object[]  {"Trn_SupplierAGB"}), "CannotDeleteReferencedRecord", 1, "");
               AnyError = 1;
            }
            pr_default.close(9);
         }
      ...
      public void ScanStart1156( )
      {
         ...
         {
            RcdFound56 = 1;
            A283SupplierAgbTypeId = T001112_A283SupplierAgbTypeId[0];
            AssignAttri("", false, "A283SupplierAgbTypeId", A283SupplierAgbTypeId.ToString());
         }
         /* Load Subordinate Levels */
      }

      protected void ScanNext1156( )
      {
         /* Scan next routine */
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z291SupplierAgbTypeName", Z291SupplierAgbTypeName);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198343379", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_supplieragbtype.js", "?202411198343379", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("AFTER TRN","""{"handler":"E12112","iparms":[{"av":"Gx_mode","fld":"vMODE","pic":"@!","hsh":true},{"av":"AV11TrnContext","fld":"vTRNCONTEXT","hsh":true}]}""");
      ...
      public override void initialize( )
      {
         ...
         T00114_A283SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         T00114_A291SupplierAgbTypeName = new string[] {""} ;
         T00115_A283SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         T00113_A283SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         T00113_A291SupplierAgbTypeName = new string[] {""} ;
         T00116_A283SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         T00117_A283SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         T00112_A283SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         T00112_A291SupplierAgbTypeName = new string[] {""} ;
         T001111_A49SupplierAgbId = new Guid[] {Guid.Empty} ;
         T001112_A283SupplierAgbTypeId = new Guid[] {Guid.Empty} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         GXEncryptionTmp = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_supplieragbtype__default(),
            new Object[][] {
                new Object[] {
               T00112_A283SupplierAgbTypeId, T00112_A291SupplierAgbTypeName
               }
               , new Object[] {
               T00113_A283SupplierAgbTypeId, T00113_A291SupplierAgbTypeName
               }
               , new Object[] {
               T00114_A283SupplierAgbTypeId, T00114_A291SupplierAgbTypeName
               }
               , new Object[] {
               T00115_A283SupplierAgbTypeId
               }
               , new Object[] {
               T00116_A283SupplierAgbTypeId
               }
               , new Object[] {
               T00117_A283SupplierAgbTypeId
               }
               , new Object[] {
               }
               , new Object[] {
               ...
               , new Object[] {
               T001111_A49SupplierAgbId
               }
               , new Object[] {
               T001112_A283SupplierAgbTypeId
               }
            }
         );
      ...
      private Guid[] T00114_A283SupplierAgbTypeId ;
      private string[] T00114_A291SupplierAgbTypeName ;
      private Guid[] T00115_A283SupplierAgbTypeId ;
      private Guid[] T00113_A283SupplierAgbTypeId ;
      private string[] T00113_A291SupplierAgbTypeName ;
      private Guid[] T00116_A283SupplierAgbTypeId ;
      private Guid[] T00117_A283SupplierAgbTypeId ;
      private Guid[] T00112_A283SupplierAgbTypeId ;
      private string[] T00112_A291SupplierAgbTypeName ;
      private Guid[] T001111_A49SupplierAgbId ;
      private Guid[] T001112_A283SupplierAgbTypeId ;
 ...
 public class trn_supplieragbtype__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
            new CursorDef("T00112", "SELECT SupplierAgbTypeId, SupplierAgbTypeName FROM Trn_SupplierAgbType WHERE SupplierAgbTypeId = :SupplierAgbTypeId  FOR UPDATE OF Trn_SupplierAgbType NOWAIT",true, GxErrorMask.GX_NOMASK, false, this,prmT00112,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T00113", "SELECT SupplierAgbTypeId, SupplierAgbTypeName FROM Trn_SupplierAgbType WHERE SupplierAgbTypeId = :SupplierAgbTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00113,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T00114", "SELECT TM1.SupplierAgbTypeId, TM1.SupplierAgbTypeName FROM Trn_SupplierAgbType TM1 WHERE TM1.SupplierAgbTypeId = :SupplierAgbTypeId ORDER BY TM1.SupplierAgbTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00114,100, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T00115", "SELECT SupplierAgbTypeId FROM Trn_SupplierAgbType WHERE SupplierAgbTypeId = :SupplierAgbTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00115,1, GxCacheFrequency.OFF ,true,false )
           ,new CursorDef("T00116", "SELECT SupplierAgbTypeId FROM Trn_SupplierAgbType WHERE ( SupplierAgbTypeId > :SupplierAgbTypeId) ORDER BY SupplierAgbTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT00116,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T00117", "SELECT SupplierAgbTypeId FROM Trn_SupplierAgbType WHERE ( SupplierAgbTypeId < :SupplierAgbTypeId) ORDER BY SupplierAgbTypeId DESC ",true, GxErrorMask.GX_NOMASK, false, this,prmT00117,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T00118", "SAVEPOINT gxupdate;INSERT INTO Trn_SupplierAgbType(SupplierAgbTypeId, SupplierAgbTypeName) VALUES(:SupplierAgbTypeId, :SupplierAgbTypeName);RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT,prmT00118)
           ,new CursorDef("T00119", "SAVEPOINT gxupdate;UPDATE Trn_SupplierAgbType SET SupplierAgbTypeName=:SupplierAgbTypeName  WHERE SupplierAgbTypeId = :SupplierAgbTypeId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT00119)
           ,new CursorDef("T001110", "SAVEPOINT gxupdate;DELETE FROM Trn_SupplierAgbType  WHERE SupplierAgbTypeId = :SupplierAgbTypeId;RELEASE SAVEPOINT gxupdate", GxErrorMask.GX_ROLLBACKSAVEPOINT | GxErrorMask.GX_NOMASK,prmT001110)
           ,new CursorDef("T001111", "SELECT SupplierAgbId FROM Trn_SupplierAGB WHERE SupplierAgbTypeId = :SupplierAgbTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001111,1, GxCacheFrequency.OFF ,true,true )
           ,new CursorDef("T001112", "SELECT SupplierAgbTypeId FROM Trn_SupplierAgbType ORDER BY SupplierAgbTypeId ",true, GxErrorMask.GX_NOMASK, false, this,prmT001112,100, GxCacheFrequency.OFF ,true,false )
        };
     }
  }
