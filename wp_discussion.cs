...
namespace GeneXus.Programs {
   public class wp_discussion : GXDataArea
   {
      public wp_discussion( )
      {
      ...
      public wp_discussion( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_discussion.aspx") +"\">") ;
      ...
      {
         return formatLink("wp_discussion.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WP_Discussion" ;
      }
      ...
      protected void WB7Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0015"+"", StringUtil.RTrim( WebComp_Component1_Component));
               context.WriteHtmlText( "<div") ;
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 15 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Component1_Component) != 0 )
                           {
                              WebComp_Component1.componentprocess("W0015", "", sEvt);
                           }
                           WebComp_Component1_Component = OldComponent1;
                        }
                     }
      ...
      protected void E117Y2( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Component1_Component), StringUtil.Lower( "WC_Discussions")) != 0 )
         {
            WebComp_Component1 = getWebComponent(GetType(), "GeneXus.Programs", "wc_discussions", new Object[] {context} );
            WebComp_Component1.ComponentInit();
            WebComp_Component1.Name = "WC_Discussions";
            WebComp_Component1_Component = "WC_Discussions";
         }
         if ( StringUtil.Len( WebComp_Component1_Component) != 0 )
         {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411156404435", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_discussion.js", "?202411156404435", false, true);
