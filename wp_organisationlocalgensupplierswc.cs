...
namespace GeneXus.Programs {
   public class wp_organisationlocalgensupplierswc : GXWebComponent
   {
      public wp_organisationlocalgensupplierswc( )
      {
      ...
      public wp_organisationlocalgensupplierswc( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV40IsAuthorized_Display = StringUtil.StrToBool( GetPar( "IsAuthorized_Display"));
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV47Pgmname = "WP_OrganisationLocalGenSuppliersWC";
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "WP_Organisation Local Gen Suppliers WC", "")) ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_organisationlocalgensupplierswc.aspx") +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DISPLAY", AV40IsAuthorized_Display);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DISPLAY", GetSecureSignedToken( sPrefix, AV40IsAuthorized_Display, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_UPDATE", AV42IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV42IsAuthorized_Update, context));
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DELETE", AV44IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV44IsAuthorized_Delete, context));
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_INSERT", AV45IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV45IsAuthorized_Insert, context));
      ...
      {
         return "WP_OrganisationLocalGenSuppliersWC" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "WP_Organisation Local Gen Suppliers WC", "") ;
      }
      ...
      protected void WB7B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wp_organisationlocalgensupplierswc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
               context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void START7B2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "WP_Organisation Local Gen Suppliers WC", ""), 0) ;
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignAttri(sPrefix, false, edtavDisplay_Internalname, AV39Display);
      ...
      protected void RF7B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H007B2 */
            pr_default.execute(0, new Object[] {AV46Udparg1, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV22TFSupplierGenCompanyName, AV23TFSupplierGenCompanyName_Sel, lV24TFSupplierGenTypeName, AV25TFSupplierGenTypeName_Sel, lV26TFSupplierGenContactName, AV27TFSupplierGenContactName_Sel, lV28TFSupplierGenContactPhone, AV29TFSupplierGenContactPhone_Sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_35_idx = 1;
            sGXsfl_35_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_35_idx), 4, 0), 4, "0");
            SubsflControlProps_352( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A48SupplierGenContactPhone = H007B2_A48SupplierGenContactPhone[0];
               A47SupplierGenContactName = H007B2_A47SupplierGenContactName[0];
               A335SupplierGenAddressCountry = H007B2_A335SupplierGenAddressCountry[0];
               A295SupplierGenAddressCity = H007B2_A295SupplierGenAddressCity[0];
               A294SupplierGenAddressZipCode = H007B2_A294SupplierGenAddressZipCode[0];
               A336SupplierGenAddressLine1 = H007B2_A336SupplierGenAddressLine1[0];
               A337SupplierGenAddressLine2 = H007B2_A337SupplierGenAddressLine2[0];
               A382SupplierGenPhoneNumber = H007B2_A382SupplierGenPhoneNumber[0];
               A381SupplierGenPhoneCode = H007B2_A381SupplierGenPhoneCode[0];
               A290SupplierGenTypeName = H007B2_A290SupplierGenTypeName[0];
               A44SupplierGenCompanyName = H007B2_A44SupplierGenCompanyName[0];
               A43SupplierGenKvkNumber = H007B2_A43SupplierGenKvkNumber[0];
               A282SupplierGenTypeId = H007B2_A282SupplierGenTypeId[0];
               A42SupplierGenId = H007B2_A42SupplierGenId[0];
               A11OrganisationId = H007B2_A11OrganisationId[0];
               n11OrganisationId = H007B2_n11OrganisationId[0];
               A290SupplierGenTypeName = H007B2_A290SupplierGenTypeName[0];
               /* Execute user event: Grid.Load */
               E187B2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV28TFSupplierGenContactPhone = StringUtil.PadR( StringUtil.RTrim( AV28TFSupplierGenContactPhone), 20, "%");
         /* Using cursor H007B3 */
         pr_default.execute(1, new Object[] {AV46Udparg1, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV16FilterFullText, lV22TFSupplierGenCompanyName, AV23TFSupplierGenCompanyName_Sel, lV24TFSupplierGenTypeName, AV25TFSupplierGenTypeName_Sel, lV26TFSupplierGenContactName, AV27TFSupplierGenContactName_Sel, lV28TFSupplierGenContactPhone, AV29TFSupplierGenContactPhone_Sel});
      ...
      private void E187B2( )
      {
         ...
         if ( AV40IsAuthorized_Display )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wp_organisationgeneralsuppliers.aspx"+UrlEncode(StringUtil.RTrim(""));
            edtavDisplay_Link = formatLink("wp_organisationgeneralsuppliers.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         }
      ...
      protected void E117B2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("WP_OrganisationLocalGenSuppliersWCFilters")) + "," + UrlEncode(StringUtil.RTrim(AV47Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("WP_OrganisationLocalGenSuppliersWCFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "WP_OrganisationLocalGenSuppliersWCFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void S152( )
      {
         ...
         returnInSub = false;
         GXt_boolean1 = AV40IsAuthorized_Display;
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "wp_organisationgeneralsuppliers_Execute", out  GXt_boolean1) ;
         AV40IsAuthorized_Display = GXt_boolean1;
         AssignAttri(sPrefix, false, "AV40IsAuthorized_Display", AV40IsAuthorized_Display);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DISPLAY", GetSecureSignedToken( sPrefix, AV40IsAuthorized_Display, context));
         if ( ! ( AV40IsAuthorized_Display ) )
         {
         ...
         AssignAttri(sPrefix, false, "AV42IsAuthorized_Update", AV42IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( sPrefix, AV42IsAuthorized_Update, context));
         if ( ! ( AV42IsAuthorized_Update ) )
         {
         ...
         AssignAttri(sPrefix, false, "AV44IsAuthorized_Delete", AV44IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( sPrefix, AV44IsAuthorized_Delete, context));
         if ( ! ( AV44IsAuthorized_Delete ) )
         {
         ...
         AssignAttri(sPrefix, false, "AV45IsAuthorized_Insert", AV45IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( sPrefix, AV45IsAuthorized_Insert, context));
         if ( ! ( AV45IsAuthorized_Insert ) )
         {
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "WP_OrganisationLocalGenSuppliersWCFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wp_organisationlocalgensupplierswc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241021953299", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wp_organisationlocalgensupplierswc.js", "?2024102195331", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_352( )
      {
         ...
         edtSupplierGenTypeId_Internalname = sPrefix+"SUPPLIERGENTYPEID_"+sGXsfl_35_idx;
         edtSupplierGenKvkNumber_Internalname = sPrefix+"SUPPLIERGENKVKNUMBER_"+sGXsfl_35_idx;
         edtSupplierGenCompanyName_Internalname = sPrefix+"SUPPLIERGENCOMPANYNAME_"+sGXsfl_35_idx;
         edtSupplierGenTypeName_Internalname = sPrefix+"SUPPLIERGENTYPENAME_"+sGXsfl_35_idx;
         edtSupplierGenPhoneCode_Internalname = sPrefix+"SUPPLIERGENPHONECODE_"+sGXsfl_35_idx;
         edtSupplierGenPhoneNumber_Internalname = sPrefix+"SUPPLIERGENPHONENUMBER_"+sGXsfl_35_idx;
         edtSupplierGenAddressLine2_Internalname = sPrefix+"SUPPLIERGENADDRESSLINE2_"+sGXsfl_35_idx;
         edtSupplierGenAddressLine1_Internalname = sPrefix+"SUPPLIERGENADDRESSLINE1_"+sGXsfl_35_idx;
         edtSupplierGenAddressZipCode_Internalname = sPrefix+"SUPPLIERGENADDRESSZIPCODE_"+sGXsfl_35_idx;
         edtSupplierGenAddressCity_Internalname = sPrefix+"SUPPLIERGENADDRESSCITY_"+sGXsfl_35_idx;
         edtSupplierGenAddressCountry_Internalname = sPrefix+"SUPPLIERGENADDRESSCOUNTRY_"+sGXsfl_35_idx;
         edtSupplierGenContactName_Internalname = sPrefix+"SUPPLIERGENCONTACTNAME_"+sGXsfl_35_idx;
         edtSupplierGenContactPhone_Internalname = sPrefix+"SUPPLIERGENCONTACTPHONE_"+sGXsfl_35_idx;
      ...
      protected void SubsflControlProps_fel_352( )
      {
         ...
         edtSupplierGenTypeId_Internalname = sPrefix+"SUPPLIERGENTYPEID_"+sGXsfl_35_fel_idx;
         edtSupplierGenKvkNumber_Internalname = sPrefix+"SUPPLIERGENKVKNUMBER_"+sGXsfl_35_fel_idx;
         edtSupplierGenCompanyName_Internalname = sPrefix+"SUPPLIERGENCOMPANYNAME_"+sGXsfl_35_fel_idx;
         edtSupplierGenTypeName_Internalname = sPrefix+"SUPPLIERGENTYPENAME_"+sGXsfl_35_fel_idx;
         edtSupplierGenPhoneCode_Internalname = sPrefix+"SUPPLIERGENPHONECODE_"+sGXsfl_35_fel_idx;
         edtSupplierGenPhoneNumber_Internalname = sPrefix+"SUPPLIERGENPHONENUMBER_"+sGXsfl_35_fel_idx;
         edtSupplierGenAddressLine2_Internalname = sPrefix+"SUPPLIERGENADDRESSLINE2_"+sGXsfl_35_fel_idx;
         edtSupplierGenAddressLine1_Internalname = sPrefix+"SUPPLIERGENADDRESSLINE1_"+sGXsfl_35_fel_idx;
         edtSupplierGenAddressZipCode_Internalname = sPrefix+"SUPPLIERGENADDRESSZIPCODE_"+sGXsfl_35_fel_idx;
         edtSupplierGenAddressCity_Internalname = sPrefix+"SUPPLIERGENADDRESSCITY_"+sGXsfl_35_fel_idx;
         edtSupplierGenAddressCountry_Internalname = sPrefix+"SUPPLIERGENADDRESSCOUNTRY_"+sGXsfl_35_fel_idx;
         edtSupplierGenContactName_Internalname = sPrefix+"SUPPLIERGENCONTACTNAME_"+sGXsfl_35_fel_idx;
         edtSupplierGenContactPhone_Internalname = sPrefix+"SUPPLIERGENCONTACTPHONE_"+sGXsfl_35_fel_idx;
      ...
      public override void initialize_properties( )
      {
         ...
         Ddo_grid_Datalistproc = "WP_OrganisationLocalGenSuppliersWCGetFilterData";
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"sPrefix"},{"av":"AV21ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFSupplierGenCompanyName","fld":"vTFSUPPLIERGENCOMPANYNAME"},{"av":"AV23TFSupplierGenCompanyName_Sel","fld":"vTFSUPPLIERGENCOMPANYNAME_SEL"},{"av":"AV24TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV25TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV26TFSupplierGenContactName","fld":"vTFSUPPLIERGENCONTACTNAME"},{"av":"AV27TFSupplierGenContactName_Sel","fld":"vTFSUPPLIERGENCONTACTNAME_SEL"},{"av":"AV28TFSupplierGenContactPhone","fld":"vTFSUPPLIERGENCONTACTPHONE"},{"av":"AV29TFSupplierGenContactPhone_Sel","fld":"vTFSUPPLIERGENCONTACTPHONE_SEL"},{"av":"AV40IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV42IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV44IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV21ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV35GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV36GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV37GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV40IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV42IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV44IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV19ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E127B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV21ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFSupplierGenCompanyName","fld":"vTFSUPPLIERGENCOMPANYNAME"},{"av":"AV23TFSupplierGenCompanyName_Sel","fld":"vTFSUPPLIERGENCOMPANYNAME_SEL"},{"av":"AV24TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV25TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV26TFSupplierGenContactName","fld":"vTFSUPPLIERGENCONTACTNAME"},{"av":"AV27TFSupplierGenContactName_Sel","fld":"vTFSUPPLIERGENCONTACTNAME_SEL"},{"av":"AV28TFSupplierGenContactPhone","fld":"vTFSUPPLIERGENCONTACTPHONE"},{"av":"AV29TFSupplierGenContactPhone_Sel","fld":"vTFSUPPLIERGENCONTACTPHONE_SEL"},{"av":"AV40IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV42IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV44IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E137B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV21ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFSupplierGenCompanyName","fld":"vTFSUPPLIERGENCOMPANYNAME"},{"av":"AV23TFSupplierGenCompanyName_Sel","fld":"vTFSUPPLIERGENCOMPANYNAME_SEL"},{"av":"AV24TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV25TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV26TFSupplierGenContactName","fld":"vTFSUPPLIERGENCONTACTNAME"},{"av":"AV27TFSupplierGenContactName_Sel","fld":"vTFSUPPLIERGENCONTACTNAME_SEL"},{"av":"AV28TFSupplierGenContactPhone","fld":"vTFSUPPLIERGENCONTACTPHONE"},{"av":"AV29TFSupplierGenContactPhone_Sel","fld":"vTFSUPPLIERGENCONTACTPHONE_SEL"},{"av":"AV40IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV42IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV44IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E147B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV21ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFSupplierGenCompanyName","fld":"vTFSUPPLIERGENCOMPANYNAME"},{"av":"AV23TFSupplierGenCompanyName_Sel","fld":"vTFSUPPLIERGENCOMPANYNAME_SEL"},{"av":"AV24TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV25TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV26TFSupplierGenContactName","fld":"vTFSUPPLIERGENCONTACTNAME"},{"av":"AV27TFSupplierGenContactName_Sel","fld":"vTFSUPPLIERGENCONTACTNAME_SEL"},{"av":"AV28TFSupplierGenContactPhone","fld":"vTFSUPPLIERGENCONTACTPHONE"},{"av":"AV29TFSupplierGenContactPhone_Sel","fld":"vTFSUPPLIERGENCONTACTPHONE_SEL"},{"av":"AV40IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV42IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV44IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E187B2","iparms":[{"av":"A335SupplierGenAddressCountry","fld":"SUPPLIERGENADDRESSCOUNTRY"},{"av":"A295SupplierGenAddressCity","fld":"SUPPLIERGENADDRESSCITY"},{"av":"A294SupplierGenAddressZipCode","fld":"SUPPLIERGENADDRESSZIPCODE"},{"av":"A336SupplierGenAddressLine1","fld":"SUPPLIERGENADDRESSLINE1"},{"av":"A337SupplierGenAddressLine2","fld":"SUPPLIERGENADDRESSLINE2"},{"av":"AV40IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV42IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A42SupplierGenId","fld":"SUPPLIERGENID","hsh":true},{"av":"AV44IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"A282SupplierGenTypeId","fld":"SUPPLIERGENTYPEID"}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV17SupplierAddress","fld":"vSUPPLIERADDRESS"},{"av":"AV39Display","fld":"vDISPLAY"},{"av":"edtavDisplay_Link","ctrl":"vDISPLAY","prop":"Link"},{"av":"AV41Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV43Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"edtSupplierGenTypeName_Link","ctrl":"SUPPLIERGENTYPENAME","prop":"Link"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E117B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV21ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFSupplierGenCompanyName","fld":"vTFSUPPLIERGENCOMPANYNAME"},{"av":"AV23TFSupplierGenCompanyName_Sel","fld":"vTFSUPPLIERGENCOMPANYNAME_SEL"},{"av":"AV24TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV25TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV26TFSupplierGenContactName","fld":"vTFSUPPLIERGENCONTACTNAME"},{"av":"AV27TFSupplierGenContactName_Sel","fld":"vTFSUPPLIERGENCONTACTNAME_SEL"},{"av":"AV28TFSupplierGenContactPhone","fld":"vTFSUPPLIERGENCONTACTPHONE"},{"av":"AV29TFSupplierGenContactPhone_Sel","fld":"vTFSUPPLIERGENCONTACTPHONE_SEL"},{"av":"AV40IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV42IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV44IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV21ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV12GridState","fld":"vGRIDSTATE"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV22TFSupplierGenCompanyName","fld":"vTFSUPPLIERGENCOMPANYNAME"},{"av":"AV23TFSupplierGenCompanyName_Sel","fld":"vTFSUPPLIERGENCOMPANYNAME_SEL"},{"av":"AV24TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV25TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV26TFSupplierGenContactName","fld":"vTFSUPPLIERGENCONTACTNAME"},{"av":"AV27TFSupplierGenContactName_Sel","fld":"vTFSUPPLIERGENCONTACTNAME_SEL"},{"av":"AV28TFSupplierGenContactPhone","fld":"vTFSUPPLIERGENCONTACTPHONE"},{"av":"AV29TFSupplierGenContactPhone_Sel","fld":"vTFSUPPLIERGENCONTACTPHONE_SEL"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV35GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV36GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV37GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV40IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV42IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV44IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV19ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E157B2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV14OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV15OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV16FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV21ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV47Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV22TFSupplierGenCompanyName","fld":"vTFSUPPLIERGENCOMPANYNAME"},{"av":"AV23TFSupplierGenCompanyName_Sel","fld":"vTFSUPPLIERGENCOMPANYNAME_SEL"},{"av":"AV24TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV25TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV26TFSupplierGenContactName","fld":"vTFSUPPLIERGENCONTACTNAME"},{"av":"AV27TFSupplierGenContactName_Sel","fld":"vTFSUPPLIERGENCONTACTNAME_SEL"},{"av":"AV28TFSupplierGenContactPhone","fld":"vTFSUPPLIERGENCONTACTPHONE"},{"av":"AV29TFSupplierGenContactPhone_Sel","fld":"vTFSUPPLIERGENCONTACTPHONE_SEL"},{"av":"AV40IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV42IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV44IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV38IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"sPrefix"},{"av":"A42SupplierGenId","fld":"SUPPLIERGENID","hsh":true}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"AV21ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV35GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV36GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV37GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV40IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV42IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV44IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV45IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV19ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV12GridState","fld":"vGRIDSTATE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         H007B2_A48SupplierGenContactPhone = new string[] {""} ;
         H007B2_A47SupplierGenContactName = new string[] {""} ;
         H007B2_A335SupplierGenAddressCountry = new string[] {""} ;
         H007B2_A295SupplierGenAddressCity = new string[] {""} ;
         H007B2_A294SupplierGenAddressZipCode = new string[] {""} ;
         H007B2_A336SupplierGenAddressLine1 = new string[] {""} ;
         H007B2_A337SupplierGenAddressLine2 = new string[] {""} ;
         H007B2_A382SupplierGenPhoneNumber = new string[] {""} ;
         H007B2_A381SupplierGenPhoneCode = new string[] {""} ;
         H007B2_A290SupplierGenTypeName = new string[] {""} ;
         H007B2_A44SupplierGenCompanyName = new string[] {""} ;
         H007B2_A43SupplierGenKvkNumber = new string[] {""} ;
         H007B2_A282SupplierGenTypeId = new Guid[] {Guid.Empty} ;
         H007B2_A42SupplierGenId = new Guid[] {Guid.Empty} ;
         H007B2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H007B2_n11OrganisationId = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wp_organisationlocalgensupplierswc__default(),
            new Object[][] {
                new Object[] {
               H007B2_A48SupplierGenContactPhone, H007B2_A47SupplierGenContactName, H007B2_A335SupplierGenAddressCountry, H007B2_A295SupplierGenAddressCity, H007B2_A294SupplierGenAddressZipCode, H007B2_A336SupplierGenAddressLine1, H007B2_A337SupplierGenAddressLine2, H007B2_A382SupplierGenPhoneNumber, H007B2_A381SupplierGenPhoneCode, H007B2_A290SupplierGenTypeName,
               H007B2_A44SupplierGenCompanyName, H007B2_A43SupplierGenKvkNumber, H007B2_A282SupplierGenTypeId, H007B2_A42SupplierGenId, H007B2_A11OrganisationId, H007B2_n11OrganisationId
               }
               , new Object[] {
      ...
      private bool AV40IsAuthorized_Display ;
      ...
      private string[] H007B2_A48SupplierGenContactPhone ;
      private string[] H007B2_A47SupplierGenContactName ;
      private string[] H007B2_A335SupplierGenAddressCountry ;
      private string[] H007B2_A295SupplierGenAddressCity ;
      private string[] H007B2_A294SupplierGenAddressZipCode ;
      private string[] H007B2_A336SupplierGenAddressLine1 ;
      private string[] H007B2_A337SupplierGenAddressLine2 ;
      private string[] H007B2_A382SupplierGenPhoneNumber ;
      private string[] H007B2_A381SupplierGenPhoneCode ;
      private string[] H007B2_A290SupplierGenTypeName ;
      private string[] H007B2_A44SupplierGenCompanyName ;
      private string[] H007B2_A43SupplierGenKvkNumber ;
      private Guid[] H007B2_A282SupplierGenTypeId ;
      private Guid[] H007B2_A42SupplierGenId ;
      private Guid[] H007B2_A11OrganisationId ;
      private bool[] H007B2_n11OrganisationId ;
   ...
   public class wp_organisationlocalgensupplierswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H007B2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007B2,11, GxCacheFrequency.OFF ,true,false )
