...
namespace GeneXus.Programs {
   ...
   public class trn_pagewwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A318Trn_PageName )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV40Trn_pagewwds_3_tftrn_pagename_sel)) && ! ( StringUtil.StrCmp(AV40Trn_pagewwds_3_tftrn_pagename_sel, "<#Empty#>") == 0 ) )
         {
         ...
         if ( StringUtil.StrCmp(AV40Trn_pagewwds_3_tftrn_pagename_sel, "<#Empty#>") == 0 )
         {
