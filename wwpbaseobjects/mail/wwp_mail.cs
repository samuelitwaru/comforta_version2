...
namespace GeneXus.Programs.wwpbaseobjects.mail {
   public class wwp_mail : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPMailCreated_Internalname, context.localUtil.TToC( A196WWPMailCreated, 10, 12, 0, 3, "/", ":", " "), context.localUtil.Format( A196WWPMailCreated, "99/99/9999 99:99:99.999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',12,24,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',12,24,'eng',false,0);"+";gx.evt.onblur(this,79);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPMailCreated_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPMailCreated_Enabled, 0, "text", "", 27, "chr", 1, "row", 27, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_DateTimeMillis", "end", false, "", "HLP_WWPBaseObjects/Mail/WWP_Mail.htm");
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPMailScheduled_Internalname, context.localUtil.TToC( A197WWPMailScheduled, 10, 12, 0, 3, "/", ":", " "), context.localUtil.Format( A197WWPMailScheduled, "99/99/9999 99:99:99.999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',12,24,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',12,24,'eng',false,0);"+";gx.evt.onblur(this,84);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPMailScheduled_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPMailScheduled_Enabled, 0, "text", "", 27, "chr", 1, "row", 27, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_DateTimeMillis", "end", false, "", "HLP_WWPBaseObjects/Mail/WWP_Mail.htm");
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPMailProcessed_Internalname, context.localUtil.TToC( A191WWPMailProcessed, 10, 12, 0, 3, "/", ":", " "), context.localUtil.Format( A191WWPMailProcessed, "99/99/9999 99:99:99.999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',12,24,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',12,24,'eng',false,0);"+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPMailProcessed_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPMailProcessed_Enabled, 0, "text", "", 27, "chr", 1, "row", 27, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_DateTimeMillis", "end", false, "", "HLP_WWPBaseObjects/Mail/WWP_Mail.htm");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPMailCreated_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A196WWPMailCreated", context.localUtil.TToC( A196WWPMailCreated, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPMailScheduled_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A197WWPMailScheduled", context.localUtil.TToC( A197WWPMailScheduled, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPMailProcessed_Internalname), 2, 0) == 0 )
            {
               ...
               AssignAttri("", false, "A191WWPMailProcessed", context.localUtil.TToC( A191WWPMailProcessed, 10, 12, 0, 3, "/", ":", " "));
            }
            else
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20241119834200", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/mail/wwp_mail.js", "?20241119834201", false, true);
      ...
      public void Valid_Wwpmailid( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z186WWPMailStatus", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z186WWPMailStatus), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z196WWPMailCreated", context.localUtil.TToC( Z196WWPMailCreated, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z197WWPMailScheduled", context.localUtil.TToC( Z197WWPMailScheduled, 10, 12, 0, 3, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z191WWPMailProcessed", context.localUtil.TToC( Z191WWPMailProcessed, 10, 12, 0, 3, "/", ":", " "));
