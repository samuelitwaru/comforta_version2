...
namespace GeneXus.Programs.wwpbaseobjects.mail {
   ...
   public class SdtWWP_Mail : GxSilentTrnSdt
   {
      ...
      public void Load( long AV185WWPMailId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV185WWPMailId});
         return  ;
      }
      ...
      public void UpdateDirties( GeneXus.Programs.wwpbaseobjects.mail.SdtWWP_Mail sdt )
      {
         ...
         {
            gxTv_SdtWWP_Mail_Wwpmailto_N = (short)(sdt.gxTv_SdtWWP_Mail_Wwpmailto_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_Mail_Wwpmailto = sdt.gxTv_SdtWWP_Mail_Wwpmailto ;
         }
         if ( sdt.IsDirty("WWPMailCC") )
         {
            gxTv_SdtWWP_Mail_Wwpmailcc_N = (short)(sdt.gxTv_SdtWWP_Mail_Wwpmailcc_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_Mail_Wwpmailcc = sdt.gxTv_SdtWWP_Mail_Wwpmailcc ;
         }
         if ( sdt.IsDirty("WWPMailBCC") )
         {
            gxTv_SdtWWP_Mail_Wwpmailbcc_N = (short)(sdt.gxTv_SdtWWP_Mail_Wwpmailbcc_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_Mail_Wwpmailbcc = sdt.gxTv_SdtWWP_Mail_Wwpmailbcc ;
         }
         ...
         {
            gxTv_SdtWWP_Mail_Wwpmailprocessed_N = (short)(sdt.gxTv_SdtWWP_Mail_Wwpmailprocessed_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_Mail_Wwpmailprocessed = sdt.gxTv_SdtWWP_Mail_Wwpmailprocessed ;
         }
         if ( sdt.IsDirty("WWPMailDetail") )
         {
            gxTv_SdtWWP_Mail_Wwpmaildetail_N = (short)(sdt.gxTv_SdtWWP_Mail_Wwpmaildetail_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_Mail_Wwpmaildetail = sdt.gxTv_SdtWWP_Mail_Wwpmaildetail ;
         }
         if ( sdt.IsDirty("WWPNotificationId") )
         {
            gxTv_SdtWWP_Mail_Wwpnotificationid_N = (short)(sdt.gxTv_SdtWWP_Mail_Wwpnotificationid_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_Mail_Wwpnotificationid = sdt.gxTv_SdtWWP_Mail_Wwpnotificationid ;
         }
   ...
   public class SdtWWP_Mail_RESTInterface : GxGenericCollectionItem<GeneXus.Programs.wwpbaseobjects.mail.SdtWWP_Mail>
   {
      ...
      public string gxTpr_Wwpmailid
      {
         ...
         set {
            sdt.gxTpr_Wwpmailid = (long)(Math.Round(NumberUtil.Val( value, "."), 18, MidpointRounding.ToEven));
         }
