...
namespace GeneXus.Programs.wwpbaseobjects.notifications.web {
   public class wwp_webnotification : GXDataArea
   {
      ...
      protected void DrawControls( )
      {
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPWebNotificationCreated_Internalname, context.localUtil.TToC( A150WWPWebNotificationCreated, 10, 12, 1, 2, "/", ":", " "), context.localUtil.Format( A150WWPWebNotificationCreated, "99/99/9999 99:99:99.999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'MDY',12,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'MDY',12,12,'eng',false,0);"+";gx.evt.onblur(this,84);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPWebNotificationCreated_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPWebNotificationCreated_Enabled, 0, "text", "", 27, "chr", 1, "row", 27, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_DateTimeMillis", "end", false, "", "HLP_WWPBaseObjects/Notifications/Web/WWP_WebNotification.htm");
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPWebNotificationScheduled_Internalname, context.localUtil.TToC( A163WWPWebNotificationScheduled, 10, 12, 1, 2, "/", ":", " "), context.localUtil.Format( A163WWPWebNotificationScheduled, "99/99/9999 99:99:99.999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'MDY',12,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'MDY',12,12,'eng',false,0);"+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPWebNotificationScheduled_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPWebNotificationScheduled_Enabled, 0, "text", "", 27, "chr", 1, "row", 27, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_DateTimeMillis", "end", false, "", "HLP_WWPBaseObjects/Notifications/Web/WWP_WebNotification.htm");
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPWebNotificationProcessed_Internalname, context.localUtil.TToC( A160WWPWebNotificationProcessed, 10, 12, 1, 2, "/", ":", " "), context.localUtil.Format( A160WWPWebNotificationProcessed, "99/99/9999 99:99:99.999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'MDY',12,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'MDY',12,12,'eng',false,0);"+";gx.evt.onblur(this,94);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPWebNotificationProcessed_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPWebNotificationProcessed_Enabled, 0, "text", "", 27, "chr", 1, "row", 27, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_DateTimeMillis", "end", false, "", "HLP_WWPBaseObjects/Notifications/Web/WWP_WebNotification.htm");
         ...
         GxWebStd.gx_single_line_edit( context, edtWWPWebNotificationRead_Internalname, context.localUtil.TToC( A151WWPWebNotificationRead, 10, 12, 1, 2, "/", ":", " "), context.localUtil.Format( A151WWPWebNotificationRead, "99/99/9999 99:99:99.999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'MDY',12,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'MDY',12,12,'eng',false,0);"+";gx.evt.onblur(this,99);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtWWPWebNotificationRead_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtWWPWebNotificationRead_Enabled, 0, "text", "", 27, "chr", 1, "row", 27, 0, 0, 0, 0, -1, 0, true, "WWPBaseObjects\\WWP_DateTimeMillis", "end", false, "", "HLP_WWPBaseObjects/Notifications/Web/WWP_WebNotification.htm");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AssignAttri("", false, "A159WWPWebNotificationStatus", StringUtil.LTrimStr( (decimal)(A159WWPWebNotificationStatus), 4, 0));
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPWebNotificationCreated_Internalname), 1, 1) == 0 )
            {
               ...
               AssignAttri("", false, "A150WWPWebNotificationCreated", context.localUtil.TToC( A150WWPWebNotificationCreated, 10, 12, 1, 2, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPWebNotificationScheduled_Internalname), 1, 1) == 0 )
            {
               ...
               AssignAttri("", false, "A163WWPWebNotificationScheduled", context.localUtil.TToC( A163WWPWebNotificationScheduled, 10, 12, 1, 2, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPWebNotificationProcessed_Internalname), 1, 1) == 0 )
            {
               ...
               AssignAttri("", false, "A160WWPWebNotificationProcessed", context.localUtil.TToC( A160WWPWebNotificationProcessed, 10, 12, 1, 2, "/", ":", " "));
            }
            else
            {
            ...
            if ( context.localUtil.VCDateTime( cgiGet( edtWWPWebNotificationRead_Internalname), 1, 1) == 0 )
            {
               ...
               AssignAttri("", false, "A151WWPWebNotificationRead", context.localUtil.TToC( A151WWPWebNotificationRead, 10, 12, 1, 2, "/", ":", " "));
            }
            else
            {
      ...
      protected void gxLoad_6( long A127WWPNotificationId )
      {
         ...
         AddString( "[[") ;
         AddString( "\""+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A128WWPNotificationDefinitionId), 10, 0, ".", "")))+"\""+","+"\""+GXUtil.EncodeJSConstant( context.localUtil.TToC( A129WWPNotificationCreated, 10, 12, 1, 2, "/", ":", " "))+"\""+","+"\""+GXUtil.EncodeJSConstant( A165WWPNotificationMetadata)+"\"") ;
         AddString( "]") ;
         if ( (pr_default.getStatus(5) == 101) )
         {
            AddString( ",") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?20249271947335", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/notifications/web/wwp_webnotification.js", "?20249271947336", false, true);
      ...
      public void Valid_Wwpwebnotificationid( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z159WWPWebNotificationStatus", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z159WWPWebNotificationStatus), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z150WWPWebNotificationCreated", context.localUtil.TToC( Z150WWPWebNotificationCreated, 10, 12, 1, 2, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z163WWPWebNotificationScheduled", context.localUtil.TToC( Z163WWPWebNotificationScheduled, 10, 12, 1, 2, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z160WWPWebNotificationProcessed", context.localUtil.TToC( Z160WWPWebNotificationProcessed, 10, 12, 1, 2, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z151WWPWebNotificationRead", context.localUtil.TToC( Z151WWPWebNotificationRead, 10, 12, 1, 2, "/", ":", " "));
