...
namespace GeneXus.Programs.wwpbaseobjects.notifications.web {
   ...
   [XmlType(TypeName =  "WWP_WebNotification" , Namespace = "Comforta_version2" )]
   [Serializable]
   public class SdtWWP_WebNotification : GxSilentTrnSdt
   {
      ...
      public void Load( long AV152WWPWebNotificationId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV152WWPWebNotificationId});
         return  ;
      }
      ...
      public void UpdateDirties( GeneXus.Programs.wwpbaseobjects.notifications.web.SdtWWP_WebNotification sdt )
      {
         ...
         {
            gxTv_SdtWWP_WebNotification_Wwpnotificationid_N = (short)(sdt.gxTv_SdtWWP_WebNotification_Wwpnotificationid_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_WebNotification_Wwpnotificationid = sdt.gxTv_SdtWWP_WebNotification_Wwpnotificationid ;
         }
         ...
         {
            gxTv_SdtWWP_WebNotification_Wwpnotificationmetadata_N = (short)(sdt.gxTv_SdtWWP_WebNotification_Wwpnotificationmetadata_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_WebNotification_Wwpnotificationmetadata = sdt.gxTv_SdtWWP_WebNotification_Wwpnotificationmetadata ;
         }
         ...
         {
            gxTv_SdtWWP_WebNotification_Wwpwebnotificationread_N = (short)(sdt.gxTv_SdtWWP_WebNotification_Wwpwebnotificationread_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_WebNotification_Wwpwebnotificationread = sdt.gxTv_SdtWWP_WebNotification_Wwpwebnotificationread ;
         }
         if ( sdt.IsDirty("WWPWebNotificationDetail") )
         {
            gxTv_SdtWWP_WebNotification_Wwpwebnotificationdetail_N = (short)(sdt.gxTv_SdtWWP_WebNotification_Wwpwebnotificationdetail_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_WebNotification_Wwpwebnotificationdetail = sdt.gxTv_SdtWWP_WebNotification_Wwpwebnotificationdetail ;
         }
         if ( sdt.IsDirty("WWPWebNotificationReceived") )
         {
            gxTv_SdtWWP_WebNotification_Wwpwebnotificationreceived_N = (short)(sdt.gxTv_SdtWWP_WebNotification_Wwpwebnotificationreceived_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_WebNotification_Wwpwebnotificationreceived = sdt.gxTv_SdtWWP_WebNotification_Wwpwebnotificationreceived ;
         }
         return  ;
   ...
   [DataContract(Name = @"WWPBaseObjects\Notifications\Web\WWP_WebNotification", Namespace = "Comforta_version2")]
   ...
   public class SdtWWP_WebNotification_RESTInterface : GxGenericCollectionItem<GeneXus.Programs.wwpbaseobjects.notifications.web.SdtWWP_WebNotification>
   {
      ...
      public string gxTpr_Wwpwebnotificationid
      {
         ...
         set {
            sdt.gxTpr_Wwpwebnotificationid = (long)(Math.Round(NumberUtil.Val( value, "."), 18, MidpointRounding.ToEven));
         }
      ...
      public string gxTpr_Wwpnotificationid
      {
         ...
         set {
            sdt.gxTpr_Wwpnotificationid = (long)(Math.Round(NumberUtil.Val( value, "."), 18, MidpointRounding.ToEven));
         }
