...
namespace GeneXus.Programs.wwpbaseobjects.notifications.web {
   ...
   [XmlType(TypeName =  "WWP_WebClient" , Namespace = "Comforta_version2" )]
   [Serializable]
   public class SdtWWP_WebClient : GxSilentTrnSdt
   {
      ...
      public void Load( string AV153WWPWebClientId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(string)AV153WWPWebClientId});
         return  ;
      }
      ...
      public void UpdateDirties( GeneXus.Programs.wwpbaseobjects.notifications.web.SdtWWP_WebClient sdt )
      {
         ...
         {
            gxTv_SdtWWP_WebClient_Wwpuserextendedid_N = (short)(sdt.gxTv_SdtWWP_WebClient_Wwpuserextendedid_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_WebClient_Wwpuserextendedid = sdt.gxTv_SdtWWP_WebClient_Wwpuserextendedid ;
         }
         return  ;
   ...
   [DataContract(Name = @"WWPBaseObjects\Notifications\Web\WWP_WebClient", Namespace = "Comforta_version2")]
