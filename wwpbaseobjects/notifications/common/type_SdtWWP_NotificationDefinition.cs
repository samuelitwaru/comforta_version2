...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   ...
   [XmlType(TypeName =  "WWP_NotificationDefinition" , Namespace = "Comforta_version2" )]
   [Serializable]
   public class SdtWWP_NotificationDefinition : GxSilentTrnSdt
   {
      ...
      public void Load( long AV128WWPNotificationDefinitionId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV128WWPNotificationDefinitionId});
         return  ;
      }
      ...
      public override GeneXus.Utils.GxStringCollection StateAttributes( )
      {
         ...
         state.Add("gxTpr_Wwpnotificationdefinitionsecfuncionality_Z");
         state.Add("gxTpr_Wwpnotificationdefinitionisauthorized_Z");
         return state ;
      }
      ...
      public override void Copy( GxUserType source )
      {
         ...
         gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionsecfuncionality = sdt.gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionsecfuncionality ;
         gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized = sdt.gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized ;
         ...
         gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionsecfuncionality_Z = sdt.gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionsecfuncionality_Z ;
         gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized_Z = sdt.gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized_Z ;
         return  ;
      }
      ...
      public long gxTpr_Wwpnotificationdefinitionid
      {
         ...
         set {
            ...
            if ( gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionid != value )
            {
               ...
               this.gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionsecfuncionality_Z_SetNull( );
               this.gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized_Z_SetNull( );
            }
      ...
      [  SoapElement( ElementName = "WWPNotificationDefinitionSecFuncionality" )]
      [  XmlElement( ElementName = "WWPNotificationDefinitionSecFuncionality"   )]
      public string gxTpr_Wwpnotificationdefinitionsecfuncionality
      {
         get {
      ...
      [  SoapElement( ElementName = "WWPNotificationDefinitionIsAuthorized" )]
      [  XmlElement( ElementName = "WWPNotificationDefinitionIsAuthorized"   )]
      public bool gxTpr_Wwpnotificationdefinitionisauthorized
      {
         get {
      ...
      public void gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized_SetNull( )
      {
      ...
      public bool gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized_IsNull( )
      {
         return false ;
      }
      ...
      [  SoapElement( ElementName = "WWPNotificationDefinitionSecFuncionality_Z" )]
      [  XmlElement( ElementName = "WWPNotificationDefinitionSecFuncionality_Z"   )]
      public string gxTpr_Wwpnotificationdefinitionsecfuncionality_Z
      {
         get {
      ...
      public void gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionsecfuncionality_Z_SetNull( )
      {
      ...
      public bool gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionsecfuncionality_Z_IsNull( )
      {
         return false ;
      }

      [  SoapElement( ElementName = "WWPNotificationDefinitionIsAuthorized_Z" )]
      [  XmlElement( ElementName = "WWPNotificationDefinitionIsAuthorized_Z"   )]
      public bool gxTpr_Wwpnotificationdefinitionisauthorized_Z
      {
         get {
      ...
      public void gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized_Z_SetNull( )
      {
      ...
      public bool gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized_Z_IsNull( )
      {
         return false ;
      }
      ...
      private bool gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized ;
      private bool gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionallowusersubscription_Z ;
      private bool gxTv_SdtWWP_NotificationDefinition_Wwpnotificationdefinitionisauthorized_Z ;
   ...
   [DataContract(Name = @"WWPBaseObjects\Notifications\Common\WWP_NotificationDefinition", Namespace = "Comforta_version2")]
   ...
   public class SdtWWP_NotificationDefinition_RESTInterface : GxGenericCollectionItem<GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_NotificationDefinition>
   {
      ...
      public string gxTpr_Wwpnotificationdefinitionid
      {
         ...
         set {
            sdt.gxTpr_Wwpnotificationdefinitionid = (long)(Math.Round(NumberUtil.Val( value, "."), 18, MidpointRounding.ToEven));
         }
      ...
      public string gxTpr_Wwpentityid
      {
         ...
         set {
            sdt.gxTpr_Wwpentityid = (long)(Math.Round(NumberUtil.Val( value, "."), 18, MidpointRounding.ToEven));
         }
      ...
      [DataMember( Name = "WWPNotificationDefinitionSecFuncionality" , Order = 12 )]
      [GxSeudo()]
      public string gxTpr_Wwpnotificationdefinitionsecfuncionality
      {
         get {
            return sdt.gxTpr_Wwpnotificationdefinitionsecfuncionality ;
         }

         set {
            sdt.gxTpr_Wwpnotificationdefinitionsecfuncionality = value;
         }

      }

      [DataMember( Name = "WWPNotificationDefinitionIsAuthorized" , Order = 13 )]
      [GxSeudo()]
      public bool gxTpr_Wwpnotificationdefinitionisauthorized
      {
         get {
            return sdt.gxTpr_Wwpnotificationdefinitionisauthorized ;
         }

         set {
            sdt.gxTpr_Wwpnotificationdefinitionisauthorized = value;
         }
