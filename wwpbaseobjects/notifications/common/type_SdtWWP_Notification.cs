...
namespace GeneXus.Programs.wwpbaseobjects.notifications.common {
   ...
   public class SdtWWP_Notification : GxSilentTrnSdt
   {
      ...
      public void Load( long AV127WWPNotificationId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV127WWPNotificationId});
         return  ;
      }
      ...
      public void UpdateDirties( GeneXus.Programs.wwpbaseobjects.notifications.common.SdtWWP_Notification sdt )
      {
         ...
         {
            gxTv_SdtWWP_Notification_Wwpuserextendedid_N = (short)(sdt.gxTv_SdtWWP_Notification_Wwpuserextendedid_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_Notification_Wwpuserextendedid = sdt.gxTv_SdtWWP_Notification_Wwpuserextendedid ;
         }
         ...
         {
            gxTv_SdtWWP_Notification_Wwpnotificationmetadata_N = (short)(sdt.gxTv_SdtWWP_Notification_Wwpnotificationmetadata_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_Notification_Wwpnotificationmetadata = sdt.gxTv_SdtWWP_Notification_Wwpnotificationmetadata ;
         }
         return  ;
