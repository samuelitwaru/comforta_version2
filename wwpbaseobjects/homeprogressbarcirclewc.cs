...
namespace GeneXus.Programs.wwpbaseobjects {
   public class homeprogressbarcirclewc : GXWebComponent
   {
      ...
      public homeprogressbarcirclewc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(string)AV5OptionTitle,(short)AV6Percentage});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               ...
               GXEncryptionTmp = "wwpbaseobjects.homeprogressbarcirclewc.aspx"+UrlEncode(StringUtil.RTrim(AV5OptionTitle)) + "," + UrlEncode(StringUtil.LTrimStr(AV6Percentage,4,0));
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.homeprogressbarcirclewc.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"UCPB_Circlewidth", StringUtil.LTrim( StringUtil.NToC( (decimal)(Ucpb_Circlewidth), 9, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"UCPB_Circleprogresswidth", StringUtil.LTrim( StringUtil.NToC( (decimal)(Ucpb_Circleprogresswidth), 9, 0, ".", "")));
      }
      ...
      {
         return "WWPBaseObjects.HomeProgressBarCircleWC" ;
      }
      ...
      protected void WB1C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablemain_Internalname, 1, 0, "px", 0, "px", "TableCardsMenuOptionWCCircle", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
         ...
         if ( nDonePA == 0 )
         {
            ...
            if ( StringUtil.Len( sPrefix) == 0 )
            {
               if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
               {
                  ...
                  if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wwpbaseobjects.homeprogressbarcirclewc.aspx")), "wwpbaseobjects.homeprogressbarcirclewc.aspx") == 0 ) )
                  {
                     SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wwpbaseobjects.homeprogressbarcirclewc.aspx")))) ;
                  }
                  else
                  {
                     GxWebError = 1;
      ...
      protected void E111C2( )
      {
         /* Start Routine */
         returnInSub = false;
         Ucpb_Percentage = AV6Percentage;
         ucUcpb.SendProperty(context, sPrefix, false, Ucpb_Internalname, "Percentage", StringUtil.LTrimStr( (decimal)(Ucpb_Percentage), 9, 0));
         Ucpb_Caption = StringUtil.Trim( StringUtil.Str( (decimal)(AV6Percentage), 4, 0))+"%";
         ucUcpb.SendProperty(context, sPrefix, false, Ucpb_Internalname, "Caption", Ucpb_Caption);
      }
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         AssignAttri(sPrefix, false, "AV5OptionTitle", AV5OptionTitle);
         AV6Percentage = Convert.ToInt16(getParm(obj,1));
         AssignAttri(sPrefix, false, "AV6Percentage", StringUtil.LTrimStr( (decimal)(AV6Percentage), 4, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6Percentage = (string)((string)getParm(obj,1));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wwpbaseobjects\\homeprogressbarcirclewc", GetJustCreated( ));
         ...
         else
         {
            ...
            AssignAttri(sPrefix, false, "AV5OptionTitle", AV5OptionTitle);
            AV6Percentage = Convert.ToInt16(getParm(obj,3));
            AssignAttri(sPrefix, false, "AV6Percentage", StringUtil.LTrimStr( (decimal)(AV6Percentage), 4, 0));
         }
         wcpOAV5OptionTitle = cgiGet( sPrefix+"wcpOAV5OptionTitle");
         wcpOAV6Percentage = (short)(Math.Round(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6Percentage"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411211537514", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/homeprogressbarcirclewc.js", "?202411211537514", false, true);
            context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/DVProgressIndicator/DVProgressIndicatorRender.js", "", false, true);
         }
      ...
      {
         Ucpb_Internalname = sPrefix+"UCPB";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavOptiontitle_Enabled = 0;
         Ucpb_Circleprogresswidth = 3;
         Ucpb_Circlewidth = 46;
         Ucpb_Percentage = 45;
         Ucpb_Cls = "CardsMenuProgressIndicatorCircle";
         Ucpb_Caption = "45%";
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( context.isSpaRequest( ) )
      ...
      private int Ucpb_Percentage ;
      private int Ucpb_Circlewidth ;
      private int Ucpb_Circleprogresswidth ;
      private int idxLst ;
      ...
      private string Ucpb_Caption ;
      private string Ucpb_Cls ;
