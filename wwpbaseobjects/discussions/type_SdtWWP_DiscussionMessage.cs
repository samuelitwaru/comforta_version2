...
namespace GeneXus.Programs.wwpbaseobjects.discussions {
   ...
   [XmlType(TypeName =  "WWP_DiscussionMessage" , Namespace = "Comforta_version2" )]
   [Serializable]
   public class SdtWWP_DiscussionMessage : GxSilentTrnSdt
   {
      ...
      public void Load( long AV200WWPDiscussionMessageId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV200WWPDiscussionMessageId});
         return  ;
      }
      ...
      public void UpdateDirties( GeneXus.Programs.wwpbaseobjects.discussions.SdtWWP_DiscussionMessage sdt )
      {
         ...
         {
            gxTv_SdtWWP_DiscussionMessage_Wwpdiscussionmessagethreadid_N = (short)(sdt.gxTv_SdtWWP_DiscussionMessage_Wwpdiscussionmessagethreadid_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_DiscussionMessage_Wwpdiscussionmessagethreadid = sdt.gxTv_SdtWWP_DiscussionMessage_Wwpdiscussionmessagethreadid ;
         }
   ...
   [DataContract(Name = @"WWPBaseObjects\Discussions\WWP_DiscussionMessage", Namespace = "Comforta_version2")]
   [GxJsonSerialization("default")]
   public class SdtWWP_DiscussionMessage_RESTInterface : GxGenericCollectionItem<GeneXus.Programs.wwpbaseobjects.discussions.SdtWWP_DiscussionMessage>
   {
      ...
      public string gxTpr_Wwpdiscussionmessagethreadid
      {
         ...
         set {
            sdt.gxTpr_Wwpdiscussionmessagethreadid = (long)(Math.Round(NumberUtil.Val( value, "."), 18, MidpointRounding.ToEven));
         }
   ...
   [DataContract(Name = @"WWPBaseObjects\Discussions\WWP_DiscussionMessage", Namespace = "Comforta_version2")]
   [GxJsonSerialization("default")]
   public class SdtWWP_DiscussionMessage_RESTLInterface : GxGenericCollectionItem<GeneXus.Programs.wwpbaseobjects.discussions.SdtWWP_DiscussionMessage>
   {
