...
namespace GeneXus.Programs.wwpbaseobjects.discussions {
   public class wwp_notifydiscussionmessage : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         {
            AV10WWPNotificationShortDescription = StringUtil.Format( "You were mentioned by %1 in a comment on %2: %3", StringUtil.Trim( AV23WWPUserExtendedFullName), StringUtil.Trim( AV24WWPEntityName), AV19WWPSubscriptionEntityRecordDescription, "", "", "", "", "", "");
         ...
         AV10WWPNotificationShortDescription = StringUtil.Format( "%1 added a comment on %2: %3", StringUtil.Trim( AV23WWPUserExtendedFullName), StringUtil.Trim( AV24WWPEntityName), AV19WWPSubscriptionEntityRecordDescription, "", "", "", "", "", "");
