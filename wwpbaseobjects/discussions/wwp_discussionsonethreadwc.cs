   ...
   public class wwp_discussionsonethreadwc : GXWebComponent
   {
      ...
      protected void E121U2( )
      {
         ...
         if ( StringUtil.StartsWith( AV24NotificationInfo.gxTpr_Id, "WebNotification#") )
         {
            ...
            if ( StringUtil.StartsWith( AV25WebNotification.gxTpr_Wwpnotificationdefinitionname, context.GetMessage( "Discussion", "")) )
            {
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102518413978", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/discussions/wwp_discussionsonethreadwc.js", "?2024102518413981", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Suggest/SuggestRender.js", "", false, true);
