...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="HomeModulesSDTItem" , Namespace="Comforta_version2" )]
	[Serializable]
	public class SdtHomeModulesSDT_HomeModulesSDTItem : GxUserType
	{
		public SdtHomeModulesSDT_HomeModulesSDTItem( )
		{
			...
			gxTv_SdtHomeModulesSDT_HomeModulesSDTItem_Rolename = "";
		...
		{
			get {
				return gxTv_SdtHomeModulesSDT_HomeModulesSDTItem_Rolename; 
			}
			set {
				gxTv_SdtHomeModulesSDT_HomeModulesSDTItem_Rolename = value;
				SetDirty("Rolename");
			}
		}
		...
		protected string gxTv_SdtHomeModulesSDT_HomeModulesSDTItem_Rolename;
	...
	[DataContract(Name=@"HomeModulesSDTItem", Namespace="Comforta_version2")]
