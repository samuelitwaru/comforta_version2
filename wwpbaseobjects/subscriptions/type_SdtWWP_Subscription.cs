...
namespace GeneXus.Programs.wwpbaseobjects.subscriptions {
   ...
   public class SdtWWP_Subscription : GxSilentTrnSdt
   {
      ...
      public void Load( long AV130WWPSubscriptionId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV130WWPSubscriptionId});
         return  ;
      }
      ...
      public void UpdateDirties( GeneXus.Programs.wwpbaseobjects.subscriptions.SdtWWP_Subscription sdt )
      {
         ...
         {
            gxTv_SdtWWP_Subscription_Wwpuserextendedid_N = (short)(sdt.gxTv_SdtWWP_Subscription_Wwpuserextendedid_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_Subscription_Wwpuserextendedid = sdt.gxTv_SdtWWP_Subscription_Wwpuserextendedid ;
         }
         ...
         {
            gxTv_SdtWWP_Subscription_Wwpsubscriptionroleid_N = (short)(sdt.gxTv_SdtWWP_Subscription_Wwpsubscriptionroleid_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_Subscription_Wwpsubscriptionroleid = sdt.gxTv_SdtWWP_Subscription_Wwpsubscriptionroleid ;
         }
   ...
   public class SdtWWP_Subscription_RESTInterface : GxGenericCollectionItem<GeneXus.Programs.wwpbaseobjects.subscriptions.SdtWWP_Subscription>
   {
      ...
      public string gxTpr_Wwpsubscriptionid
      {
         ...
         set {
            sdt.gxTpr_Wwpsubscriptionid = (long)(Math.Round(NumberUtil.Val( value, "."), 18, MidpointRounding.ToEven));
         }
