...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="WWPTransactionContext.Attribute" , Namespace="Comforta_version2" )]
	[Serializable]
	...
	[DataContract(Name=@"WWPTransactionContext.Attribute", Namespace="Comforta_version2")]
