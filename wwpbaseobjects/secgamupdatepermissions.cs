   ...
   public class secgamupdatepermissions : GXProcedure
   {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         while ( AV28GXV1 <= AV18GAMApplicationPermissions.Count )
         {
            ...
            if ( ! ( ( StringUtil.StrCmp(StringUtil.Lower( AV15GAMApplicationPermission.gxTpr_Name), "is_gam_administrator") == 0 ) || StringUtil.Like( StringUtil.Lower( AV15GAMApplicationPermission.gxTpr_Name) , StringUtil.PadR( "%_execute" , 254 , "%"),  ' ' ) || StringUtil.Like( StringUtil.Lower( AV15GAMApplicationPermission.gxTpr_Name) , StringUtil.PadR( "%_insert" , 254 , "%"),  ' ' ) || StringUtil.Like( StringUtil.Lower( AV15GAMApplicationPermission.gxTpr_Name) , StringUtil.PadR( "%_update" , 254 , "%"),  ' ' ) || StringUtil.Like( StringUtil.Lower( AV15GAMApplicationPermission.gxTpr_Name) , StringUtil.PadR( "%_delete" , 254 , "%"),  ' ' ) || StringUtil.Like( StringUtil.Lower( AV15GAMApplicationPermission.gxTpr_Name) , StringUtil.PadR( "%_fullcontrol" , 254 , "%"),  ' ' ) || StringUtil.Like( StringUtil.Lower( AV15GAMApplicationPermission.gxTpr_Name) , StringUtil.PadR( "%_services_" , 254 , "%"),  ' ' ) || StringUtil.Like( StringUtil.Lower( AV15GAMApplicationPermission.gxTpr_Name) , StringUtil.PadR( "custom_%" , 254 , "%"),  ' ' ) ) )
            {
