...
namespace GeneXus.Programs.wwpbaseobjects.sms {
   ...
   public class SdtWWP_SMS : GxSilentTrnSdt
   {
      ...
      public void Load( long AV138WWPSMSId )
      {
         IGxSilentTrn obj;
         obj = getTransaction();
         obj.LoadKey(new Object[] {(long)AV138WWPSMSId});
         return  ;
      }
      ...
      public void UpdateDirties( GeneXus.Programs.wwpbaseobjects.sms.SdtWWP_SMS sdt )
      {
         ...
         {
            gxTv_SdtWWP_SMS_Wwpsmsprocessed_N = (short)(sdt.gxTv_SdtWWP_SMS_Wwpsmsprocessed_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_SMS_Wwpsmsprocessed = sdt.gxTv_SdtWWP_SMS_Wwpsmsprocessed ;
         }
         if ( sdt.IsDirty("WWPSMSDetail") )
         {
            gxTv_SdtWWP_SMS_Wwpsmsdetail_N = (short)(sdt.gxTv_SdtWWP_SMS_Wwpsmsdetail_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_SMS_Wwpsmsdetail = sdt.gxTv_SdtWWP_SMS_Wwpsmsdetail ;
         }
         if ( sdt.IsDirty("WWPNotificationId") )
         {
            gxTv_SdtWWP_SMS_Wwpnotificationid_N = (short)(sdt.gxTv_SdtWWP_SMS_Wwpnotificationid_N);
            sdtIsNull = 0;
            gxTv_SdtWWP_SMS_Wwpnotificationid = sdt.gxTv_SdtWWP_SMS_Wwpnotificationid ;
         }
   ...
   public class SdtWWP_SMS_RESTInterface : GxGenericCollectionItem<GeneXus.Programs.wwpbaseobjects.sms.SdtWWP_SMS>
   {
      ...
      public string gxTpr_Wwpsmsid
      {
         ...
         set {
            sdt.gxTpr_Wwpsmsid = (long)(Math.Round(NumberUtil.Val( value, "."), 18, MidpointRounding.ToEven));
         }
      ...
      {
         get {
            return DateTimeUtil.TToC3( sdt.gxTpr_Wwpsmscreated, (IGxContext)(context)) ;
         }

         set {
            sdt.gxTpr_Wwpsmscreated = DateTimeUtil.CToT2( value, (IGxContext)(context));
         }
      ...
      {
         get {
            return DateTimeUtil.TToC3( sdt.gxTpr_Wwpsmsscheduled, (IGxContext)(context)) ;
         }

         set {
            sdt.gxTpr_Wwpsmsscheduled = DateTimeUtil.CToT2( value, (IGxContext)(context));
         }
      ...
      {
         get {
            return DateTimeUtil.TToC3( sdt.gxTpr_Wwpsmsprocessed, (IGxContext)(context)) ;
         }

         set {
            sdt.gxTpr_Wwpsmsprocessed = DateTimeUtil.CToT2( value, (IGxContext)(context));
         }
