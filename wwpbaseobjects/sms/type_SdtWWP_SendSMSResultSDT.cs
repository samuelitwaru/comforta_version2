...
namespace GeneXus.Programs.wwpbaseobjects.sms
{
	...
	[XmlType(TypeName="WWP_SendSMSResultSDT" , Namespace="Comforta_version2" )]
	[Serializable]
	public class SdtWWP_SendSMSResultSDT : GxUserType
	{
		...
		public GxSimpleCollection<string> gxTpr_To_GxSimpleCollection
		{
			...
			set {
				gxTv_SdtWWP_SendSMSResultSDT_To_N = false;
		...
		protected bool gxTv_SdtWWP_SendSMSResultSDT_To_N;
	...
	[DataContract(Name=@"WWP_SendSMSResultSDT", Namespace="Comforta_version2")]
	public class SdtWWP_SendSMSResultSDT_RESTInterface : GxGenericCollectionItem<SdtWWP_SendSMSResultSDT>, System.Web.SessionState.IRequiresSessionState
	{
		...
		{
			get { 
				return DateTimeUtil.TToC2( sdt.gxTpr_Modified_at,context);

			}
			set { 
				sdt.gxTpr_Modified_at = DateTimeUtil.CToT2(value,context);
			}
		}
		...
		{
			get { 
				return DateTimeUtil.TToC2( sdt.gxTpr_Expire_at,context);

			}
			set { 
				sdt.gxTpr_Expire_at = DateTimeUtil.CToT2(value,context);
			}
		}
