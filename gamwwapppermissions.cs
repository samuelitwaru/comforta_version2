...
namespace GeneXus.Programs {
   public class gamwwapppermissions : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV72IsAuthorized_Display = StringUtil.StrToBool( GetPar( "IsAuthorized_Display"));
         AV74IsAuthorized_Update = StringUtil.StrToBool( GetPar( "IsAuthorized_Update"));
         AV75IsAuthorized_Delete = StringUtil.StrToBool( GetPar( "IsAuthorized_Delete"));
         ...
         AV76IsAuthorized_Back = StringUtil.StrToBool( GetPar( "IsAuthorized_Back"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV60ManageFiltersExecutionStep, AV54ColumnsSelector, AV79Pgmname, AV16FilName, AV27PermissionAccessTypeDefault, AV28PermissionTypeFilter, AV24isAutomaticPermission, AV9ApplicationId, AV72IsAuthorized_Display, AV74IsAuthorized_Update, AV75IsAuthorized_Delete, AV20IsAuthorized_BtnChildren, AV23IsAuthorized_Name, AV76IsAuthorized_Back, AV77IsAuthorized_Insert) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "gamwwapppermissions.aspx"+UrlEncode(StringUtil.LTrimStr(AV9ApplicationId,12,0));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamwwapppermissions.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISPLAY", AV72IsAuthorized_Display);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DISPLAY", GetSecureSignedToken( "", AV72IsAuthorized_Display, context));
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( "", AV75IsAuthorized_Delete, context));
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_BACK", AV76IsAuthorized_Back);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_BACK", GetSecureSignedToken( "", AV76IsAuthorized_Back, context));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vMANAGEFILTERSEXECUTIONSTEP", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV60ManageFiltersExecutionStep), 1, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV79Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV79Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "vAPPLICATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9ApplicationId), 12, 0, context.GetLanguageProperty( "decimal_point"), "")));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISPLAY", AV72IsAuthorized_Display);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DISPLAY", GetSecureSignedToken( "", AV72IsAuthorized_Display, context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_UPDATE", AV74IsAuthorized_Update);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_UPDATE", GetSecureSignedToken( "", AV74IsAuthorized_Update, context));
      ...
      public override string GetSelfLink( )
      {
         GXKey = Crypto.GetSiteKey( );
         GXEncryptionTmp = "gamwwapppermissions.aspx"+UrlEncode(StringUtil.LTrimStr(AV9ApplicationId,12,0));
         return formatLink("gamwwapppermissions.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }
      ...
      {
         return context.GetMessage( "WWP_GAM_PermissionsApplication", "") ;
      }

      protected void WB910( )
      {
         if ( context.isAjaxRequest( ) )
         {
            disableOutput();
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(57), 2, 0)+","+"null"+");", context.GetMessage( "WWP_EditColumnsCaption", ""), bttBtneditcolumns_Jsonclick, 0, context.GetMessage( "WWP_EditColumnsTooltip", ""), "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMWWAppPermissions.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            ...
            wb_table1_23_912( true) ;
         }
         else
         {
            wb_table1_23_912( false) ;
         }
         return  ;
      }

      protected void wb_table1_23_912e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START912( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "WWP_GAM_PermissionsApplication", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void WS912( )
      {
         START912( ) ;
         EVT912( ) ;
      }

      protected void EVT912( )
      {
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignAttri("", false, edtavUpdate_Internalname, AV73Update);
                              ...
                              AV7AppId = (long)(Math.Round(context.localUtil.CToN( cgiGet( edtavAppid_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void PA912( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "gamwwapppermissions.aspx")), "gamwwapppermissions.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "gamwwapppermissions.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      protected void send_integrity_lvl_hashes912( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV79Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV79Pgmname, "")), context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DISPLAY", AV72IsAuthorized_Display);
      ...
      protected void STRUP910( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV67GridCurrentPage = (long)(Math.Round(context.localUtil.CToN( cgiGet( "vGRIDCURRENTPAGE"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")), 18, MidpointRounding.ToEven));
      ...
      protected void E17912( )
      {
         ...
         Form.Caption = context.GetMessage( "WWP_GAM_PermissionsApplication", "");
         ...
         edtavBtnchildren_Title = context.GetMessage( "WWP_GAM_Children", "");
         AssignProp("", false, edtavBtnchildren_Internalname, "Title", edtavBtnchildren_Title, !bGXsfl_57_Refreshing);
         AV8Application.load( AV9ApplicationId);
         Form.Caption = StringUtil.Format( context.GetMessage( "WWP_GAM_PermissionsOfApplication", ""), AV8Application.gxTpr_Name, "", "", "", "", "", "", "", "");
         AssignProp("", false, "FORM", "Caption", Form.Caption, true);
      }

      protected void E18912( )
      {
         if ( gx_refresh_fired )
         {
            return  ;
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV79Pgmname, out  GXt_char3) ;
      ...
      private void E19912( )
      {
         ...
         while ( AV80GXV1 <= AV30Permissions.Count )
         {
            ...
            {
               GXKey = Crypto.GetSiteKey( );
               GXEncryptionTmp = "gamapppermissionentry.aspx"+UrlEncode(StringUtil.RTrim("DSP")) + "," + UrlEncode(StringUtil.LTrimStr(AV9ApplicationId,12,0)) + "," + UrlEncode(StringUtil.RTrim(AV19Id));
               edtavDisplay_Link = formatLink("gamapppermissionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            ...
            {
               GXKey = Crypto.GetSiteKey( );
               GXEncryptionTmp = "gamapppermissionentry.aspx"+UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(StringUtil.LTrimStr(AV9ApplicationId,12,0)) + "," + UrlEncode(StringUtil.RTrim(AV19Id));
               edtavUpdate_Link = formatLink("gamapppermissionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            ...
            {
               GXKey = Crypto.GetSiteKey( );
               GXEncryptionTmp = "gamapppermissionentry.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(StringUtil.LTrimStr(AV9ApplicationId,12,0)) + "," + UrlEncode(StringUtil.RTrim(AV19Id));
               edtavDelete_Link = formatLink("gamapppermissionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            ...
            {
               GXKey = Crypto.GetSiteKey( );
               GXEncryptionTmp = "gamapppermissionchildren.aspx"+UrlEncode(StringUtil.LTrimStr(AV9ApplicationId,12,0)) + "," + UrlEncode(StringUtil.RTrim(AV19Id));
               edtavBtnchildren_Link = formatLink("gamapppermissionchildren.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            if ( AV23IsAuthorized_Name )
            {
               GXKey = Crypto.GetSiteKey( );
               GXEncryptionTmp = "gamapppermissionentry.aspx"+UrlEncode(StringUtil.RTrim("DSP")) + "," + UrlEncode(StringUtil.LTrimStr(AV9ApplicationId,12,0)) + "," + UrlEncode(StringUtil.RTrim(AV19Id));
               edtavName_Link = formatLink("gamapppermissionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
            }
            /* Load Method */
            if ( wbStart != -1 )
            {
      ...
      protected void E14912( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "GAMWWAppPermissionsColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV42ColumnsSelectorXML)) ? "" : AV54ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E11912( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            if (returnInSub) return;
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("GAMWWAppPermissionsFilters")) + "," + UrlEncode(StringUtil.RTrim(AV79Pgmname+"GridState"));
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("GAMWWAppPermissionsFilters"));
         ...
         else
         {
            ...
            else
            {
               ...
               S162 ();
               if (returnInSub) return;
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV79Pgmname+"GridState",  AV61ManageFiltersXml) ;
      ...
      protected void E15912( )
      {
         /* 'DoBack' Routine */
         returnInSub = false;
         if ( AV76IsAuthorized_Back )
         {
      ...
      protected void E16912( )
      {
         ...
         {
            GXKey = Crypto.GetSiteKey( );
            GXEncryptionTmp = "gamapppermissionentry.aspx"+UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode(StringUtil.LTrimStr(AV9ApplicationId,12,0)) + "," + UrlEncode(StringUtil.RTrim(""));
            CallWebObject(formatLink("gamapppermissionentry.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S132( )
      {
         ...
         AssignAttri("", false, "AV72IsAuthorized_Display", AV72IsAuthorized_Display);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DISPLAY", GetSecureSignedToken( "", AV72IsAuthorized_Display, context));
         if ( ! ( AV72IsAuthorized_Display ) )
         {
         ...
         AssignAttri("", false, "AV75IsAuthorized_Delete", AV75IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( "", AV75IsAuthorized_Delete, context));
         if ( ! ( AV75IsAuthorized_Delete ) )
         {
         ...
         GXt_boolean1 = AV76IsAuthorized_Back;
         ...
         AV76IsAuthorized_Back = GXt_boolean1;
         AssignAttri("", false, "AV76IsAuthorized_Back", AV76IsAuthorized_Back);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_BACK", GetSecureSignedToken( "", AV76IsAuthorized_Back, context));
         if ( ! ( AV76IsAuthorized_Back ) )
         {
      ...
      protected void S122( )
      {
         ...
         {
            AV40GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV79Pgmname+"GridState"), null, "", "");
         }
         else
         {
      ...
      protected void S172( )
      {
         ...
         {
            AV41GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV40GridState.gxTpr_Filtervalues.Item(AV81GXV2));
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV40GridState,  "FILNAME",  context.GetMessage( "WWP_GAM_Name", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV16FilName)),  0,  AV16FilName,  AV16FilName,  false,  "",  "") ;
         AV78AuxText = "[" + AV27PermissionAccessTypeDefault + "]";
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV40GridState,  "PERMISSIONACCESSTYPEDEFAULT",  context.GetMessage( "WWP_GAM_DefaultAccess", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV27PermissionAccessTypeDefault)),  0,  AV27PermissionAccessTypeDefault,  StringUtil.StringReplace( StringUtil.StringReplace( AV78AuxText, "[A]", context.GetMessage( "WWP_GAM_Allow", "")), "[R]", context.GetMessage( "WWP_GAM_Restricted", "")),  false,  "",  "") ;
         AV78AuxText = "[" + AV28PermissionTypeFilter + "]";
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV40GridState,  "PERMISSIONTYPEFILTER",  context.GetMessage( "WWP_GAM_FilterBy", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV28PermissionTypeFilter)),  0,  AV28PermissionTypeFilter,  StringUtil.StringReplace( StringUtil.StringReplace( StringUtil.StringReplace( StringUtil.StringReplace( AV78AuxText, "[A]", context.GetMessage( "WWP_GAM_All", "")), "[F]", context.GetMessage( "WWP_GAM_FirstLevel", "")), "[P]", context.GetMessage( "WWP_GAM_Parents", "")), "[C]", context.GetMessage( "WWP_GAM_AllChildren", "")),  false,  "",  "") ;
         AV78AuxText = "[" + AV24isAutomaticPermission + "]";
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV40GridState,  "ISAUTOMATICPERMISSION",  context.GetMessage( "WWP_GAM_OnlyAutomaticPermissions", ""),  !String.IsNullOrEmpty(StringUtil.RTrim( AV24isAutomaticPermission)),  0,  AV24isAutomaticPermission,  StringUtil.StringReplace( StringUtil.StringReplace( StringUtil.StringReplace( AV78AuxText, "[A]", context.GetMessage( "WWP_GAM_All", "")), "[T]", context.GetMessage( "WWP_GAM_Yes", "")), "[F]", context.GetMessage( "WWP_GAM_No", "")),  false,  "",  "") ;
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV79Pgmname+"GridState",  AV40GridState.ToXml(false, true, "", "")) ;
      }

      protected void wb_table1_23_912( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            context.WriteHtmlText( "<td>") ;
            wb_table2_28_912( true) ;
         }
         else
         {
            wb_table2_28_912( false) ;
         }
         return  ;
      }

      protected void wb_table2_28_912e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_23_912e( true) ;
         }
         else
         {
            wb_table1_23_912e( false) ;
         }
      }

      protected void wb_table2_28_912( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavPermissionaccesstypedefault_Internalname, context.GetMessage( "WWP_GAM_DefaultAccess", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavPermissiontypefilter_Internalname, context.GetMessage( "WWP_GAM_FilterBy", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavIsautomaticpermission_Internalname, context.GetMessage( "WWP_GAM_OnlyAutomaticPermissions", ""), "gx-form-item AttributeLabel", 1, true, "width: 25%;");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 75, "%", 0, "px", "gx-form-item gx-attribute", "start", "top", "", "", "div");
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_28_912e( true) ;
         }
         else
         {
            wb_table2_28_912e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024112115483046", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamwwapppermissions.js", "?2024112115483047", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_572( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_57_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavAppid_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7AppId), 12, 0, context.GetLanguageProperty( "decimal_point"), "")),StringUtil.LTrim( ((edtavAppid_Enabled!=0) ? context.localUtil.Format( (decimal)(AV7AppId), "ZZZZZZZZZZZ9") : context.localUtil.Format( (decimal)(AV7AppId), "ZZZZZZZZZZZ9")))," dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+""+" onchange=\""+"gx.num.valid_integer( this,gx.thousandSeparator);"+";gx.evt.onchange(this, event)\" ",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtavAppid_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(short)0,(int)edtavAppid_Enabled,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)12,(short)0,(short)0,(short)57,(short)0,(short)-1,(short)0,(bool)true,(string)"GeneXusSecurityCommon\\GAMKeyNumLong",(string)"end",(bool)false,(string)""});
      ...
      protected void init_web_controls( )
      {
         ...
         cmbavPermissionaccesstypedefault.addItem("", context.GetMessage( "GX_EmptyItemText", ""), 0);
         cmbavPermissionaccesstypedefault.addItem("A", context.GetMessage( "WWP_GAM_Allow", ""), 0);
         cmbavPermissionaccesstypedefault.addItem("R", context.GetMessage( "WWP_GAM_Restricted", ""), 0);
         if ( cmbavPermissionaccesstypedefault.ItemCount > 0 )
         {
            AV27PermissionAccessTypeDefault = cmbavPermissionaccesstypedefault.getValidValue(AV27PermissionAccessTypeDefault);
            AssignAttri("", false, "AV27PermissionAccessTypeDefault", AV27PermissionAccessTypeDefault);
         ...
         cmbavPermissiontypefilter.addItem("A", context.GetMessage( "WWP_GAM_All", ""), 0);
         cmbavPermissiontypefilter.addItem("F", context.GetMessage( "WWP_GAM_FirstLevel", ""), 0);
         cmbavPermissiontypefilter.addItem("P", context.GetMessage( "WWP_GAM_Parents", ""), 0);
         cmbavPermissiontypefilter.addItem("C", context.GetMessage( "WWP_GAM_AllChildren", ""), 0);
         if ( cmbavPermissiontypefilter.ItemCount > 0 )
         {
            AV28PermissionTypeFilter = cmbavPermissiontypefilter.getValidValue(AV28PermissionTypeFilter);
            AssignAttri("", false, "AV28PermissionTypeFilter", AV28PermissionTypeFilter);
         ...
         cmbavIsautomaticpermission.addItem("A", context.GetMessage( "WWP_GAM_All", ""), 0);
         cmbavIsautomaticpermission.addItem("T", context.GetMessage( "WWP_GAM_Yes", ""), 0);
         cmbavIsautomaticpermission.addItem("F", context.GetMessage( "WWP_GAM_No", ""), 0);
         if ( cmbavIsautomaticpermission.ItemCount > 0 )
         {
            AV24isAutomaticPermission = cmbavIsautomaticpermission.getValidValue(AV24isAutomaticPermission);
            AssignAttri("", false, "AV24isAutomaticPermission", AV24isAutomaticPermission);
      ...
      protected void StartGridControl57( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.SendWebValue( context.GetMessage( "WWP_GAM_DefaultAccess", "")) ;
            context.WriteHtmlTextNl( "</th>") ;
         ...
         else
         {
            ...
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
            GridColumn.AddObjectProperty("Value", GXUtil.ValueEncode( StringUtil.RTrim( AV73Update)));
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"edtavBtnchildren_Title","ctrl":"vBTNCHILDREN","prop":"Title"},{"av":"AV9ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV79Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"cmbavPermissionaccesstypedefault"},{"av":"AV27PermissionAccessTypeDefault","fld":"vPERMISSIONACCESSTYPEDEFAULT"},{"av":"cmbavPermissiontypefilter"},{"av":"AV28PermissionTypeFilter","fld":"vPERMISSIONTYPEFILTER"},{"av":"cmbavIsautomaticpermission"},{"av":"AV24isAutomaticPermission","fld":"vISAUTOMATICPERMISSION"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"AV23IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtavName_Visible","ctrl":"vNAME","prop":"Visible"},{"av":"edtavDsc_Visible","ctrl":"vDSC","prop":"Visible"},{"av":"cmbavAccesstype"},{"av":"AV67GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV70GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"edtavBtnchildren_Visible","ctrl":"vBTNCHILDREN","prop":"Visible"},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"ctrl":"BTNBACK","prop":"Visible"},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV64ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV40GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E12912","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV79Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"cmbavPermissionaccesstypedefault"},{"av":"AV27PermissionAccessTypeDefault","fld":"vPERMISSIONACCESSTYPEDEFAULT"},{"av":"cmbavPermissiontypefilter"},{"av":"AV28PermissionTypeFilter","fld":"vPERMISSIONTYPEFILTER"},{"av":"cmbavIsautomaticpermission"},{"av":"AV24isAutomaticPermission","fld":"vISAUTOMATICPERMISSION"},{"av":"edtavBtnchildren_Title","ctrl":"vBTNCHILDREN","prop":"Title"},{"av":"AV9ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"AV23IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E13912","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV79Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"cmbavPermissionaccesstypedefault"},{"av":"AV27PermissionAccessTypeDefault","fld":"vPERMISSIONACCESSTYPEDEFAULT"},{"av":"cmbavPermissiontypefilter"},{"av":"AV28PermissionTypeFilter","fld":"vPERMISSIONTYPEFILTER"},{"av":"cmbavIsautomaticpermission"},{"av":"AV24isAutomaticPermission","fld":"vISAUTOMATICPERMISSION"},{"av":"edtavBtnchildren_Title","ctrl":"vBTNCHILDREN","prop":"Title"},{"av":"AV9ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"AV23IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E19912","iparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV9ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"cmbavPermissionaccesstypedefault"},{"av":"AV27PermissionAccessTypeDefault","fld":"vPERMISSIONACCESSTYPEDEFAULT"},{"av":"cmbavPermissiontypefilter"},{"av":"AV28PermissionTypeFilter","fld":"vPERMISSIONTYPEFILTER"},{"av":"cmbavIsautomaticpermission"},{"av":"AV24isAutomaticPermission","fld":"vISAUTOMATICPERMISSION"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"AV23IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV7AppId","fld":"vAPPID","pic":"ZZZZZZZZZZZ9"},{"av":"AV18GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV19Id","fld":"vID"},{"av":"AV25Name","fld":"vNAME"},{"av":"AV14Dsc","fld":"vDSC"},{"av":"cmbavAccesstype"},{"av":"AV6AccessType","fld":"vACCESSTYPE"},{"av":"AV71Display","fld":"vDISPLAY"},{"av":"edtavDisplay_Link","ctrl":"vDISPLAY","prop":"Link"},{"av":"AV73Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV5Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"AV11BtnChildren","fld":"vBTNCHILDREN"},{"av":"edtavBtnchildren_Link","ctrl":"vBTNCHILDREN","prop":"Link"},{"av":"edtavName_Link","ctrl":"vNAME","prop":"Link"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E14912","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV79Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"cmbavPermissionaccesstypedefault"},{"av":"AV27PermissionAccessTypeDefault","fld":"vPERMISSIONACCESSTYPEDEFAULT"},{"av":"cmbavPermissiontypefilter"},{"av":"AV28PermissionTypeFilter","fld":"vPERMISSIONTYPEFILTER"},{"av":"cmbavIsautomaticpermission"},{"av":"AV24isAutomaticPermission","fld":"vISAUTOMATICPERMISSION"},{"av":"edtavBtnchildren_Title","ctrl":"vBTNCHILDREN","prop":"Title"},{"av":"AV9ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"AV23IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",""","oparms":[{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"edtavName_Visible","ctrl":"vNAME","prop":"Visible"},{"av":"edtavDsc_Visible","ctrl":"vDSC","prop":"Visible"},{"av":"cmbavAccesstype"},{"av":"AV67GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV70GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"edtavBtnchildren_Visible","ctrl":"vBTNCHILDREN","prop":"Visible"},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"ctrl":"BTNBACK","prop":"Visible"},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV64ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV40GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E11912","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV79Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"cmbavPermissionaccesstypedefault"},{"av":"AV27PermissionAccessTypeDefault","fld":"vPERMISSIONACCESSTYPEDEFAULT"},{"av":"cmbavPermissiontypefilter"},{"av":"AV28PermissionTypeFilter","fld":"vPERMISSIONTYPEFILTER"},{"av":"cmbavIsautomaticpermission"},{"av":"AV24isAutomaticPermission","fld":"vISAUTOMATICPERMISSION"},{"av":"edtavBtnchildren_Title","ctrl":"vBTNCHILDREN","prop":"Title"},{"av":"AV9ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"AV23IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV40GridState","fld":"vGRIDSTATE"}]""");
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40GridState","fld":"vGRIDSTATE"},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"cmbavPermissionaccesstypedefault"},{"av":"AV27PermissionAccessTypeDefault","fld":"vPERMISSIONACCESSTYPEDEFAULT"},{"av":"cmbavPermissiontypefilter"},{"av":"AV28PermissionTypeFilter","fld":"vPERMISSIONTYPEFILTER"},{"av":"cmbavIsautomaticpermission"},{"av":"AV24isAutomaticPermission","fld":"vISAUTOMATICPERMISSION"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtavName_Visible","ctrl":"vNAME","prop":"Visible"},{"av":"edtavDsc_Visible","ctrl":"vDSC","prop":"Visible"},{"av":"cmbavAccesstype"},{"av":"AV67GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV70GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"edtavBtnchildren_Visible","ctrl":"vBTNCHILDREN","prop":"Visible"},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"ctrl":"BTNBACK","prop":"Visible"},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV64ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("'DOBACK'","""{"handler":"E15912","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV79Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"cmbavPermissionaccesstypedefault"},{"av":"AV27PermissionAccessTypeDefault","fld":"vPERMISSIONACCESSTYPEDEFAULT"},{"av":"cmbavPermissiontypefilter"},{"av":"AV28PermissionTypeFilter","fld":"vPERMISSIONTYPEFILTER"},{"av":"cmbavIsautomaticpermission"},{"av":"AV24isAutomaticPermission","fld":"vISAUTOMATICPERMISSION"},{"av":"edtavBtnchildren_Title","ctrl":"vBTNCHILDREN","prop":"Title"},{"av":"AV9ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"AV23IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("'DOBACK'",""","oparms":[{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtavName_Visible","ctrl":"vNAME","prop":"Visible"},{"av":"edtavDsc_Visible","ctrl":"vDSC","prop":"Visible"},{"av":"cmbavAccesstype"},{"av":"AV67GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV70GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"edtavBtnchildren_Visible","ctrl":"vBTNCHILDREN","prop":"Visible"},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"ctrl":"BTNBACK","prop":"Visible"},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV64ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV40GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E16912","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV79Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV16FilName","fld":"vFILNAME"},{"av":"cmbavPermissionaccesstypedefault"},{"av":"AV27PermissionAccessTypeDefault","fld":"vPERMISSIONACCESSTYPEDEFAULT"},{"av":"cmbavPermissiontypefilter"},{"av":"AV28PermissionTypeFilter","fld":"vPERMISSIONTYPEFILTER"},{"av":"cmbavIsautomaticpermission"},{"av":"AV24isAutomaticPermission","fld":"vISAUTOMATICPERMISSION"},{"av":"edtavBtnchildren_Title","ctrl":"vBTNCHILDREN","prop":"Title"},{"av":"AV9ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"AV23IsAuthorized_Name","fld":"vISAUTHORIZED_NAME","hsh":true},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"AV9ApplicationId","fld":"vAPPLICATIONID","pic":"ZZZZZZZZZZZ9"},{"av":"AV60ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV54ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtavName_Visible","ctrl":"vNAME","prop":"Visible"},{"av":"edtavDsc_Visible","ctrl":"vDSC","prop":"Visible"},{"av":"cmbavAccesstype"},{"av":"AV67GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV70GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV72IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"edtavDisplay_Visible","ctrl":"vDISPLAY","prop":"Visible"},{"av":"AV74IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"edtavUpdate_Visible","ctrl":"vUPDATE","prop":"Visible"},{"av":"AV75IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"edtavDelete_Visible","ctrl":"vDELETE","prop":"Visible"},{"av":"AV20IsAuthorized_BtnChildren","fld":"vISAUTHORIZED_BTNCHILDREN","hsh":true},{"av":"edtavBtnchildren_Visible","ctrl":"vBTNCHILDREN","prop":"Visible"},{"av":"AV76IsAuthorized_Back","fld":"vISAUTHORIZED_BACK","hsh":true},{"ctrl":"BTNBACK","prop":"Visible"},{"av":"AV77IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"av":"AV64ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV40GridState","fld":"vGRIDSTATE"}]}""");
      ...
      private bool AV72IsAuthorized_Display ;
      ...
      private bool AV76IsAuthorized_Back ;
