...
namespace GeneXus.Programs {
   public class trn_managerww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV61OrganisationId, AV19ManageFiltersExecutionStep, AV83Pgmname, AV15FilterFullText, AV20TFManagerGivenName, AV21TFManagerGivenName_Sel, AV22TFManagerLastName, AV23TFManagerLastName_Sel, AV26TFManagerEmail, AV27TFManagerEmail_Sel, AV28TFManagerPhone, AV29TFManagerPhone_Sel, AV31TFManagerGender_Sels, AV43IsAuthorized_Display, AV45IsAuthorized_Update, AV47IsAuthorized_Delete) ;
      ...
      protected void WB3E0( )
      {
         ...
         if ( wbEnd == 37 )
         {
            ...
            wb_table1_61_3E2( true) ;
         }
         else
         {
            wb_table1_61_3E2( false) ;
         }
         return  ;
      }

      protected void wb_table1_61_3E2e( bool wbgen )
      {
         if ( wbgen )
         {
            /* User Defined Control */
      ...
      {
         /* GeneXus formulas. */
         AV83Pgmname = "Trn_ManagerWW";
         edtavManagerisactive_Enabled = 0;
      }

      protected int subGridclient_rec_count_fnc( )
      {
         AV84Trn_managerwwds_1_filterfulltext = AV15FilterFullText;
         AV85Trn_managerwwds_2_tfmanagergivenname = AV20TFManagerGivenName;
         AV86Trn_managerwwds_3_tfmanagergivenname_sel = AV21TFManagerGivenName_Sel;
         AV87Trn_managerwwds_4_tfmanagerlastname = AV22TFManagerLastName;
         AV88Trn_managerwwds_5_tfmanagerlastname_sel = AV23TFManagerLastName_Sel;
         AV89Trn_managerwwds_6_tfmanageremail = AV26TFManagerEmail;
         AV90Trn_managerwwds_7_tfmanageremail_sel = AV27TFManagerEmail_Sel;
         AV91Trn_managerwwds_8_tfmanagerphone = AV28TFManagerPhone;
         AV92Trn_managerwwds_9_tfmanagerphone_sel = AV29TFManagerPhone_Sel;
         AV93Trn_managerwwds_10_tfmanagergender_sels = AV31TFManagerGender_Sels;
         GRID_nRecordCount = 0;
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              A27ManagerGender ,
                                              AV93Trn_managerwwds_10_tfmanagergender_sels ,
                                              AV86Trn_managerwwds_3_tfmanagergivenname_sel ,
                                              AV85Trn_managerwwds_2_tfmanagergivenname ,
                                              AV88Trn_managerwwds_5_tfmanagerlastname_sel ,
                                              AV87Trn_managerwwds_4_tfmanagerlastname ,
                                              AV90Trn_managerwwds_7_tfmanageremail_sel ,
                                              AV89Trn_managerwwds_6_tfmanageremail ,
                                              AV92Trn_managerwwds_9_tfmanagerphone_sel ,
                                              AV91Trn_managerwwds_8_tfmanagerphone ,
                                              AV93Trn_managerwwds_10_tfmanagergender_sels.Count ,
                                              A22ManagerGivenName ,
                                              A23ManagerLastName ,
                                              A25ManagerEmail ,
                                              A26ManagerPhone ,
                                              AV13OrderedBy ,
                                              AV14OrderedDsc ,
                                              AV84Trn_managerwwds_1_filterfulltext ,
                                              A11OrganisationId ,
                                              AV61OrganisationId } ,
                                              new int[]{
         ...
         lV85Trn_managerwwds_2_tfmanagergivenname = StringUtil.Concat( StringUtil.RTrim( AV85Trn_managerwwds_2_tfmanagergivenname), "%", "");
         lV87Trn_managerwwds_4_tfmanagerlastname = StringUtil.Concat( StringUtil.RTrim( AV87Trn_managerwwds_4_tfmanagerlastname), "%", "");
         lV89Trn_managerwwds_6_tfmanageremail = StringUtil.Concat( StringUtil.RTrim( AV89Trn_managerwwds_6_tfmanageremail), "%", "");
         lV91Trn_managerwwds_8_tfmanagerphone = StringUtil.PadR( StringUtil.RTrim( AV91Trn_managerwwds_8_tfmanagerphone), 20, "%");
         /* Using cursor H003E2 */
         pr_default.execute(0, new Object[] {AV61OrganisationId, lV85Trn_managerwwds_2_tfmanagergivenname, AV86Trn_managerwwds_3_tfmanagergivenname_sel, lV87Trn_managerwwds_4_tfmanagerlastname, AV88Trn_managerwwds_5_tfmanagerlastname_sel, lV89Trn_managerwwds_6_tfmanageremail, AV90Trn_managerwwds_7_tfmanageremail_sel, lV91Trn_managerwwds_8_tfmanagerphone, AV92Trn_managerwwds_9_tfmanagerphone_sel});
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV84Trn_managerwwds_1_filterfulltext)) || ( ( StringUtil.Like( A22ManagerGivenName , StringUtil.PadR( "%" + AV84Trn_managerwwds_1_filterfulltext , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( A23ManagerLastName , StringUtil.PadR( "%" + AV84Trn_managerwwds_1_filterfulltext , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( A25ManagerEmail , StringUtil.PadR( "%" + AV84Trn_managerwwds_1_filterfulltext , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( A26ManagerPhone , StringUtil.PadR( "%" + AV84Trn_managerwwds_1_filterfulltext , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( context.GetMessage( "male", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV84Trn_managerwwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A27ManagerGender, "Male") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "female", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV84Trn_managerwwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A27ManagerGender, "Female") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "other", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV84Trn_managerwwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A27ManagerGender, "Other") == 0 ) ) ) )
            {
      ...
      protected void RF3E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV91Trn_managerwwds_8_tfmanagerphone = StringUtil.PadR( StringUtil.RTrim( AV91Trn_managerwwds_8_tfmanagerphone), 20, "%");
            /* Using cursor H003E3 */
            pr_default.execute(1, new Object[] {AV61OrganisationId, lV85Trn_managerwwds_2_tfmanagergivenname, AV86Trn_managerwwds_3_tfmanagergivenname_sel, lV87Trn_managerwwds_4_tfmanagerlastname, AV88Trn_managerwwds_5_tfmanagerlastname_sel, lV89Trn_managerwwds_6_tfmanageremail, AV90Trn_managerwwds_7_tfmanageremail_sel, lV91Trn_managerwwds_8_tfmanagerphone, AV92Trn_managerwwds_9_tfmanagerphone_sel});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
            GRID_nEOF = 0;
      ...
      protected void E193E2( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV83Pgmname, out  GXt_char4) ;
      ...
      protected void E113E2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_ManagerWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV83Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV83Pgmname+"GridState",  AV18ManageFiltersXml) ;
      ...
      protected void E143E2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0068",(string)"",(string)"Trn_Manager",(short)1,(string)"",(string)""});
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV16Session.Get(AV83Pgmname+"GridState"), "") == 0 )
         {
            AV11GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV83Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV16Session.Get(AV83Pgmname+"GridState"), null, "", "");
         }
         AV13OrderedBy = AV11GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV13OrderedBy", StringUtil.LTrimStr( (decimal)(AV13OrderedBy), 4, 0));
         AV14OrderedDsc = AV11GridState.gxTpr_Ordereddsc;
      ...
      protected void S182( )
      {
         ...
         returnInSub = false;
         AV94GXV1 = 1;
         while ( AV94GXV1 <= AV11GridState.gxTpr_Filtervalues.Count )
         {
            AV12GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV94GXV1));
      ...
      protected void wb_table1_61_3E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_61_3E2e( true) ;
         }
         else
         {
            wb_table1_61_3E2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102518434153", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_managerww.js", "?2024102518434155", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV61OrganisationId","fld":"vORGANISATIONID"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV83Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV20TFManagerGivenName","fld":"vTFMANAGERGIVENNAME"},{"av":"AV21TFManagerGivenName_Sel","fld":"vTFMANAGERGIVENNAME_SEL"},{"av":"AV22TFManagerLastName","fld":"vTFMANAGERLASTNAME"},{"av":"AV23TFManagerLastName_Sel","fld":"vTFMANAGERLASTNAME_SEL"},{"av":"AV26TFManagerEmail","fld":"vTFMANAGEREMAIL"},{"av":"AV27TFManagerEmail_Sel","fld":"vTFMANAGEREMAIL_SEL"},{"av":"AV28TFManagerPhone","fld":"vTFMANAGERPHONE"},{"av":"AV29TFManagerPhone_Sel","fld":"vTFMANAGERPHONE_SEL"},{"av":"AV31TFManagerGender_Sels","fld":"vTFMANAGERGENDER_SELS"},{"av":"AV43IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV45IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV47IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
         setEventMetadata("REFRESH",""","oparms":[{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV38GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV39GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV40GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"edtavManagerisactive_Columnheaderclass","ctrl":"vMANAGERISACTIVE","prop":"Columnheaderclass"},{"av":"AV43IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV45IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV47IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV17ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E123E2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV61OrganisationId","fld":"vORGANISATIONID"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV83Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV20TFManagerGivenName","fld":"vTFMANAGERGIVENNAME"},{"av":"AV21TFManagerGivenName_Sel","fld":"vTFMANAGERGIVENNAME_SEL"},{"av":"AV22TFManagerLastName","fld":"vTFMANAGERLASTNAME"},{"av":"AV23TFManagerLastName_Sel","fld":"vTFMANAGERLASTNAME_SEL"},{"av":"AV26TFManagerEmail","fld":"vTFMANAGEREMAIL"},{"av":"AV27TFManagerEmail_Sel","fld":"vTFMANAGEREMAIL_SEL"},{"av":"AV28TFManagerPhone","fld":"vTFMANAGERPHONE"},{"av":"AV29TFManagerPhone_Sel","fld":"vTFMANAGERPHONE_SEL"},{"av":"AV31TFManagerGender_Sels","fld":"vTFMANAGERGENDER_SELS"},{"av":"AV43IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV45IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV47IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E203E2","iparms":[{"av":"A394ManagerIsActive","fld":"MANAGERISACTIVE"},{"av":"AV43IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV45IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV47IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV20TFManagerGivenName","fld":"vTFMANAGERGIVENNAME"},{"av":"AV21TFManagerGivenName_Sel","fld":"vTFMANAGERGIVENNAME_SEL"},{"av":"AV22TFManagerLastName","fld":"vTFMANAGERLASTNAME"},{"av":"AV23TFManagerLastName_Sel","fld":"vTFMANAGERLASTNAME_SEL"},{"av":"AV26TFManagerEmail","fld":"vTFMANAGEREMAIL"},{"av":"AV27TFManagerEmail_Sel","fld":"vTFMANAGEREMAIL_SEL"},{"av":"AV28TFManagerPhone","fld":"vTFMANAGERPHONE"},{"av":"AV29TFManagerPhone_Sel","fld":"vTFMANAGERPHONE_SEL"},{"av":"AV31TFManagerGender_Sels","fld":"vTFMANAGERGENDER_SELS"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV30TFManagerGender_SelsJson","fld":"vTFMANAGERGENDER_SELSJSON"},{"av":"AV38GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV39GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV40GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"edtavManagerisactive_Columnheaderclass","ctrl":"vMANAGERISACTIVE","prop":"Columnheaderclass"},{"av":"AV43IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV45IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV47IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV17ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E213E2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV82ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"A21ManagerId","fld":"MANAGERID","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedBy","fld":"vORDEREDBY","pic":"ZZZ9"},{"av":"AV14OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV61OrganisationId","fld":"vORGANISATIONID"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV83Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV15FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV20TFManagerGivenName","fld":"vTFMANAGERGIVENNAME"},{"av":"AV21TFManagerGivenName_Sel","fld":"vTFMANAGERGIVENNAME_SEL"},{"av":"AV22TFManagerLastName","fld":"vTFMANAGERLASTNAME"},{"av":"AV23TFManagerLastName_Sel","fld":"vTFMANAGERLASTNAME_SEL"},{"av":"AV26TFManagerEmail","fld":"vTFMANAGEREMAIL"},{"av":"AV27TFManagerEmail_Sel","fld":"vTFMANAGEREMAIL_SEL"},{"av":"AV28TFManagerPhone","fld":"vTFMANAGERPHONE"},{"av":"AV29TFManagerPhone_Sel","fld":"vTFMANAGERPHONE_SEL"},{"av":"AV31TFManagerGender_Sels","fld":"vTFMANAGERGENDER_SELS"},{"av":"AV43IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV45IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV47IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
         setEventMetadata("VACTIONGROUP.CLICK",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV82ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"AV19ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV38GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV39GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV40GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"edtavManagerisactive_Columnheaderclass","ctrl":"vMANAGERISACTIVE","prop":"Columnheaderclass"},{"av":"AV43IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV45IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV47IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV17ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV91Trn_managerwwds_8_tfmanagerphone = "";
         AV92Trn_managerwwds_9_tfmanagerphone_sel = "";
         AV93Trn_managerwwds_10_tfmanagergender_sels = new GxSimpleCollection<string>();
         lV85Trn_managerwwds_2_tfmanagergivenname = "";
         lV87Trn_managerwwds_4_tfmanagerlastname = "";
         lV89Trn_managerwwds_6_tfmanageremail = "";
         lV91Trn_managerwwds_8_tfmanagerphone = "";
      ...
      private int AV93Trn_managerwwds_10_tfmanagergender_sels_Count ;
      ...
      private string AV91Trn_managerwwds_8_tfmanagerphone ;
      private string AV92Trn_managerwwds_9_tfmanagerphone_sel ;
      private string lV91Trn_managerwwds_8_tfmanagerphone ;
      ...
      private string AV84Trn_managerwwds_1_filterfulltext ;
      private string AV85Trn_managerwwds_2_tfmanagergivenname ;
      private string AV86Trn_managerwwds_3_tfmanagergivenname_sel ;
      private string AV87Trn_managerwwds_4_tfmanagerlastname ;
      private string AV88Trn_managerwwds_5_tfmanagerlastname_sel ;
      private string AV89Trn_managerwwds_6_tfmanageremail ;
      private string AV90Trn_managerwwds_7_tfmanageremail_sel ;
      private string lV85Trn_managerwwds_2_tfmanagergivenname ;
      private string lV87Trn_managerwwds_4_tfmanagerlastname ;
      private string lV89Trn_managerwwds_6_tfmanageremail ;
      ...
      private GxSimpleCollection<string> AV93Trn_managerwwds_10_tfmanagergender_sels ;
   ...
   public class trn_managerww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003E2( IGxContext context ,
                                             ...
                                             GxSimpleCollection<string> AV93Trn_managerwwds_10_tfmanagergender_sels ,
                                             string AV86Trn_managerwwds_3_tfmanagergivenname_sel ,
                                             string AV85Trn_managerwwds_2_tfmanagergivenname ,
                                             string AV88Trn_managerwwds_5_tfmanagerlastname_sel ,
                                             string AV87Trn_managerwwds_4_tfmanagerlastname ,
                                             string AV90Trn_managerwwds_7_tfmanageremail_sel ,
                                             string AV89Trn_managerwwds_6_tfmanageremail ,
                                             string AV92Trn_managerwwds_9_tfmanagerphone_sel ,
                                             string AV91Trn_managerwwds_8_tfmanagerphone ,
                                             int AV93Trn_managerwwds_10_tfmanagergender_sels_Count ,
                                             string A22ManagerGivenName ,
                                             ...
                                             short AV13OrderedBy ,
                                             bool AV14OrderedDsc ,
                                             string AV84Trn_managerwwds_1_filterfulltext ,
                                             ...
                                             Guid AV61OrganisationId )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV86Trn_managerwwds_3_tfmanagergivenname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV85Trn_managerwwds_2_tfmanagergivenname)) ) )
         {
            AddWhere(sWhereString, "(ManagerGivenName like :lV85Trn_managerwwds_2_tfmanagergivenname)");
         }
         else
         {
            GXv_int10[1] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV86Trn_managerwwds_3_tfmanagergivenname_sel)) && ! ( StringUtil.StrCmp(AV86Trn_managerwwds_3_tfmanagergivenname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(ManagerGivenName = ( :AV86Trn_managerwwds_3_tfmanagergivenname_sel))");
         }
         else
         {
            GXv_int10[2] = 1;
         }
         if ( StringUtil.StrCmp(AV86Trn_managerwwds_3_tfmanagergivenname_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerGivenName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV88Trn_managerwwds_5_tfmanagerlastname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV87Trn_managerwwds_4_tfmanagerlastname)) ) )
         {
            AddWhere(sWhereString, "(ManagerLastName like :lV87Trn_managerwwds_4_tfmanagerlastname)");
         }
         else
         {
            GXv_int10[3] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV88Trn_managerwwds_5_tfmanagerlastname_sel)) && ! ( StringUtil.StrCmp(AV88Trn_managerwwds_5_tfmanagerlastname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(ManagerLastName = ( :AV88Trn_managerwwds_5_tfmanagerlastname_sel))");
         }
         else
         {
            GXv_int10[4] = 1;
         }
         if ( StringUtil.StrCmp(AV88Trn_managerwwds_5_tfmanagerlastname_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerLastName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV90Trn_managerwwds_7_tfmanageremail_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV89Trn_managerwwds_6_tfmanageremail)) ) )
         {
            AddWhere(sWhereString, "(ManagerEmail like :lV89Trn_managerwwds_6_tfmanageremail)");
         }
         else
         {
            GXv_int10[5] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV90Trn_managerwwds_7_tfmanageremail_sel)) && ! ( StringUtil.StrCmp(AV90Trn_managerwwds_7_tfmanageremail_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(ManagerEmail = ( :AV90Trn_managerwwds_7_tfmanageremail_sel))");
         }
         else
         {
            GXv_int10[6] = 1;
         }
         if ( StringUtil.StrCmp(AV90Trn_managerwwds_7_tfmanageremail_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerEmail))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV92Trn_managerwwds_9_tfmanagerphone_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV91Trn_managerwwds_8_tfmanagerphone)) ) )
         {
            AddWhere(sWhereString, "(ManagerPhone like :lV91Trn_managerwwds_8_tfmanagerphone)");
         }
         else
         {
            GXv_int10[7] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV92Trn_managerwwds_9_tfmanagerphone_sel)) && ! ( StringUtil.StrCmp(AV92Trn_managerwwds_9_tfmanagerphone_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(ManagerPhone = ( :AV92Trn_managerwwds_9_tfmanagerphone_sel))");
         }
         else
         {
            GXv_int10[8] = 1;
         }
         if ( StringUtil.StrCmp(AV92Trn_managerwwds_9_tfmanagerphone_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerPhone))=0))");
         }
         if ( AV93Trn_managerwwds_10_tfmanagergender_sels_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV93Trn_managerwwds_10_tfmanagergender_sels, "ManagerGender IN (", ")")+")");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV85Trn_managerwwds_2_tfmanagergivenname",GXType.VarChar,100,0) ,
          new ParDef("AV86Trn_managerwwds_3_tfmanagergivenname_sel",GXType.VarChar,100,0) ,
          new ParDef("lV87Trn_managerwwds_4_tfmanagerlastname",GXType.VarChar,100,0) ,
          new ParDef("AV88Trn_managerwwds_5_tfmanagerlastname_sel",GXType.VarChar,100,0) ,
          new ParDef("lV89Trn_managerwwds_6_tfmanageremail",GXType.VarChar,100,0) ,
          new ParDef("AV90Trn_managerwwds_7_tfmanageremail_sel",GXType.VarChar,100,0) ,
          new ParDef("lV91Trn_managerwwds_8_tfmanagerphone",GXType.Char,20,0) ,
          new ParDef("AV92Trn_managerwwds_9_tfmanagerphone_sel",GXType.Char,20,0)
          };
          Object[] prmH003E3;
