...
namespace GeneXus.Programs {
   public class trn_managerww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedBy, AV14OrderedDsc, AV61OrganisationId, AV19ManageFiltersExecutionStep, AV82Pgmname, AV15FilterFullText, AV20TFManagerGivenName, AV21TFManagerGivenName_Sel, AV22TFManagerLastName, AV23TFManagerLastName_Sel, AV26TFManagerEmail, AV27TFManagerEmail_Sel, AV28TFManagerPhone, AV29TFManagerPhone_Sel, AV31TFManagerGender_Sels, AV43IsAuthorized_Display, AV45IsAuthorized_Update) ;
      ...
      {
         AV83Trn_managerwwds_1_filterfulltext = AV15FilterFullText;
         AV84Trn_managerwwds_2_tfmanagergivenname = AV20TFManagerGivenName;
         AV85Trn_managerwwds_3_tfmanagergivenname_sel = AV21TFManagerGivenName_Sel;
         AV86Trn_managerwwds_4_tfmanagerlastname = AV22TFManagerLastName;
         AV87Trn_managerwwds_5_tfmanagerlastname_sel = AV23TFManagerLastName_Sel;
         AV88Trn_managerwwds_6_tfmanageremail = AV26TFManagerEmail;
         AV89Trn_managerwwds_7_tfmanageremail_sel = AV27TFManagerEmail_Sel;
         AV90Trn_managerwwds_8_tfmanagerphone = AV28TFManagerPhone;
         AV91Trn_managerwwds_9_tfmanagerphone_sel = AV29TFManagerPhone_Sel;
         AV92Trn_managerwwds_10_tfmanagergender_sels = AV31TFManagerGender_Sels;
         GRID_nRecordCount = 0;
         pr_default.dynParam(0, new Object[]{ new Object[]{
                                              A27ManagerGender ,
                                              AV92Trn_managerwwds_10_tfmanagergender_sels ,
                                              AV85Trn_managerwwds_3_tfmanagergivenname_sel ,
                                              AV84Trn_managerwwds_2_tfmanagergivenname ,
                                              AV87Trn_managerwwds_5_tfmanagerlastname_sel ,
                                              AV86Trn_managerwwds_4_tfmanagerlastname ,
                                              AV89Trn_managerwwds_7_tfmanageremail_sel ,
                                              AV88Trn_managerwwds_6_tfmanageremail ,
                                              AV91Trn_managerwwds_9_tfmanagerphone_sel ,
                                              AV90Trn_managerwwds_8_tfmanagerphone ,
                                              AV92Trn_managerwwds_10_tfmanagergender_sels.Count ,
                                              A22ManagerGivenName ,
                                              A23ManagerLastName ,
                                              A25ManagerEmail ,
                                              A26ManagerPhone ,
                                              AV13OrderedBy ,
                                              AV14OrderedDsc ,
                                              AV83Trn_managerwwds_1_filterfulltext ,
                                              A11OrganisationId ,
                                              AV61OrganisationId } ,
                                              new int[]{
         ...
         lV84Trn_managerwwds_2_tfmanagergivenname = StringUtil.Concat( StringUtil.RTrim( AV84Trn_managerwwds_2_tfmanagergivenname), "%", "");
         lV86Trn_managerwwds_4_tfmanagerlastname = StringUtil.Concat( StringUtil.RTrim( AV86Trn_managerwwds_4_tfmanagerlastname), "%", "");
         lV88Trn_managerwwds_6_tfmanageremail = StringUtil.Concat( StringUtil.RTrim( AV88Trn_managerwwds_6_tfmanageremail), "%", "");
         lV90Trn_managerwwds_8_tfmanagerphone = StringUtil.PadR( StringUtil.RTrim( AV90Trn_managerwwds_8_tfmanagerphone), 20, "%");
         /* Using cursor H003E2 */
         pr_default.execute(0, new Object[] {AV61OrganisationId, lV84Trn_managerwwds_2_tfmanagergivenname, AV85Trn_managerwwds_3_tfmanagergivenname_sel, lV86Trn_managerwwds_4_tfmanagerlastname, AV87Trn_managerwwds_5_tfmanagerlastname_sel, lV88Trn_managerwwds_6_tfmanageremail, AV89Trn_managerwwds_7_tfmanageremail_sel, lV90Trn_managerwwds_8_tfmanagerphone, AV91Trn_managerwwds_9_tfmanagerphone_sel});
         while ( (pr_default.getStatus(0) != 101) )
         {
            ...
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV83Trn_managerwwds_1_filterfulltext)) || ( ( StringUtil.Like( A22ManagerGivenName , StringUtil.PadR( "%" + AV83Trn_managerwwds_1_filterfulltext , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( A23ManagerLastName , StringUtil.PadR( "%" + AV83Trn_managerwwds_1_filterfulltext , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( A25ManagerEmail , StringUtil.PadR( "%" + AV83Trn_managerwwds_1_filterfulltext , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( A26ManagerPhone , StringUtil.PadR( "%" + AV83Trn_managerwwds_1_filterfulltext , 101 , "%"),  ' ' ) ) || ( StringUtil.Like( context.GetMessage( "male", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV83Trn_managerwwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A27ManagerGender, "Male") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "female", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV83Trn_managerwwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A27ManagerGender, "Female") == 0 ) ) || ( StringUtil.Like( context.GetMessage( "other", "") , StringUtil.PadR( "%" + StringUtil.Lower( AV83Trn_managerwwds_1_filterfulltext) , 255 , "%"),  ' ' ) && ( StringUtil.StrCmp(A27ManagerGender, "Other") == 0 ) ) ) )
            {
      ...
      protected void RF3E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV90Trn_managerwwds_8_tfmanagerphone = StringUtil.PadR( StringUtil.RTrim( AV90Trn_managerwwds_8_tfmanagerphone), 20, "%");
            /* Using cursor H003E3 */
            pr_default.execute(1, new Object[] {AV61OrganisationId, lV84Trn_managerwwds_2_tfmanagergivenname, AV85Trn_managerwwds_3_tfmanagergivenname_sel, lV86Trn_managerwwds_4_tfmanagerlastname, AV87Trn_managerwwds_5_tfmanagerlastname_sel, lV88Trn_managerwwds_6_tfmanageremail, AV89Trn_managerwwds_7_tfmanageremail_sel, lV90Trn_managerwwds_8_tfmanagerphone, AV91Trn_managerwwds_9_tfmanagerphone_sel});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
            GRID_nEOF = 0;
      ...
      private void E203E2( )
      {
         if ( ( subGrid_Islastpage == 1 ) || ( subGrid_Rows == 0 ) || ( ( GRID_nCurrentRecord >= GRID_nFirstRecordOnPage ) && ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_fnc_Recordsperpage( ) ) ) )
         {
            ...
            if ( StringUtil.StrCmp(A28ManagerGAMGUID, new prc_getloggedinuserid(context).executeUdp( )) == 0 )
            {
      ...
      protected void E113E2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_ManagerWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV82Pgmname+"GridState"));
         ...
         else
         {
            ...
            else
            {
               ...
               new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV82Pgmname+"GridState",  AV18ManageFiltersXml) ;
      ...
      protected void S132( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV16Session.Get(AV82Pgmname+"GridState"), "") == 0 )
         {
            AV11GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV82Pgmname+"GridState"), null, "", "");
         }
         else
         {
            AV11GridState.FromXml(AV16Session.Get(AV82Pgmname+"GridState"), null, "", "");
         }
         AV13OrderedBy = AV11GridState.gxTpr_Orderedby;
         AssignAttri("", false, "AV13OrderedBy", StringUtil.LTrimStr( (decimal)(AV13OrderedBy), 4, 0));
         AV14OrderedDsc = AV11GridState.gxTpr_Ordereddsc;
      ...
      protected void S182( )
      {
         ...
         returnInSub = false;
         AV93GXV1 = 1;
         while ( AV93GXV1 <= AV11GridState.gxTpr_Filtervalues.Count )
         {
            AV12GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV93GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202410161751525", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_managerww.js", "?202410161751527", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void SubsflControlProps_372( )
      {
         ...
         chkManagerIsActive_Internalname = "MANAGERISACTIVE_"+sGXsfl_37_idx;
      ...
      protected void SubsflControlProps_fel_372( )
      {
         ...
         chkManagerIsActive_Internalname = "MANAGERISACTIVE_"+sGXsfl_37_fel_idx;
      ...
      protected void sendrow_372( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_37_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "AttributeCheckBox";
            StyleString = "";
            GXCCtl = "MANAGERISACTIVE_" + sGXsfl_37_idx;
            chkManagerIsActive.Name = GXCCtl;
            chkManagerIsActive.WebTags = "";
            chkManagerIsActive.Caption = "";
            AssignProp("", false, chkManagerIsActive_Internalname, "TitleCaption", chkManagerIsActive.Caption, !bGXsfl_37_Refreshing);
            ...
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtavResendinvite_Internalname,StringUtil.RTrim( AV56ReSendInvite),(string)"",TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,55);\"",(string)"'"+""+"'"+",false,"+"'"+"e213e2_client"+"'",(string)"",(string)"",(string)edtavResendinvite_Tooltiptext,(string)"",(string)edtavResendinvite_Jsonclick,(short)7,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWIconActionColumn",(string)"",(int)edtavResendinvite_Visible,(int)edtavResendinvite_Enabled,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)20,(short)0,(short)1,(short)37,(short)0,(short)-1,(short)-1,(bool)true,(string)"",(string)"start",(bool)true,(string)""});
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E203E2","iparms":[{"av":"AV43IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"A21ManagerId","fld":"MANAGERID","hsh":true},{"av":"A11OrganisationId","fld":"ORGANISATIONID","hsh":true},{"av":"AV45IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"A394ManagerIsActive","fld":"MANAGERISACTIVE"},{"av":"A28ManagerGAMGUID","fld":"MANAGERGAMGUID","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"AV42Display","fld":"vDISPLAY"},{"av":"edtavDisplay_Link","ctrl":"vDISPLAY","prop":"Link"},{"av":"AV44Update","fld":"vUPDATE"},{"av":"edtavUpdate_Link","ctrl":"vUPDATE","prop":"Link"},{"av":"AV46Delete","fld":"vDELETE"},{"av":"edtavDelete_Link","ctrl":"vDELETE","prop":"Link"},{"av":"AV56ReSendInvite","fld":"vRESENDINVITE"},{"av":"edtavManagerisactive_Columnclass","ctrl":"vMANAGERISACTIVE","prop":"Columnclass"},{"av":"AV60ManagerIsActive","fld":"vMANAGERISACTIVE"},{"av":"edtavResendinvite_Tooltiptext","ctrl":"vRESENDINVITE","prop":"Tooltiptext"}]}""");
      ...
      public override void initialize( )
      {
         ...
         AV90Trn_managerwwds_8_tfmanagerphone = "";
         AV91Trn_managerwwds_9_tfmanagerphone_sel = "";
         AV92Trn_managerwwds_10_tfmanagergender_sels = new GxSimpleCollection<string>();
         lV84Trn_managerwwds_2_tfmanagergivenname = "";
         lV86Trn_managerwwds_4_tfmanagerlastname = "";
         lV88Trn_managerwwds_6_tfmanageremail = "";
         lV90Trn_managerwwds_8_tfmanagerphone = "";
      ...
      private int AV92Trn_managerwwds_10_tfmanagergender_sels_Count ;
      ...
      private string AV90Trn_managerwwds_8_tfmanagerphone ;
      private string AV91Trn_managerwwds_9_tfmanagerphone_sel ;
      private string lV90Trn_managerwwds_8_tfmanagerphone ;
      ...
      private string AV83Trn_managerwwds_1_filterfulltext ;
      private string AV84Trn_managerwwds_2_tfmanagergivenname ;
      private string AV85Trn_managerwwds_3_tfmanagergivenname_sel ;
      private string AV86Trn_managerwwds_4_tfmanagerlastname ;
      private string AV87Trn_managerwwds_5_tfmanagerlastname_sel ;
      private string AV88Trn_managerwwds_6_tfmanageremail ;
      private string AV89Trn_managerwwds_7_tfmanageremail_sel ;
      private string lV84Trn_managerwwds_2_tfmanagergivenname ;
      private string lV86Trn_managerwwds_4_tfmanagerlastname ;
      private string lV88Trn_managerwwds_6_tfmanageremail ;
      ...
      private GxSimpleCollection<string> AV92Trn_managerwwds_10_tfmanagergender_sels ;
   ...
   public class trn_managerww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H003E2( IGxContext context ,
                                             ...
                                             GxSimpleCollection<string> AV92Trn_managerwwds_10_tfmanagergender_sels ,
                                             string AV85Trn_managerwwds_3_tfmanagergivenname_sel ,
                                             string AV84Trn_managerwwds_2_tfmanagergivenname ,
                                             string AV87Trn_managerwwds_5_tfmanagerlastname_sel ,
                                             string AV86Trn_managerwwds_4_tfmanagerlastname ,
                                             string AV89Trn_managerwwds_7_tfmanageremail_sel ,
                                             string AV88Trn_managerwwds_6_tfmanageremail ,
                                             string AV91Trn_managerwwds_9_tfmanagerphone_sel ,
                                             string AV90Trn_managerwwds_8_tfmanagerphone ,
                                             int AV92Trn_managerwwds_10_tfmanagergender_sels_Count ,
                                             string A22ManagerGivenName ,
                                             ...
                                             short AV13OrderedBy ,
                                             bool AV14OrderedDsc ,
                                             string AV83Trn_managerwwds_1_filterfulltext ,
                                             ...
                                             Guid AV61OrganisationId )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV85Trn_managerwwds_3_tfmanagergivenname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV84Trn_managerwwds_2_tfmanagergivenname)) ) )
         {
            AddWhere(sWhereString, "(ManagerGivenName like :lV84Trn_managerwwds_2_tfmanagergivenname)");
         }
         else
         {
            GXv_int10[1] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV85Trn_managerwwds_3_tfmanagergivenname_sel)) && ! ( StringUtil.StrCmp(AV85Trn_managerwwds_3_tfmanagergivenname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(ManagerGivenName = ( :AV85Trn_managerwwds_3_tfmanagergivenname_sel))");
         }
         else
         {
            GXv_int10[2] = 1;
         }
         if ( StringUtil.StrCmp(AV85Trn_managerwwds_3_tfmanagergivenname_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerGivenName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV87Trn_managerwwds_5_tfmanagerlastname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV86Trn_managerwwds_4_tfmanagerlastname)) ) )
         {
            AddWhere(sWhereString, "(ManagerLastName like :lV86Trn_managerwwds_4_tfmanagerlastname)");
         }
         else
         {
            GXv_int10[3] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV87Trn_managerwwds_5_tfmanagerlastname_sel)) && ! ( StringUtil.StrCmp(AV87Trn_managerwwds_5_tfmanagerlastname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(ManagerLastName = ( :AV87Trn_managerwwds_5_tfmanagerlastname_sel))");
         }
         else
         {
            GXv_int10[4] = 1;
         }
         if ( StringUtil.StrCmp(AV87Trn_managerwwds_5_tfmanagerlastname_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerLastName))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV89Trn_managerwwds_7_tfmanageremail_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV88Trn_managerwwds_6_tfmanageremail)) ) )
         {
            AddWhere(sWhereString, "(ManagerEmail like :lV88Trn_managerwwds_6_tfmanageremail)");
         }
         else
         {
            GXv_int10[5] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV89Trn_managerwwds_7_tfmanageremail_sel)) && ! ( StringUtil.StrCmp(AV89Trn_managerwwds_7_tfmanageremail_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(ManagerEmail = ( :AV89Trn_managerwwds_7_tfmanageremail_sel))");
         }
         else
         {
            GXv_int10[6] = 1;
         }
         if ( StringUtil.StrCmp(AV89Trn_managerwwds_7_tfmanageremail_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerEmail))=0))");
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV91Trn_managerwwds_9_tfmanagerphone_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV90Trn_managerwwds_8_tfmanagerphone)) ) )
         {
            AddWhere(sWhereString, "(ManagerPhone like :lV90Trn_managerwwds_8_tfmanagerphone)");
         }
         else
         {
            GXv_int10[7] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV91Trn_managerwwds_9_tfmanagerphone_sel)) && ! ( StringUtil.StrCmp(AV91Trn_managerwwds_9_tfmanagerphone_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(ManagerPhone = ( :AV91Trn_managerwwds_9_tfmanagerphone_sel))");
         }
         else
         {
            GXv_int10[8] = 1;
         }
         if ( StringUtil.StrCmp(AV91Trn_managerwwds_9_tfmanagerphone_sel, "<#Empty#>") == 0 )
         {
            AddWhere(sWhereString, "((char_length(trim(trailing ' ' from ManagerPhone))=0))");
         }
         if ( AV92Trn_managerwwds_10_tfmanagergender_sels_Count > 0 )
         {
            AddWhere(sWhereString, "("+new GxDbmsUtils( new GxPostgreSql()).ValueList(AV92Trn_managerwwds_10_tfmanagergender_sels, "ManagerGender IN (", ")")+")");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV84Trn_managerwwds_2_tfmanagergivenname",GXType.VarChar,100,0) ,
          new ParDef("AV85Trn_managerwwds_3_tfmanagergivenname_sel",GXType.VarChar,100,0) ,
          new ParDef("lV86Trn_managerwwds_4_tfmanagerlastname",GXType.VarChar,100,0) ,
          new ParDef("AV87Trn_managerwwds_5_tfmanagerlastname_sel",GXType.VarChar,100,0) ,
          new ParDef("lV88Trn_managerwwds_6_tfmanageremail",GXType.VarChar,100,0) ,
          new ParDef("AV89Trn_managerwwds_7_tfmanageremail_sel",GXType.VarChar,100,0) ,
          new ParDef("lV90Trn_managerwwds_8_tfmanagerphone",GXType.Char,20,0) ,
          new ParDef("AV91Trn_managerwwds_9_tfmanagerphone_sel",GXType.Char,20,0)
          };
          Object[] prmH003E3;
