...
namespace GeneXus.Programs {
   public class trn_managerww : GXDataArea
   {
      ...
      protected void WB3E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_ManagerWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsubscriptions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "", bttBtnsubscriptions_Jsonclick, 0, "Subscriptions", "", StyleString, ClassString, bttBtnsubscriptions_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_ManagerWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void RF3E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV90Trn_managerwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV90Trn_managerwwds_1_filterfulltext), "%", "");
            lV90Trn_managerwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV90Trn_managerwwds_1_filterfulltext), "%", "");
            lV90Trn_managerwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV90Trn_managerwwds_1_filterfulltext), "%", "");
            lV90Trn_managerwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV90Trn_managerwwds_1_filterfulltext), "%", "");
            lV90Trn_managerwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV90Trn_managerwwds_1_filterfulltext), "%", "");
            ...
            /* Using cursor H003E2 */
            pr_default.execute(0, new Object[] {AV61OrganisationId, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV91Trn_managerwwds_2_tfmanagergivenname, AV92Trn_managerwwds_3_tfmanagergivenname_sel, lV93Trn_managerwwds_4_tfmanagerlastname, AV94Trn_managerwwds_5_tfmanagerlastname_sel, lV95Trn_managerwwds_6_tfmanageremail, AV96Trn_managerwwds_7_tfmanageremail_sel, lV97Trn_managerwwds_8_tfmanagerphone, AV98Trn_managerwwds_9_tfmanagerphone_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV97Trn_managerwwds_8_tfmanagerphone = StringUtil.PadR( StringUtil.RTrim( AV97Trn_managerwwds_8_tfmanagerphone), 20, "%");
         /* Using cursor H003E3 */
         pr_default.execute(1, new Object[] {AV61OrganisationId, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV90Trn_managerwwds_1_filterfulltext, lV91Trn_managerwwds_2_tfmanagergivenname, AV92Trn_managerwwds_3_tfmanagergivenname_sel, lV93Trn_managerwwds_4_tfmanagerlastname, AV94Trn_managerwwds_5_tfmanagerlastname_sel, lV95Trn_managerwwds_6_tfmanageremail, AV96Trn_managerwwds_7_tfmanageremail_sel, lV97Trn_managerwwds_8_tfmanagerphone, AV98Trn_managerwwds_9_tfmanagerphone_sel});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198373722", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_managerww.js", "?202411198373726", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      private string lV90Trn_managerwwds_1_filterfulltext ;
   ...
   public class trn_managerww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             Guid AV61OrganisationId )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " ManagerIsActive, ManagerIsMainManager, ManagerGAMGUID, ManagerGender, ManagerPhoneNumber, ManagerPhoneCode, ManagerPhone, ManagerEmail, ManagerInitials, ManagerLastName, ManagerGivenName, OrganisationId, ManagerId";
         sFromString = " FROM Trn_Manager";
         sOrderString = "";
         AddWhere(sWhereString, "(OrganisationId = :AV61OrganisationId)");
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV90Trn_managerwwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( ManagerGivenName like '%' || :lV90Trn_managerwwds_1_filterfulltext) or ( ManagerLastName like '%' || :lV90Trn_managerwwds_1_filterfulltext) or ( ManagerEmail like '%' || :lV90Trn_managerwwds_1_filterfulltext) or ( ManagerPhone like '%' || :lV90Trn_managerwwds_1_filterfulltext) or ( 'male' like '%' || LOWER(:lV90Trn_managerwwds_1_filterfulltext) and ManagerGender = ( 'Male')) or ( 'female' like '%' || LOWER(:lV90Trn_managerwwds_1_filterfulltext) and ManagerGender = ( 'Female')) or ( 'other' like '%' || LOWER(:lV90Trn_managerwwds_1_filterfulltext) and ManagerGender = ( 'Other')))");
         }
         else
         {
            GXv_int10[1] = 1;
         ...
         {
            sOrderString += " ORDER BY ManagerGivenName, ManagerId, OrganisationId";
         }
         else if ( ( AV13OrderedBy == 1 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY ManagerGivenName DESC, ManagerId, OrganisationId";
         }
         else if ( ( AV13OrderedBy == 2 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY ManagerLastName, ManagerId, OrganisationId";
         }
         else if ( ( AV13OrderedBy == 2 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY ManagerLastName DESC, ManagerId, OrganisationId";
         }
         else if ( ( AV13OrderedBy == 3 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY ManagerEmail, ManagerId, OrganisationId";
         }
         else if ( ( AV13OrderedBy == 3 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY ManagerEmail DESC, ManagerId, OrganisationId";
         }
         else if ( ( AV13OrderedBy == 4 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY ManagerPhone, ManagerId, OrganisationId";
         }
         else if ( ( AV13OrderedBy == 4 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY ManagerPhone DESC, ManagerId, OrganisationId";
         }
         else if ( ( AV13OrderedBy == 5 ) && ! AV14OrderedDsc )
         {
            sOrderString += " ORDER BY ManagerGender, ManagerId, OrganisationId";
         }
         else if ( ( AV13OrderedBy == 5 ) && ( AV14OrderedDsc ) )
         {
            sOrderString += " ORDER BY ManagerGender DESC, ManagerId, OrganisationId";
         }
         else if ( true )
         {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV90Trn_managerwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV90Trn_managerwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV90Trn_managerwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV90Trn_managerwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV90Trn_managerwwds_1_filterfulltext",GXType.VarChar,100,0) ,
