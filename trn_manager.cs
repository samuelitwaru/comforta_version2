   ...
   public class trn_manager : GXDataArea
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxJX_Action25") == 0 )
         {
            ...
            XC_25_035( A25ManagerEmail, A22ManagerGivenName, A23ManagerLastName) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxJX_Action26") == 0 )
         {
            ...
            XC_26_035( A22ManagerGivenName, A23ManagerLastName) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxJX_Action28") == 0 )
         {
            ...
            XC_28_035( Gx_mode, A28ManagerGAMGUID, A22ManagerGivenName, A23ManagerLastName) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxJX_Action30") == 0 )
         {
            ...
            XC_30_035( Gx_mode, A28ManagerGAMGUID) ;
            return  ;
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102518394264", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_manager.js", "?2024102518394266", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
      ...
      protected void XC_21_035( GeneXus.Programs.wwpbaseobjects.SdtAuditingObject AV29AuditingObject ,
                                Guid A21ManagerId ,
      ...
      protected void XC_23_035( string Gx_mode ,
      ...
      protected void XC_25_035( string A25ManagerEmail ,
      ...
      protected void XC_26_035( string A22ManagerGivenName ,
                                string A23ManagerLastName )
      {
         new prc_getnameinitials(context ).execute(  A22ManagerGivenName,  A23ManagerLastName, out  A24ManagerInitials) ;
         AssignAttri("", false, "A24ManagerInitials", A24ManagerInitials);
      ...
      protected void XC_28_035( string Gx_mode ,
