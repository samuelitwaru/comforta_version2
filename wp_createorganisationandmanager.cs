...
namespace GeneXus.Programs {
   public class wp_createorganisationandmanager : GXDataArea
   {
      ...
      protected void E114E2( )
      {
         ...
         AV14WizardStep.gxTpr_Title = context.GetMessage( "Organisation", "");
         AV14WizardStep.gxTpr_Description = context.GetMessage( "Organisation", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102518432197", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createorganisationandmanager.js", "?2024102518432197", false, true);
