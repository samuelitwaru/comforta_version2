...
namespace GeneXus.Programs {
   public class wp_createorganisationandmanager : GXDataArea
   {
      public wp_createorganisationandmanager( )
      {
      ...
      public wp_createorganisationandmanager( IGxContext context )
      {
      ...
      {
         get {
            return "wp_createorganisationandmanager_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "wp_createorganisationandmanager.aspx"+UrlEncode(StringUtil.RTrim(AV10PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV11CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV9GoingBack));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wp_createorganisationandmanager.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "wp_createorganisationandmanager.aspx"+UrlEncode(StringUtil.RTrim(AV10PreviousStep)) + "," + UrlEncode(StringUtil.RTrim(AV11CurrentStep)) + "," + UrlEncode(StringUtil.BoolToStr(AV9GoingBack));
         return formatLink("wp_createorganisationandmanager.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "WP_CreateOrganisationAndManager" ;
      }
      ...
      protected void WB4E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_6_4E2( true) ;
         }
         else
         {
            wb_table1_6_4E2( false) ;
         }
         return  ;
      }

      protected void wb_table1_6_4E2e( bool wbgen )
      {
         if ( wbgen )
         {
      ...
      protected void PA4E2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "wp_createorganisationandmanager.aspx")), "wp_createorganisationandmanager.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "wp_createorganisationandmanager.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
      ...
      {
         /* GeneXus formulas. */
         AV16Pgmname = "WP_CreateOrganisationAndManager";
      }
      ...
      protected void E114E2( )
      {
         ...
         AV14WizardStep.gxTpr_Title = "Organisation Information";
         AV14WizardStep.gxTpr_Description = "Organisation Information";
         AV13WizardSteps.Add(AV14WizardStep, 0);
         AV14WizardStep = new GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem(context);
         AV14WizardStep.gxTpr_Code = "Step2";
         AV14WizardStep.gxTpr_Title = "Manager information";
         AV14WizardStep.gxTpr_Description = "Manager information";
         AV13WizardSteps.Add(AV14WizardStep, 0);
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step1") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WP_CreateOrganisationAndManagerStep1")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wp_createorganisationandmanagerstep1", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WP_CreateOrganisationAndManagerStep1";
               WebComp_Wizardstepwc_Component = "WP_CreateOrganisationAndManagerStep1";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
               WebComp_Wizardstepwc.componentprepare(new Object[] {(string)"W0012",(string)"",(string)AV16Pgmname+"_Data",(string)AV10PreviousStep,(bool)AV9GoingBack});
         ...
         else if ( StringUtil.StrCmp(AV12CurrentStepAux, "Step2") == 0 )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Wizardstepwc_Component), StringUtil.Lower( "WP_CreateOrganisationAndManagerStep2")) != 0 )
            {
               WebComp_Wizardstepwc = getWebComponent(GetType(), "GeneXus.Programs", "wp_createorganisationandmanagerstep2", new Object[] {context} );
               WebComp_Wizardstepwc.ComponentInit();
               WebComp_Wizardstepwc.Name = "WP_CreateOrganisationAndManagerStep2";
               WebComp_Wizardstepwc_Component = "WP_CreateOrganisationAndManagerStep2";
            }
            if ( StringUtil.Len( WebComp_Wizardstepwc_Component) != 0 )
            {
               WebComp_Wizardstepwc.setjustcreated();
      ...
      protected void wb_table1_6_4E2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0012"+"", StringUtil.RTrim( WebComp_Wizardstepwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            wb_table1_6_4E2e( true) ;
         }
         else
         {
            wb_table1_6_4E2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719492438", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wp_createorganisationandmanager.js", "?202492719492438", false, true);
