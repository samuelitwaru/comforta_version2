...
namespace GeneXus.Programs {
   public class trn_suppliergentypewwgetfilterdata : GXProcedure
   {
      ...
      {
         get {
            return "trn_suppliergentypeww_Services_Execute" ;
         }

      }

      public trn_suppliergentypewwgetfilterdata( )
      {
      ...
      public trn_suppliergentypewwgetfilterdata( IGxContext context )
      {
      ...
      protected override void ExecutePrivate( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Upper( AV29DDOName), "DDO_SUPPLIERGENTYPENAME") == 0 )
         {
      ...
      protected void S111( )
      {
         ...
         returnInSub = false;
         if ( StringUtil.StrCmp(AV24Session.Get("Trn_SupplierGenTypeWWGridState"), "") == 0 )
         {
            AV26GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  "Trn_SupplierGenTypeWWGridState"), null, "", "");
         }
         else
         {
            AV26GridState.FromXml(AV24Session.Get("Trn_SupplierGenTypeWWGridState"), null, "", "");
         }
         AV36GXV1 = 1;
         while ( AV36GXV1 <= AV26GridState.gxTpr_Filtervalues.Count )
         {
            ...
            else if ( StringUtil.StrCmp(AV27GridStateFilterValue.gxTpr_Name, "TFSUPPLIERGENTYPENAME") == 0 )
            {
               AV11TFSupplierGenTypeName = AV27GridStateFilterValue.gxTpr_Value;
            }
            else if ( StringUtil.StrCmp(AV27GridStateFilterValue.gxTpr_Name, "TFSUPPLIERGENTYPENAME_SEL") == 0 )
            {
               AV12TFSupplierGenTypeName_Sel = AV27GridStateFilterValue.gxTpr_Value;
            }
      ...
      protected void S121( )
      {
         ...
         returnInSub = false;
         AV11TFSupplierGenTypeName = AV13SearchTxt;
         AV12TFSupplierGenTypeName_Sel = "";
         AV38Trn_suppliergentypewwds_1_filterfulltext = AV35FilterFullText;
         AV39Trn_suppliergentypewwds_2_tfsuppliergentypename = AV11TFSupplierGenTypeName;
         AV40Trn_suppliergentypewwds_3_tfsuppliergentypename_sel = AV12TFSupplierGenTypeName_Sel;
         ...
         /* Using cursor P006O2 */
         pr_default.execute(0, new Object[] {lV38Trn_suppliergentypewwds_1_filterfulltext, lV39Trn_suppliergentypewwds_2_tfsuppliergentypename, AV40Trn_suppliergentypewwds_3_tfsuppliergentypename_sel});
         while ( (pr_default.getStatus(0) != 101) )
         {
            BRK6O2 = false;
            A290SupplierGenTypeName = P006O2_A290SupplierGenTypeName[0];
            A282SupplierGenTypeId = P006O2_A282SupplierGenTypeId[0];
            AV23count = 0;
            while ( (pr_default.getStatus(0) != 101) && ( StringUtil.StrCmp(P006O2_A290SupplierGenTypeName[0], A290SupplierGenTypeName) == 0 ) )
            {
               BRK6O2 = false;
               A282SupplierGenTypeId = P006O2_A282SupplierGenTypeId[0];
            ...
            if ( (0==AV14SkipItems) )
            {
               AV18Option = (String.IsNullOrEmpty(StringUtil.RTrim( A290SupplierGenTypeName)) ? "<#Empty#>" : A290SupplierGenTypeName);
      ...
      public override void initialize( )
      {
         ...
         A290SupplierGenTypeName = "";
         P006O2_A290SupplierGenTypeName = new string[] {""} ;
         P006O2_A282SupplierGenTypeId = new Guid[] {Guid.Empty} ;
         A282SupplierGenTypeId = Guid.Empty;
         AV18Option = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_suppliergentypewwgetfilterdata__default(),
            new Object[][] {
                new Object[] {
               P006O2_A290SupplierGenTypeName, P006O2_A282SupplierGenTypeId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private string AV11TFSupplierGenTypeName ;
      private string AV12TFSupplierGenTypeName_Sel ;
      ...
      private string[] P006O2_A290SupplierGenTypeName ;
      private Guid[] P006O2_A282SupplierGenTypeId ;
      private string aP3_OptionsJson ;
      private string aP4_OptionsDescJson ;
      private string aP5_OptionIndexesJson ;
   }

   public class trn_suppliergentypewwgetfilterdata__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A290SupplierGenTypeName )
      {
         ...
         scmdbuf += " ORDER BY SupplierGenTypeName";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_P006O2(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] );
         }
