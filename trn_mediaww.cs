...
namespace GeneXus.Programs {
   public class trn_mediaww : GXDataArea
   {
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vTFMEDIASIZE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV22TFMediaSize), 8, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vTFMEDIASIZE_TO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV23TFMediaSize_To), 8, 0, ".", "")));
      ...
      protected void WB7N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_MediaWW.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_MediaWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsubscriptions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "", bttBtnsubscriptions_Jsonclick, 0, "Subscriptions", "", StyleString, ClassString, bttBtnsubscriptions_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_MediaWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void S162( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV11GridState,  "TFMEDIASIZE",  "Size",  !((0==AV22TFMediaSize)&&(0==AV23TFMediaSize_To)),  0,  StringUtil.Trim( StringUtil.Str( (decimal)(AV22TFMediaSize), 8, 0)),  ((0==AV22TFMediaSize) ? "" : StringUtil.Trim( context.localUtil.Format( (decimal)(AV22TFMediaSize), "ZZZZZZZ9"))),  true,  StringUtil.Trim( StringUtil.Str( (decimal)(AV23TFMediaSize_To), 8, 0)),  ((0==AV23TFMediaSize_To) ? "" : StringUtil.Trim( context.localUtil.Format( (decimal)(AV23TFMediaSize_To), "ZZZZZZZ9")))) ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV11GridState,  "TFMEDIATYPE",  "Type",  !String.IsNullOrEmpty(StringUtil.RTrim( AV24TFMediaType)),  0,  AV24TFMediaType,  AV24TFMediaType,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV25TFMediaType_Sel)),  AV25TFMediaType_Sel,  AV25TFMediaType_Sel) ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV11GridState,  "TFMEDIAURL",  "Url",  !String.IsNullOrEmpty(StringUtil.RTrim( AV26TFMediaUrl)),  0,  AV26TFMediaUrl,  AV26TFMediaUrl,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV27TFMediaUrl_Sel)),  AV27TFMediaUrl_Sel,  AV27TFMediaUrl_Sel) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198391054", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_mediaww.js", "?202411198391057", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void sendrow_392( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_39_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtMediaSize_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A413MediaSize), 8, 0, ".", "")),StringUtil.LTrim( context.localUtil.Format( (decimal)(A413MediaSize), "ZZZZZZZ9")),(string)" dir=\"ltr\" inputmode=\"numeric\" pattern=\"[0-9]*\""+"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtMediaSize_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn",(string)"",(int)edtMediaSize_Visible,(short)0,(short)0,(string)"text",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)8,(short)0,(short)0,(short)39,(short)0,(short)-1,(short)0,(bool)true,(string)"",(string)"end",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
