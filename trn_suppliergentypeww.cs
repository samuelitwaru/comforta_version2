...
namespace GeneXus.Programs {
   public class trn_suppliergentypeww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedDsc, AV14FilterFullText, AV18ManageFiltersExecutionStep, AV37Pgmname, AV19TFSupplierGenTypeName, AV20TFSupplierGenTypeName_Sel, AV30IsAuthorized_Display, AV32IsAuthorized_Update, AV34IsAuthorized_Delete, AV28IsAuthorized_SupplierGenTypeName, AV35IsAuthorized_Insert) ;
      ...
      {
         /* GeneXus formulas. */
         AV37Pgmname = "Trn_SupplierGenTypeWW";
      }
      ...
      protected void RF4T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV38Trn_suppliergentypewwds_1_filterfulltext ,
                                                 AV40Trn_suppliergentypewwds_3_tfsuppliergentypename_sel ,
                                                 AV39Trn_suppliergentypewwds_2_tfsuppliergentypename ,
            ...
            lV38Trn_suppliergentypewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV38Trn_suppliergentypewwds_1_filterfulltext), "%", "");
            lV39Trn_suppliergentypewwds_2_tfsuppliergentypename = StringUtil.Concat( StringUtil.RTrim( AV39Trn_suppliergentypewwds_2_tfsuppliergentypename), "%", "");
            /* Using cursor H004T2 */
            pr_default.execute(0, new Object[] {lV38Trn_suppliergentypewwds_1_filterfulltext, lV39Trn_suppliergentypewwds_2_tfsuppliergentypename, AV40Trn_suppliergentypewwds_3_tfsuppliergentypename_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
      ...
      {
         AV38Trn_suppliergentypewwds_1_filterfulltext = AV14FilterFullText;
         AV39Trn_suppliergentypewwds_2_tfsuppliergentypename = AV19TFSupplierGenTypeName;
         AV40Trn_suppliergentypewwds_3_tfsuppliergentypename_sel = AV20TFSupplierGenTypeName_Sel;
         ...
         lV39Trn_suppliergentypewwds_2_tfsuppliergentypename = StringUtil.Concat( StringUtil.RTrim( AV39Trn_suppliergentypewwds_2_tfsuppliergentypename), "%", "");
         /* Using cursor H004T3 */
         pr_default.execute(1, new Object[] {lV38Trn_suppliergentypewwds_1_filterfulltext, lV39Trn_suppliergentypewwds_2_tfsuppliergentypename, AV40Trn_suppliergentypewwds_3_tfsuppliergentypename_sel});
      ...
      protected void E114T2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_SupplierGenTypeWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV37Pgmname+"GridState"));
      ...
      protected void E144T2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0051",(string)"",(string)"Trn_SupplierGenType",(short)1,(string)"",(string)""});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102518435679", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_suppliergentypeww.js", "?2024102518435680", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV36ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"edtSupplierGenTypeName_Link","ctrl":"SUPPLIERGENTYPENAME","prop":"Link"}]}""");
         ...
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E204T2","iparms":[{"av":"cmbavActiongroup"},{"av":"AV36ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV37Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV20TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A282SupplierGenTypeId","fld":"SUPPLIERGENTYPEID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         A290SupplierGenTypeName = "";
         lV38Trn_suppliergentypewwds_1_filterfulltext = "";
         lV39Trn_suppliergentypewwds_2_tfsuppliergentypename = "";
         AV38Trn_suppliergentypewwds_1_filterfulltext = "";
         AV40Trn_suppliergentypewwds_3_tfsuppliergentypename_sel = "";
         AV39Trn_suppliergentypewwds_2_tfsuppliergentypename = "";
      ...
      private string lV38Trn_suppliergentypewwds_1_filterfulltext ;
      private string lV39Trn_suppliergentypewwds_2_tfsuppliergentypename ;
      private string AV38Trn_suppliergentypewwds_1_filterfulltext ;
      private string AV40Trn_suppliergentypewwds_3_tfsuppliergentypename_sel ;
      private string AV39Trn_suppliergentypewwds_2_tfsuppliergentypename ;
   ...
   public class trn_suppliergentypeww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H004T2( IGxContext context ,
                                             string AV38Trn_suppliergentypewwds_1_filterfulltext ,
                                             string AV40Trn_suppliergentypewwds_3_tfsuppliergentypename_sel ,
                                             string AV39Trn_suppliergentypewwds_2_tfsuppliergentypename ,
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV38Trn_suppliergentypewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV39Trn_suppliergentypewwds_2_tfsuppliergentypename",GXType.VarChar,100,0) ,
          new ParDef("AV40Trn_suppliergentypewwds_3_tfsuppliergentypename_sel",GXType.VarChar,100,0) ,
