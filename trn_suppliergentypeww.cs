...
namespace GeneXus.Programs {
   public class trn_suppliergentypeww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV28IsAuthorized_SupplierGenTypeName = StringUtil.StrToBool( GetPar( "IsAuthorized_SupplierGenTypeName"));
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedDsc, AV14FilterFullText, AV18ManageFiltersExecutionStep, AV36Pgmname, AV19TFSupplierGenTypeName, AV20TFSupplierGenTypeName_Sel, AV30IsAuthorized_Display, AV32IsAuthorized_Update, AV34IsAuthorized_Delete, AV28IsAuthorized_SupplierGenTypeName, AV35IsAuthorized_Insert) ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_SUPPLIERGENTYPENAME", AV28IsAuthorized_SupplierGenTypeName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_SUPPLIERGENTYPENAME", GetSecureSignedToken( "", AV28IsAuthorized_SupplierGenTypeName, context));
      ...
      protected void WB4T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_SupplierGenTypeWW.htm");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsubscriptions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(37), 2, 0)+","+"null"+");", "", bttBtnsubscriptions_Jsonclick, 0, "Subscriptions", "", StyleString, ClassString, bttBtnsubscriptions_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_SupplierGenTypeWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       bool AV28IsAuthorized_SupplierGenTypeName ,
      ...
      {
         /* GeneXus formulas. */
         AV36Pgmname = "Trn_SupplierGenTypeWW";
      ...
      protected void RF4T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV37Trn_suppliergentypewwds_1_filterfulltext ,
                                                 AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel ,
                                                 AV38Trn_suppliergentypewwds_2_tfsuppliergentypename ,
            ...
            lV37Trn_suppliergentypewwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV37Trn_suppliergentypewwds_1_filterfulltext), "%", "");
            lV38Trn_suppliergentypewwds_2_tfsuppliergentypename = StringUtil.Concat( StringUtil.RTrim( AV38Trn_suppliergentypewwds_2_tfsuppliergentypename), "%", "");
            /* Using cursor H004T2 */
            pr_default.execute(0, new Object[] {lV37Trn_suppliergentypewwds_1_filterfulltext, lV38Trn_suppliergentypewwds_2_tfsuppliergentypename, AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
      ...
      protected void send_integrity_lvl_hashes4T2( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV35IsAuthorized_Insert, context));
         GxWebStd.gx_hidden_field( context, "gxhash_SUPPLIERGENTYPEID"+"_"+sGXsfl_37_idx, GetSecureSignedToken( sGXsfl_37_idx, A282SupplierGenTypeId, context));
      }
      ...
      {
         AV37Trn_suppliergentypewwds_1_filterfulltext = AV14FilterFullText;
         AV38Trn_suppliergentypewwds_2_tfsuppliergentypename = AV19TFSupplierGenTypeName;
         AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel = AV20TFSupplierGenTypeName_Sel;
         ...
         lV38Trn_suppliergentypewwds_2_tfsuppliergentypename = StringUtil.Concat( StringUtil.RTrim( AV38Trn_suppliergentypewwds_2_tfsuppliergentypename), "%", "");
         /* Using cursor H004T3 */
         pr_default.execute(1, new Object[] {lV37Trn_suppliergentypewwds_1_filterfulltext, lV38Trn_suppliergentypewwds_2_tfsuppliergentypename, AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel});
      ...
      protected void E174T2( )
      {
         ...
         GXt_boolean1 = AV28IsAuthorized_SupplierGenTypeName;
         ...
         AV28IsAuthorized_SupplierGenTypeName = GXt_boolean1;
         AssignAttri("", false, "AV28IsAuthorized_SupplierGenTypeName", AV28IsAuthorized_SupplierGenTypeName);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_SUPPLIERGENTYPENAME", GetSecureSignedToken( "", AV28IsAuthorized_SupplierGenTypeName, context));
      ...
      private void E194T2( )
      {
         ...
         if ( AV30IsAuthorized_Display )
         {
            ...
            edtavDisplay_Link = formatLink("trn_suppliergentypeview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         }
         ...
         if ( AV32IsAuthorized_Update )
         {
            ...
            edtavUpdate_Link = formatLink("trn_suppliergentype.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         }
         ...
         if ( AV34IsAuthorized_Delete )
         {
            ...
            edtavDelete_Link = formatLink("trn_suppliergentype.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey);
         }
         if ( AV28IsAuthorized_SupplierGenTypeName )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetCookie( "GX_SESSION_ID"))) )
            {
               gxcookieaux = context.SetCookie( "GX_SESSION_ID", Encrypt64( Crypto.GetEncryptionKey( ), Crypto.GetServerKey( )), "", (DateTime)(DateTime.MinValue), "", (short)(context.GetHttpSecure( )));
      ...
      protected void E114T2( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_SupplierGenTypeWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV36Pgmname+"GridState"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_SupplierGenTypeWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char3) ;
      ...
      protected void E144T2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0053",(string)"",(string)"Trn_SupplierGenType",(short)1,(string)"",(string)""});
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_suppliergentype_Update", out  GXt_boolean1) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_suppliergentype_Delete", out  GXt_boolean1) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_suppliergentype_Insert", out  GXt_boolean1) ;
      ...
      protected void S182( )
      {
         ...
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV20TFSupplierGenTypeName_Sel)),  AV20TFSupplierGenTypeName_Sel, out  GXt_char3) ;
         Ddo_grid_Selectedvalue_set = GXt_char3;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char3 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV19TFSupplierGenTypeName)),  AV19TFSupplierGenTypeName, out  GXt_char3) ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202492719495970", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_suppliergentypeww.js", "?202492719495973", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV20TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true}]""");
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","""{"handler":"E124T2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV20TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Selectedpage","ctrl":"GRIDPAGINATIONBAR","prop":"SelectedPage"}]}""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","""{"handler":"E134T2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV20TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Gridpaginationbar_Rowsperpageselectedvalue","ctrl":"GRIDPAGINATIONBAR","prop":"RowsPerPageSelectedValue"}]""");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",""","oparms":[{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"}]}""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E154T2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV20TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E194T2","iparms":[{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"A282SupplierGenTypeId","fld":"SUPPLIERGENTYPEID","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true}]""");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED","""{"handler":"E114T2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV20TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_managefilters_Activeeventkey","ctrl":"DDO_MANAGEFILTERS","prop":"ActiveEventKey"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]""");
         ...
         setEventMetadata("'DOINSERT'","""{"handler":"E164T2","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV36Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFSupplierGenTypeName","fld":"vTFSUPPLIERGENTYPENAME"},{"av":"AV20TFSupplierGenTypeName_Sel","fld":"vTFSUPPLIERGENTYPENAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV28IsAuthorized_SupplierGenTypeName","fld":"vISAUTHORIZED_SUPPLIERGENTYPENAME","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A282SupplierGenTypeId","fld":"SUPPLIERGENTYPEID","hsh":true}]""");
      ...
      public override void initialize( )
      {
         ...
         AV31Update = "";
         AV33Delete = "";
         lV37Trn_suppliergentypewwds_1_filterfulltext = "";
         lV38Trn_suppliergentypewwds_2_tfsuppliergentypename = "";
         AV37Trn_suppliergentypewwds_1_filterfulltext = "";
         AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel = "";
         AV38Trn_suppliergentypewwds_2_tfsuppliergentypename = "";
      ...
      private bool AV28IsAuthorized_SupplierGenTypeName ;
      ...
      private string lV37Trn_suppliergentypewwds_1_filterfulltext ;
      private string lV38Trn_suppliergentypewwds_2_tfsuppliergentypename ;
      private string AV37Trn_suppliergentypewwds_1_filterfulltext ;
      private string AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel ;
      private string AV38Trn_suppliergentypewwds_2_tfsuppliergentypename ;
   ...
   public class trn_suppliergentypeww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H004T2( IGxContext context ,
                                             string AV37Trn_suppliergentypewwds_1_filterfulltext ,
                                             string AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel ,
                                             string AV38Trn_suppliergentypewwds_2_tfsuppliergentypename ,
                                             ...
                                             bool AV13OrderedDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV37Trn_suppliergentypewwds_1_filterfulltext)) )
         {
            AddWhere(sWhereString, "(( SupplierGenTypeName like '%' || :lV37Trn_suppliergentypewwds_1_filterfulltext))");
         }
         else
         {
            GXv_int5[0] = 1;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV38Trn_suppliergentypewwds_2_tfsuppliergentypename)) ) )
         {
            AddWhere(sWhereString, "(SupplierGenTypeName like :lV38Trn_suppliergentypewwds_2_tfsuppliergentypename)");
         }
         else
         {
            GXv_int5[1] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel)) && ! ( StringUtil.StrCmp(AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(SupplierGenTypeName = ( :AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel))");
         }
         else
         {
            GXv_int5[2] = 1;
         }
         if ( StringUtil.StrCmp(AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel, "<#Empty#>") == 0 )
         {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV37Trn_suppliergentypewwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV38Trn_suppliergentypewwds_2_tfsuppliergentypename",GXType.VarChar,100,0) ,
          new ParDef("AV39Trn_suppliergentypewwds_3_tfsuppliergentypename_sel",GXType.VarChar,100,0) ,
