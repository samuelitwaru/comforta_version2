   ...
   public class GxWebStd
   {
                                        ...
                                        string sCallerPgm )
      {
         ...
         if ( nEnabled == 1 )
         {
            ...
            if ( ! ( StringUtil.StrCmp(sContenttype, "text/html") == 0 ) && context.CheckContentType( "text", sContenttype, sURL) )
            {
               context.WriteHtmlText( " accept=\"") ;
               context.WriteHtmlText( sContenttype) ;
               context.WriteHtmlText( "\" ") ;
                                    ...
                                    string sCallerPgm )
      {
         ...
         else
         {
            ...
            context.WriteHtmlText( "\"") ;
            if ( StringUtil.StrCmp(StringUtil.Substring( sImageURL, 1, 11), "gx-image://") == 0 )
            {
               context.WriteHtmlText( " data-gx-image-uri=\"") ;
               context.WriteHtmlText( sImageURL) ;
               context.WriteHtmlText( "\"") ;
            }
            else
            {
                                             ...
                                             string sImgSrcSet )
      {
         ...
         context.WriteHtmlText( " data-gx-readonly ") ;
         context.WriteHtmlText( " alt=\"") ;
         context.SendWebValue( (String.IsNullOrEmpty(StringUtil.RTrim( sAlternateText)) ? sTooltipText : sAlternateText)) ;
         context.WriteHtmlText( "\"") ;
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( sTooltipText)) )
                                             ...
                                             string sClassString )
      {
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( sUserOnClickCode)) )
         {
            if ( ! (0==nJScriptCode) )
            {
               context.WriteHtmlText( "<a href=\"javascript:void(0)\" data-gx-evt=\"") ;
               context.WriteHtmlText( StringUtil.Trim( StringUtil.Str( (decimal)(nJScriptCode), 10, 0))) ;
               context.WriteHtmlText( "\"") ;
            }
            else
                                         ...
                                         int nParentIsFreeStyle )
      {
         ...
         {
            if ( ( StringUtil.StrCmp(sAlign, "left") == 0 ) || ( StringUtil.StrCmp(sAlign, "start") == 0 ) )
            {
            ...
            else
            {
               ...
               {
                  if ( ( StringUtil.StrCmp(sAlign, "right") == 0 ) || ( StringUtil.StrCmp(sAlign, "end") == 0 ) )
                  {
