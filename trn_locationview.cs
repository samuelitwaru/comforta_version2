...
namespace GeneXus.Programs {
   public class trn_locationview : GXDataArea
   {
      public trn_locationview( )
      {
      ...
      public trn_locationview( IGxContext context )
      {
      ...
      {
         get {
            return "trn_locationview_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         GXEncryptionTmp = "trn_locationview.aspx"+UrlEncode(AV10LocationId.ToString()) + "," + UrlEncode(AV11OrganisationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_locationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vLOCATIONID", AV10LocationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vLOCATIONID", GetSecureSignedToken( "", AV10LocationId, context));
         GxWebStd.gx_hidden_field( context, "vORGANISATIONID", AV11OrganisationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vORGANISATIONID", GetSecureSignedToken( "", AV11OrganisationId, context));
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Trn_amenitywc == null ) )
         {
            WebComp_Trn_amenitywc.componentjscripts();
         }
         if ( ! ( WebComp_Trn_receptionistwc == null ) )
         {
            WebComp_Trn_receptionistwc.componentjscripts();
         }
      ...
      public override string GetSelfLink( )
      {
         GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
         GXEncryptionTmp = "trn_locationview.aspx"+UrlEncode(AV10LocationId.ToString()) + "," + UrlEncode(AV11OrganisationId.ToString()) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode));
         return formatLink("trn_locationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey) ;
      }

      public override string GetPgmname( )
      {
         return "Trn_LocationView" ;
      }

      public override string GetPgmdesc( )
      {
         return context.GetMessage( "Trn_Location View", "") ;
      }
      ...
      protected void WB4U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, context.GetMessage( "Back", ""), lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, 0, "HLP_Trn_LocationView.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTrn_locationgeneral_cell_Internalname, 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            /* User Defined Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrn_amenity_title_Internalname, context.GetMessage( "Amenities", ""), "", "", lblTrn_amenity_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_LocationView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Trn_Amenity") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel1"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtabletrn_amenity_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0037"+"", StringUtil.RTrim( WebComp_Trn_amenitywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0037"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Trn_amenitywc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldTrn_amenitywc), StringUtil.Lower( WebComp_Trn_amenitywc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
                  }
                  WebComp_Trn_amenitywc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldTrn_amenitywc), StringUtil.Lower( WebComp_Trn_amenitywc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTrn_receptionist_title_Internalname, context.GetMessage( "Receptionists", ""), "", "", lblTrn_receptionist_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_Trn_LocationView.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "start", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Trn_Receptionist") ;
            GxWebStd.gx_div_end( context, "start", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtabletrn_receptionist_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "start", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "start", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0045"+"", StringUtil.RTrim( WebComp_Trn_receptionistwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0045"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Trn_receptionistwc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldTrn_receptionistwc), StringUtil.Lower( WebComp_Trn_receptionistwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0045"+"");
                  }
                  WebComp_Trn_receptionistwc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldTrn_receptionistwc), StringUtil.Lower( WebComp_Trn_receptionistwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START4U2( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( "Trn_Location View", ""), 0) ;
         context.wjLoc = "";
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldTrn_amenitywc = cgiGet( "W0037");
                           if ( ( StringUtil.Len( OldTrn_amenitywc) == 0 ) || ( StringUtil.StrCmp(OldTrn_amenitywc, WebComp_Trn_amenitywc_Component) != 0 ) )
                           {
                              WebComp_Trn_amenitywc = getWebComponent(GetType(), "GeneXus.Programs", OldTrn_amenitywc, new Object[] {context} );
                              WebComp_Trn_amenitywc.ComponentInit();
                              WebComp_Trn_amenitywc.Name = "OldTrn_amenitywc";
                              WebComp_Trn_amenitywc_Component = OldTrn_amenitywc;
                           }
                           if ( StringUtil.Len( WebComp_Trn_amenitywc_Component) != 0 )
                           {
                              WebComp_Trn_amenitywc.componentprocess("W0037", "", sEvt);
                           }
                           WebComp_Trn_amenitywc_Component = OldTrn_amenitywc;
                        }
                        else if ( nCmpId == 45 )
                        {
                           OldTrn_receptionistwc = cgiGet( "W0045");
                           if ( ( StringUtil.Len( OldTrn_receptionistwc) == 0 ) || ( StringUtil.StrCmp(OldTrn_receptionistwc, WebComp_Trn_receptionistwc_Component) != 0 ) )
                           {
                              WebComp_Trn_receptionistwc = getWebComponent(GetType(), "GeneXus.Programs", OldTrn_receptionistwc, new Object[] {context} );
                              WebComp_Trn_receptionistwc.ComponentInit();
                              WebComp_Trn_receptionistwc.Name = "OldTrn_receptionistwc";
                              WebComp_Trn_receptionistwc_Component = OldTrn_receptionistwc;
                           }
                           if ( StringUtil.Len( WebComp_Trn_receptionistwc_Component) != 0 )
                           {
                              WebComp_Trn_receptionistwc.componentprocess("W0045", "", sEvt);
                           }
                           WebComp_Trn_receptionistwc_Component = OldTrn_receptionistwc;
                        }
                        else if ( nCmpId == 50 )
      ...
      protected void PA4U2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ( StringUtil.StrCmp(context.GetRequestQueryString( ), "") != 0 ) && ( GxWebError == 0 ) && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( ( StringUtil.StrCmp(StringUtil.Right( GXDecQS, 6), Crypto.CheckSum( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), 6)) == 0 ) && ( StringUtil.StrCmp(StringUtil.Substring( GXDecQS, 1, StringUtil.Len( "trn_locationview.aspx")), "trn_locationview.aspx") == 0 ) )
               {
                  SetQueryString( StringUtil.Right( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)), (short)(StringUtil.Len( StringUtil.Left( GXDecQS, (short)(StringUtil.Len( GXDecQS)-6)))-StringUtil.Len( "trn_locationview.aspx")))) ;
               }
               else
               {
                  GxWebError = 1;
            ...
            if ( ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               if ( nGotPars == 0 )
               {
                  ...
                  {
                     AV10LocationId = StringUtil.StrToGuid( gxfirstwebparm);
                     AssignAttri("", false, "AV10LocationId", AV10LocationId.ToString());
                     GxWebStd.gx_hidden_field( context, "gxhash_vLOCATIONID", GetSecureSignedToken( "", AV10LocationId, context));
      ...
      protected void RF4U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Trn_amenitywc_Component) != 0 )
               {
                  WebComp_Trn_amenitywc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Trn_receptionistwc_Component) != 0 )
               {
                  WebComp_Trn_receptionistwc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         ...
         {
            /* Using cursor H004U2 */
            pr_default.execute(0, new Object[] {AV10LocationId, AV11OrganisationId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A11OrganisationId = H004U2_A11OrganisationId[0];
               A29LocationId = H004U2_A29LocationId[0];
               /* Execute user event: Load */
               E164U2 ();
      ...
      protected void E144U2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("trn_locationww.aspx") ;
         AssignProp("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV17GXLvl9 = 0;
         /* Using cursor H004U3 */
         pr_default.execute(1, new Object[] {AV10LocationId, AV11OrganisationId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A11OrganisationId = H004U3_A11OrganisationId[0];
            A29LocationId = H004U3_A29LocationId[0];
            A31LocationName = H004U3_A31LocationName[0];
            AV17GXLvl9 = 1;
            Form.Caption = A31LocationName;
      ...
      protected void E154U2( )
      {
         /* Refresh Routine */
         returnInSub = false;
         if ( ! new GeneXus.Programs.wwpbaseobjects.discussions.wwp_hasdiscussionmessages(context).executeUdp(  "Trn_Location",  StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString())) )
         {
         ...
         if ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_Location",  2) )
         {
      ...
      protected void E114U2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0050",(string)"",(string)"Trn_Location",(short)2,StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString()),(string)AV15RecordDescription});
      ...
      protected void E124U2( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0050",(string)"",(string)"Trn_Location",StringUtil.Trim( A29LocationId.ToString())+";"+StringUtil.Trim( A11OrganisationId.ToString()),(string)AV15RecordDescription,formatLink("trn_locationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey)});
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Webcomponent_general_Component), StringUtil.Lower( "Trn_LocationGeneral")) != 0 )
         {
            WebComp_Webcomponent_general = getWebComponent(GetType(), "GeneXus.Programs", "trn_locationgeneral", new Object[] {context} );
            WebComp_Webcomponent_general.ComponentInit();
            WebComp_Webcomponent_general.Name = "Trn_LocationGeneral";
            WebComp_Webcomponent_general_Component = "Trn_LocationGeneral";
         }
         if ( StringUtil.Len( WebComp_Webcomponent_general_Component) != 0 )
         {
            WebComp_Webcomponent_general.setjustcreated();
            WebComp_Webcomponent_general.componentprepare(new Object[] {(string)"W0023",(string)"",(Guid)AV10LocationId,(Guid)AV11OrganisationId});
      ...
      protected void S122( )
      {
         /* 'LOADTABS' Routine */
         returnInSub = false;
         if ( AV12LoadAllTabs || ( StringUtil.StrCmp(AV13SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV13SelectedTabCode, "Trn_Amenity") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Trn_amenitywc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Trn_amenitywc_Component), StringUtil.Lower( "Trn_LocationTrn_AmenityWC")) != 0 )
            {
               WebComp_Trn_amenitywc = getWebComponent(GetType(), "GeneXus.Programs", "trn_locationtrn_amenitywc", new Object[] {context} );
               WebComp_Trn_amenitywc.ComponentInit();
               WebComp_Trn_amenitywc.Name = "Trn_LocationTrn_AmenityWC";
               WebComp_Trn_amenitywc_Component = "Trn_LocationTrn_AmenityWC";
            }
            if ( StringUtil.Len( WebComp_Trn_amenitywc_Component) != 0 )
            {
               WebComp_Trn_amenitywc.setjustcreated();
               WebComp_Trn_amenitywc.componentprepare(new Object[] {(string)"W0037",(string)"",(Guid)AV10LocationId,(Guid)AV11OrganisationId});
               WebComp_Trn_amenitywc.componentbind(new Object[] {(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Trn_amenitywc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0037"+"");
               WebComp_Trn_amenitywc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
         ...
         if ( AV12LoadAllTabs || ( StringUtil.StrCmp(AV13SelectedTabCode, "Trn_Receptionist") == 0 ) )
         {
            /* Object Property */
            if ( true )
            {
               bDynCreated_Trn_receptionistwc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Trn_receptionistwc_Component), StringUtil.Lower( "Trn_LocationTrn_ReceptionistWC")) != 0 )
            {
               WebComp_Trn_receptionistwc = getWebComponent(GetType(), "GeneXus.Programs", "trn_locationtrn_receptionistwc", new Object[] {context} );
               WebComp_Trn_receptionistwc.ComponentInit();
               WebComp_Trn_receptionistwc.Name = "Trn_LocationTrn_ReceptionistWC";
               WebComp_Trn_receptionistwc_Component = "Trn_LocationTrn_ReceptionistWC";
            }
            if ( StringUtil.Len( WebComp_Trn_receptionistwc_Component) != 0 )
            {
               WebComp_Trn_receptionistwc.setjustcreated();
               WebComp_Trn_receptionistwc.componentprepare(new Object[] {(string)"W0045",(string)"",(Guid)AV10LocationId,(Guid)AV11OrganisationId});
               WebComp_Trn_receptionistwc.componentbind(new Object[] {(string)"",(string)""});
            }
            if ( isFullAjaxMode( ) || isAjaxCallMode( ) && bDynCreated_Trn_receptionistwc )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0045"+"");
               WebComp_Trn_receptionistwc.componentdraw();
               context.httpAjaxContext.ajax_rspEndCmp();
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10LocationId = (Guid)getParm(obj,0);
         AssignAttri("", false, "AV10LocationId", AV10LocationId.ToString());
         GxWebStd.gx_hidden_field( context, "gxhash_vLOCATIONID", GetSecureSignedToken( "", AV10LocationId, context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Trn_amenitywc == null ) )
         {
            if ( StringUtil.Len( WebComp_Trn_amenitywc_Component) != 0 )
            {
               WebComp_Trn_amenitywc.componentthemes();
            }
         }
         if ( ! ( WebComp_Trn_receptionistwc == null ) )
         {
            if ( StringUtil.Len( WebComp_Trn_receptionistwc_Component) != 0 )
            {
               WebComp_Trn_receptionistwc.componentthemes();
            }
         }
         if ( ! ( WebComp_Wwpaux_wc == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024101016443352", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_locationview.js", "?2024101016443352", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         divTrn_locationgeneral_cell_Internalname = "TRN_LOCATIONGENERAL_CELL";
         lblTrn_amenity_title_Internalname = "TRN_AMENITY_TITLE";
         divUnnamedtabletrn_amenity_Internalname = "UNNAMEDTABLETRN_AMENITY";
         lblTrn_receptionist_title_Internalname = "TRN_RECEPTIONIST_TITLE";
         divUnnamedtabletrn_receptionist_Internalname = "UNNAMEDTABLETRN_RECEPTIONIST";
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "Trn_Location View", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","""{"handler":"Refresh","iparms":[{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"AV10LocationId","fld":"vLOCATIONID","hsh":true},{"av":"AV11OrganisationId","fld":"vORGANISATIONID","hsh":true},{"av":"AV8TabCode","fld":"vTABCODE","hsh":true}]""");
         ...
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E114U2","iparms":[{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"},{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true}]""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT","""{"handler":"E124U2","iparms":[{"av":"AV15RecordDescription","fld":"vRECORDDESCRIPTION","hsh":true},{"av":"A29LocationId","fld":"LOCATIONID"},{"av":"A11OrganisationId","fld":"ORGANISATIONID"}]""");
         setEventMetadata("DDC_DISCUSSIONS.ONLOADCOMPONENT",""","oparms":[{"ctrl":"WWPAUX_WC"}]}""");
         setEventMetadata("TABS.TABCHANGED","""{"handler":"E134U2","iparms":[{"av":"Tabs_Activepagecontrolname","ctrl":"TABS","prop":"ActivePageControlName"},{"av":"AV12LoadAllTabs","fld":"vLOADALLTABS"},{"av":"AV13SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV10LocationId","fld":"vLOCATIONID","hsh":true},{"av":"AV11OrganisationId","fld":"vORGANISATIONID","hsh":true}]""");
         setEventMetadata("TABS.TABCHANGED",""","oparms":[{"av":"AV13SelectedTabCode","fld":"vSELECTEDTABCODE"},{"av":"AV12LoadAllTabs","fld":"vLOADALLTABS"},{"ctrl":"TRN_AMENITYWC"},{"ctrl":"TRN_RECEPTIONISTWC"}]}""");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         lblTrn_amenity_title_Jsonclick = "";
         WebComp_Trn_amenitywc_Component = "";
         OldTrn_amenitywc = "";
         lblTrn_receptionist_title_Jsonclick = "";
         WebComp_Trn_receptionistwc_Component = "";
         OldTrn_receptionistwc = "";
         ...
         sEvtType = "";
         GXDecQS = "";
         H004U2_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H004U2_A29LocationId = new Guid[] {Guid.Empty} ;
         AV6WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H004U3_A11OrganisationId = new Guid[] {Guid.Empty} ;
         H004U3_A29LocationId = new Guid[] {Guid.Empty} ;
         H004U3_A31LocationName = new string[] {""} ;
         A31LocationName = "";
         AV16Session = context.GetSession();
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_locationview__default(),
            new Object[][] {
                new Object[] {
               H004U2_A11OrganisationId, H004U2_A29LocationId
               }
               , new Object[] {
               H004U3_A11OrganisationId, H004U3_A29LocationId, H004U3_A31LocationName
               }
            }
         );
         WebComp_Webcomponent_general = new GeneXus.Http.GXNullWebComponent();
         WebComp_Trn_amenitywc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Trn_receptionistwc = new GeneXus.Http.GXNullWebComponent();
      ...
      private string divTrn_locationgeneral_cell_Internalname ;
      ...
      private string lblTrn_amenity_title_Internalname ;
      private string lblTrn_amenity_title_Jsonclick ;
      private string divUnnamedtabletrn_amenity_Internalname ;
      private string WebComp_Trn_amenitywc_Component ;
      private string OldTrn_amenitywc ;
      private string lblTrn_receptionist_title_Internalname ;
      private string lblTrn_receptionist_title_Jsonclick ;
      private string divUnnamedtabletrn_receptionist_Internalname ;
      private string WebComp_Trn_receptionistwc_Component ;
      private string OldTrn_receptionistwc ;
      ...
      private bool bDynCreated_Trn_amenitywc ;
      private bool bDynCreated_Trn_receptionistwc ;
      ...
      private Guid wcpOAV10LocationId ;
      private Guid wcpOAV11OrganisationId ;
      private Guid A29LocationId ;
      private Guid A11OrganisationId ;
      private IGxSession AV16Session ;
      private GXWebComponent WebComp_Webcomponent_general ;
      private GXWebComponent WebComp_Trn_amenitywc ;
      private GXWebComponent WebComp_Trn_receptionistwc ;
      ...
      private Guid[] H004U2_A11OrganisationId ;
      private Guid[] H004U2_A29LocationId ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
      private Guid[] H004U3_A11OrganisationId ;
      private Guid[] H004U3_A29LocationId ;
      private string[] H004U3_A31LocationName ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class trn_locationview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004U2", "SELECT OrganisationId, LocationId FROM Trn_Location WHERE LocationId = :AV10LocationId and OrganisationId = :AV11OrganisationId ORDER BY LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004U2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H004U3", "SELECT OrganisationId, LocationId, LocationName FROM Trn_Location WHERE (LocationId = :AV10LocationId and OrganisationId = :AV11OrganisationId) AND (LocationId = :AV10LocationId and OrganisationId = :AV11OrganisationId) ORDER BY LocationId, OrganisationId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004U3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
