...
namespace GeneXus.Programs {
   public class trn_medicalindicationww : GXDataArea
   {
      ...
      {
         return context.GetMessage( " Medical Indications", "") ;
      }
      ...
      protected void START642( )
      {
         ...
         Form.Meta.addItem("description", context.GetMessage( " Medical Indications", ""), 0) ;
         context.wjLoc = "";
      ...
      protected void E18642( )
      {
         ...
         Form.Caption = context.GetMessage( " Medical Indications", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411156402334", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_medicalindicationww.js", "?202411156402336", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
