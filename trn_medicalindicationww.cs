...
namespace GeneXus.Programs {
   public class trn_medicalindicationww : GXDataArea
   {
      public trn_medicalindicationww( )
      {
      ...
      public trn_medicalindicationww( IGxContext context )
      {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         AV19TFMedicalIndicationName = GetPar( "TFMedicalIndicationName");
         AV20TFMedicalIndicationName_Sel = GetPar( "TFMedicalIndicationName_Sel");
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedDsc, AV14FilterFullText, AV18ManageFiltersExecutionStep, AV40ColumnsSelector, AV42Pgmname, AV19TFMedicalIndicationName, AV20TFMedicalIndicationName_Sel, AV30IsAuthorized_Display, AV32IsAuthorized_Update, AV34IsAuthorized_Delete, AV35IsAuthorized_Insert) ;
      ...
      {
         get {
            return "trn_medicalindicationww_Execute" ;
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("trn_medicalindicationww.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV42Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV42Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "vTFMEDICALINDICATIONNAME", AV19TFMedicalIndicationName);
         GxWebStd.gx_hidden_field( context, "vTFMEDICALINDICATIONNAME_SEL", AV20TFMedicalIndicationName_Sel);
      ...
      {
         return formatLink("trn_medicalindicationww.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "Trn_MedicalIndicationWW" ;
      }
      ...
      protected void WB640( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_MedicalIndicationWW.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtneditcolumns_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "Select columns", bttBtneditcolumns_Jsonclick, 0, "Select columns", "", StyleString, ClassString, 1, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_MedicalIndicationWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "start", "top", "", "", "div");
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsubscriptions_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(39), 2, 0)+","+"null"+");", "", bttBtnsubscriptions_Jsonclick, 0, "Subscriptions", "", StyleString, ClassString, bttBtnsubscriptions_Visible, 0, "standard", "'"+""+"'"+",false,"+"'"+""+"'", TempTags, "", context.GetButtonType( ), "HLP_Trn_MedicalIndicationWW.htm");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
            GxWebStd.gx_div_end( context, "start", "top", "div");
      ...
      protected void START642( )
      {
         ...
         Form.Meta.addItem("description", " Medical Indications", 0) ;
         context.wjLoc = "";
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       string AV42Pgmname ,
                                       string AV19TFMedicalIndicationName ,
                                       string AV20TFMedicalIndicationName_Sel ,
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_MEDICALINDICATIONID", GetSecureSignedToken( "", A98MedicalIndicationId, context));
      ...
      {
         /* GeneXus formulas. */
         AV42Pgmname = "Trn_MedicalIndicationWW";
      }
      ...
      protected void RF642( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV43Trn_medicalindicationwwds_1_filterfulltext ,
                                                 AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel ,
                                                 AV44Trn_medicalindicationwwds_2_tfmedicalindicationname ,
            ...
            lV43Trn_medicalindicationwwds_1_filterfulltext = StringUtil.Concat( StringUtil.RTrim( AV43Trn_medicalindicationwwds_1_filterfulltext), "%", "");
            lV44Trn_medicalindicationwwds_2_tfmedicalindicationname = StringUtil.Concat( StringUtil.RTrim( AV44Trn_medicalindicationwwds_2_tfmedicalindicationname), "%", "");
            /* Using cursor H00642 */
            pr_default.execute(0, new Object[] {lV43Trn_medicalindicationwwds_1_filterfulltext, lV44Trn_medicalindicationwwds_2_tfmedicalindicationname, AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_39_idx = 1;
            sGXsfl_39_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_39_idx), 4, 0), 4, "0");
            SubsflControlProps_392( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A99MedicalIndicationName = H00642_A99MedicalIndicationName[0];
               A98MedicalIndicationId = H00642_A98MedicalIndicationId[0];
               /* Execute user event: Grid.Load */
               E20642 ();
      ...
      protected void send_integrity_lvl_hashes642( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_DELETE", AV34IsAuthorized_Delete);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_DELETE", GetSecureSignedToken( "", AV34IsAuthorized_Delete, context));
         GxWebStd.gx_hidden_field( context, "gxhash_MEDICALINDICATIONID"+"_"+sGXsfl_39_idx, GetSecureSignedToken( sGXsfl_39_idx, A98MedicalIndicationId, context));
         GxWebStd.gx_boolean_hidden_field( context, "vISAUTHORIZED_INSERT", AV35IsAuthorized_Insert);
         GxWebStd.gx_hidden_field( context, "gxhash_vISAUTHORIZED_INSERT", GetSecureSignedToken( "", AV35IsAuthorized_Insert, context));
      }
      ...
      {
         AV43Trn_medicalindicationwwds_1_filterfulltext = AV14FilterFullText;
         AV44Trn_medicalindicationwwds_2_tfmedicalindicationname = AV19TFMedicalIndicationName;
         AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel = AV20TFMedicalIndicationName_Sel;
         ...
         lV44Trn_medicalindicationwwds_2_tfmedicalindicationname = StringUtil.Concat( StringUtil.RTrim( AV44Trn_medicalindicationwwds_2_tfmedicalindicationname), "%", "");
         /* Using cursor H00643 */
         pr_default.execute(1, new Object[] {lV43Trn_medicalindicationwwds_1_filterfulltext, lV44Trn_medicalindicationwwds_2_tfmedicalindicationname, AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel});
      ...
      protected void E18642( )
      {
         ...
         Form.Caption = " Medical Indications";
      ...
      protected void E19642( )
      {
         ...
         if ( StringUtil.StrCmp(AV15Session.Get("Trn_MedicalIndicationWWColumnsSelector"), "") != 0 )
         {
            AV38ColumnsSelectorXML = AV15Session.Get("Trn_MedicalIndicationWWColumnsSelector");
         ...
         edtMedicalIndicationName_Visible = (((GeneXus.Programs.wwpbaseobjects.SdtWWPColumnsSelector_Column)AV40ColumnsSelector.gxTpr_Columns.Item(1)).gxTpr_Isvisible ? 1 : 0);
         AssignProp("", false, edtMedicalIndicationName_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtMedicalIndicationName_Visible), 5, 0), !bGXsfl_39_Refreshing);
      ...
      protected void E15642( )
      {
         ...
         {
            if ( StringUtil.StrCmp(Ddo_grid_Selectedcolumn, "MedicalIndicationName") == 0 )
            {
               AV19TFMedicalIndicationName = Ddo_grid_Filteredtext_get;
               AssignAttri("", false, "AV19TFMedicalIndicationName", AV19TFMedicalIndicationName);
               AV20TFMedicalIndicationName_Sel = Ddo_grid_Selectedvalue_get;
               AssignAttri("", false, "AV20TFMedicalIndicationName_Sel", AV20TFMedicalIndicationName_Sel);
            }
            subgrid_firstpage( ) ;
         }
         /*  Sending Event outputs  */
      ...
      protected void E16642( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savecolumnsselectorstate(context ).execute(  "Trn_MedicalIndicationWWColumnsSelector",  (String.IsNullOrEmpty(StringUtil.RTrim( AV38ColumnsSelectorXML)) ? "" : AV40ColumnsSelector.ToXml(false, true, "", ""))) ;
      ...
      protected void E11642( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_MedicalIndicationWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV42Pgmname+"GridState"));
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Manage#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.managefilters.aspx"+UrlEncode(StringUtil.RTrim("Trn_MedicalIndicationWWFilters"));
         ...
         else
         {
            ...
            new GeneXus.Programs.wwpbaseobjects.getfilterbyname(context ).execute(  "Trn_MedicalIndicationWWFilters",  Ddo_managefilters_Activeeventkey, out  GXt_char2) ;
      ...
      protected void E14642( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0054",(string)"",(string)"Trn_MedicalIndication",(short)1,(string)"",(string)""});
      ...
      protected void S162( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_columnsselector_add(context ).execute( ref  AV40ColumnsSelector,  "MedicalIndicationName",  "",  "Medical Indication",  true,  "") ;
         GXt_char2 = AV39UserCustomValue;
         new GeneXus.Programs.wwpbaseobjects.loadcolumnsselectorstate(context ).execute(  "Trn_MedicalIndicationWWColumnsSelector", out  GXt_char2) ;
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_medicalindicationview_Execute", out  GXt_boolean3) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_medicalindication_Update", out  GXt_boolean3) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_medicalindication_Delete", out  GXt_boolean3) ;
         ...
         new GeneXus.Programs.wwpbaseobjects.secgamisauthbyfunctionalitykey(context ).execute(  "trn_medicalindication_Insert", out  GXt_boolean3) ;
         ...
         if ( ! ( new GeneXus.Programs.wwpbaseobjects.subscriptions.wwp_hassubscriptionstodisplay(context).executeUdp(  "Trn_MedicalIndication",  1) ) )
         {
      ...
      protected void S112( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_managefiltersloadsavedfilters(context ).execute(  "Trn_MedicalIndicationWWFilters",  "",  "",  false, out  GXt_objcol_SdtDVB_SDTDropDownOptionsData_Item4) ;
      ...
      protected void S182( )
      {
         ...
         AV14FilterFullText = "";
         AssignAttri("", false, "AV14FilterFullText", AV14FilterFullText);
         AV19TFMedicalIndicationName = "";
         AssignAttri("", false, "AV19TFMedicalIndicationName", AV19TFMedicalIndicationName);
         AV20TFMedicalIndicationName_Sel = "";
         AssignAttri("", false, "AV20TFMedicalIndicationName_Sel", AV20TFMedicalIndicationName_Sel);
      ...
      protected void S202( )
      {
         ...
         if ( AV30IsAuthorized_Display )
         {
            ...
            CallWebObject(formatLink("trn_medicalindicationview.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
         {
      ...
      protected void S222( )
      {
         ...
         if ( AV34IsAuthorized_Delete )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "trn_medicalindication.aspx"+UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(A98MedicalIndicationId.ToString());
            CallWebObject(formatLink("trn_medicalindication.aspx") + "?" + UriEncrypt64( GXEncryptionTmp+Crypto.CheckSum( GXEncryptionTmp, 6), GXKey));
            context.wjLocDisableFrm = 1;
         }
         else
      ...
      protected void S192( )
      {
         ...
         while ( AV46GXV1 <= AV11GridState.gxTpr_Filtervalues.Count )
         {
            ...
            {
               AV19TFMedicalIndicationName = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV19TFMedicalIndicationName", AV19TFMedicalIndicationName);
            }
            else if ( StringUtil.StrCmp(AV12GridStateFilterValue.gxTpr_Name, "TFMEDICALINDICATIONNAME_SEL") == 0 )
            {
               AV20TFMedicalIndicationName_Sel = AV12GridStateFilterValue.gxTpr_Value;
               AssignAttri("", false, "AV20TFMedicalIndicationName_Sel", AV20TFMedicalIndicationName_Sel);
            }
            AV46GXV1 = (int)(AV46GXV1+1);
         }
         GXt_char2 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV20TFMedicalIndicationName_Sel)),  AV20TFMedicalIndicationName_Sel, out  GXt_char2) ;
         Ddo_grid_Selectedvalue_set = GXt_char2;
         ucDdo_grid.SendProperty(context, "", false, Ddo_grid_Internalname, "SelectedValue_set", Ddo_grid_Selectedvalue_set);
         GXt_char2 = "";
         new GeneXus.Programs.wwpbaseobjects.wwp_getfilterval(context ).execute(  String.IsNullOrEmpty(StringUtil.RTrim( AV19TFMedicalIndicationName)),  AV19TFMedicalIndicationName, out  GXt_char2) ;
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalue(context ).execute( ref  AV11GridState,  "FILTERFULLTEXT",  "Main filter",  !String.IsNullOrEmpty(StringUtil.RTrim( AV14FilterFullText)),  0,  AV14FilterFullText,  AV14FilterFullText,  false,  "",  "") ;
         new GeneXus.Programs.wwpbaseobjects.wwp_gridstateaddfiltervalueandsel(context ).execute( ref  AV11GridState,  "TFMEDICALINDICATIONNAME",  "Medical Indication",  !String.IsNullOrEmpty(StringUtil.RTrim( AV19TFMedicalIndicationName)),  0,  AV19TFMedicalIndicationName,  AV19TFMedicalIndicationName,  false,  "",  "",  !String.IsNullOrEmpty(StringUtil.RTrim( AV20TFMedicalIndicationName_Sel)),  AV20TFMedicalIndicationName_Sel,  AV20TFMedicalIndicationName_Sel) ;
      ...
      protected void S122( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Trn_MedicalIndication";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202411198381535", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_medicalindicationww.js", "?202411198381539", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      protected void StartGridControl39( )
      {
         if ( GridContainer.GetWrapped() == 1 )
         {
            ...
            context.WriteHtmlText( "<th align=\""+"start"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+((edtMedicalIndicationName_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
         ...
         else
         {
            ...
            GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtMedicalIndicationName_Visible), 5, 0, ".", "")));
            GridContainer.AddColumnProperties(GridColumn);
            GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      public override void initialize_properties( )
      {
         ...
         edtMedicalIndicationName_Visible = -1;
         edtMedicalIndicationName_Enabled = 0;
         edtMedicalIndicationId_Enabled = 0;
         subGrid_Sortable = 0;
         ...
         Ddo_grid_Datalistproc = "Trn_MedicalIndicationWWGetFilterData";
         ...
         Ddo_grid_Columnids = "1:MedicalIndicationName";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED","""{"handler":"E15642","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV42Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFMedicalIndicationName","fld":"vTFMEDICALINDICATIONNAME"},{"av":"AV20TFMedicalIndicationName_Sel","fld":"vTFMEDICALINDICATIONNAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_grid_Activeeventkey","ctrl":"DDO_GRID","prop":"ActiveEventKey"},{"av":"Ddo_grid_Selectedcolumn","ctrl":"DDO_GRID","prop":"SelectedColumn"},{"av":"Ddo_grid_Filteredtext_get","ctrl":"DDO_GRID","prop":"FilteredText_get"},{"av":"Ddo_grid_Selectedvalue_get","ctrl":"DDO_GRID","prop":"SelectedValue_get"}]""");
         setEventMetadata("DDO_GRID.ONOPTIONCLICKED",""","oparms":[{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV19TFMedicalIndicationName","fld":"vTFMEDICALINDICATIONNAME"},{"av":"AV20TFMedicalIndicationName_Sel","fld":"vTFMEDICALINDICATIONNAME_SEL"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"}]}""");
         setEventMetadata("GRID.LOAD","""{"handler":"E20642","iparms":[{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
         setEventMetadata("GRID.LOAD",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV36ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"}]}""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED","""{"handler":"E16642","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV42Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFMedicalIndicationName","fld":"vTFMEDICALINDICATIONNAME"},{"av":"AV20TFMedicalIndicationName_Sel","fld":"vTFMEDICALINDICATIONNAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"Ddo_gridcolumnsselector_Columnsselectorvalues","ctrl":"DDO_GRIDCOLUMNSSELECTOR","prop":"ColumnsSelectorValues"}]""");
         setEventMetadata("DDO_GRIDCOLUMNSSELECTOR.ONCOLUMNSCHANGED",""","oparms":[{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"edtMedicalIndicationName_Visible","ctrl":"MEDICALINDICATIONNAME","prop":"Visible"},{"av":"AV25GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV26GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV27GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV16ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         ...
         setEventMetadata("DDO_MANAGEFILTERS.ONOPTIONCLICKED",""","oparms":[{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV11GridState","fld":"vGRIDSTATE"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV19TFMedicalIndicationName","fld":"vTFMEDICALINDICATIONNAME"},{"av":"AV20TFMedicalIndicationName_Sel","fld":"vTFMEDICALINDICATIONNAME_SEL"},{"av":"Ddo_grid_Selectedvalue_set","ctrl":"DDO_GRID","prop":"SelectedValue_set"},{"av":"Ddo_grid_Filteredtext_set","ctrl":"DDO_GRID","prop":"FilteredText_set"},{"av":"Ddo_grid_Sortedstatus","ctrl":"DDO_GRID","prop":"SortedStatus"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMedicalIndicationName_Visible","ctrl":"MEDICALINDICATIONNAME","prop":"Visible"},{"av":"AV25GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV26GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV27GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV16ManageFiltersData","fld":"vMANAGEFILTERSDATA"}]}""");
         setEventMetadata("VACTIONGROUP.CLICK","""{"handler":"E21642","iparms":[{"av":"cmbavActiongroup"},{"av":"AV36ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV42Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFMedicalIndicationName","fld":"vTFMEDICALINDICATIONNAME"},{"av":"AV20TFMedicalIndicationName_Sel","fld":"vTFMEDICALINDICATIONNAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID","hsh":true}]""");
         setEventMetadata("VACTIONGROUP.CLICK",""","oparms":[{"av":"cmbavActiongroup"},{"av":"AV36ActionGroup","fld":"vACTIONGROUP","pic":"ZZZ9"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMedicalIndicationName_Visible","ctrl":"MEDICALINDICATIONNAME","prop":"Visible"},{"av":"AV25GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV26GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV27GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV16ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("'DOINSERT'","""{"handler":"E17642","iparms":[{"av":"GRID_nFirstRecordOnPage"},{"av":"GRID_nEOF"},{"av":"subGrid_Rows","ctrl":"GRID","prop":"Rows"},{"av":"AV13OrderedDsc","fld":"vORDEREDDSC"},{"av":"AV14FilterFullText","fld":"vFILTERFULLTEXT"},{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"AV42Pgmname","fld":"vPGMNAME","hsh":true},{"av":"AV19TFMedicalIndicationName","fld":"vTFMEDICALINDICATIONNAME"},{"av":"AV20TFMedicalIndicationName_Sel","fld":"vTFMEDICALINDICATIONNAME_SEL"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"av":"A98MedicalIndicationId","fld":"MEDICALINDICATIONID","hsh":true}]""");
         setEventMetadata("'DOINSERT'",""","oparms":[{"av":"AV18ManageFiltersExecutionStep","fld":"vMANAGEFILTERSEXECUTIONSTEP","pic":"9"},{"av":"AV40ColumnsSelector","fld":"vCOLUMNSSELECTOR"},{"av":"edtMedicalIndicationName_Visible","ctrl":"MEDICALINDICATIONNAME","prop":"Visible"},{"av":"AV25GridCurrentPage","fld":"vGRIDCURRENTPAGE","pic":"ZZZZZZZZZ9"},{"av":"AV26GridPageCount","fld":"vGRIDPAGECOUNT","pic":"ZZZZZZZZZ9"},{"av":"AV27GridAppliedFilters","fld":"vGRIDAPPLIEDFILTERS"},{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true},{"av":"AV35IsAuthorized_Insert","fld":"vISAUTHORIZED_INSERT","hsh":true},{"ctrl":"BTNINSERT","prop":"Visible"},{"ctrl":"BTNSUBSCRIPTIONS","prop":"Visible"},{"av":"AV16ManageFiltersData","fld":"vMANAGEFILTERSDATA"},{"av":"AV11GridState","fld":"vGRIDSTATE"}]}""");
         setEventMetadata("DDC_SUBSCRIPTIONS.ONLOADCOMPONENT","""{"handler":"E14642","iparms":[]""");
      ...
      public override void initialize( )
      {
         ...
         A99MedicalIndicationName = "";
         lV43Trn_medicalindicationwwds_1_filterfulltext = "";
         lV44Trn_medicalindicationwwds_2_tfmedicalindicationname = "";
         AV43Trn_medicalindicationwwds_1_filterfulltext = "";
         AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel = "";
         AV44Trn_medicalindicationwwds_2_tfmedicalindicationname = "";
         H00642_A99MedicalIndicationName = new string[] {""} ;
         H00642_A98MedicalIndicationId = new Guid[] {Guid.Empty} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.trn_medicalindicationww__default(),
            new Object[][] {
                new Object[] {
               H00642_A99MedicalIndicationName, H00642_A98MedicalIndicationId
               }
               , new Object[] {
      ...
      private int edtMedicalIndicationName_Visible ;
      ...
      private string AV19TFMedicalIndicationName ;
      private string AV20TFMedicalIndicationName_Sel ;
      private string AV27GridAppliedFilters ;
      private string A99MedicalIndicationName ;
      private string lV43Trn_medicalindicationwwds_1_filterfulltext ;
      private string lV44Trn_medicalindicationwwds_2_tfmedicalindicationname ;
      private string AV43Trn_medicalindicationwwds_1_filterfulltext ;
      private string AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel ;
      private string AV44Trn_medicalindicationwwds_2_tfmedicalindicationname ;
      ...
      private string[] H00642_A99MedicalIndicationName ;
      private Guid[] H00642_A98MedicalIndicationId ;
   ...
   public class trn_medicalindicationww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H00642( IGxContext context ,
                                             string AV43Trn_medicalindicationwwds_1_filterfulltext ,
                                             string AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel ,
                                             string AV44Trn_medicalindicationwwds_2_tfmedicalindicationname ,
                                             ...
                                             bool AV13OrderedDsc )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel)) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV44Trn_medicalindicationwwds_2_tfmedicalindicationname)) ) )
         {
            AddWhere(sWhereString, "(MedicalIndicationName like :lV44Trn_medicalindicationwwds_2_tfmedicalindicationname)");
         }
         else
         {
            GXv_int5[1] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel)) && ! ( StringUtil.StrCmp(AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel, "<#Empty#>") == 0 ) )
         {
            AddWhere(sWhereString, "(MedicalIndicationName = ( :AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel))");
         }
         else
         {
            GXv_int5[2] = 1;
         }
         if ( StringUtil.StrCmp(AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel, "<#Empty#>") == 0 )
         {
         ...
         {
            sOrderString += " ORDER BY MedicalIndicationName DESC, MedicalIndicationId";
         }
         else if ( true )
         {
            sOrderString += " ORDER BY MedicalIndicationId";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00642(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] );
               case 1 :
                     return conditional_H00643(context, (string)dynConstraints[0] , (string)dynConstraints[1] , (string)dynConstraints[2] , (string)dynConstraints[3] , (bool)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("lV43Trn_medicalindicationwwds_1_filterfulltext",GXType.VarChar,100,0) ,
          new ParDef("lV44Trn_medicalindicationwwds_2_tfmedicalindicationname",GXType.VarChar,100,0) ,
          new ParDef("AV45Trn_medicalindicationwwds_3_tfmedicalindicationname_sel",GXType.VarChar,100,0) ,
