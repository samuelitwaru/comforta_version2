...
namespace GeneXus.Programs {
   public class trn_medicalindicationww : GXDataArea
   {
      ...
      protected void gxgrGrid_refresh_invoke( )
      {
         ...
         gxgrGrid_refresh( subGrid_Rows, AV13OrderedDsc, AV14FilterFullText, AV18ManageFiltersExecutionStep, AV37Pgmname, AV19TFMedicalIndicationName, AV20TFMedicalIndicationName_Sel, AV30IsAuthorized_Display, AV32IsAuthorized_Update, AV34IsAuthorized_Delete, AV35IsAuthorized_Insert) ;
      ...
      {
         /* GeneXus formulas. */
         AV37Pgmname = "Trn_MedicalIndicationWW";
      }
      ...
      protected void RF642( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00642 */
            pr_default.execute(0, new Object[] {lV38Trn_medicalindicationwwds_1_filterfulltext, lV39Trn_medicalindicationwwds_2_tfmedicalindicationname, AV40Trn_medicalindicationwwds_3_tfmedicalindicationname_sel, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_37_idx = 1;
            sGXsfl_37_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_37_idx), 4, 0), 4, "0");
            SubsflControlProps_372( ) ;
      ...
      {
         AV38Trn_medicalindicationwwds_1_filterfulltext = AV14FilterFullText;
         AV39Trn_medicalindicationwwds_2_tfmedicalindicationname = AV19TFMedicalIndicationName;
         AV40Trn_medicalindicationwwds_3_tfmedicalindicationname_sel = AV20TFMedicalIndicationName_Sel;
         ...
         lV39Trn_medicalindicationwwds_2_tfmedicalindicationname = StringUtil.Concat( StringUtil.RTrim( AV39Trn_medicalindicationwwds_2_tfmedicalindicationname), "%", "");
         /* Using cursor H00643 */
         pr_default.execute(1, new Object[] {lV38Trn_medicalindicationwwds_1_filterfulltext, lV39Trn_medicalindicationwwds_2_tfmedicalindicationname, AV40Trn_medicalindicationwwds_3_tfmedicalindicationname_sel});
      ...
      protected void E18642( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.wwp_getappliedfiltersdescription(context ).execute(  AV37Pgmname, out  GXt_char2) ;
      ...
      protected void E11642( )
      {
         ...
         else if ( StringUtil.StrCmp(Ddo_managefilters_Activeeventkey, "<#Save#>") == 0 )
         {
            ...
            GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
            GXEncryptionTmp = "wwpbaseobjects.savefilteras.aspx"+UrlEncode(StringUtil.RTrim("Trn_MedicalIndicationWWFilters")) + "," + UrlEncode(StringUtil.RTrim(AV37Pgmname+"GridState"));
      ...
      protected void E14642( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wwpaux_wc_Component) != 0 )
         {
            ...
            WebComp_Wwpaux_wc.componentprepare(new Object[] {(string)"W0051",(string)"",(string)"Trn_MedicalIndication",(short)1,(string)"",(string)""});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2024102518441323", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("trn_medicalindicationww.js", "?2024102518441325", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
         context.AddJavascriptSource("DVelop/Shared/WorkWithPlusCommon.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false, true);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","""{"handler":"E19642","iparms":[{"av":"AV30IsAuthorized_Display","fld":"vISAUTHORIZED_DISPLAY","hsh":true},{"av":"AV32IsAuthorized_Update","fld":"vISAUTHORIZED_UPDATE","hsh":true},{"av":"AV34IsAuthorized_Delete","fld":"vISAUTHORIZED_DELETE","hsh":true}]""");
   ...
   public class trn_medicalindicationww__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV13OrderedDsc )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV40Trn_medicalindicationwwds_3_tfmedicalindicationname_sel)) && ! ( StringUtil.StrCmp(AV40Trn_medicalindicationwwds_3_tfmedicalindicationname_sel, "<#Empty#>") == 0 ) )
         {
         ...
         if ( StringUtil.StrCmp(AV40Trn_medicalindicationwwds_3_tfmedicalindicationname_sel, "<#Empty#>") == 0 )
         {
